...
$ helm repo update
$ helm search repo appscode/snsawskubedbcom-topic-editor --version=v0.27.0
...
```bash
$ helm upgrade -i snsawskubedbcom-topic-editor appscode/snsawskubedbcom-topic-editor -n default --create-namespace --version=v0.27.0 --set apiVersion=sns.aws.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i snsawskubedbcom-topic-editor appscode/snsawskubedbcom-topic-editor -n default --create-namespace --version=v0.27.0 --values values.yaml
```
