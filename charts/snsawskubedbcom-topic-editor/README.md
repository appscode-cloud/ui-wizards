...
$ helm repo update
$ helm search repo appscode-charts-oci/snsawskubedbcom-topic-editor --version=v0.4.19
$ helm upgrade -i snsawskubedbcom-topic-editor appscode-charts-oci/snsawskubedbcom-topic-editor -n default --create-namespace --version=v0.4.19
```
...
```bash
$ helm upgrade -i snsawskubedbcom-topic-editor appscode-charts-oci/snsawskubedbcom-topic-editor -n default --create-namespace --version=v0.4.19 --set apiVersion=sns.aws.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i snsawskubedbcom-topic-editor appscode-charts-oci/snsawskubedbcom-topic-editor -n default --create-namespace --version=v0.4.19 --values values.yaml
```
