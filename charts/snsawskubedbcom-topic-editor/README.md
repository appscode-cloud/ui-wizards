...
$ helm repo update
$ helm search repo appscode-charts-oci/snsawskubedbcom-topic-editor --version=v0.14.0
$ helm upgrade -i snsawskubedbcom-topic-editor appscode-charts-oci/snsawskubedbcom-topic-editor -n default --create-namespace --version=v0.14.0
```
...
```bash
$ helm upgrade -i snsawskubedbcom-topic-editor appscode-charts-oci/snsawskubedbcom-topic-editor -n default --create-namespace --version=v0.14.0 --set apiVersion=sns.aws.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i snsawskubedbcom-topic-editor appscode-charts-oci/snsawskubedbcom-topic-editor -n default --create-namespace --version=v0.14.0 --values values.yaml
```
