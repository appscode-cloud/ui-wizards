...
$ helm repo update
$ helm search repo appscode/metak8sappscodecom-gatewayinfo-editor --version=v0.21.0
$ helm upgrade -i metak8sappscodecom-gatewayinfo-editor appscode/metak8sappscodecom-gatewayinfo-editor -n default --create-namespace --version=v0.21.0
```
...
```bash
$ helm upgrade -i metak8sappscodecom-gatewayinfo-editor appscode/metak8sappscodecom-gatewayinfo-editor -n default --create-namespace --version=v0.21.0 --set apiVersion=meta.k8s.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i metak8sappscodecom-gatewayinfo-editor appscode/metak8sappscodecom-gatewayinfo-editor -n default --create-namespace --version=v0.21.0 --values values.yaml
```
