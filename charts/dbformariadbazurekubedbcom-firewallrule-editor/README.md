...
$ helm repo update
$ helm search repo appscode-charts-oci/dbformariadbazurekubedbcom-firewallrule-editor --version=v0.13.0
$ helm upgrade -i dbformariadbazurekubedbcom-firewallrule-editor appscode-charts-oci/dbformariadbazurekubedbcom-firewallrule-editor -n default --create-namespace --version=v0.13.0
```
...
```bash
$ helm upgrade -i dbformariadbazurekubedbcom-firewallrule-editor appscode-charts-oci/dbformariadbazurekubedbcom-firewallrule-editor -n default --create-namespace --version=v0.13.0 --set apiVersion=dbformariadb.azure.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i dbformariadbazurekubedbcom-firewallrule-editor appscode-charts-oci/dbformariadbazurekubedbcom-firewallrule-editor -n default --create-namespace --version=v0.13.0 --values values.yaml
```
