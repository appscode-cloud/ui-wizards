...
*/}}
{{- define "kubedbcom-singlestore-editor-options.name" -}}
...
*/}}
{{- define "kubedbcom-singlestore-editor-options.fullname" -}}
...
*/}}
{{- define "kubedbcom-singlestore-editor-options.chart" -}}
...
Common labels
*/}}
{{- define "kubedbcom-singlestore-editor-options.labels" -}}
{{ include "kubedbcom-singlestore-editor-options.selectorLabels" . }}
...
Selector labels
*/}}
{{- define "kubedbcom-singlestore-editor-options.selectorLabels" -}}
app.kubernetes.io/name: singlestores.kubedb.com
app.kubernetes.io/instance: {{ include "kubedbcom-singlestore-editor-options.fullname" . }}
{{- end }}

{{/*
Create the name of the service account to use
*/}}
{{- define "kubedbcom-singlestore-editor-options.serviceAccountName" -}}
{{- if .Values.spec.serviceAccount.create }}
{{- default (include "kubedbcom-singlestore-editor-options.fullname" .) .Values.spec.serviceAccount.name }}
{{- else }}
...
Common annotations
*/}}
{{- define "kubedbcom-singlestore-editor-options.annotations" -}}
...
Alert Enabled
*/}}
{{- define "kubedbcom-singlestore-editor-options.alertEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
