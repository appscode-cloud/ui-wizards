...
$ helm repo update
$ helm search repo bytebuilders-ui/kubedbcom-singlestore-editor-options --version=v0.4.21
$ helm upgrade -i kubedbcom-singlestore-editor-options bytebuilders-ui/kubedbcom-singlestore-editor-options -n kube-system --create-namespace --version=v0.4.21
```
...
```bash
$ helm upgrade -i kubedbcom-singlestore-editor-options bytebuilders-ui/kubedbcom-singlestore-editor-options -n kube-system --create-namespace --version=v0.4.21 --set metadata.resource.group=kubedb.com
```
...
```bash
$ helm upgrade -i kubedbcom-singlestore-editor-options bytebuilders-ui/kubedbcom-singlestore-editor-options -n kube-system --create-namespace --version=v0.4.21 --values values.yaml
```
