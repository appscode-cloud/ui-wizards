...
$ helm repo update
$ helm search repo appscode/archiverkubedbcom-mssqlserverarchiver-editor --version=v0.15.0
$ helm upgrade -i archiverkubedbcom-mssqlserverarchiver-editor appscode/archiverkubedbcom-mssqlserverarchiver-editor -n default --create-namespace --version=v0.15.0
```
...
```bash
$ helm upgrade -i archiverkubedbcom-mssqlserverarchiver-editor appscode/archiverkubedbcom-mssqlserverarchiver-editor -n default --create-namespace --version=v0.15.0 --set apiVersion=archiver.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i archiverkubedbcom-mssqlserverarchiver-editor appscode/archiverkubedbcom-mssqlserverarchiver-editor -n default --create-namespace --version=v0.15.0 --values values.yaml
```
