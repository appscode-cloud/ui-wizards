...
$ helm repo update
$ helm search repo appscode/gatewaynetworkingk8sio-httproute-editor --version=v0.32.0
$ helm upgrade -i gatewaynetworkingk8sio-httproute-editor appscode/gatewaynetworkingk8sio-httproute-editor -n default --create-namespace --version=v0.32.0
```
...
```bash
$ helm upgrade -i gatewaynetworkingk8sio-httproute-editor appscode/gatewaynetworkingk8sio-httproute-editor -n default --create-namespace --version=v0.32.0 --set apiVersion=gateway.networking.k8s.io/v1
```
...
```bash
$ helm upgrade -i gatewaynetworkingk8sio-httproute-editor appscode/gatewaynetworkingk8sio-httproute-editor -n default --create-namespace --version=v0.32.0 --values values.yaml
```
