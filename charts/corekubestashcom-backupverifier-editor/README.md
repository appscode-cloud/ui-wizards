...
$ helm repo update
$ helm search repo appscode/corekubestashcom-backupverifier-editor --version=v0.14.0
$ helm upgrade -i corekubestashcom-backupverifier-editor appscode/corekubestashcom-backupverifier-editor -n default --create-namespace --version=v0.14.0
```
...
```bash
$ helm upgrade -i corekubestashcom-backupverifier-editor appscode/corekubestashcom-backupverifier-editor -n default --create-namespace --version=v0.14.0 --set apiVersion=core.kubestash.com/v1alpha1
```
...
```bash
$ helm upgrade -i corekubestashcom-backupverifier-editor appscode/corekubestashcom-backupverifier-editor -n default --create-namespace --version=v0.14.0 --values values.yaml
```
