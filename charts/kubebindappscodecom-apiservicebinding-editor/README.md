...
$ helm repo update
$ helm search repo appscode/kubebindappscodecom-apiservicebinding-editor --version=v0.15.0
$ helm upgrade -i kubebindappscodecom-apiservicebinding-editor appscode/kubebindappscodecom-apiservicebinding-editor -n default --create-namespace --version=v0.15.0
```
...
```bash
$ helm upgrade -i kubebindappscodecom-apiservicebinding-editor appscode/kubebindappscodecom-apiservicebinding-editor -n default --create-namespace --version=v0.15.0 --set apiVersion=kube-bind.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i kubebindappscodecom-apiservicebinding-editor appscode/kubebindappscodecom-apiservicebinding-editor -n default --create-namespace --version=v0.15.0 --values values.yaml
```
