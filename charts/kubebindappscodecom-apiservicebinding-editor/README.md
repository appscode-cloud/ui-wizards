...
$ helm repo update
$ helm search repo appscode-charts-oci/kubebindappscodecom-apiservicebinding-editor --version=v0.4.19
$ helm upgrade -i kubebindappscodecom-apiservicebinding-editor appscode-charts-oci/kubebindappscodecom-apiservicebinding-editor -n default --create-namespace --version=v0.4.19
```
...
```bash
$ helm upgrade -i kubebindappscodecom-apiservicebinding-editor appscode-charts-oci/kubebindappscodecom-apiservicebinding-editor -n default --create-namespace --version=v0.4.19 --set apiVersion=kube-bind.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i kubebindappscodecom-apiservicebinding-editor appscode-charts-oci/kubebindappscodecom-apiservicebinding-editor -n default --create-namespace --version=v0.4.19 --values values.yaml
```
