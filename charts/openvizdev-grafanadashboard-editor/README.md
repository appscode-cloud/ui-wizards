...
$ helm repo update
$ helm search repo appscode-charts-oci/openvizdev-grafanadashboard-editor --version=v0.11.0
...
```bash
$ helm upgrade -i openvizdev-grafanadashboard-editor appscode-charts-oci/openvizdev-grafanadashboard-editor -n default --create-namespace --version=v0.11.0 --set apiVersion=openviz.dev/v1alpha1
```
...
```bash
$ helm upgrade -i openvizdev-grafanadashboard-editor appscode-charts-oci/openvizdev-grafanadashboard-editor -n default --create-namespace --version=v0.11.0 --values values.yaml
```
