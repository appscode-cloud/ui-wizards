...
$ helm repo update
$ helm search repo bytebuilders-ui/openvizdev-grafanadashboard-editor --version=v0.4.3
$ helm upgrade -i openvizdev-grafanadashboard-editor bytebuilders-ui/openvizdev-grafanadashboard-editor -n default --create-namespace --version=v0.4.3
```
...
```bash
$ helm upgrade -i openvizdev-grafanadashboard-editor bytebuilders-ui/openvizdev-grafanadashboard-editor -n default --create-namespace --version=v0.4.3 --set apiVersion=openviz.dev/v1alpha1
```
...
```bash
$ helm upgrade -i openvizdev-grafanadashboard-editor bytebuilders-ui/openvizdev-grafanadashboard-editor -n default --create-namespace --version=v0.4.3 --values values.yaml
```
