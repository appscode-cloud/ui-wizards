...
$ helm repo update
$ helm search repo appscode-charts-oci/openvizdev-grafanadashboard-editor --version=v0.4.21
$ helm upgrade -i openvizdev-grafanadashboard-editor appscode-charts-oci/openvizdev-grafanadashboard-editor -n default --create-namespace --version=v0.4.21
```
...
```bash
$ helm upgrade -i openvizdev-grafanadashboard-editor appscode-charts-oci/openvizdev-grafanadashboard-editor -n default --create-namespace --version=v0.4.21 --set apiVersion=openviz.dev/v1alpha1
```
...
```bash
$ helm upgrade -i openvizdev-grafanadashboard-editor appscode-charts-oci/openvizdev-grafanadashboard-editor -n default --create-namespace --version=v0.4.21 --values values.yaml
```
