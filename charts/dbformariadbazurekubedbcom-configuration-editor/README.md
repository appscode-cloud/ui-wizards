...
$ helm repo update
$ helm search repo appscode-charts-oci/dbformariadbazurekubedbcom-configuration-editor --version=v0.5.0
$ helm upgrade -i dbformariadbazurekubedbcom-configuration-editor appscode-charts-oci/dbformariadbazurekubedbcom-configuration-editor -n default --create-namespace --version=v0.5.0
```
...
```bash
$ helm upgrade -i dbformariadbazurekubedbcom-configuration-editor appscode-charts-oci/dbformariadbazurekubedbcom-configuration-editor -n default --create-namespace --version=v0.5.0 --set apiVersion=dbformariadb.azure.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i dbformariadbazurekubedbcom-configuration-editor appscode-charts-oci/dbformariadbazurekubedbcom-configuration-editor -n default --create-namespace --version=v0.5.0 --values values.yaml
```
