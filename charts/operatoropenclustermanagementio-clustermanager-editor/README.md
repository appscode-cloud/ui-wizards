...
$ helm repo update
$ helm search repo appscode-charts-oci/operatoropenclustermanagementio-clustermanager-editor --version=v0.6.0
$ helm upgrade -i operatoropenclustermanagementio-clustermanager-editor appscode-charts-oci/operatoropenclustermanagementio-clustermanager-editor -n default --create-namespace --version=v0.6.0
```
...
```bash
$ helm upgrade -i operatoropenclustermanagementio-clustermanager-editor appscode-charts-oci/operatoropenclustermanagementio-clustermanager-editor -n default --create-namespace --version=v0.6.0 --set apiVersion=operator.open-cluster-management.io/v1
```
...
```bash
$ helm upgrade -i operatoropenclustermanagementio-clustermanager-editor appscode-charts-oci/operatoropenclustermanagementio-clustermanager-editor -n default --create-namespace --version=v0.6.0 --values values.yaml
```
