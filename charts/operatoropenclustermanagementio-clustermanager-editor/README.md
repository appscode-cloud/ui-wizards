...
$ helm repo update
$ helm search repo bytebuilders-ui/operatoropenclustermanagementio-clustermanager-editor --version=v0.4.18
$ helm upgrade -i operatoropenclustermanagementio-clustermanager-editor bytebuilders-ui/operatoropenclustermanagementio-clustermanager-editor -n default --create-namespace --version=v0.4.18
```
...
```bash
$ helm upgrade -i operatoropenclustermanagementio-clustermanager-editor bytebuilders-ui/operatoropenclustermanagementio-clustermanager-editor -n default --create-namespace --version=v0.4.18 --set apiVersion=operator.open-cluster-management.io/v1
```
...
```bash
$ helm upgrade -i operatoropenclustermanagementio-clustermanager-editor bytebuilders-ui/operatoropenclustermanagementio-clustermanager-editor -n default --create-namespace --version=v0.4.18 --values values.yaml
```
