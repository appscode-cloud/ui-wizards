...
$ helm repo update
$ helm search repo bytebuilders-ui/clusteropenclustermanagementio-clusterclaim-editor --version=v0.4.17
$ helm upgrade -i clusteropenclustermanagementio-clusterclaim-editor bytebuilders-ui/clusteropenclustermanagementio-clusterclaim-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i clusteropenclustermanagementio-clusterclaim-editor bytebuilders-ui/clusteropenclustermanagementio-clusterclaim-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=cluster.open-cluster-management.io/v1alpha1
```
...
```bash
$ helm upgrade -i clusteropenclustermanagementio-clusterclaim-editor bytebuilders-ui/clusteropenclustermanagementio-clusterclaim-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
