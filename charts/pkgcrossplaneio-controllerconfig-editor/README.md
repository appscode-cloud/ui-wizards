...
$ helm repo update
$ helm search repo appscode/pkgcrossplaneio-controllerconfig-editor --version=v0.25.0
$ helm upgrade -i pkgcrossplaneio-controllerconfig-editor appscode/pkgcrossplaneio-controllerconfig-editor -n default --create-namespace --version=v0.25.0
```
...
```bash
$ helm upgrade -i pkgcrossplaneio-controllerconfig-editor appscode/pkgcrossplaneio-controllerconfig-editor -n default --create-namespace --version=v0.25.0 --set apiVersion=pkg.crossplane.io/v1alpha1
```
...
```bash
$ helm upgrade -i pkgcrossplaneio-controllerconfig-editor appscode/pkgcrossplaneio-controllerconfig-editor -n default --create-namespace --version=v0.25.0 --values values.yaml
```
