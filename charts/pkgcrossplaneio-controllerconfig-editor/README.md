...
$ helm repo update
$ helm search repo bytebuilders-ui/pkgcrossplaneio-controllerconfig-editor --version=v0.4.16
$ helm upgrade -i pkgcrossplaneio-controllerconfig-editor bytebuilders-ui/pkgcrossplaneio-controllerconfig-editor -n default --create-namespace --version=v0.4.16
```
...
```bash
$ helm upgrade -i pkgcrossplaneio-controllerconfig-editor bytebuilders-ui/pkgcrossplaneio-controllerconfig-editor -n default --create-namespace --version=v0.4.16 --set apiVersion=pkg.crossplane.io/v1alpha1
```
...
```bash
$ helm upgrade -i pkgcrossplaneio-controllerconfig-editor bytebuilders-ui/pkgcrossplaneio-controllerconfig-editor -n default --create-namespace --version=v0.4.16 --values values.yaml
```
