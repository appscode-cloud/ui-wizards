...
$ helm repo update
$ helm search repo appscode-charts-oci/pkgcrossplaneio-controllerconfig-editor --version=v0.5.0
$ helm upgrade -i pkgcrossplaneio-controllerconfig-editor appscode-charts-oci/pkgcrossplaneio-controllerconfig-editor -n default --create-namespace --version=v0.5.0
```
...
```bash
$ helm upgrade -i pkgcrossplaneio-controllerconfig-editor appscode-charts-oci/pkgcrossplaneio-controllerconfig-editor -n default --create-namespace --version=v0.5.0 --set apiVersion=pkg.crossplane.io/v1alpha1
```
...
```bash
$ helm upgrade -i pkgcrossplaneio-controllerconfig-editor appscode-charts-oci/pkgcrossplaneio-controllerconfig-editor -n default --create-namespace --version=v0.5.0 --values values.yaml
```
