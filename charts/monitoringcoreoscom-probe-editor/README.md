...
$ helm repo update
$ helm search repo appscode/monitoringcoreoscom-probe-editor --version=v0.25.0
$ helm upgrade -i monitoringcoreoscom-probe-editor appscode/monitoringcoreoscom-probe-editor -n default --create-namespace --version=v0.25.0
```
...
```bash
$ helm upgrade -i monitoringcoreoscom-probe-editor appscode/monitoringcoreoscom-probe-editor -n default --create-namespace --version=v0.25.0 --set apiVersion=monitoring.coreos.com/v1
```
...
```bash
$ helm upgrade -i monitoringcoreoscom-probe-editor appscode/monitoringcoreoscom-probe-editor -n default --create-namespace --version=v0.25.0 --values values.yaml
```
