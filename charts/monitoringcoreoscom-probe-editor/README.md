...
$ helm repo update
$ helm install monitoringcoreoscom-probe-editor bytebuilders-ui/monitoringcoreoscom-probe-editor -n default --version=v0.1.0
```
...
```console
$ helm install monitoringcoreoscom-probe-editor bytebuilders-ui/monitoringcoreoscom-probe-editor -n default --version=v0.1.0 --set apiVersion=monitoring.coreos.com/v1
```
...
```console
$ helm install monitoringcoreoscom-probe-editor bytebuilders-ui/monitoringcoreoscom-probe-editor -n default --version=v0.1.0 --values values.yaml
```
