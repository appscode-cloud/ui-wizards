...
$ helm repo update
$ helm search repo appscode-charts-oci/monitoringcoreoscom-probe-editor --version=v0.8.0
$ helm upgrade -i monitoringcoreoscom-probe-editor appscode-charts-oci/monitoringcoreoscom-probe-editor -n default --create-namespace --version=v0.8.0
```
...
```bash
$ helm upgrade -i monitoringcoreoscom-probe-editor appscode-charts-oci/monitoringcoreoscom-probe-editor -n default --create-namespace --version=v0.8.0 --set apiVersion=monitoring.coreos.com/v1
```
...
```bash
$ helm upgrade -i monitoringcoreoscom-probe-editor appscode-charts-oci/monitoringcoreoscom-probe-editor -n default --create-namespace --version=v0.8.0 --values values.yaml
```
