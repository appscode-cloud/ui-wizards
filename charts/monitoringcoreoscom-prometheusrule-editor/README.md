...
$ helm repo update
$ helm search repo appscode-charts-oci/monitoringcoreoscom-prometheusrule-editor --version=v0.7.0
$ helm upgrade -i monitoringcoreoscom-prometheusrule-editor appscode-charts-oci/monitoringcoreoscom-prometheusrule-editor -n default --create-namespace --version=v0.7.0
```
...
```bash
$ helm upgrade -i monitoringcoreoscom-prometheusrule-editor appscode-charts-oci/monitoringcoreoscom-prometheusrule-editor -n default --create-namespace --version=v0.7.0 --set apiVersion=monitoring.coreos.com/v1
```
...
```bash
$ helm upgrade -i monitoringcoreoscom-prometheusrule-editor appscode-charts-oci/monitoringcoreoscom-prometheusrule-editor -n default --create-namespace --version=v0.7.0 --values values.yaml
```
