...
$ helm repo update
$ helm search repo bytebuilders-ui/grafanasearchlightdev-dashboard-editor --version=v0.13.0
$ helm upgrade -i grafanasearchlightdev-dashboard-editor bytebuilders-ui/grafanasearchlightdev-dashboard-editor -n default --create-namespace --version=v0.13.0
```
...
```bash
$ helm upgrade -i grafanasearchlightdev-dashboard-editor bytebuilders-ui/grafanasearchlightdev-dashboard-editor -n default --create-namespace --version=v0.13.0 --set apiVersion=grafana.searchlight.dev/v1alpha1
```
...
```bash
$ helm upgrade -i grafanasearchlightdev-dashboard-editor bytebuilders-ui/grafanasearchlightdev-dashboard-editor -n default --create-namespace --version=v0.13.0 --values values.yaml
```
