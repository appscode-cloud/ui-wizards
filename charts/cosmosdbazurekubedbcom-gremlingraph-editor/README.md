...
$ helm repo update
$ helm search repo appscode-charts-oci/cosmosdbazurekubedbcom-gremlingraph-editor --version=v0.13.0
$ helm upgrade -i cosmosdbazurekubedbcom-gremlingraph-editor appscode-charts-oci/cosmosdbazurekubedbcom-gremlingraph-editor -n default --create-namespace --version=v0.13.0
```
...
```bash
$ helm upgrade -i cosmosdbazurekubedbcom-gremlingraph-editor appscode-charts-oci/cosmosdbazurekubedbcom-gremlingraph-editor -n default --create-namespace --version=v0.13.0 --set apiVersion=cosmosdb.azure.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i cosmosdbazurekubedbcom-gremlingraph-editor appscode-charts-oci/cosmosdbazurekubedbcom-gremlingraph-editor -n default --create-namespace --version=v0.13.0 --values values.yaml
```
