...
$ helm repo update
$ helm search repo appscode/cosmosdbazurekubedbcom-gremlingraph-editor --version=v0.18.0
$ helm upgrade -i cosmosdbazurekubedbcom-gremlingraph-editor appscode/cosmosdbazurekubedbcom-gremlingraph-editor -n default --create-namespace --version=v0.18.0
```
...
```bash
$ helm upgrade -i cosmosdbazurekubedbcom-gremlingraph-editor appscode/cosmosdbazurekubedbcom-gremlingraph-editor -n default --create-namespace --version=v0.18.0 --set apiVersion=cosmosdb.azure.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i cosmosdbazurekubedbcom-gremlingraph-editor appscode/cosmosdbazurekubedbcom-gremlingraph-editor -n default --create-namespace --version=v0.18.0 --values values.yaml
```
