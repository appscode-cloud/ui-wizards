...
$ helm repo update
$ helm search repo appscode/core-binding-editor --version=v0.21.0
$ helm upgrade -i core-binding-editor appscode/core-binding-editor -n default --create-namespace --version=v0.21.0
```
...
```bash
$ helm upgrade -i core-binding-editor appscode/core-binding-editor -n default --create-namespace --version=v0.21.0 --set apiVersion=v1
```
...
```bash
$ helm upgrade -i core-binding-editor appscode/core-binding-editor -n default --create-namespace --version=v0.21.0 --values values.yaml
```
