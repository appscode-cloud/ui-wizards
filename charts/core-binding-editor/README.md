...
$ helm repo update
$ helm search repo bytebuilders-ui/core-binding-editor --version=v0.4.2
$ helm upgrade -i core-binding-editor bytebuilders-ui/core-binding-editor -n default --create-namespace --version=v0.4.2
```
...
```bash
$ helm upgrade -i core-binding-editor bytebuilders-ui/core-binding-editor -n default --create-namespace --version=v0.4.2 --set apiVersion=v1
```
...
```bash
$ helm upgrade -i core-binding-editor bytebuilders-ui/core-binding-editor -n default --create-namespace --version=v0.4.2 --values values.yaml
```
