...
$ helm repo update
$ helm install core-binding-editor bytebuilders-ui/core-binding-editor -n default --version=v0.1.0
```
...
```console
$ helm install core-binding-editor bytebuilders-ui/core-binding-editor -n default --version=v0.1.0 --set apiVersion=/v1
```
...
```console
$ helm install core-binding-editor bytebuilders-ui/core-binding-editor -n default --version=v0.1.0 --values values.yaml
```
