...
$ helm repo update
$ helm search repo appscode-charts-oci/core-binding-editor --version=v0.14.0
$ helm upgrade -i core-binding-editor appscode-charts-oci/core-binding-editor -n default --create-namespace --version=v0.14.0
```
...
```bash
$ helm upgrade -i core-binding-editor appscode-charts-oci/core-binding-editor -n default --create-namespace --version=v0.14.0 --set apiVersion=v1
```
...
```bash
$ helm upgrade -i core-binding-editor appscode-charts-oci/core-binding-editor -n default --create-namespace --version=v0.14.0 --values values.yaml
```
