...
$ helm repo update
$ helm search repo bytebuilders-ui/core-binding-editor --version=v0.4.1
$ helm upgrade -i core-binding-editor bytebuilders-ui/core-binding-editor -n default --create-namespace --version=v0.4.1
```
...
```bash
$ helm upgrade -i core-binding-editor bytebuilders-ui/core-binding-editor -n default --create-namespace --version=v0.4.1 --set apiVersion=v1
```
...
```bash
$ helm upgrade -i core-binding-editor bytebuilders-ui/core-binding-editor -n default --create-namespace --version=v0.4.1 --values values.yaml
```
