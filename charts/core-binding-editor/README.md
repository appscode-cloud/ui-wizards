...
$ helm repo update
$ helm search repo bytebuilders-ui/core-binding-editor --version=v0.4.11
$ helm upgrade -i core-binding-editor bytebuilders-ui/core-binding-editor -n default --create-namespace --version=v0.4.11
```
...
```bash
$ helm upgrade -i core-binding-editor bytebuilders-ui/core-binding-editor -n default --create-namespace --version=v0.4.11 --set apiVersion=v1
```
...
```bash
$ helm upgrade -i core-binding-editor bytebuilders-ui/core-binding-editor -n default --create-namespace --version=v0.4.11 --values values.yaml
```
