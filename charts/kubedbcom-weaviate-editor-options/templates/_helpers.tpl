...
*/}}
{{- define "kubedbcom-weaviate-editor-options.name" -}}
...
*/}}
{{- define "kubedbcom-weaviate-editor-options.fullname" -}}
...
*/}}
{{- define "kubedbcom-weaviate-editor-options.chart" -}}
...
Common labels
*/}}
{{- define "kubedbcom-weaviate-editor-options.labels" -}}
{{ include "kubedbcom-weaviate-editor-options.selectorLabels" . }}
...
Selector labels
*/}}
{{- define "kubedbcom-weaviate-editor-options.selectorLabels" -}}
app.kubernetes.io/name: weaviates.kubedb.com
app.kubernetes.io/instance: {{ include "kubedbcom-weaviate-editor-options.fullname" . }}
{{- end }}

{{/*
Create the name of the service account to use
*/}}
{{- define "kubedbcom-weaviate-editor-options.serviceAccountName" -}}
{{- if .Values.spec.serviceAccount.create }}
{{- default (include "kubedbcom-weaviate-editor-options.fullname" .) .Values.spec.serviceAccount.name }}
{{- else }}
...
Common annotations
*/}}
{{- define "kubedbcom-weaviate-editor-options.annotations" -}}
...
Alert Enabled
*/}}
{{- define "kubedbcom-weaviate-editor-options.alertEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
