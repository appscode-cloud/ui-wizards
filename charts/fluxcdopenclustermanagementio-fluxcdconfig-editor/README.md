...
$ helm repo update
$ helm search repo appscode-charts-oci/fluxcdopenclustermanagementio-fluxcdconfig-editor --version=v0.4.21
$ helm upgrade -i fluxcdopenclustermanagementio-fluxcdconfig-editor appscode-charts-oci/fluxcdopenclustermanagementio-fluxcdconfig-editor -n default --create-namespace --version=v0.4.21
```
...
```bash
$ helm upgrade -i fluxcdopenclustermanagementio-fluxcdconfig-editor appscode-charts-oci/fluxcdopenclustermanagementio-fluxcdconfig-editor -n default --create-namespace --version=v0.4.21 --set apiVersion=fluxcd.open-cluster-management.io/v1alpha1
```
...
```bash
$ helm upgrade -i fluxcdopenclustermanagementio-fluxcdconfig-editor appscode-charts-oci/fluxcdopenclustermanagementio-fluxcdconfig-editor -n default --create-namespace --version=v0.4.21 --values values.yaml
```
