...
$ helm repo update
$ helm search repo appscode/fluxcdopenclustermanagementio-fluxcdconfig-editor --version=v0.22.0
$ helm upgrade -i fluxcdopenclustermanagementio-fluxcdconfig-editor appscode/fluxcdopenclustermanagementio-fluxcdconfig-editor -n default --create-namespace --version=v0.22.0
```
...
```bash
$ helm upgrade -i fluxcdopenclustermanagementio-fluxcdconfig-editor appscode/fluxcdopenclustermanagementio-fluxcdconfig-editor -n default --create-namespace --version=v0.22.0 --set apiVersion=fluxcd.open-cluster-management.io/v1alpha1
```
...
```bash
$ helm upgrade -i fluxcdopenclustermanagementio-fluxcdconfig-editor appscode/fluxcdopenclustermanagementio-fluxcdconfig-editor -n default --create-namespace --version=v0.22.0 --values values.yaml
```
