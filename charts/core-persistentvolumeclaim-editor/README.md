...
$ helm repo update
$ helm search repo appscode-charts-oci/core-persistentvolumeclaim-editor --version=v0.7.0
$ helm upgrade -i core-persistentvolumeclaim-editor appscode-charts-oci/core-persistentvolumeclaim-editor -n default --create-namespace --version=v0.7.0
```
...
```bash
$ helm upgrade -i core-persistentvolumeclaim-editor appscode-charts-oci/core-persistentvolumeclaim-editor -n default --create-namespace --version=v0.7.0 --set apiVersion=v1
```
...
```bash
$ helm upgrade -i core-persistentvolumeclaim-editor appscode-charts-oci/core-persistentvolumeclaim-editor -n default --create-namespace --version=v0.7.0 --values values.yaml
```
