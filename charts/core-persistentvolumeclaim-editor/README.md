...
$ helm repo update
$ helm search repo appscode/core-persistentvolumeclaim-editor --version=v0.25.0
$ helm upgrade -i core-persistentvolumeclaim-editor appscode/core-persistentvolumeclaim-editor -n default --create-namespace --version=v0.25.0
```
...
```bash
$ helm upgrade -i core-persistentvolumeclaim-editor appscode/core-persistentvolumeclaim-editor -n default --create-namespace --version=v0.25.0 --set apiVersion=v1
```
...
```bash
$ helm upgrade -i core-persistentvolumeclaim-editor appscode/core-persistentvolumeclaim-editor -n default --create-namespace --version=v0.25.0 --values values.yaml
```
