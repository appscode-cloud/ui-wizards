...
$ helm repo update
$ helm search repo bytebuilders-ui/core-persistentvolumeclaim-editor --version=v0.4.17
$ helm upgrade -i core-persistentvolumeclaim-editor bytebuilders-ui/core-persistentvolumeclaim-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i core-persistentvolumeclaim-editor bytebuilders-ui/core-persistentvolumeclaim-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=v1
```
...
```bash
$ helm upgrade -i core-persistentvolumeclaim-editor bytebuilders-ui/core-persistentvolumeclaim-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
