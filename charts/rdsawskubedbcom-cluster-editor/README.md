...
$ helm repo update
$ helm search repo appscode-charts-oci/rdsawskubedbcom-cluster-editor --version=v0.11.0
...
```bash
$ helm upgrade -i rdsawskubedbcom-cluster-editor appscode-charts-oci/rdsawskubedbcom-cluster-editor -n default --create-namespace --version=v0.11.0 --set apiVersion=rds.aws.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i rdsawskubedbcom-cluster-editor appscode-charts-oci/rdsawskubedbcom-cluster-editor -n default --create-namespace --version=v0.11.0 --values values.yaml
```
