...
$ helm repo update
$ helm search repo appscode/networkazurekubedbcom-privatednszonevirtualnetworklink-editor --version=v0.34.0
$ helm upgrade -i networkazurekubedbcom-privatednszonevirtualnetworklink-editor appscode/networkazurekubedbcom-privatednszonevirtualnetworklink-editor -n default --create-namespace --version=v0.34.0
```
...
```bash
$ helm upgrade -i networkazurekubedbcom-privatednszonevirtualnetworklink-editor appscode/networkazurekubedbcom-privatednszonevirtualnetworklink-editor -n default --create-namespace --version=v0.34.0 --set apiVersion=network.azure.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i networkazurekubedbcom-privatednszonevirtualnetworklink-editor appscode/networkazurekubedbcom-privatednszonevirtualnetworklink-editor -n default --create-namespace --version=v0.34.0 --values values.yaml
```
