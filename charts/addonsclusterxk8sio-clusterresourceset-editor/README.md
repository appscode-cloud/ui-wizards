...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/addonsclusterxk8sio-clusterresourceset-editor --version=v0.4.17
$ helm upgrade -i addonsclusterxk8sio-clusterresourceset-editor bytebuilders-ui-dev/addonsclusterxk8sio-clusterresourceset-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i addonsclusterxk8sio-clusterresourceset-editor bytebuilders-ui-dev/addonsclusterxk8sio-clusterresourceset-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=addons.cluster.x-k8s.io/v1beta1
```
...
```bash
$ helm upgrade -i addonsclusterxk8sio-clusterresourceset-editor bytebuilders-ui-dev/addonsclusterxk8sio-clusterresourceset-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
