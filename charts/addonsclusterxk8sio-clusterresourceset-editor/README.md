...
$ helm repo update
$ helm search repo bytebuilders-ui/addonsclusterxk8sio-clusterresourceset-editor --version=v0.4.16
$ helm upgrade -i addonsclusterxk8sio-clusterresourceset-editor bytebuilders-ui/addonsclusterxk8sio-clusterresourceset-editor -n default --create-namespace --version=v0.4.16
```
...
```bash
$ helm upgrade -i addonsclusterxk8sio-clusterresourceset-editor bytebuilders-ui/addonsclusterxk8sio-clusterresourceset-editor -n default --create-namespace --version=v0.4.16 --set apiVersion=addons.cluster.x-k8s.io/v1beta1
```
...
```bash
$ helm upgrade -i addonsclusterxk8sio-clusterresourceset-editor bytebuilders-ui/addonsclusterxk8sio-clusterresourceset-editor -n default --create-namespace --version=v0.4.16 --values values.yaml
```
