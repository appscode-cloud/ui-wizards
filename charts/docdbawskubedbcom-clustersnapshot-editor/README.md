...
$ helm repo update
$ helm search repo appscode-charts-oci/docdbawskubedbcom-clustersnapshot-editor --version=v0.4.20
$ helm upgrade -i docdbawskubedbcom-clustersnapshot-editor appscode-charts-oci/docdbawskubedbcom-clustersnapshot-editor -n default --create-namespace --version=v0.4.20
```
...
```bash
$ helm upgrade -i docdbawskubedbcom-clustersnapshot-editor appscode-charts-oci/docdbawskubedbcom-clustersnapshot-editor -n default --create-namespace --version=v0.4.20 --set apiVersion=docdb.aws.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i docdbawskubedbcom-clustersnapshot-editor appscode-charts-oci/docdbawskubedbcom-clustersnapshot-editor -n default --create-namespace --version=v0.4.20 --values values.yaml
```
