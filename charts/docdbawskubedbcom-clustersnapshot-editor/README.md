...
$ helm repo update
$ helm search repo appscode-charts-oci/docdbawskubedbcom-clustersnapshot-editor --version=v0.11.0
...
```bash
$ helm upgrade -i docdbawskubedbcom-clustersnapshot-editor appscode-charts-oci/docdbawskubedbcom-clustersnapshot-editor -n default --create-namespace --version=v0.11.0 --set apiVersion=docdb.aws.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i docdbawskubedbcom-clustersnapshot-editor appscode-charts-oci/docdbawskubedbcom-clustersnapshot-editor -n default --create-namespace --version=v0.11.0 --values values.yaml
```
