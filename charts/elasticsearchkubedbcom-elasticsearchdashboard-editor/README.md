...
$ helm repo update
$ helm search repo appscode-charts-oci/elasticsearchkubedbcom-elasticsearchdashboard-editor --version=v0.4.21
$ helm upgrade -i elasticsearchkubedbcom-elasticsearchdashboard-editor appscode-charts-oci/elasticsearchkubedbcom-elasticsearchdashboard-editor -n default --create-namespace --version=v0.4.21
```
...
```bash
$ helm upgrade -i elasticsearchkubedbcom-elasticsearchdashboard-editor appscode-charts-oci/elasticsearchkubedbcom-elasticsearchdashboard-editor -n default --create-namespace --version=v0.4.21 --set apiVersion=elasticsearch.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i elasticsearchkubedbcom-elasticsearchdashboard-editor appscode-charts-oci/elasticsearchkubedbcom-elasticsearchdashboard-editor -n default --create-namespace --version=v0.4.21 --values values.yaml
```
