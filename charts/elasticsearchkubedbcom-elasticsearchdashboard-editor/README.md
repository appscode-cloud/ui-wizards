...
$ helm repo update
$ helm search repo appscode-charts-oci/elasticsearchkubedbcom-elasticsearchdashboard-editor --version=v0.7.0
$ helm upgrade -i elasticsearchkubedbcom-elasticsearchdashboard-editor appscode-charts-oci/elasticsearchkubedbcom-elasticsearchdashboard-editor -n default --create-namespace --version=v0.7.0
```
...
```bash
$ helm upgrade -i elasticsearchkubedbcom-elasticsearchdashboard-editor appscode-charts-oci/elasticsearchkubedbcom-elasticsearchdashboard-editor -n default --create-namespace --version=v0.7.0 --set apiVersion=elasticsearch.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i elasticsearchkubedbcom-elasticsearchdashboard-editor appscode-charts-oci/elasticsearchkubedbcom-elasticsearchdashboard-editor -n default --create-namespace --version=v0.7.0 --values values.yaml
```
