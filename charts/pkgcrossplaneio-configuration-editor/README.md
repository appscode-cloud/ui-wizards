...
$ helm repo update
$ helm search repo appscode/pkgcrossplaneio-configuration-editor --version=v0.29.0
$ helm upgrade -i pkgcrossplaneio-configuration-editor appscode/pkgcrossplaneio-configuration-editor -n default --create-namespace --version=v0.29.0
```
...
```bash
$ helm upgrade -i pkgcrossplaneio-configuration-editor appscode/pkgcrossplaneio-configuration-editor -n default --create-namespace --version=v0.29.0 --set apiVersion=pkg.crossplane.io/v1
```
...
```bash
$ helm upgrade -i pkgcrossplaneio-configuration-editor appscode/pkgcrossplaneio-configuration-editor -n default --create-namespace --version=v0.29.0 --values values.yaml
```
