...
$ helm repo update
$ helm search repo bytebuilders-ui/pkgcrossplaneio-configuration-editor --version=v0.4.16
$ helm upgrade -i pkgcrossplaneio-configuration-editor bytebuilders-ui/pkgcrossplaneio-configuration-editor -n default --create-namespace --version=v0.4.16
```
...
```bash
$ helm upgrade -i pkgcrossplaneio-configuration-editor bytebuilders-ui/pkgcrossplaneio-configuration-editor -n default --create-namespace --version=v0.4.16 --set apiVersion=pkg.crossplane.io/v1
```
...
```bash
$ helm upgrade -i pkgcrossplaneio-configuration-editor bytebuilders-ui/pkgcrossplaneio-configuration-editor -n default --create-namespace --version=v0.4.16 --values values.yaml
```
