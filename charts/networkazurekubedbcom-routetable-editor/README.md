...
$ helm repo update
$ helm search repo appscode/networkazurekubedbcom-routetable-editor --version=v0.27.0
...
```bash
$ helm upgrade -i networkazurekubedbcom-routetable-editor appscode/networkazurekubedbcom-routetable-editor -n default --create-namespace --version=v0.27.0 --set apiVersion=network.azure.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i networkazurekubedbcom-routetable-editor appscode/networkazurekubedbcom-routetable-editor -n default --create-namespace --version=v0.27.0 --values values.yaml
```
