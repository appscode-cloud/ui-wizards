...
$ helm repo update
$ helm search repo appscode-charts-oci/catalogappscodecom-proxysqlbinding-editor --version=v0.7.0
$ helm upgrade -i catalogappscodecom-proxysqlbinding-editor appscode-charts-oci/catalogappscodecom-proxysqlbinding-editor -n default --create-namespace --version=v0.7.0
```
...
```bash
$ helm upgrade -i catalogappscodecom-proxysqlbinding-editor appscode-charts-oci/catalogappscodecom-proxysqlbinding-editor -n default --create-namespace --version=v0.7.0 --set apiVersion=catalog.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i catalogappscodecom-proxysqlbinding-editor appscode-charts-oci/catalogappscodecom-proxysqlbinding-editor -n default --create-namespace --version=v0.7.0 --values values.yaml
```
