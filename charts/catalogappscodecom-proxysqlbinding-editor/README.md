...
$ helm repo update
$ helm search repo appscode/catalogappscodecom-proxysqlbinding-editor --version=v0.18.0
$ helm upgrade -i catalogappscodecom-proxysqlbinding-editor appscode/catalogappscodecom-proxysqlbinding-editor -n default --create-namespace --version=v0.18.0
```
...
```bash
$ helm upgrade -i catalogappscodecom-proxysqlbinding-editor appscode/catalogappscodecom-proxysqlbinding-editor -n default --create-namespace --version=v0.18.0 --set apiVersion=catalog.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i catalogappscodecom-proxysqlbinding-editor appscode/catalogappscodecom-proxysqlbinding-editor -n default --create-namespace --version=v0.18.0 --values values.yaml
```
