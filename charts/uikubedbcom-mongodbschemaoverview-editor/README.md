...
$ helm repo update
$ helm search repo appscode-charts-oci/uikubedbcom-mongodbschemaoverview-editor --version=v0.7.0
$ helm upgrade -i uikubedbcom-mongodbschemaoverview-editor appscode-charts-oci/uikubedbcom-mongodbschemaoverview-editor -n default --create-namespace --version=v0.7.0
```
...
```bash
$ helm upgrade -i uikubedbcom-mongodbschemaoverview-editor appscode-charts-oci/uikubedbcom-mongodbschemaoverview-editor -n default --create-namespace --version=v0.7.0 --set apiVersion=ui.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i uikubedbcom-mongodbschemaoverview-editor appscode-charts-oci/uikubedbcom-mongodbschemaoverview-editor -n default --create-namespace --version=v0.7.0 --values values.yaml
```
