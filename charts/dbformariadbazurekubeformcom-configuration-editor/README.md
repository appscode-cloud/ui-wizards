...
$ helm repo update
$ helm search repo bytebuilders-ui/dbformariadbazurekubeformcom-configuration-editor --version=v0.4.18
$ helm upgrade -i dbformariadbazurekubeformcom-configuration-editor bytebuilders-ui/dbformariadbazurekubeformcom-configuration-editor -n default --create-namespace --version=v0.4.18
```
...
```bash
$ helm upgrade -i dbformariadbazurekubeformcom-configuration-editor bytebuilders-ui/dbformariadbazurekubeformcom-configuration-editor -n default --create-namespace --version=v0.4.18 --set apiVersion=dbformariadb.azure.kubeform.com/v1alpha1
```
...
```bash
$ helm upgrade -i dbformariadbazurekubeformcom-configuration-editor bytebuilders-ui/dbformariadbazurekubeformcom-configuration-editor -n default --create-namespace --version=v0.4.18 --values values.yaml
```
