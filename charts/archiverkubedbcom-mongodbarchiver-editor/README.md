...
$ helm repo update
$ helm search repo appscode/archiverkubedbcom-mongodbarchiver-editor --version=v0.16.0
$ helm upgrade -i archiverkubedbcom-mongodbarchiver-editor appscode/archiverkubedbcom-mongodbarchiver-editor -n default --create-namespace --version=v0.16.0
```
...
```bash
$ helm upgrade -i archiverkubedbcom-mongodbarchiver-editor appscode/archiverkubedbcom-mongodbarchiver-editor -n default --create-namespace --version=v0.16.0 --set apiVersion=archiver.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i archiverkubedbcom-mongodbarchiver-editor appscode/archiverkubedbcom-mongodbarchiver-editor -n default --create-namespace --version=v0.16.0 --values values.yaml
```
