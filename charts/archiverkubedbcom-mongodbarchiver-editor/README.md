...
$ helm repo update
$ helm search repo appscode-charts-oci/archiverkubedbcom-mongodbarchiver-editor --version=v0.14.0
$ helm upgrade -i archiverkubedbcom-mongodbarchiver-editor appscode-charts-oci/archiverkubedbcom-mongodbarchiver-editor -n default --create-namespace --version=v0.14.0
```
...
```bash
$ helm upgrade -i archiverkubedbcom-mongodbarchiver-editor appscode-charts-oci/archiverkubedbcom-mongodbarchiver-editor -n default --create-namespace --version=v0.14.0 --set apiVersion=archiver.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i archiverkubedbcom-mongodbarchiver-editor appscode-charts-oci/archiverkubedbcom-mongodbarchiver-editor -n default --create-namespace --version=v0.14.0 --values values.yaml
```
