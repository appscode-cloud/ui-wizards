...
$ helm repo update
$ helm search repo appscode/ec2awskubedbcom-securitygroup-editor --version=v0.20.0
$ helm upgrade -i ec2awskubedbcom-securitygroup-editor appscode/ec2awskubedbcom-securitygroup-editor -n default --create-namespace --version=v0.20.0
```
...
```bash
$ helm upgrade -i ec2awskubedbcom-securitygroup-editor appscode/ec2awskubedbcom-securitygroup-editor -n default --create-namespace --version=v0.20.0 --set apiVersion=ec2.aws.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i ec2awskubedbcom-securitygroup-editor appscode/ec2awskubedbcom-securitygroup-editor -n default --create-namespace --version=v0.20.0 --values values.yaml
```
