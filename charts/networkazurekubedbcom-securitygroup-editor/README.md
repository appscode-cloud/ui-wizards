...
$ helm repo update
$ helm search repo appscode-charts-oci/networkazurekubedbcom-securitygroup-editor --version=v0.14.0
$ helm upgrade -i networkazurekubedbcom-securitygroup-editor appscode-charts-oci/networkazurekubedbcom-securitygroup-editor -n default --create-namespace --version=v0.14.0
```
...
```bash
$ helm upgrade -i networkazurekubedbcom-securitygroup-editor appscode-charts-oci/networkazurekubedbcom-securitygroup-editor -n default --create-namespace --version=v0.14.0 --set apiVersion=network.azure.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i networkazurekubedbcom-securitygroup-editor appscode-charts-oci/networkazurekubedbcom-securitygroup-editor -n default --create-namespace --version=v0.14.0 --values values.yaml
```
