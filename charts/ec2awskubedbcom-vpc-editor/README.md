...
$ helm repo update
$ helm search repo appscode-charts-oci/ec2awskubedbcom-vpc-editor --version=v0.7.0
$ helm upgrade -i ec2awskubedbcom-vpc-editor appscode-charts-oci/ec2awskubedbcom-vpc-editor -n default --create-namespace --version=v0.7.0
```
...
```bash
$ helm upgrade -i ec2awskubedbcom-vpc-editor appscode-charts-oci/ec2awskubedbcom-vpc-editor -n default --create-namespace --version=v0.7.0 --set apiVersion=ec2.aws.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i ec2awskubedbcom-vpc-editor appscode-charts-oci/ec2awskubedbcom-vpc-editor -n default --create-namespace --version=v0.7.0 --values values.yaml
```
