...
$ helm repo update
$ helm search repo bytebuilders-ui/metaappscodecom-resourcedescriptor-editor --version=v0.4.2
$ helm upgrade -i metaappscodecom-resourcedescriptor-editor bytebuilders-ui/metaappscodecom-resourcedescriptor-editor -n default --create-namespace --version=v0.4.2
```
...
```bash
$ helm upgrade -i metaappscodecom-resourcedescriptor-editor bytebuilders-ui/metaappscodecom-resourcedescriptor-editor -n default --create-namespace --version=v0.4.2 --set apiVersion=meta.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i metaappscodecom-resourcedescriptor-editor bytebuilders-ui/metaappscodecom-resourcedescriptor-editor -n default --create-namespace --version=v0.4.2 --values values.yaml
```
