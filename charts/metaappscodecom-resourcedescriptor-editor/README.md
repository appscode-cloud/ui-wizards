...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/metaappscodecom-resourcedescriptor-editor --version=v0.4.17
$ helm upgrade -i metaappscodecom-resourcedescriptor-editor bytebuilders-ui-dev/metaappscodecom-resourcedescriptor-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i metaappscodecom-resourcedescriptor-editor bytebuilders-ui-dev/metaappscodecom-resourcedescriptor-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=meta.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i metaappscodecom-resourcedescriptor-editor bytebuilders-ui-dev/metaappscodecom-resourcedescriptor-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
