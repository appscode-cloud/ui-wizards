...
$ helm repo update
$ helm search repo bytebuilders-ui/metaappscodecom-resourcedescriptor-editor --version=v0.4.1
$ helm upgrade -i metaappscodecom-resourcedescriptor-editor bytebuilders-ui/metaappscodecom-resourcedescriptor-editor -n default --create-namespace --version=v0.4.1
```
...
```bash
$ helm upgrade -i metaappscodecom-resourcedescriptor-editor bytebuilders-ui/metaappscodecom-resourcedescriptor-editor -n default --create-namespace --version=v0.4.1 --set apiVersion=meta.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i metaappscodecom-resourcedescriptor-editor bytebuilders-ui/metaappscodecom-resourcedescriptor-editor -n default --create-namespace --version=v0.4.1 --values values.yaml
```
