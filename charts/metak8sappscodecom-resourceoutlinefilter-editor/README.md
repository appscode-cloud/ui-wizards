...
$ helm repo update
$ helm search repo appscode/metak8sappscodecom-resourceoutlinefilter-editor --version=v0.29.0
$ helm upgrade -i metak8sappscodecom-resourceoutlinefilter-editor appscode/metak8sappscodecom-resourceoutlinefilter-editor -n default --create-namespace --version=v0.29.0
```
...
```bash
$ helm upgrade -i metak8sappscodecom-resourceoutlinefilter-editor appscode/metak8sappscodecom-resourceoutlinefilter-editor -n default --create-namespace --version=v0.29.0 --set apiVersion=meta.k8s.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i metak8sappscodecom-resourceoutlinefilter-editor appscode/metak8sappscodecom-resourceoutlinefilter-editor -n default --create-namespace --version=v0.29.0 --values values.yaml
```
