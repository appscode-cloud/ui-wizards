...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/enginekubevaultcom-awsrole-editor --version=v0.4.17
$ helm upgrade -i enginekubevaultcom-awsrole-editor bytebuilders-ui-dev/enginekubevaultcom-awsrole-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i enginekubevaultcom-awsrole-editor bytebuilders-ui-dev/enginekubevaultcom-awsrole-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=engine.kubevault.com/v1alpha1
```
...
```bash
$ helm upgrade -i enginekubevaultcom-awsrole-editor bytebuilders-ui-dev/enginekubevaultcom-awsrole-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
