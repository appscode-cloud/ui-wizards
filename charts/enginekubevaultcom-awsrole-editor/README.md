...
$ helm repo update
$ helm search repo appscode/enginekubevaultcom-awsrole-editor --version=v0.20.0
$ helm upgrade -i enginekubevaultcom-awsrole-editor appscode/enginekubevaultcom-awsrole-editor -n default --create-namespace --version=v0.20.0
```
...
```bash
$ helm upgrade -i enginekubevaultcom-awsrole-editor appscode/enginekubevaultcom-awsrole-editor -n default --create-namespace --version=v0.20.0 --set apiVersion=engine.kubevault.com/v1alpha1
```
...
```bash
$ helm upgrade -i enginekubevaultcom-awsrole-editor appscode/enginekubevaultcom-awsrole-editor -n default --create-namespace --version=v0.20.0 --values values.yaml
```
