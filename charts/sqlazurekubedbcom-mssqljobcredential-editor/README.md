...
$ helm repo update
$ helm search repo appscode/sqlazurekubedbcom-mssqljobcredential-editor --version=v0.34.0
$ helm upgrade -i sqlazurekubedbcom-mssqljobcredential-editor appscode/sqlazurekubedbcom-mssqljobcredential-editor -n default --create-namespace --version=v0.34.0
```
...
```bash
$ helm upgrade -i sqlazurekubedbcom-mssqljobcredential-editor appscode/sqlazurekubedbcom-mssqljobcredential-editor -n default --create-namespace --version=v0.34.0 --set apiVersion=sql.azure.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i sqlazurekubedbcom-mssqljobcredential-editor appscode/sqlazurekubedbcom-mssqljobcredential-editor -n default --create-namespace --version=v0.34.0 --values values.yaml
```
