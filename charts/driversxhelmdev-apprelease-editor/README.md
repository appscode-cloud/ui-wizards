...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/driversxhelmdev-apprelease-editor --version=v0.4.17
$ helm upgrade -i driversxhelmdev-apprelease-editor bytebuilders-ui-dev/driversxhelmdev-apprelease-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i driversxhelmdev-apprelease-editor bytebuilders-ui-dev/driversxhelmdev-apprelease-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=drivers.x-helm.dev/v1alpha1
```
...
```bash
$ helm upgrade -i driversxhelmdev-apprelease-editor bytebuilders-ui-dev/driversxhelmdev-apprelease-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
