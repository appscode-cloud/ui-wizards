...
$ helm repo update
$ helm search repo appscode-charts-oci/driversxhelmdev-apprelease-editor --version=v0.7.0
$ helm upgrade -i driversxhelmdev-apprelease-editor appscode-charts-oci/driversxhelmdev-apprelease-editor -n default --create-namespace --version=v0.7.0
```
...
```bash
$ helm upgrade -i driversxhelmdev-apprelease-editor appscode-charts-oci/driversxhelmdev-apprelease-editor -n default --create-namespace --version=v0.7.0 --set apiVersion=drivers.x-helm.dev/v1alpha1
```
...
```bash
$ helm upgrade -i driversxhelmdev-apprelease-editor appscode-charts-oci/driversxhelmdev-apprelease-editor -n default --create-namespace --version=v0.7.0 --values values.yaml
```
