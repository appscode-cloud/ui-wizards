...
$ helm repo update
$ helm search repo bytebuilders-ui/gatewayenvoyproxyio-authenticationfilter-editor --version=v0.4.18
$ helm upgrade -i gatewayenvoyproxyio-authenticationfilter-editor bytebuilders-ui/gatewayenvoyproxyio-authenticationfilter-editor -n default --create-namespace --version=v0.4.18
```
...
```bash
$ helm upgrade -i gatewayenvoyproxyio-authenticationfilter-editor bytebuilders-ui/gatewayenvoyproxyio-authenticationfilter-editor -n default --create-namespace --version=v0.4.18 --set apiVersion=gateway.envoyproxy.io/v1alpha1
```
...
```bash
$ helm upgrade -i gatewayenvoyproxyio-authenticationfilter-editor bytebuilders-ui/gatewayenvoyproxyio-authenticationfilter-editor -n default --create-namespace --version=v0.4.18 --values values.yaml
```
