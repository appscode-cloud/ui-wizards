...
$ helm repo update
$ helm search repo bytebuilders-ui/gatewayenvoyproxyio-authenticationfilter-editor --version=v0.4.16
$ helm upgrade -i gatewayenvoyproxyio-authenticationfilter-editor bytebuilders-ui/gatewayenvoyproxyio-authenticationfilter-editor -n default --create-namespace --version=v0.4.16
```
...
```bash
$ helm upgrade -i gatewayenvoyproxyio-authenticationfilter-editor bytebuilders-ui/gatewayenvoyproxyio-authenticationfilter-editor -n default --create-namespace --version=v0.4.16 --set apiVersion=gateway.envoyproxy.io/v1alpha1
```
...
```bash
$ helm upgrade -i gatewayenvoyproxyio-authenticationfilter-editor bytebuilders-ui/gatewayenvoyproxyio-authenticationfilter-editor -n default --create-namespace --version=v0.4.16 --values values.yaml
```
