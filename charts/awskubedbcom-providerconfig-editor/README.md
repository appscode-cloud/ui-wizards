...
$ helm repo update
$ helm search repo appscode-charts-oci/awskubedbcom-providerconfig-editor --version=v0.12.0
$ helm upgrade -i awskubedbcom-providerconfig-editor appscode-charts-oci/awskubedbcom-providerconfig-editor -n default --create-namespace --version=v0.12.0
```
...
```bash
$ helm upgrade -i awskubedbcom-providerconfig-editor appscode-charts-oci/awskubedbcom-providerconfig-editor -n default --create-namespace --version=v0.12.0 --set apiVersion=aws.kubedb.com/v1beta1
```
...
```bash
$ helm upgrade -i awskubedbcom-providerconfig-editor appscode-charts-oci/awskubedbcom-providerconfig-editor -n default --create-namespace --version=v0.12.0 --values values.yaml
```
