...
$ helm repo update
$ helm search repo appscode/awskubedbcom-providerconfig-editor --version=v0.29.0
$ helm upgrade -i awskubedbcom-providerconfig-editor appscode/awskubedbcom-providerconfig-editor -n default --create-namespace --version=v0.29.0
```
...
```bash
$ helm upgrade -i awskubedbcom-providerconfig-editor appscode/awskubedbcom-providerconfig-editor -n default --create-namespace --version=v0.29.0 --set apiVersion=aws.kubedb.com/v1beta1
```
...
```bash
$ helm upgrade -i awskubedbcom-providerconfig-editor appscode/awskubedbcom-providerconfig-editor -n default --create-namespace --version=v0.29.0 --values values.yaml
```
