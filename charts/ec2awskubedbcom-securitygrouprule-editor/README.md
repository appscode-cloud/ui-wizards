...
$ helm repo update
$ helm search repo appscode/ec2awskubedbcom-securitygrouprule-editor --version=v0.18.0
$ helm upgrade -i ec2awskubedbcom-securitygrouprule-editor appscode/ec2awskubedbcom-securitygrouprule-editor -n default --create-namespace --version=v0.18.0
```
...
```bash
$ helm upgrade -i ec2awskubedbcom-securitygrouprule-editor appscode/ec2awskubedbcom-securitygrouprule-editor -n default --create-namespace --version=v0.18.0 --set apiVersion=ec2.aws.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i ec2awskubedbcom-securitygrouprule-editor appscode/ec2awskubedbcom-securitygrouprule-editor -n default --create-namespace --version=v0.18.0 --values values.yaml
```
