...
$ helm repo update
$ helm search repo appscode-charts-oci/core-componentstatus-editor --version=v0.5.0
$ helm upgrade -i core-componentstatus-editor appscode-charts-oci/core-componentstatus-editor -n default --create-namespace --version=v0.5.0
```
...
```bash
$ helm upgrade -i core-componentstatus-editor appscode-charts-oci/core-componentstatus-editor -n default --create-namespace --version=v0.5.0 --set apiVersion=v1
```
...
```bash
$ helm upgrade -i core-componentstatus-editor appscode-charts-oci/core-componentstatus-editor -n default --create-namespace --version=v0.5.0 --values values.yaml
```
