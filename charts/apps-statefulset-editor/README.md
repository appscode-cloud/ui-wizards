...
$ helm repo update
$ helm search repo appscode/apps-statefulset-editor --version=v0.17.0
$ helm upgrade -i apps-statefulset-editor appscode/apps-statefulset-editor -n default --create-namespace --version=v0.17.0
```
...
```bash
$ helm upgrade -i apps-statefulset-editor appscode/apps-statefulset-editor -n default --create-namespace --version=v0.17.0 --set apiVersion=apps/v1
```
...
```bash
$ helm upgrade -i apps-statefulset-editor appscode/apps-statefulset-editor -n default --create-namespace --version=v0.17.0 --values values.yaml
```
