...
$ helm repo update
$ helm search repo appscode-charts-oci/apps-statefulset-editor --version=v0.4.18
$ helm upgrade -i apps-statefulset-editor appscode-charts-oci/apps-statefulset-editor -n default --create-namespace --version=v0.4.18
```
...
```bash
$ helm upgrade -i apps-statefulset-editor appscode-charts-oci/apps-statefulset-editor -n default --create-namespace --version=v0.4.18 --set apiVersion=apps/v1
```
...
```bash
$ helm upgrade -i apps-statefulset-editor appscode-charts-oci/apps-statefulset-editor -n default --create-namespace --version=v0.4.18 --values values.yaml
```
