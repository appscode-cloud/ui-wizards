...
$ helm repo update
$ helm search repo appscode-charts-oci/apps-statefulset-editor --version=v0.8.0
$ helm upgrade -i apps-statefulset-editor appscode-charts-oci/apps-statefulset-editor -n default --create-namespace --version=v0.8.0
```
...
```bash
$ helm upgrade -i apps-statefulset-editor appscode-charts-oci/apps-statefulset-editor -n default --create-namespace --version=v0.8.0 --set apiVersion=apps/v1
```
...
```bash
$ helm upgrade -i apps-statefulset-editor appscode-charts-oci/apps-statefulset-editor -n default --create-namespace --version=v0.8.0 --values values.yaml
```
