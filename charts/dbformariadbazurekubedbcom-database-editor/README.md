...
$ helm repo update
$ helm search repo appscode/dbformariadbazurekubedbcom-database-editor --version=v0.35.0
$ helm upgrade -i dbformariadbazurekubedbcom-database-editor appscode/dbformariadbazurekubedbcom-database-editor -n default --create-namespace --version=v0.35.0
```
...
```bash
$ helm upgrade -i dbformariadbazurekubedbcom-database-editor appscode/dbformariadbazurekubedbcom-database-editor -n default --create-namespace --version=v0.35.0 --set apiVersion=dbformariadb.azure.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i dbformariadbazurekubedbcom-database-editor appscode/dbformariadbazurekubedbcom-database-editor -n default --create-namespace --version=v0.35.0 --values values.yaml
```
