...
$ helm repo update
$ helm search repo appscode-charts-oci/dbformariadbazurekubedbcom-database-editor --version=v0.12.0
$ helm upgrade -i dbformariadbazurekubedbcom-database-editor appscode-charts-oci/dbformariadbazurekubedbcom-database-editor -n default --create-namespace --version=v0.12.0
```
...
```bash
$ helm upgrade -i dbformariadbazurekubedbcom-database-editor appscode-charts-oci/dbformariadbazurekubedbcom-database-editor -n default --create-namespace --version=v0.12.0 --set apiVersion=dbformariadb.azure.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i dbformariadbazurekubedbcom-database-editor appscode-charts-oci/dbformariadbazurekubedbcom-database-editor -n default --create-namespace --version=v0.12.0 --values values.yaml
```
