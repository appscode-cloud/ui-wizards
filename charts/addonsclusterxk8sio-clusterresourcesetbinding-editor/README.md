...
$ helm repo update
$ helm search repo appscode/addonsclusterxk8sio-clusterresourcesetbinding-editor --version=v0.16.0
$ helm upgrade -i addonsclusterxk8sio-clusterresourcesetbinding-editor appscode/addonsclusterxk8sio-clusterresourcesetbinding-editor -n default --create-namespace --version=v0.16.0
```
...
```bash
$ helm upgrade -i addonsclusterxk8sio-clusterresourcesetbinding-editor appscode/addonsclusterxk8sio-clusterresourcesetbinding-editor -n default --create-namespace --version=v0.16.0 --set apiVersion=addons.cluster.x-k8s.io/v1beta1
```
...
```bash
$ helm upgrade -i addonsclusterxk8sio-clusterresourcesetbinding-editor appscode/addonsclusterxk8sio-clusterresourcesetbinding-editor -n default --create-namespace --version=v0.16.0 --values values.yaml
```
