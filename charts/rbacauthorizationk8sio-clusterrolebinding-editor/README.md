...
$ helm repo update
$ helm search repo appscode-charts-oci/rbacauthorizationk8sio-clusterrolebinding-editor --version=v0.4.18
$ helm upgrade -i rbacauthorizationk8sio-clusterrolebinding-editor appscode-charts-oci/rbacauthorizationk8sio-clusterrolebinding-editor -n default --create-namespace --version=v0.4.18
```
...
```bash
$ helm upgrade -i rbacauthorizationk8sio-clusterrolebinding-editor appscode-charts-oci/rbacauthorizationk8sio-clusterrolebinding-editor -n default --create-namespace --version=v0.4.18 --set apiVersion=rbac.authorization.k8s.io/v1
```
...
```bash
$ helm upgrade -i rbacauthorizationk8sio-clusterrolebinding-editor appscode-charts-oci/rbacauthorizationk8sio-clusterrolebinding-editor -n default --create-namespace --version=v0.4.18 --values values.yaml
```
