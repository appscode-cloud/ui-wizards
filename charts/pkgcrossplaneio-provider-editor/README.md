...
$ helm repo update
$ helm search repo appscode/pkgcrossplaneio-provider-editor --version=v0.19.0
$ helm upgrade -i pkgcrossplaneio-provider-editor appscode/pkgcrossplaneio-provider-editor -n default --create-namespace --version=v0.19.0
```
...
```bash
$ helm upgrade -i pkgcrossplaneio-provider-editor appscode/pkgcrossplaneio-provider-editor -n default --create-namespace --version=v0.19.0 --set apiVersion=pkg.crossplane.io/v1
```
...
```bash
$ helm upgrade -i pkgcrossplaneio-provider-editor appscode/pkgcrossplaneio-provider-editor -n default --create-namespace --version=v0.19.0 --values values.yaml
```
