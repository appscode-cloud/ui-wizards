...
$ helm repo update
$ helm search repo bytebuilders-ui/pkgcrossplaneio-provider-editor --version=v0.4.18
$ helm upgrade -i pkgcrossplaneio-provider-editor bytebuilders-ui/pkgcrossplaneio-provider-editor -n default --create-namespace --version=v0.4.18
```
...
```bash
$ helm upgrade -i pkgcrossplaneio-provider-editor bytebuilders-ui/pkgcrossplaneio-provider-editor -n default --create-namespace --version=v0.4.18 --set apiVersion=pkg.crossplane.io/v1
```
...
```bash
$ helm upgrade -i pkgcrossplaneio-provider-editor bytebuilders-ui/pkgcrossplaneio-provider-editor -n default --create-namespace --version=v0.4.18 --values values.yaml
```
