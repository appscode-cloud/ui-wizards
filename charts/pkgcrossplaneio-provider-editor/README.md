...
$ helm repo update
$ helm search repo appscode-charts-oci/pkgcrossplaneio-provider-editor --version=v0.11.0
...
```bash
$ helm upgrade -i pkgcrossplaneio-provider-editor appscode-charts-oci/pkgcrossplaneio-provider-editor -n default --create-namespace --version=v0.11.0 --set apiVersion=pkg.crossplane.io/v1
```
...
```bash
$ helm upgrade -i pkgcrossplaneio-provider-editor appscode-charts-oci/pkgcrossplaneio-provider-editor -n default --create-namespace --version=v0.11.0 --values values.yaml
```
