...
$ helm repo update
$ helm search repo appscode-charts-oci/karpenterazurecom-aksnodeclass-editor --version=v0.11.0
...
```bash
$ helm upgrade -i karpenterazurecom-aksnodeclass-editor appscode-charts-oci/karpenterazurecom-aksnodeclass-editor -n default --create-namespace --version=v0.11.0 --set apiVersion=karpenter.azure.com/v1alpha2
```
...
```bash
$ helm upgrade -i karpenterazurecom-aksnodeclass-editor appscode-charts-oci/karpenterazurecom-aksnodeclass-editor -n default --create-namespace --version=v0.11.0 --values values.yaml
```
