...
$ helm repo update
$ helm search repo appscode/karpenterazurecom-aksnodeclass-editor --version=v0.21.0
$ helm upgrade -i karpenterazurecom-aksnodeclass-editor appscode/karpenterazurecom-aksnodeclass-editor -n default --create-namespace --version=v0.21.0
```
...
```bash
$ helm upgrade -i karpenterazurecom-aksnodeclass-editor appscode/karpenterazurecom-aksnodeclass-editor -n default --create-namespace --version=v0.21.0 --set apiVersion=karpenter.azure.com/v1alpha2
```
...
```bash
$ helm upgrade -i karpenterazurecom-aksnodeclass-editor appscode/karpenterazurecom-aksnodeclass-editor -n default --create-namespace --version=v0.21.0 --values values.yaml
```
