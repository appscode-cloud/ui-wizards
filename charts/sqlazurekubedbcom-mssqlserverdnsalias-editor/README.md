...
$ helm repo update
$ helm search repo appscode-charts-oci/sqlazurekubedbcom-mssqlserverdnsalias-editor --version=v0.4.21
$ helm upgrade -i sqlazurekubedbcom-mssqlserverdnsalias-editor appscode-charts-oci/sqlazurekubedbcom-mssqlserverdnsalias-editor -n default --create-namespace --version=v0.4.21
```
...
```bash
$ helm upgrade -i sqlazurekubedbcom-mssqlserverdnsalias-editor appscode-charts-oci/sqlazurekubedbcom-mssqlserverdnsalias-editor -n default --create-namespace --version=v0.4.21 --set apiVersion=sql.azure.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i sqlazurekubedbcom-mssqlserverdnsalias-editor appscode-charts-oci/sqlazurekubedbcom-mssqlserverdnsalias-editor -n default --create-namespace --version=v0.4.21 --values values.yaml
```
