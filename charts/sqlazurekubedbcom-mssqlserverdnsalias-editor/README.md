...
$ helm repo update
$ helm search repo appscode/sqlazurekubedbcom-mssqlserverdnsalias-editor --version=v0.34.0
$ helm upgrade -i sqlazurekubedbcom-mssqlserverdnsalias-editor appscode/sqlazurekubedbcom-mssqlserverdnsalias-editor -n default --create-namespace --version=v0.34.0
```
...
```bash
$ helm upgrade -i sqlazurekubedbcom-mssqlserverdnsalias-editor appscode/sqlazurekubedbcom-mssqlserverdnsalias-editor -n default --create-namespace --version=v0.34.0 --set apiVersion=sql.azure.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i sqlazurekubedbcom-mssqlserverdnsalias-editor appscode/sqlazurekubedbcom-mssqlserverdnsalias-editor -n default --create-namespace --version=v0.34.0 --values values.yaml
```
