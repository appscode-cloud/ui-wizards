...
$ helm repo update
$ helm search repo appscode-charts-oci/archiverkubedbcom-mariadbarchiver-editor --version=v0.12.0
$ helm upgrade -i archiverkubedbcom-mariadbarchiver-editor appscode-charts-oci/archiverkubedbcom-mariadbarchiver-editor -n default --create-namespace --version=v0.12.0
```
...
```bash
$ helm upgrade -i archiverkubedbcom-mariadbarchiver-editor appscode-charts-oci/archiverkubedbcom-mariadbarchiver-editor -n default --create-namespace --version=v0.12.0 --set apiVersion=archiver.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i archiverkubedbcom-mariadbarchiver-editor appscode-charts-oci/archiverkubedbcom-mariadbarchiver-editor -n default --create-namespace --version=v0.12.0 --values values.yaml
```
