...
$ helm repo update
$ helm search repo appscode/archiverkubedbcom-mariadbarchiver-editor --version=v0.27.0
...
```bash
$ helm upgrade -i archiverkubedbcom-mariadbarchiver-editor appscode/archiverkubedbcom-mariadbarchiver-editor -n default --create-namespace --version=v0.27.0 --set apiVersion=archiver.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i archiverkubedbcom-mariadbarchiver-editor appscode/archiverkubedbcom-mariadbarchiver-editor -n default --create-namespace --version=v0.27.0 --values values.yaml
```
