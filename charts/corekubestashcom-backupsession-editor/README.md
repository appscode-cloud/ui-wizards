...
$ helm repo update
$ helm search repo appscode-charts-oci/corekubestashcom-backupsession-editor --version=v0.4.21
$ helm upgrade -i corekubestashcom-backupsession-editor appscode-charts-oci/corekubestashcom-backupsession-editor -n default --create-namespace --version=v0.4.21
```
...
```bash
$ helm upgrade -i corekubestashcom-backupsession-editor appscode-charts-oci/corekubestashcom-backupsession-editor -n default --create-namespace --version=v0.4.21 --set apiVersion=core.kubestash.com/v1alpha1
```
...
```bash
$ helm upgrade -i corekubestashcom-backupsession-editor appscode-charts-oci/corekubestashcom-backupsession-editor -n default --create-namespace --version=v0.4.21 --values values.yaml
```
