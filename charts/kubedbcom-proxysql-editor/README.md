...
$ helm repo update
$ helm search repo appscode/kubedbcom-proxysql-editor --version=v0.35.0
$ helm upgrade -i kubedbcom-proxysql-editor appscode/kubedbcom-proxysql-editor -n default --create-namespace --version=v0.35.0
```
...
```bash
$ helm upgrade -i kubedbcom-proxysql-editor appscode/kubedbcom-proxysql-editor -n default --create-namespace --version=v0.35.0 --values values.yaml
```
