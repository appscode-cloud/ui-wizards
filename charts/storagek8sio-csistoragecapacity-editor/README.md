...
$ helm repo update
$ helm search repo bytebuilders-ui/storagek8sio-csistoragecapacity-editor --version=v0.4.12
$ helm upgrade -i storagek8sio-csistoragecapacity-editor bytebuilders-ui/storagek8sio-csistoragecapacity-editor -n default --create-namespace --version=v0.4.12
```
...
```bash
$ helm upgrade -i storagek8sio-csistoragecapacity-editor bytebuilders-ui/storagek8sio-csistoragecapacity-editor -n default --create-namespace --version=v0.4.12 --set apiVersion=storage.k8s.io/v1beta1
```
...
```bash
$ helm upgrade -i storagek8sio-csistoragecapacity-editor bytebuilders-ui/storagek8sio-csistoragecapacity-editor -n default --create-namespace --version=v0.4.12 --values values.yaml
```
