...
$ helm repo update
$ helm search repo bytebuilders-ui/storagek8sio-csistoragecapacity-editor --version=v0.4.2
$ helm upgrade -i storagek8sio-csistoragecapacity-editor bytebuilders-ui/storagek8sio-csistoragecapacity-editor -n default --create-namespace --version=v0.4.2
```
...
```bash
$ helm upgrade -i storagek8sio-csistoragecapacity-editor bytebuilders-ui/storagek8sio-csistoragecapacity-editor -n default --create-namespace --version=v0.4.2 --set apiVersion=storage.k8s.io/v1beta1
```
...
```bash
$ helm upgrade -i storagek8sio-csistoragecapacity-editor bytebuilders-ui/storagek8sio-csistoragecapacity-editor -n default --create-namespace --version=v0.4.2 --values values.yaml
```
