...
$ helm repo update
$ helm search repo appscode-charts-oci/gatewayvoyagermeshcom-mysqlroute-editor --version=v0.8.0
$ helm upgrade -i gatewayvoyagermeshcom-mysqlroute-editor appscode-charts-oci/gatewayvoyagermeshcom-mysqlroute-editor -n default --create-namespace --version=v0.8.0
```
...
```bash
$ helm upgrade -i gatewayvoyagermeshcom-mysqlroute-editor appscode-charts-oci/gatewayvoyagermeshcom-mysqlroute-editor -n default --create-namespace --version=v0.8.0 --set apiVersion=gateway.voyagermesh.com/v1alpha1
```
...
```bash
$ helm upgrade -i gatewayvoyagermeshcom-mysqlroute-editor appscode-charts-oci/gatewayvoyagermeshcom-mysqlroute-editor -n default --create-namespace --version=v0.8.0 --values values.yaml
```
