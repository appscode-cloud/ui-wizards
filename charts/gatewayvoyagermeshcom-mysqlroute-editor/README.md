...
$ helm repo update
$ helm search repo appscode-charts-oci/gatewayvoyagermeshcom-mysqlroute-editor --version=v0.4.18
$ helm upgrade -i gatewayvoyagermeshcom-mysqlroute-editor appscode-charts-oci/gatewayvoyagermeshcom-mysqlroute-editor -n default --create-namespace --version=v0.4.18
```
...
```bash
$ helm upgrade -i gatewayvoyagermeshcom-mysqlroute-editor appscode-charts-oci/gatewayvoyagermeshcom-mysqlroute-editor -n default --create-namespace --version=v0.4.18 --set apiVersion=gateway.voyagermesh.com/v1alpha1
```
...
```bash
$ helm upgrade -i gatewayvoyagermeshcom-mysqlroute-editor appscode-charts-oci/gatewayvoyagermeshcom-mysqlroute-editor -n default --create-namespace --version=v0.4.18 --values values.yaml
```
