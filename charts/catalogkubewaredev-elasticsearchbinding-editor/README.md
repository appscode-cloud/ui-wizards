...
$ helm repo update
$ helm search repo bytebuilders-ui/catalogkubewaredev-elasticsearchbinding-editor --version=v0.4.16
$ helm upgrade -i catalogkubewaredev-elasticsearchbinding-editor bytebuilders-ui/catalogkubewaredev-elasticsearchbinding-editor -n default --create-namespace --version=v0.4.16
```
...
```bash
$ helm upgrade -i catalogkubewaredev-elasticsearchbinding-editor bytebuilders-ui/catalogkubewaredev-elasticsearchbinding-editor -n default --create-namespace --version=v0.4.16 --set apiVersion=catalog.kubeware.dev/v1alpha1
```
...
```bash
$ helm upgrade -i catalogkubewaredev-elasticsearchbinding-editor bytebuilders-ui/catalogkubewaredev-elasticsearchbinding-editor -n default --create-namespace --version=v0.4.16 --values values.yaml
```
