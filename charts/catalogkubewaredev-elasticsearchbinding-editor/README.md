...
$ helm repo update
$ helm search repo appscode/catalogkubewaredev-elasticsearchbinding-editor --version=v0.34.0
$ helm upgrade -i catalogkubewaredev-elasticsearchbinding-editor appscode/catalogkubewaredev-elasticsearchbinding-editor -n default --create-namespace --version=v0.34.0
```
...
```bash
$ helm upgrade -i catalogkubewaredev-elasticsearchbinding-editor appscode/catalogkubewaredev-elasticsearchbinding-editor -n default --create-namespace --version=v0.34.0 --set apiVersion=catalog.kubeware.dev/v1alpha1
```
...
```bash
$ helm upgrade -i catalogkubewaredev-elasticsearchbinding-editor appscode/catalogkubewaredev-elasticsearchbinding-editor -n default --create-namespace --version=v0.34.0 --values values.yaml
```
