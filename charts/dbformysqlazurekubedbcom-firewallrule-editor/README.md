...
$ helm repo update
$ helm search repo appscode-charts-oci/dbformysqlazurekubedbcom-firewallrule-editor --version=v0.4.21
$ helm upgrade -i dbformysqlazurekubedbcom-firewallrule-editor appscode-charts-oci/dbformysqlazurekubedbcom-firewallrule-editor -n default --create-namespace --version=v0.4.21
```
...
```bash
$ helm upgrade -i dbformysqlazurekubedbcom-firewallrule-editor appscode-charts-oci/dbformysqlazurekubedbcom-firewallrule-editor -n default --create-namespace --version=v0.4.21 --set apiVersion=dbformysql.azure.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i dbformysqlazurekubedbcom-firewallrule-editor appscode-charts-oci/dbformysqlazurekubedbcom-firewallrule-editor -n default --create-namespace --version=v0.4.21 --values values.yaml
```
