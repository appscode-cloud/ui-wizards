...
$ helm repo update
$ helm search repo appscode/opskubedbcom-pgpoolopsrequest-editor --version=v0.33.0
$ helm upgrade -i opskubedbcom-pgpoolopsrequest-editor appscode/opskubedbcom-pgpoolopsrequest-editor -n default --create-namespace --version=v0.33.0
```
...
```bash
$ helm upgrade -i opskubedbcom-pgpoolopsrequest-editor appscode/opskubedbcom-pgpoolopsrequest-editor -n default --create-namespace --version=v0.33.0 --set apiVersion=ops.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i opskubedbcom-pgpoolopsrequest-editor appscode/opskubedbcom-pgpoolopsrequest-editor -n default --create-namespace --version=v0.33.0 --values values.yaml
```
