...
$ helm repo update
$ helm search repo appscode-charts-oci/cosmosdbazurekubedbcom-sqlfunction-editor --version=v0.11.0
...
```bash
$ helm upgrade -i cosmosdbazurekubedbcom-sqlfunction-editor appscode-charts-oci/cosmosdbazurekubedbcom-sqlfunction-editor -n default --create-namespace --version=v0.11.0 --set apiVersion=cosmosdb.azure.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i cosmosdbazurekubedbcom-sqlfunction-editor appscode-charts-oci/cosmosdbazurekubedbcom-sqlfunction-editor -n default --create-namespace --version=v0.11.0 --values values.yaml
```
