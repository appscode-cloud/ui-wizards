...
$ helm repo update
$ helm search repo appscode-charts-oci/gcpkubedbcom-storeconfig-editor --version=v0.12.0
$ helm upgrade -i gcpkubedbcom-storeconfig-editor appscode-charts-oci/gcpkubedbcom-storeconfig-editor -n default --create-namespace --version=v0.12.0
```
...
```bash
$ helm upgrade -i gcpkubedbcom-storeconfig-editor appscode-charts-oci/gcpkubedbcom-storeconfig-editor -n default --create-namespace --version=v0.12.0 --set apiVersion=gcp.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i gcpkubedbcom-storeconfig-editor appscode-charts-oci/gcpkubedbcom-storeconfig-editor -n default --create-namespace --version=v0.12.0 --values values.yaml
```
