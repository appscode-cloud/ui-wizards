...
$ helm repo update
$ helm search repo bytebuilders-ui/matchgatekeepersh-dummycrd-editor --version=v0.4.16
$ helm upgrade -i matchgatekeepersh-dummycrd-editor bytebuilders-ui/matchgatekeepersh-dummycrd-editor -n default --create-namespace --version=v0.4.16
```
...
```bash
$ helm upgrade -i matchgatekeepersh-dummycrd-editor bytebuilders-ui/matchgatekeepersh-dummycrd-editor -n default --create-namespace --version=v0.4.16 --set apiVersion=match.gatekeeper.sh/match
```
...
```bash
$ helm upgrade -i matchgatekeepersh-dummycrd-editor bytebuilders-ui/matchgatekeepersh-dummycrd-editor -n default --create-namespace --version=v0.4.16 --values values.yaml
```
