...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/matchgatekeepersh-dummycrd-editor --version=v0.4.17
$ helm upgrade -i matchgatekeepersh-dummycrd-editor bytebuilders-ui-dev/matchgatekeepersh-dummycrd-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i matchgatekeepersh-dummycrd-editor bytebuilders-ui-dev/matchgatekeepersh-dummycrd-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=match.gatekeeper.sh/match
```
...
```bash
$ helm upgrade -i matchgatekeepersh-dummycrd-editor bytebuilders-ui-dev/matchgatekeepersh-dummycrd-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
