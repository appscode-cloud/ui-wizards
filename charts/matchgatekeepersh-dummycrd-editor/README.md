...
$ helm repo update
$ helm search repo appscode-charts-oci/matchgatekeepersh-dummycrd-editor --version=v0.14.0
$ helm upgrade -i matchgatekeepersh-dummycrd-editor appscode-charts-oci/matchgatekeepersh-dummycrd-editor -n default --create-namespace --version=v0.14.0
```
...
```bash
$ helm upgrade -i matchgatekeepersh-dummycrd-editor appscode-charts-oci/matchgatekeepersh-dummycrd-editor -n default --create-namespace --version=v0.14.0 --set apiVersion=match.gatekeeper.sh/match
```
...
```bash
$ helm upgrade -i matchgatekeepersh-dummycrd-editor appscode-charts-oci/matchgatekeepersh-dummycrd-editor -n default --create-namespace --version=v0.14.0 --values values.yaml
```
