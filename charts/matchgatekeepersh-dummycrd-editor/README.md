...
$ helm repo update
$ helm search repo bytebuilders-ui/matchgatekeepersh-dummycrd-editor --version=v0.4.18
$ helm upgrade -i matchgatekeepersh-dummycrd-editor bytebuilders-ui/matchgatekeepersh-dummycrd-editor -n default --create-namespace --version=v0.4.18
```
...
```bash
$ helm upgrade -i matchgatekeepersh-dummycrd-editor bytebuilders-ui/matchgatekeepersh-dummycrd-editor -n default --create-namespace --version=v0.4.18 --set apiVersion=match.gatekeeper.sh/match
```
...
```bash
$ helm upgrade -i matchgatekeepersh-dummycrd-editor bytebuilders-ui/matchgatekeepersh-dummycrd-editor -n default --create-namespace --version=v0.4.18 --values values.yaml
```
