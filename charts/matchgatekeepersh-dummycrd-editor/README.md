...
$ helm repo update
$ helm search repo appscode-charts-oci/matchgatekeepersh-dummycrd-editor --version=v0.4.21
$ helm upgrade -i matchgatekeepersh-dummycrd-editor appscode-charts-oci/matchgatekeepersh-dummycrd-editor -n default --create-namespace --version=v0.4.21
```
...
```bash
$ helm upgrade -i matchgatekeepersh-dummycrd-editor appscode-charts-oci/matchgatekeepersh-dummycrd-editor -n default --create-namespace --version=v0.4.21 --set apiVersion=match.gatekeeper.sh/match
```
...
```bash
$ helm upgrade -i matchgatekeepersh-dummycrd-editor appscode-charts-oci/matchgatekeepersh-dummycrd-editor -n default --create-namespace --version=v0.4.21 --values values.yaml
```
