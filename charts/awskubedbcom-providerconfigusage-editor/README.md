...
$ helm repo update
$ helm search repo appscode/awskubedbcom-providerconfigusage-editor --version=v0.36.0
$ helm upgrade -i awskubedbcom-providerconfigusage-editor appscode/awskubedbcom-providerconfigusage-editor -n default --create-namespace --version=v0.36.0
```
...
```bash
$ helm upgrade -i awskubedbcom-providerconfigusage-editor appscode/awskubedbcom-providerconfigusage-editor -n default --create-namespace --version=v0.36.0 --set apiVersion=aws.kubedb.com/v1beta1
```
...
```bash
$ helm upgrade -i awskubedbcom-providerconfigusage-editor appscode/awskubedbcom-providerconfigusage-editor -n default --create-namespace --version=v0.36.0 --values values.yaml
```
