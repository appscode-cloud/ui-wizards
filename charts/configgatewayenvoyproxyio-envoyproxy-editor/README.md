...
$ helm repo update
$ helm search repo appscode-charts-oci/configgatewayenvoyproxyio-envoyproxy-editor --version=v0.7.0
$ helm upgrade -i configgatewayenvoyproxyio-envoyproxy-editor appscode-charts-oci/configgatewayenvoyproxyio-envoyproxy-editor -n default --create-namespace --version=v0.7.0
```
...
```bash
$ helm upgrade -i configgatewayenvoyproxyio-envoyproxy-editor appscode-charts-oci/configgatewayenvoyproxyio-envoyproxy-editor -n default --create-namespace --version=v0.7.0 --set apiVersion=config.gateway.envoyproxy.io/v1alpha1
```
...
```bash
$ helm upgrade -i configgatewayenvoyproxyio-envoyproxy-editor appscode-charts-oci/configgatewayenvoyproxyio-envoyproxy-editor -n default --create-namespace --version=v0.7.0 --values values.yaml
```
