...
$ helm repo update
$ helm search repo appscode-charts-oci/configgatewayenvoyproxyio-envoyproxy-editor --version=v0.4.21
$ helm upgrade -i configgatewayenvoyproxyio-envoyproxy-editor appscode-charts-oci/configgatewayenvoyproxyio-envoyproxy-editor -n default --create-namespace --version=v0.4.21
```
...
```bash
$ helm upgrade -i configgatewayenvoyproxyio-envoyproxy-editor appscode-charts-oci/configgatewayenvoyproxyio-envoyproxy-editor -n default --create-namespace --version=v0.4.21 --set apiVersion=config.gateway.envoyproxy.io/v1alpha1
```
...
```bash
$ helm upgrade -i configgatewayenvoyproxyio-envoyproxy-editor appscode-charts-oci/configgatewayenvoyproxyio-envoyproxy-editor -n default --create-namespace --version=v0.4.21 --values values.yaml
```
