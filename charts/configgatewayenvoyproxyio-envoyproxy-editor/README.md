...
$ helm repo update
$ helm search repo appscode-charts-oci/configgatewayenvoyproxyio-envoyproxy-editor --version=v0.4.18
$ helm upgrade -i configgatewayenvoyproxyio-envoyproxy-editor appscode-charts-oci/configgatewayenvoyproxyio-envoyproxy-editor -n default --create-namespace --version=v0.4.18
```
...
```bash
$ helm upgrade -i configgatewayenvoyproxyio-envoyproxy-editor appscode-charts-oci/configgatewayenvoyproxyio-envoyproxy-editor -n default --create-namespace --version=v0.4.18 --set apiVersion=config.gateway.envoyproxy.io/v1alpha1
```
...
```bash
$ helm upgrade -i configgatewayenvoyproxyio-envoyproxy-editor appscode-charts-oci/configgatewayenvoyproxyio-envoyproxy-editor -n default --create-namespace --version=v0.4.18 --values values.yaml
```
