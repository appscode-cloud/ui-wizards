...
$ helm repo update
$ helm search repo bytebuilders-ui/configgatewayenvoyproxyio-envoyproxy-editor --version=v0.4.16
$ helm upgrade -i configgatewayenvoyproxyio-envoyproxy-editor bytebuilders-ui/configgatewayenvoyproxyio-envoyproxy-editor -n default --create-namespace --version=v0.4.16
```
...
```bash
$ helm upgrade -i configgatewayenvoyproxyio-envoyproxy-editor bytebuilders-ui/configgatewayenvoyproxyio-envoyproxy-editor -n default --create-namespace --version=v0.4.16 --set apiVersion=config.gateway.envoyproxy.io/v1alpha1
```
...
```bash
$ helm upgrade -i configgatewayenvoyproxyio-envoyproxy-editor bytebuilders-ui/configgatewayenvoyproxyio-envoyproxy-editor -n default --create-namespace --version=v0.4.16 --values values.yaml
```
