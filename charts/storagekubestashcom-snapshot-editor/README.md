...
$ helm repo update
$ helm search repo appscode/storagekubestashcom-snapshot-editor --version=v0.19.0
$ helm upgrade -i storagekubestashcom-snapshot-editor appscode/storagekubestashcom-snapshot-editor -n default --create-namespace --version=v0.19.0
```
...
```bash
$ helm upgrade -i storagekubestashcom-snapshot-editor appscode/storagekubestashcom-snapshot-editor -n default --create-namespace --version=v0.19.0 --set apiVersion=storage.kubestash.com/v1alpha1
```
...
```bash
$ helm upgrade -i storagekubestashcom-snapshot-editor appscode/storagekubestashcom-snapshot-editor -n default --create-namespace --version=v0.19.0 --values values.yaml
```
