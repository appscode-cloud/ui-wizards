...
$ helm repo update
$ helm search repo appscode-charts-oci/catalogkubedbcom-pgpoolversion-editor --version=v0.4.21
$ helm upgrade -i catalogkubedbcom-pgpoolversion-editor appscode-charts-oci/catalogkubedbcom-pgpoolversion-editor -n default --create-namespace --version=v0.4.21
```
...
```bash
$ helm upgrade -i catalogkubedbcom-pgpoolversion-editor appscode-charts-oci/catalogkubedbcom-pgpoolversion-editor -n default --create-namespace --version=v0.4.21 --set apiVersion=catalog.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i catalogkubedbcom-pgpoolversion-editor appscode-charts-oci/catalogkubedbcom-pgpoolversion-editor -n default --create-namespace --version=v0.4.21 --values values.yaml
```
