...
$ helm repo update
$ helm search repo appscode-charts-oci/extensions-daemonset-editor --version=v0.4.18
$ helm upgrade -i extensions-daemonset-editor appscode-charts-oci/extensions-daemonset-editor -n default --create-namespace --version=v0.4.18
```
...
```bash
$ helm upgrade -i extensions-daemonset-editor appscode-charts-oci/extensions-daemonset-editor -n default --create-namespace --version=v0.4.18 --set apiVersion=extensions/v1beta1
```
...
```bash
$ helm upgrade -i extensions-daemonset-editor appscode-charts-oci/extensions-daemonset-editor -n default --create-namespace --version=v0.4.18 --values values.yaml
```
