...
$ helm repo update
$ helm search repo appscode/catalogkubedbcom-druidversion-editor --version=v0.25.0
$ helm upgrade -i catalogkubedbcom-druidversion-editor appscode/catalogkubedbcom-druidversion-editor -n default --create-namespace --version=v0.25.0
```
...
```bash
$ helm upgrade -i catalogkubedbcom-druidversion-editor appscode/catalogkubedbcom-druidversion-editor -n default --create-namespace --version=v0.25.0 --set apiVersion=catalog.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i catalogkubedbcom-druidversion-editor appscode/catalogkubedbcom-druidversion-editor -n default --create-namespace --version=v0.25.0 --values values.yaml
```
