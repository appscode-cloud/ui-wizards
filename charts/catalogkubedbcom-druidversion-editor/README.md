...
$ helm repo update
$ helm search repo appscode-charts-oci/catalogkubedbcom-druidversion-editor --version=v0.11.0
...
```bash
$ helm upgrade -i catalogkubedbcom-druidversion-editor appscode-charts-oci/catalogkubedbcom-druidversion-editor -n default --create-namespace --version=v0.11.0 --set apiVersion=catalog.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i catalogkubedbcom-druidversion-editor appscode-charts-oci/catalogkubedbcom-druidversion-editor -n default --create-namespace --version=v0.11.0 --values values.yaml
```
