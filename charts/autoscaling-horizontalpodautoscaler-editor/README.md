...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/autoscaling-horizontalpodautoscaler-editor --version=v0.4.17
$ helm upgrade -i autoscaling-horizontalpodautoscaler-editor bytebuilders-ui-dev/autoscaling-horizontalpodautoscaler-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i autoscaling-horizontalpodautoscaler-editor bytebuilders-ui-dev/autoscaling-horizontalpodautoscaler-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=autoscaling/v2beta2
```
...
```bash
$ helm upgrade -i autoscaling-horizontalpodautoscaler-editor bytebuilders-ui-dev/autoscaling-horizontalpodautoscaler-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
