...
$ helm repo update
$ helm search repo appscode-charts-oci/autoscaling-horizontalpodautoscaler-editor --version=v0.4.21
$ helm upgrade -i autoscaling-horizontalpodautoscaler-editor appscode-charts-oci/autoscaling-horizontalpodautoscaler-editor -n default --create-namespace --version=v0.4.21
```
...
```bash
$ helm upgrade -i autoscaling-horizontalpodautoscaler-editor appscode-charts-oci/autoscaling-horizontalpodautoscaler-editor -n default --create-namespace --version=v0.4.21 --set apiVersion=autoscaling/v2beta2
```
...
```bash
$ helm upgrade -i autoscaling-horizontalpodautoscaler-editor appscode-charts-oci/autoscaling-horizontalpodautoscaler-editor -n default --create-namespace --version=v0.4.21 --values values.yaml
```
