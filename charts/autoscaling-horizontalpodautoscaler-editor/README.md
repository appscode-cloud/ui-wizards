...
$ helm repo update
$ helm search repo appscode/autoscaling-horizontalpodautoscaler-editor --version=v0.32.0
$ helm upgrade -i autoscaling-horizontalpodautoscaler-editor appscode/autoscaling-horizontalpodautoscaler-editor -n default --create-namespace --version=v0.32.0
```
...
```bash
$ helm upgrade -i autoscaling-horizontalpodautoscaler-editor appscode/autoscaling-horizontalpodautoscaler-editor -n default --create-namespace --version=v0.32.0 --set apiVersion=autoscaling/v2beta2
```
...
```bash
$ helm upgrade -i autoscaling-horizontalpodautoscaler-editor appscode/autoscaling-horizontalpodautoscaler-editor -n default --create-namespace --version=v0.32.0 --values values.yaml
```
