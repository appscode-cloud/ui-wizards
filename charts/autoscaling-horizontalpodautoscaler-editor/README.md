...
$ helm repo update
$ helm search repo appscode-charts-oci/autoscaling-horizontalpodautoscaler-editor --version=v0.4.19
$ helm upgrade -i autoscaling-horizontalpodautoscaler-editor appscode-charts-oci/autoscaling-horizontalpodautoscaler-editor -n default --create-namespace --version=v0.4.19
```
...
```bash
$ helm upgrade -i autoscaling-horizontalpodautoscaler-editor appscode-charts-oci/autoscaling-horizontalpodautoscaler-editor -n default --create-namespace --version=v0.4.19 --set apiVersion=autoscaling/v2beta2
```
...
```bash
$ helm upgrade -i autoscaling-horizontalpodautoscaler-editor appscode-charts-oci/autoscaling-horizontalpodautoscaler-editor -n default --create-namespace --version=v0.4.19 --values values.yaml
```
