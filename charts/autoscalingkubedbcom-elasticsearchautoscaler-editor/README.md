...
$ helm repo update
$ helm search repo appscode/autoscalingkubedbcom-elasticsearchautoscaler-editor --version=v0.37.0
$ helm upgrade -i autoscalingkubedbcom-elasticsearchautoscaler-editor appscode/autoscalingkubedbcom-elasticsearchautoscaler-editor -n default --create-namespace --version=v0.37.0
```
...
```bash
$ helm upgrade -i autoscalingkubedbcom-elasticsearchautoscaler-editor appscode/autoscalingkubedbcom-elasticsearchautoscaler-editor -n default --create-namespace --version=v0.37.0 --set apiVersion=autoscaling.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i autoscalingkubedbcom-elasticsearchautoscaler-editor appscode/autoscalingkubedbcom-elasticsearchautoscaler-editor -n default --create-namespace --version=v0.37.0 --values values.yaml
```
