...
$ helm repo update
$ helm search repo appscode/rdsawskubedbcom-clusterroleassociation-editor --version=v0.25.0
$ helm upgrade -i rdsawskubedbcom-clusterroleassociation-editor appscode/rdsawskubedbcom-clusterroleassociation-editor -n default --create-namespace --version=v0.25.0
```
...
```bash
$ helm upgrade -i rdsawskubedbcom-clusterroleassociation-editor appscode/rdsawskubedbcom-clusterroleassociation-editor -n default --create-namespace --version=v0.25.0 --set apiVersion=rds.aws.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i rdsawskubedbcom-clusterroleassociation-editor appscode/rdsawskubedbcom-clusterroleassociation-editor -n default --create-namespace --version=v0.25.0 --values values.yaml
```
