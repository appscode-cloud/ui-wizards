...
$ helm repo update
$ helm search repo appscode-charts-oci/rdsawskubedbcom-clusterroleassociation-editor --version=v0.4.18
$ helm upgrade -i rdsawskubedbcom-clusterroleassociation-editor appscode-charts-oci/rdsawskubedbcom-clusterroleassociation-editor -n default --create-namespace --version=v0.4.18
```
...
```bash
$ helm upgrade -i rdsawskubedbcom-clusterroleassociation-editor appscode-charts-oci/rdsawskubedbcom-clusterroleassociation-editor -n default --create-namespace --version=v0.4.18 --set apiVersion=rds.aws.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i rdsawskubedbcom-clusterroleassociation-editor appscode-charts-oci/rdsawskubedbcom-clusterroleassociation-editor -n default --create-namespace --version=v0.4.18 --values values.yaml
```
