...
$ helm repo update
$ helm search repo appscode/core-persistentvolume-editor --version=v0.20.0
$ helm upgrade -i core-persistentvolume-editor appscode/core-persistentvolume-editor -n default --create-namespace --version=v0.20.0
```
...
```bash
$ helm upgrade -i core-persistentvolume-editor appscode/core-persistentvolume-editor -n default --create-namespace --version=v0.20.0 --set apiVersion=v1
```
...
```bash
$ helm upgrade -i core-persistentvolume-editor appscode/core-persistentvolume-editor -n default --create-namespace --version=v0.20.0 --values values.yaml
```
