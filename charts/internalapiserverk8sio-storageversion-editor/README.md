...
$ helm repo update
$ helm search repo appscode-charts-oci/internalapiserverk8sio-storageversion-editor --version=v0.4.19
$ helm upgrade -i internalapiserverk8sio-storageversion-editor appscode-charts-oci/internalapiserverk8sio-storageversion-editor -n default --create-namespace --version=v0.4.19
```
...
```bash
$ helm upgrade -i internalapiserverk8sio-storageversion-editor appscode-charts-oci/internalapiserverk8sio-storageversion-editor -n default --create-namespace --version=v0.4.19 --set apiVersion=internal.apiserver.k8s.io/v1alpha1
```
...
```bash
$ helm upgrade -i internalapiserverk8sio-storageversion-editor appscode-charts-oci/internalapiserverk8sio-storageversion-editor -n default --create-namespace --version=v0.4.19 --values values.yaml
```
