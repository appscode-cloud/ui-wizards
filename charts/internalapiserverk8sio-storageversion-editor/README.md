...
$ helm repo update
$ helm search repo bytebuilders-ui/internalapiserverk8sio-storageversion-editor --version=v0.4.17
$ helm upgrade -i internalapiserverk8sio-storageversion-editor bytebuilders-ui/internalapiserverk8sio-storageversion-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i internalapiserverk8sio-storageversion-editor bytebuilders-ui/internalapiserverk8sio-storageversion-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=internal.apiserver.k8s.io/v1alpha1
```
...
```bash
$ helm upgrade -i internalapiserverk8sio-storageversion-editor bytebuilders-ui/internalapiserverk8sio-storageversion-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
