...
$ helm repo update
$ helm search repo appscode-charts-oci/openvizdev-grafanadatasource-editor --version=v0.14.0
$ helm upgrade -i openvizdev-grafanadatasource-editor appscode-charts-oci/openvizdev-grafanadatasource-editor -n default --create-namespace --version=v0.14.0
```
...
```bash
$ helm upgrade -i openvizdev-grafanadatasource-editor appscode-charts-oci/openvizdev-grafanadatasource-editor -n default --create-namespace --version=v0.14.0 --set apiVersion=openviz.dev/v1alpha1
```
...
```bash
$ helm upgrade -i openvizdev-grafanadatasource-editor appscode-charts-oci/openvizdev-grafanadatasource-editor -n default --create-namespace --version=v0.14.0 --values values.yaml
```
