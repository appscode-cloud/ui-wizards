...
$ helm repo update
$ helm search repo bytebuilders-ui/supervisorappscodecom-approvalpolicy-editor --version=v0.4.16
$ helm upgrade -i supervisorappscodecom-approvalpolicy-editor bytebuilders-ui/supervisorappscodecom-approvalpolicy-editor -n default --create-namespace --version=v0.4.16
```
...
```bash
$ helm upgrade -i supervisorappscodecom-approvalpolicy-editor bytebuilders-ui/supervisorappscodecom-approvalpolicy-editor -n default --create-namespace --version=v0.4.16 --set apiVersion=supervisor.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i supervisorappscodecom-approvalpolicy-editor bytebuilders-ui/supervisorappscodecom-approvalpolicy-editor -n default --create-namespace --version=v0.4.16 --values values.yaml
```
