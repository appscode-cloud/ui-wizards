...
$ helm repo update
$ helm search repo bytebuilders-ui/supervisorappscodecom-approvalpolicy-editor --version=v0.4.11
$ helm upgrade -i supervisorappscodecom-approvalpolicy-editor bytebuilders-ui/supervisorappscodecom-approvalpolicy-editor -n default --create-namespace --version=v0.4.11
```
...
```bash
$ helm upgrade -i supervisorappscodecom-approvalpolicy-editor bytebuilders-ui/supervisorappscodecom-approvalpolicy-editor -n default --create-namespace --version=v0.4.11 --set apiVersion=supervisor.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i supervisorappscodecom-approvalpolicy-editor bytebuilders-ui/supervisorappscodecom-approvalpolicy-editor -n default --create-namespace --version=v0.4.11 --values values.yaml
```
