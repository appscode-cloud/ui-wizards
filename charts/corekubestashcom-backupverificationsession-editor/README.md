...
$ helm repo update
$ helm search repo appscode-charts-oci/corekubestashcom-backupverificationsession-editor --version=v0.11.0
...
```bash
$ helm upgrade -i corekubestashcom-backupverificationsession-editor appscode-charts-oci/corekubestashcom-backupverificationsession-editor -n default --create-namespace --version=v0.11.0 --set apiVersion=core.kubestash.com/v1alpha1
```
...
```bash
$ helm upgrade -i corekubestashcom-backupverificationsession-editor appscode-charts-oci/corekubestashcom-backupverificationsession-editor -n default --create-namespace --version=v0.11.0 --values values.yaml
```
