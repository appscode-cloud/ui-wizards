...
$ helm repo update
$ helm search repo appscode/corekubestashcom-backupverificationsession-editor --version=v0.28.0
$ helm upgrade -i corekubestashcom-backupverificationsession-editor appscode/corekubestashcom-backupverificationsession-editor -n default --create-namespace --version=v0.28.0
```
...
```bash
$ helm upgrade -i corekubestashcom-backupverificationsession-editor appscode/corekubestashcom-backupverificationsession-editor -n default --create-namespace --version=v0.28.0 --set apiVersion=core.kubestash.com/v1alpha1
```
...
```bash
$ helm upgrade -i corekubestashcom-backupverificationsession-editor appscode/corekubestashcom-backupverificationsession-editor -n default --create-namespace --version=v0.28.0 --values values.yaml
```
