...
$ helm repo update
$ helm install extensions-networkpolicy-editor bytebuilders-ui-dev/extensions-networkpolicy-editor -n default
```
...
```console
$ helm install extensions-networkpolicy-editor bytebuilders-ui-dev/extensions-networkpolicy-editor -n default --set apiVersion=extensions/v1beta1
```
...
```console
$ helm install extensions-networkpolicy-editor bytebuilders-ui-dev/extensions-networkpolicy-editor -n default --values values.yaml
```
