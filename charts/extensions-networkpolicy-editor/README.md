...
$ helm repo update
$ helm search repo appscode-charts-oci/extensions-networkpolicy-editor --version=v0.13.0
$ helm upgrade -i extensions-networkpolicy-editor appscode-charts-oci/extensions-networkpolicy-editor -n default --create-namespace --version=v0.13.0
```
...
```bash
$ helm upgrade -i extensions-networkpolicy-editor appscode-charts-oci/extensions-networkpolicy-editor -n default --create-namespace --version=v0.13.0 --set apiVersion=extensions/v1beta1
```
...
```bash
$ helm upgrade -i extensions-networkpolicy-editor appscode-charts-oci/extensions-networkpolicy-editor -n default --create-namespace --version=v0.13.0 --values values.yaml
```
