...
$ helm repo update
$ helm search repo appscode-charts-oci/extensions-networkpolicy-editor --version=v0.4.20
$ helm upgrade -i extensions-networkpolicy-editor appscode-charts-oci/extensions-networkpolicy-editor -n default --create-namespace --version=v0.4.20
```
...
```bash
$ helm upgrade -i extensions-networkpolicy-editor appscode-charts-oci/extensions-networkpolicy-editor -n default --create-namespace --version=v0.4.20 --set apiVersion=extensions/v1beta1
```
...
```bash
$ helm upgrade -i extensions-networkpolicy-editor appscode-charts-oci/extensions-networkpolicy-editor -n default --create-namespace --version=v0.4.20 --values values.yaml
```
