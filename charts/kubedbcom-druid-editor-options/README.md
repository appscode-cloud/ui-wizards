...
$ helm repo update
$ helm search repo bytebuilders-ui/kubedbcom-druid-editor-options --version=v0.4.21
$ helm upgrade -i kubedbcom-druid-editor-options bytebuilders-ui/kubedbcom-druid-editor-options -n kube-system --create-namespace --version=v0.4.21
```
...
| spec.topology.middleManagers.podResources.resources.limits.cpu                 |                                                                                                      | <code>500m</code>                                         |
| spec.topology.middleManagers.podResources.resources.limits.memory              |                                                                                                      | <code>1Gi</code>                                          |
| spec.topology.middleManagers.persistence.size                                  |                                                                                                      | <code>10Gi</code>                                         |
| spec.topology.historicals.replicas                                             |                                                                                                      | <code>3</code>                                            |
| spec.topology.historicals.podResources.machine                                 |                                                                                                      | <code>""</code>                                           |
| spec.topology.historicals.podResources.resources.limits.cpu                    |                                                                                                      | <code>500m</code>                                         |
| spec.topology.historicals.podResources.resources.limits.memory                 |                                                                                                      | <code>1Gi</code>                                          |
...
| spec.topology.brokers.podResources.resources.limits.cpu                        |                                                                                                      | <code>500m</code>                                         |
| spec.topology.brokers.podResources.resources.limits.memory                     |                                                                                                      | <code>1Gi</code>                                          |
| spec.topology.coordinators.replicas                                            |                                                                                                      | <code>2</code>                                            |
| spec.topology.coordinators.podResources.machine                                |                                                                                                      | <code>""</code>                                           |
| spec.topology.coordinators.podResources.resources.limits.cpu                   |                                                                                                      | <code>500m</code>                                         |
| spec.topology.coordinators.podResources.resources.limits.memory                |                                                                                                      | <code>1Gi</code>                                          |
...
| spec.admin.databases.Druid.versions.default                                    |                                                                                                      | <code>"28.0.1"</code>                                     |
...
```bash
$ helm upgrade -i kubedbcom-druid-editor-options bytebuilders-ui/kubedbcom-druid-editor-options -n kube-system --create-namespace --version=v0.4.21 --set metadata.resource.group=kubedb.com
```
...
```bash
$ helm upgrade -i kubedbcom-druid-editor-options bytebuilders-ui/kubedbcom-druid-editor-options -n kube-system --create-namespace --version=v0.4.21 --values values.yaml
```
