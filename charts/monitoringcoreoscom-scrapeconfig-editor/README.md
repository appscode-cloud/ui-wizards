...
$ helm repo update
$ helm search repo appscode-charts-oci/monitoringcoreoscom-scrapeconfig-editor --version=v0.4.18
$ helm upgrade -i monitoringcoreoscom-scrapeconfig-editor appscode-charts-oci/monitoringcoreoscom-scrapeconfig-editor -n default --create-namespace --version=v0.4.18
```
...
```bash
$ helm upgrade -i monitoringcoreoscom-scrapeconfig-editor appscode-charts-oci/monitoringcoreoscom-scrapeconfig-editor -n default --create-namespace --version=v0.4.18 --set apiVersion=monitoring.coreos.com/v1alpha1
```
...
```bash
$ helm upgrade -i monitoringcoreoscom-scrapeconfig-editor appscode-charts-oci/monitoringcoreoscom-scrapeconfig-editor -n default --create-namespace --version=v0.4.18 --values values.yaml
```
