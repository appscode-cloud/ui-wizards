...
*/}}
{{- define "kubedbcom-ignite-editor.name" -}}
...
*/}}
{{- define "kubedbcom-ignite-editor.fullname" -}}
...
*/}}
{{- define "kubedbcom-ignite-editor.chart" -}}
...
Common labels
*/}}
{{- define "kubedbcom-ignite-editor.labels" -}}
{{ include "kubedbcom-ignite-editor.selectorLabels" . }}
...
Selector labels
*/}}
{{- define "kubedbcom-ignite-editor.selectorLabels" -}}
app.kubernetes.io/name: ignites.kubedb.com
app.kubernetes.io/instance: {{ include "kubedbcom-ignite-editor.fullname" . }}
{{- end }}

{{/*
Create the name of the service account to use
*/}}
{{- define "kubedbcom-ignite-editor.serviceAccountName" -}}
{{- if .Values.spec.serviceAccount.create }}
{{- default (include "kubedbcom-ignite-editor.fullname" .) .Values.spec.serviceAccount.name }}
{{- else }}
...
Common annotations
*/}}
{{- define "kubedbcom-ignite-editor.annotations" -}}
...
Alert Enabled
*/}}
{{- define "kubedbcom-ignite-editor.alertEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
{{- $key := mustLast . -}}
{{- $rest := mustInitial . -}}
{{- $rules := mustLast $rest -}}
