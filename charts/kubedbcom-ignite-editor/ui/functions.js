...
export const useFunc = (model) => {
  ...
  function onScheduleBackupChange() {
    ...
    if (scheduleBackup === 'no') {
      ...
      // delete annotation from kubedbComIgnite annotation
      deleteKubeDbComIgniteDbAnnotation(getValue, model, commit)
    } else {
  ...
  function getBackupConfigsAndAnnotations(getValue, model) {
    ...
    const kubedbComIgniteAnnotations =
      getValue(model, '/resources/kubedbComIgnite/metadata/annotations') || {}

    const isBluePrint = Object.keys(kubedbComIgniteAnnotations).some(
      (k) =>
  ...
  function deleteKubeDbComIgniteDbAnnotation(getValue, model, commit) {
    const annotations = getValue(model, '/resources/kubedbComIgnite/metadata/annotations') || {}
    ...
    commit('wizard/model$update', {
      path: '/resources/kubedbComIgnite/metadata/annotations',
  ...
  async function initBackupData() {
    ...
    dbResource = getValue(model, '/resources/kubedbComIgnite')
  ...
  function onBackupTypeChange() {
    ...
    commit('wizard/model$update', {
      path: '/resources/kubedbComIgnite',
  ...
  function onArchiverChange() {
    ...
    const path = 'resources/kubedbComIgnite/spec/archiver'
    if (archiverSwitch) {
      commit('wizard/model$update', {
        path: path,
  ...
  function addLabelAnnotation(type) {
    ...
    commit('wizard/model$update', {
      path: `/resources/kubedbComIgnite/metadata/${type}`,
      value: obj,
      force: true,
    })
  }
  ...
  function isConsole() {
    ...
    if (isKube) {
      ...
      commit('wizard/model$update', {
        path: '/resources/autoscalingKubedbComIgniteAutoscaler/spec/databaseRef/name',
        value: dbName,
        force: true,
      })
      ...
      commit('wizard/model$update', {
        path: '/resources/autoscalingKubedbComIgniteAutoscaler/metadata/name',
        value: modifiedName,
        force: true,
      })
      const namespace = storeGet('/route/query/namespace') || ''
      if (namespace) {
        commit('wizard/model$update', {
          path: '/resources/autoscalingKubedbComIgniteAutoscaler/metadata/namespace',
          value: namespace,
          force: true,
        })
      }
  ...
  function onNamespaceChange() {
    ...
    const agent = getValue(model, '/resources/kubedbComIgnite/spec/monitor/agent')
  ...
  async function getIgniteDbs() {
    // watchDependency('model#/resources/autoscalingKubedbComIgniteAutoscaler/metadata/namespace')
    const namespace = getValue(
      model,
      '/resources/autoscalingKubedbComIgniteAutoscaler/metadata/namespace',
    )
    const owner = storeGet('/route/params/user')
    const cluster = storeGet('/route/params/cluster')
    const storageEngine = getValue(model, '/resources/kubedbComIgnite/spec/storageEngine')
    showStoragememory = storageEngine === 'inMemory'
    const resp = await axios.get(
      `/clusters/${owner}/${cluster}/proxy/kubedb.com/v1alpha2/namespaces/${namespace}/ignites`,
      {
        params: { filter: { items: { metadata: { name: null } } } },
      },
    )
  ...
  function initMetadata() {
    const dbName =
      getValue(model, '/resources/autoscalingKubedbComIgniteAutoscaler/spec/databaseRef/name') || ''
    ...
    if (type === 'compute')
      commit('wizard/model$delete', '/resources/autoscalingKubedbComIgniteAutoscaler/spec/storage')
    if (type === 'storage')
      commit('wizard/model$delete', '/resources/autoscalingKubedbComIgniteAutoscaler/spec/compute')
  }

  async function fetchTopologyMachines() {
    const annotations =
      getValue(model, '/resources/autoscalingKubedbComIgniteAutoscaler/metadata/annotations') || {}
  ...
  function onTriggerChange(type) {
    ...
    const commitPath = `/resources/autoscalingKubedbComIgniteAutoscaler/spec/${type}/trigger`
  ...
  function onMachineChange(type) {
    const annoPath = '/resources/autoscalingKubedbComIgniteAutoscaler/metadata/annotations'
    ...
    const maxMachineAllocatable = maxMachineObj
      ...
      : null
    const allowedPath = `/resources/autoscalingKubedbComIgniteAutoscaler/spec/compute/${type}`
  ...
  function setControlledResources(type) {
    ...
    const path = `/resources/autoscalingKubedbComIgniteAutoscaler/spec/compute/${type}/controlledResources`
    commit('wizard/model$update', {
      path: path,
      value: list,
      force: true,
  ...
  function isNodeTopologySelected() {
    // watchDependency(
    //   'model#/resources/autoscalingKubedbComIgniteAutoscaler/spec/compute/nodeTopology/name',
    // )
    const nodeTopologyName =
      getValue(
        model,
        '/resources/autoscalingKubedbComIgniteAutoscaler/spec/compute/nodeTopology/name',
      ) || ''
  ...
  function showOpsRequestOptions() {
    ...
    // watchDependency('model#/resources/autoscalingKubedbComIgniteAutoscaler/spec/databaseRef/name')
  ...
  function onEnableMonitoringChange() {
    ...
    if (configureStatus) {
      commit('wizard/model$update', {
        path: '/resources/kubedbComIgnite/spec/monitor',
        value: {},
        force: true,
      })
    } else {
      commit('wizard/model$delete', '/resources/kubedbComIgnite/spec/monitor')
    }
  ...
  function onCustomizeExporterChange() {
    ...
    if (configureStatus) {
      commit('wizard/model$update', {
        path: '/resources/kubedbComIgnite/spec/monitor/prometheus/exporter',
        value: {},
        force: true,
      })
    } else {
      commit('wizard/model$delete', '/resources/kubedbComIgnite/spec/monitor/prometheus/exporter')
    }
  }
  ...
  function onLabelChange() {
    const labels = getValue(model, '/resources/kubedbComIgnite/spec/metadata/labels')
  ...
  function getOpsRequestUrl(reqType) {
    ...
    if (isKube) return pathConstructedForKubedb
      ...
      return `${domain}/console/${owner}/kubernetes/${cluster}/ops.kubedb.com/v1alpha1/igniteopsrequests/create?name=${dbname}&namespace=${namespace}&group=${group}&version=${version}&resource=${resource}&kind=${kind}&page=operations&requestType=VerticalScaling`
  }
  ...
  function onNamespaceChange() {
    ...
    if (!namespace) {
      commit(
        'wizard/model$delete',
        '/resources/autoscalingKubedbComIgniteAutoscaler/spec/databaseRef/name',
      )
    }
  }
  ...
  async function getConfigMapKeys(index) {
    ...
    const configMapName = getValue(
      model,
      `/resources/kubedbComIgnite/spec/monitor/prometheus/exporter/env/${index}/valueFrom/configMapKeyRef/name`,
    )
  ...
  async function getSecretKeys(index) {
    ...
    const secretName = getValue(
      model,
      `/resources/kubedbComIgnite/spec/monitor/prometheus/exporter/env/${index}/valueFrom/secretKeyRef/name`,
    )
  ...
  function isBindingAlreadyOn() {
    ...
    const isExposeBinding = !!keys.find((str) => str === 'catalogAppscodeComIgniteBinding')
  ...
  function addOrRemoveBinding() {
    ...
    const labels = getValue(model, '/resources/kubedbComIgnite/metadata/labels')
    const bindingValues = {
    ...
    if (value) {
      commit('wizard/model$update', {
        path: '/resources/catalogAppscodeComIgniteBinding',
        value: bindingValues,
        force: true,
      })
    } else {
      commit('wizard/model$delete', '/resources/catalogAppscodeComIgniteBinding')
    }
  }
  ...
  function onEnvArrayChange() {
    ...
    if (filteredEnv.length)
      commit('wizard/model$update', {
        path: '/resources/kubedbComIgnite/spec/monitor/prometheus/exporter/env',
        value: filteredEnv,
        force: true,
      })
  }
  ...
  function initEnvArray() {
    const env = getValue(model, '/resources/kubedbComIgnite/spec/monitor/prometheus/exporter/env')
  ...
  function initMonitoring() {
    const env =
      getValue(model, '/resources/kubedbComIgnite/spec/monitor/prometheus/exporter/env') || []
