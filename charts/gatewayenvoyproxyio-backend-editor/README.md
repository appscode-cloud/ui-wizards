...
$ helm repo update
$ helm search repo appscode-charts-oci/gatewayenvoyproxyio-backend-editor --version=v0.7.0
$ helm upgrade -i gatewayenvoyproxyio-backend-editor appscode-charts-oci/gatewayenvoyproxyio-backend-editor -n default --create-namespace --version=v0.7.0
```
...
```bash
$ helm upgrade -i gatewayenvoyproxyio-backend-editor appscode-charts-oci/gatewayenvoyproxyio-backend-editor -n default --create-namespace --version=v0.7.0 --set apiVersion=gateway.envoyproxy.io/v1alpha1
```
...
```bash
$ helm upgrade -i gatewayenvoyproxyio-backend-editor appscode-charts-oci/gatewayenvoyproxyio-backend-editor -n default --create-namespace --version=v0.7.0 --values values.yaml
```
