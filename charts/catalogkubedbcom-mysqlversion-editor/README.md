...
$ helm repo update
$ helm search repo appscode-charts-oci/catalogkubedbcom-mysqlversion-editor --version=v0.14.0
$ helm upgrade -i catalogkubedbcom-mysqlversion-editor appscode-charts-oci/catalogkubedbcom-mysqlversion-editor -n default --create-namespace --version=v0.14.0
```
...
```bash
$ helm upgrade -i catalogkubedbcom-mysqlversion-editor appscode-charts-oci/catalogkubedbcom-mysqlversion-editor -n default --create-namespace --version=v0.14.0 --set apiVersion=catalog.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i catalogkubedbcom-mysqlversion-editor appscode-charts-oci/catalogkubedbcom-mysqlversion-editor -n default --create-namespace --version=v0.14.0 --values values.yaml
```
