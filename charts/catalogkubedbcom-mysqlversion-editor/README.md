...
$ helm repo update
$ helm search repo bytebuilders-ui/catalogkubedbcom-mysqlversion-editor --version=v0.4.12
$ helm upgrade -i catalogkubedbcom-mysqlversion-editor bytebuilders-ui/catalogkubedbcom-mysqlversion-editor -n default --create-namespace --version=v0.4.12
```
...
```bash
$ helm upgrade -i catalogkubedbcom-mysqlversion-editor bytebuilders-ui/catalogkubedbcom-mysqlversion-editor -n default --create-namespace --version=v0.4.12 --set apiVersion=catalog.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i catalogkubedbcom-mysqlversion-editor bytebuilders-ui/catalogkubedbcom-mysqlversion-editor -n default --create-namespace --version=v0.4.12 --values values.yaml
```
