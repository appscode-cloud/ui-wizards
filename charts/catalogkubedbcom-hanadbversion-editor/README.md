...
$ helm repo update
$ helm search repo appscode/catalogkubedbcom-hanadbversion-editor --version=v0.34.0
$ helm upgrade -i catalogkubedbcom-hanadbversion-editor appscode/catalogkubedbcom-hanadbversion-editor -n default --create-namespace --version=v0.34.0
```
...
```bash
$ helm upgrade -i catalogkubedbcom-hanadbversion-editor appscode/catalogkubedbcom-hanadbversion-editor -n default --create-namespace --version=v0.34.0 --set apiVersion=catalog.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i catalogkubedbcom-hanadbversion-editor appscode/catalogkubedbcom-hanadbversion-editor -n default --create-namespace --version=v0.34.0 --values values.yaml
```
