...
$ helm repo update
$ helm search repo bytebuilders-ui/catalogkubewaredev-mysqlbinding-editor --version=v0.4.17
$ helm upgrade -i catalogkubewaredev-mysqlbinding-editor bytebuilders-ui/catalogkubewaredev-mysqlbinding-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i catalogkubewaredev-mysqlbinding-editor bytebuilders-ui/catalogkubewaredev-mysqlbinding-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=catalog.kubeware.dev/v1alpha1
```
...
```bash
$ helm upgrade -i catalogkubewaredev-mysqlbinding-editor bytebuilders-ui/catalogkubewaredev-mysqlbinding-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
