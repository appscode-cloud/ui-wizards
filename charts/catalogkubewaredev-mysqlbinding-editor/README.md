...
$ helm repo update
$ helm search repo appscode-charts-oci/catalogkubewaredev-mysqlbinding-editor --version=v0.4.19
$ helm upgrade -i catalogkubewaredev-mysqlbinding-editor appscode-charts-oci/catalogkubewaredev-mysqlbinding-editor -n default --create-namespace --version=v0.4.19
```
...
```bash
$ helm upgrade -i catalogkubewaredev-mysqlbinding-editor appscode-charts-oci/catalogkubewaredev-mysqlbinding-editor -n default --create-namespace --version=v0.4.19 --set apiVersion=catalog.kubeware.dev/v1alpha1
```
...
```bash
$ helm upgrade -i catalogkubewaredev-mysqlbinding-editor appscode-charts-oci/catalogkubewaredev-mysqlbinding-editor -n default --create-namespace --version=v0.4.19 --values values.yaml
```
