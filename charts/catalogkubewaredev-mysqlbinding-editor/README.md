...
$ helm repo update
$ helm search repo appscode-charts-oci/catalogkubewaredev-mysqlbinding-editor --version=v0.11.0
...
```bash
$ helm upgrade -i catalogkubewaredev-mysqlbinding-editor appscode-charts-oci/catalogkubewaredev-mysqlbinding-editor -n default --create-namespace --version=v0.11.0 --set apiVersion=catalog.kubeware.dev/v1alpha1
```
...
```bash
$ helm upgrade -i catalogkubewaredev-mysqlbinding-editor appscode-charts-oci/catalogkubewaredev-mysqlbinding-editor -n default --create-namespace --version=v0.11.0 --values values.yaml
```
