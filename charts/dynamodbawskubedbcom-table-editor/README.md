...
$ helm repo update
$ helm search repo appscode-charts-oci/dynamodbawskubedbcom-table-editor --version=v0.13.0
$ helm upgrade -i dynamodbawskubedbcom-table-editor appscode-charts-oci/dynamodbawskubedbcom-table-editor -n default --create-namespace --version=v0.13.0
```
...
```bash
$ helm upgrade -i dynamodbawskubedbcom-table-editor appscode-charts-oci/dynamodbawskubedbcom-table-editor -n default --create-namespace --version=v0.13.0 --set apiVersion=dynamodb.aws.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i dynamodbawskubedbcom-table-editor appscode-charts-oci/dynamodbawskubedbcom-table-editor -n default --create-namespace --version=v0.13.0 --values values.yaml
```
