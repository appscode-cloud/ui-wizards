...
$ helm repo update
$ helm search repo bytebuilders-ui/storagek8sio-csidriver-editor --version=v0.4.13
$ helm upgrade -i storagek8sio-csidriver-editor bytebuilders-ui/storagek8sio-csidriver-editor -n default --create-namespace --version=v0.4.13
```
...
```bash
$ helm upgrade -i storagek8sio-csidriver-editor bytebuilders-ui/storagek8sio-csidriver-editor -n default --create-namespace --version=v0.4.13 --set apiVersion=storage.k8s.io/v1
```
...
```bash
$ helm upgrade -i storagek8sio-csidriver-editor bytebuilders-ui/storagek8sio-csidriver-editor -n default --create-namespace --version=v0.4.13 --values values.yaml
```
