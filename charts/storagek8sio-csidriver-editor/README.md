...
$ helm repo update
$ helm search repo appscode/storagek8sio-csidriver-editor --version=v0.19.0
$ helm upgrade -i storagek8sio-csidriver-editor appscode/storagek8sio-csidriver-editor -n default --create-namespace --version=v0.19.0
```
...
```bash
$ helm upgrade -i storagek8sio-csidriver-editor appscode/storagek8sio-csidriver-editor -n default --create-namespace --version=v0.19.0 --set apiVersion=storage.k8s.io/v1
```
...
```bash
$ helm upgrade -i storagek8sio-csidriver-editor appscode/storagek8sio-csidriver-editor -n default --create-namespace --version=v0.19.0 --values values.yaml
```
