...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/repositoriesstashappscodecom-snapshot-editor --version=v0.4.17
$ helm upgrade -i repositoriesstashappscodecom-snapshot-editor bytebuilders-ui-dev/repositoriesstashappscodecom-snapshot-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i repositoriesstashappscodecom-snapshot-editor bytebuilders-ui-dev/repositoriesstashappscodecom-snapshot-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=repositories.stash.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i repositoriesstashappscodecom-snapshot-editor bytebuilders-ui-dev/repositoriesstashappscodecom-snapshot-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
