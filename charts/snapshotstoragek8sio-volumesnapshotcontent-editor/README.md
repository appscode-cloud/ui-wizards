...
$ helm repo update
$ helm search repo appscode-charts-oci/snapshotstoragek8sio-volumesnapshotcontent-editor --version=v0.4.21
$ helm upgrade -i snapshotstoragek8sio-volumesnapshotcontent-editor appscode-charts-oci/snapshotstoragek8sio-volumesnapshotcontent-editor -n default --create-namespace --version=v0.4.21
```
...
```bash
$ helm upgrade -i snapshotstoragek8sio-volumesnapshotcontent-editor appscode-charts-oci/snapshotstoragek8sio-volumesnapshotcontent-editor -n default --create-namespace --version=v0.4.21 --set apiVersion=snapshot.storage.k8s.io/v1
```
...
```bash
$ helm upgrade -i snapshotstoragek8sio-volumesnapshotcontent-editor appscode-charts-oci/snapshotstoragek8sio-volumesnapshotcontent-editor -n default --create-namespace --version=v0.4.21 --values values.yaml
```
