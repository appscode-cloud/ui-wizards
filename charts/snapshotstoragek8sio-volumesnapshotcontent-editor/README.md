...
$ helm repo update
$ helm search repo appscode-charts-oci/snapshotstoragek8sio-volumesnapshotcontent-editor --version=v0.11.0
...
```bash
$ helm upgrade -i snapshotstoragek8sio-volumesnapshotcontent-editor appscode-charts-oci/snapshotstoragek8sio-volumesnapshotcontent-editor -n default --create-namespace --version=v0.11.0 --set apiVersion=snapshot.storage.k8s.io/v1
```
...
```bash
$ helm upgrade -i snapshotstoragek8sio-volumesnapshotcontent-editor appscode-charts-oci/snapshotstoragek8sio-volumesnapshotcontent-editor -n default --create-namespace --version=v0.11.0 --values values.yaml
```
