...
$ helm repo update
$ helm search repo bytebuilders-ui/sqlgcpkubeformcom-database-editor --version=v0.4.18
$ helm upgrade -i sqlgcpkubeformcom-database-editor bytebuilders-ui/sqlgcpkubeformcom-database-editor -n default --create-namespace --version=v0.4.18
```
...
```bash
$ helm upgrade -i sqlgcpkubeformcom-database-editor bytebuilders-ui/sqlgcpkubeformcom-database-editor -n default --create-namespace --version=v0.4.18 --set apiVersion=sql.gcp.kubeform.com/v1alpha1
```
...
```bash
$ helm upgrade -i sqlgcpkubeformcom-database-editor bytebuilders-ui/sqlgcpkubeformcom-database-editor -n default --create-namespace --version=v0.4.18 --values values.yaml
```
