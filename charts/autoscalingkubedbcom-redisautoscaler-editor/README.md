...
$ helm repo update
$ helm search repo appscode-charts-oci/autoscalingkubedbcom-redisautoscaler-editor --version=v0.4.20
$ helm upgrade -i autoscalingkubedbcom-redisautoscaler-editor appscode-charts-oci/autoscalingkubedbcom-redisautoscaler-editor -n default --create-namespace --version=v0.4.20
```
...
```bash
$ helm upgrade -i autoscalingkubedbcom-redisautoscaler-editor appscode-charts-oci/autoscalingkubedbcom-redisautoscaler-editor -n default --create-namespace --version=v0.4.20 --set apiVersion=autoscaling.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i autoscalingkubedbcom-redisautoscaler-editor appscode-charts-oci/autoscalingkubedbcom-redisautoscaler-editor -n default --create-namespace --version=v0.4.20 --values values.yaml
```
