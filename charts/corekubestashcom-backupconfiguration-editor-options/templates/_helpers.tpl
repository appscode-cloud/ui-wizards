...
*/}}
{{- define "kubestashcom-backupconfiguration-editor-options.name" -}}
...
*/}}
{{- define "kubestashcom-backupconfiguration-editor-options.fullname" -}}
...
*/}}
{{- define "kubestashcom-backupconfiguration-editor-options.chart" -}}
...
Common labels
*/}}
{{- define "kubestashcom-backupconfiguration-editor-options.labels" -}}
{{ include "kubestashcom-backupconfiguration-editor-options.selectorLabels" . }}
...
Selector labels
*/}}
{{- define "kubestashcom-backupconfiguration-editor-options.selectorLabels" -}}
app.kubernetes.io/name: backupconfigurations.core.kubestash.com
app.kubernetes.io/instance: {{ include "kubestashcom-backupconfiguration-editor-options.fullname" . }}
{{- end }}

{{/*
Create the name of the service account to use
*/}}
{{- define "kubestashcom-backupconfiguration-editor-options.serviceAccountName" -}}
{{- if .Values.spec.serviceAccount.create }}
{{- default (include "kubestashcom-backupconfiguration-editor-options.fullname" .) .Values.spec.serviceAccount.name }}
{{- else }}
...
Common annotations
*/}}
{{- define "kubestashcom-backupconfiguration-editor-options.annotations" -}}
...
Alert labels
*/}}
{{- define "kubestashcom-backupconfiguration-editor-options.alertLabels" -}}
k8s_group: {{ .Values.metadata.resource.group }}
k8s_kind: {{ .Values.metadata.resource.kind }}
k8s_resource: {{ .Values.metadata.resource.name }}
app: {{ include "kubestashcom-backupconfiguration-editor-options.fullname" . }}
