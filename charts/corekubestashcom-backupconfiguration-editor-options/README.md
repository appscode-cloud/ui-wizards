...
$ helm repo update
$ helm search repo bytebuilders-ui/corekubestashcom-backupconfiguration-editor-options --version=v0.11.0
...
```bash
$ helm upgrade -i kubestashcom-backupconfiguration-editor-options bytebuilders-ui/corekubestashcom-backupconfiguration-editor-options -n kube-system --create-namespace --version=v0.11.0 --set metadata.resource.group=core.kubestash.com
```
...
```bash
$ helm upgrade -i kubestashcom-backupconfiguration-editor-options bytebuilders-ui/corekubestashcom-backupconfiguration-editor-options -n kube-system --create-namespace --version=v0.11.0 --values values.yaml
```
