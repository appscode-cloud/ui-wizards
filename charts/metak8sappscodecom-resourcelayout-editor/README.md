...
$ helm repo update
$ helm search repo appscode/metak8sappscodecom-resourcelayout-editor --version=v0.22.0
$ helm upgrade -i metak8sappscodecom-resourcelayout-editor appscode/metak8sappscodecom-resourcelayout-editor -n default --create-namespace --version=v0.22.0
```
...
```bash
$ helm upgrade -i metak8sappscodecom-resourcelayout-editor appscode/metak8sappscodecom-resourcelayout-editor -n default --create-namespace --version=v0.22.0 --set apiVersion=meta.k8s.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i metak8sappscodecom-resourcelayout-editor appscode/metak8sappscodecom-resourcelayout-editor -n default --create-namespace --version=v0.22.0 --values values.yaml
```
