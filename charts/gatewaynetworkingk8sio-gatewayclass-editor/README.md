...
$ helm repo update
$ helm search repo appscode/gatewaynetworkingk8sio-gatewayclass-editor --version=v0.21.0
$ helm upgrade -i gatewaynetworkingk8sio-gatewayclass-editor appscode/gatewaynetworkingk8sio-gatewayclass-editor -n default --create-namespace --version=v0.21.0
```
...
```bash
$ helm upgrade -i gatewaynetworkingk8sio-gatewayclass-editor appscode/gatewaynetworkingk8sio-gatewayclass-editor -n default --create-namespace --version=v0.21.0 --set apiVersion=gateway.networking.k8s.io/v1
```
...
```bash
$ helm upgrade -i gatewaynetworkingk8sio-gatewayclass-editor appscode/gatewaynetworkingk8sio-gatewayclass-editor -n default --create-namespace --version=v0.21.0 --values values.yaml
```
