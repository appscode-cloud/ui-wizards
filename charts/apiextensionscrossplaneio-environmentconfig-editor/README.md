...
$ helm repo update
$ helm search repo bytebuilders-ui/apiextensionscrossplaneio-environmentconfig-editor --version=v0.4.17
$ helm upgrade -i apiextensionscrossplaneio-environmentconfig-editor bytebuilders-ui/apiextensionscrossplaneio-environmentconfig-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i apiextensionscrossplaneio-environmentconfig-editor bytebuilders-ui/apiextensionscrossplaneio-environmentconfig-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=apiextensions.crossplane.io/v1alpha1
```
...
```bash
$ helm upgrade -i apiextensionscrossplaneio-environmentconfig-editor bytebuilders-ui/apiextensionscrossplaneio-environmentconfig-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
