...
$ helm repo update
$ helm search repo appscode-charts-oci/discoveryk8sio-endpointslice-editor --version=v0.8.0
$ helm upgrade -i discoveryk8sio-endpointslice-editor appscode-charts-oci/discoveryk8sio-endpointslice-editor -n default --create-namespace --version=v0.8.0
```
...
```bash
$ helm upgrade -i discoveryk8sio-endpointslice-editor appscode-charts-oci/discoveryk8sio-endpointslice-editor -n default --create-namespace --version=v0.8.0 --set apiVersion=discovery.k8s.io/v1
```
...
```bash
$ helm upgrade -i discoveryk8sio-endpointslice-editor appscode-charts-oci/discoveryk8sio-endpointslice-editor -n default --create-namespace --version=v0.8.0 --values values.yaml
```
