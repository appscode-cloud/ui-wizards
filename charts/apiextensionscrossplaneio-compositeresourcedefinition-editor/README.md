...
$ helm repo update
$ helm search repo bytebuilders-ui/apiextensionscrossplaneio-compositeresourcedefinition-editor --version=v0.4.16
$ helm upgrade -i apiextensionscrossplaneio-compositeresourcedefinition-editor bytebuilders-ui/apiextensionscrossplaneio-compositeresourcedefinition-editor -n default --create-namespace --version=v0.4.16
```
...
```bash
$ helm upgrade -i apiextensionscrossplaneio-compositeresourcedefinition-editor bytebuilders-ui/apiextensionscrossplaneio-compositeresourcedefinition-editor -n default --create-namespace --version=v0.4.16 --set apiVersion=apiextensions.crossplane.io/v1
```
...
```bash
$ helm upgrade -i apiextensionscrossplaneio-compositeresourcedefinition-editor bytebuilders-ui/apiextensionscrossplaneio-compositeresourcedefinition-editor -n default --create-namespace --version=v0.4.16 --values values.yaml
```
