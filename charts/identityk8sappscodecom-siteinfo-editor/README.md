...
$ helm repo update
$ helm search repo appscode-charts-oci/identityk8sappscodecom-siteinfo-editor --version=v0.4.21
$ helm upgrade -i identityk8sappscodecom-siteinfo-editor appscode-charts-oci/identityk8sappscodecom-siteinfo-editor -n default --create-namespace --version=v0.4.21
```
...
```bash
$ helm upgrade -i identityk8sappscodecom-siteinfo-editor appscode-charts-oci/identityk8sappscodecom-siteinfo-editor -n default --create-namespace --version=v0.4.21 --set apiVersion=identity.k8s.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i identityk8sappscodecom-siteinfo-editor appscode-charts-oci/identityk8sappscodecom-siteinfo-editor -n default --create-namespace --version=v0.4.21 --values values.yaml
```
