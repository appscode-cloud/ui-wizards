...
$ helm repo update
$ helm search repo bytebuilders-ui/apiextensionscrossplaneio-composition-editor --version=v0.4.18
$ helm upgrade -i apiextensionscrossplaneio-composition-editor bytebuilders-ui/apiextensionscrossplaneio-composition-editor -n default --create-namespace --version=v0.4.18
```
...
```bash
$ helm upgrade -i apiextensionscrossplaneio-composition-editor bytebuilders-ui/apiextensionscrossplaneio-composition-editor -n default --create-namespace --version=v0.4.18 --set apiVersion=apiextensions.crossplane.io/v1
```
...
```bash
$ helm upgrade -i apiextensionscrossplaneio-composition-editor bytebuilders-ui/apiextensionscrossplaneio-composition-editor -n default --create-namespace --version=v0.4.18 --values values.yaml
```
