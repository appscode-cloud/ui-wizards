...
$ helm repo update
$ helm search repo appscode-charts-oci/apiextensionscrossplaneio-composition-editor --version=v0.4.20
$ helm upgrade -i apiextensionscrossplaneio-composition-editor appscode-charts-oci/apiextensionscrossplaneio-composition-editor -n default --create-namespace --version=v0.4.20
```
...
```bash
$ helm upgrade -i apiextensionscrossplaneio-composition-editor appscode-charts-oci/apiextensionscrossplaneio-composition-editor -n default --create-namespace --version=v0.4.20 --set apiVersion=apiextensions.crossplane.io/v1
```
...
```bash
$ helm upgrade -i apiextensionscrossplaneio-composition-editor appscode-charts-oci/apiextensionscrossplaneio-composition-editor -n default --create-namespace --version=v0.4.20 --values values.yaml
```
