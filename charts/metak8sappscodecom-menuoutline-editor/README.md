...
$ helm repo update
$ helm search repo appscode/metak8sappscodecom-menuoutline-editor --version=v0.19.0
$ helm upgrade -i metak8sappscodecom-menuoutline-editor appscode/metak8sappscodecom-menuoutline-editor -n default --create-namespace --version=v0.19.0
```
...
```bash
$ helm upgrade -i metak8sappscodecom-menuoutline-editor appscode/metak8sappscodecom-menuoutline-editor -n default --create-namespace --version=v0.19.0 --set apiVersion=meta.k8s.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i metak8sappscodecom-menuoutline-editor appscode/metak8sappscodecom-menuoutline-editor -n default --create-namespace --version=v0.19.0 --values values.yaml
```
