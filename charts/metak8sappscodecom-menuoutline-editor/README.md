...
$ helm repo update
$ helm search repo appscode-charts-oci/metak8sappscodecom-menuoutline-editor --version=v0.4.20
$ helm upgrade -i metak8sappscodecom-menuoutline-editor appscode-charts-oci/metak8sappscodecom-menuoutline-editor -n default --create-namespace --version=v0.4.20
```
...
```bash
$ helm upgrade -i metak8sappscodecom-menuoutline-editor appscode-charts-oci/metak8sappscodecom-menuoutline-editor -n default --create-namespace --version=v0.4.20 --set apiVersion=meta.k8s.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i metak8sappscodecom-menuoutline-editor appscode-charts-oci/metak8sappscodecom-menuoutline-editor -n default --create-namespace --version=v0.4.20 --values values.yaml
```
