...
$ helm repo update
$ helm search repo appscode-charts-oci/opskubedbcom-singlestoreopsrequest-editor --version=v0.14.0
$ helm upgrade -i opskubedbcom-singlestoreopsrequest-editor appscode-charts-oci/opskubedbcom-singlestoreopsrequest-editor -n default --create-namespace --version=v0.14.0
```
...
```bash
$ helm upgrade -i opskubedbcom-singlestoreopsrequest-editor appscode-charts-oci/opskubedbcom-singlestoreopsrequest-editor -n default --create-namespace --version=v0.14.0 --set apiVersion=ops.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i opskubedbcom-singlestoreopsrequest-editor appscode-charts-oci/opskubedbcom-singlestoreopsrequest-editor -n default --create-namespace --version=v0.14.0 --values values.yaml
```
