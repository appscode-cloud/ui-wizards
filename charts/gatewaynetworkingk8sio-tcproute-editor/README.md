...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/gatewaynetworkingk8sio-tcproute-editor --version=v0.4.17
$ helm upgrade -i gatewaynetworkingk8sio-tcproute-editor bytebuilders-ui-dev/gatewaynetworkingk8sio-tcproute-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i gatewaynetworkingk8sio-tcproute-editor bytebuilders-ui-dev/gatewaynetworkingk8sio-tcproute-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=gateway.networking.k8s.io/v1alpha2
```
...
```bash
$ helm upgrade -i gatewaynetworkingk8sio-tcproute-editor bytebuilders-ui-dev/gatewaynetworkingk8sio-tcproute-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
