...
$ helm repo update
$ helm search repo appscode-charts-oci/gatewaynetworkingk8sio-tcproute-editor --version=v0.4.19
$ helm upgrade -i gatewaynetworkingk8sio-tcproute-editor appscode-charts-oci/gatewaynetworkingk8sio-tcproute-editor -n default --create-namespace --version=v0.4.19
```
...
```bash
$ helm upgrade -i gatewaynetworkingk8sio-tcproute-editor appscode-charts-oci/gatewaynetworkingk8sio-tcproute-editor -n default --create-namespace --version=v0.4.19 --set apiVersion=gateway.networking.k8s.io/v1alpha2
```
...
```bash
$ helm upgrade -i gatewaynetworkingk8sio-tcproute-editor appscode-charts-oci/gatewaynetworkingk8sio-tcproute-editor -n default --create-namespace --version=v0.4.19 --values values.yaml
```
