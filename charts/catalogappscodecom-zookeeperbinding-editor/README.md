...
$ helm repo update
$ helm search repo appscode-charts-oci/catalogappscodecom-zookeeperbinding-editor --version=v0.11.0
...
```bash
$ helm upgrade -i catalogappscodecom-zookeeperbinding-editor appscode-charts-oci/catalogappscodecom-zookeeperbinding-editor -n default --create-namespace --version=v0.11.0 --set apiVersion=catalog.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i catalogappscodecom-zookeeperbinding-editor appscode-charts-oci/catalogappscodecom-zookeeperbinding-editor -n default --create-namespace --version=v0.11.0 --values values.yaml
```
