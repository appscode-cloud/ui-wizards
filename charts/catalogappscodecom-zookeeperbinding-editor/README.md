...
$ helm repo update
$ helm search repo appscode/catalogappscodecom-zookeeperbinding-editor --version=v0.20.0
$ helm upgrade -i catalogappscodecom-zookeeperbinding-editor appscode/catalogappscodecom-zookeeperbinding-editor -n default --create-namespace --version=v0.20.0
```
...
```bash
$ helm upgrade -i catalogappscodecom-zookeeperbinding-editor appscode/catalogappscodecom-zookeeperbinding-editor -n default --create-namespace --version=v0.20.0 --set apiVersion=catalog.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i catalogappscodecom-zookeeperbinding-editor appscode/catalogappscodecom-zookeeperbinding-editor -n default --create-namespace --version=v0.20.0 --values values.yaml
```
