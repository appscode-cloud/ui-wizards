...
$ helm repo update
$ helm search repo appscode/sqlazurekubedbcom-mssqlserversecurityalertpolicy-editor --version=v0.14.0
$ helm upgrade -i sqlazurekubedbcom-mssqlserversecurityalertpolicy-editor appscode/sqlazurekubedbcom-mssqlserversecurityalertpolicy-editor -n default --create-namespace --version=v0.14.0
```
...
```bash
$ helm upgrade -i sqlazurekubedbcom-mssqlserversecurityalertpolicy-editor appscode/sqlazurekubedbcom-mssqlserversecurityalertpolicy-editor -n default --create-namespace --version=v0.14.0 --set apiVersion=sql.azure.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i sqlazurekubedbcom-mssqlserversecurityalertpolicy-editor appscode/sqlazurekubedbcom-mssqlserversecurityalertpolicy-editor -n default --create-namespace --version=v0.14.0 --values values.yaml
```
