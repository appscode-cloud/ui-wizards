...
$ helm repo update
$ helm search repo appscode/kubedbcom-postgres-editor --version=v0.35.0
$ helm upgrade -i kubedbcom-postgres-editor appscode/kubedbcom-postgres-editor -n default --create-namespace --version=v0.35.0
```
...
```bash
$ helm upgrade -i kubedbcom-postgres-editor appscode/kubedbcom-postgres-editor -n default --create-namespace --version=v0.35.0 --values values.yaml
```
