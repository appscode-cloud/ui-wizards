...
$ helm repo update
$ helm search repo appscode/uik8sappscodecom-resourceeditor-editor --version=v0.14.0
$ helm upgrade -i uik8sappscodecom-resourceeditor-editor appscode/uik8sappscodecom-resourceeditor-editor -n default --create-namespace --version=v0.14.0
```
...
```bash
$ helm upgrade -i uik8sappscodecom-resourceeditor-editor appscode/uik8sappscodecom-resourceeditor-editor -n default --create-namespace --version=v0.14.0 --set apiVersion=ui.k8s.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i uik8sappscodecom-resourceeditor-editor appscode/uik8sappscodecom-resourceeditor-editor -n default --create-namespace --version=v0.14.0 --values values.yaml
```
