...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/uik8sappscodecom-resourceeditor-editor --version=v0.4.17
$ helm upgrade -i uik8sappscodecom-resourceeditor-editor bytebuilders-ui-dev/uik8sappscodecom-resourceeditor-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i uik8sappscodecom-resourceeditor-editor bytebuilders-ui-dev/uik8sappscodecom-resourceeditor-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=ui.k8s.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i uik8sappscodecom-resourceeditor-editor bytebuilders-ui-dev/uik8sappscodecom-resourceeditor-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
