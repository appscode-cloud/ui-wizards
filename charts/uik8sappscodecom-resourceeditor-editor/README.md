...
$ helm repo update
$ helm search repo bytebuilders-ui/uik8sappscodecom-resourceeditor-editor --version=v0.4.13
$ helm upgrade -i uik8sappscodecom-resourceeditor-editor bytebuilders-ui/uik8sappscodecom-resourceeditor-editor -n default --create-namespace --version=v0.4.13
```
...
```bash
$ helm upgrade -i uik8sappscodecom-resourceeditor-editor bytebuilders-ui/uik8sappscodecom-resourceeditor-editor -n default --create-namespace --version=v0.4.13 --set apiVersion=ui.k8s.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i uik8sappscodecom-resourceeditor-editor bytebuilders-ui/uik8sappscodecom-resourceeditor-editor -n default --create-namespace --version=v0.4.13 --values values.yaml
```
