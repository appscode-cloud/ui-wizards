...
$ helm repo update
$ helm search repo appscode-charts-oci/apps-replicaset-editor --version=v0.13.0
$ helm upgrade -i apps-replicaset-editor appscode-charts-oci/apps-replicaset-editor -n default --create-namespace --version=v0.13.0
```
...
```bash
$ helm upgrade -i apps-replicaset-editor appscode-charts-oci/apps-replicaset-editor -n default --create-namespace --version=v0.13.0 --set apiVersion=apps/v1
```
...
```bash
$ helm upgrade -i apps-replicaset-editor appscode-charts-oci/apps-replicaset-editor -n default --create-namespace --version=v0.13.0 --values values.yaml
```
