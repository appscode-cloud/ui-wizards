...
$ helm repo update
$ helm search repo appscode-charts-oci/apps-replicaset-editor --version=v0.4.20
$ helm upgrade -i apps-replicaset-editor appscode-charts-oci/apps-replicaset-editor -n default --create-namespace --version=v0.4.20
```
...
```bash
$ helm upgrade -i apps-replicaset-editor appscode-charts-oci/apps-replicaset-editor -n default --create-namespace --version=v0.4.20 --set apiVersion=apps/v1
```
...
```bash
$ helm upgrade -i apps-replicaset-editor appscode-charts-oci/apps-replicaset-editor -n default --create-namespace --version=v0.4.20 --values values.yaml
```
