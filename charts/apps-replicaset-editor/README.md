...
$ helm repo update
$ helm search repo bytebuilders-ui/apps-replicaset-editor --version=v0.4.2
$ helm upgrade -i apps-replicaset-editor bytebuilders-ui/apps-replicaset-editor -n default --create-namespace --version=v0.4.2
```
...
```bash
$ helm upgrade -i apps-replicaset-editor bytebuilders-ui/apps-replicaset-editor -n default --create-namespace --version=v0.4.2 --set apiVersion=apps/v1
```
...
```bash
$ helm upgrade -i apps-replicaset-editor bytebuilders-ui/apps-replicaset-editor -n default --create-namespace --version=v0.4.2 --values values.yaml
```
