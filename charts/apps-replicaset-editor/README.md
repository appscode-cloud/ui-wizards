...
$ helm repo update
$ helm search repo appscode/apps-replicaset-editor --version=v0.14.0
$ helm upgrade -i apps-replicaset-editor appscode/apps-replicaset-editor -n default --create-namespace --version=v0.14.0
```
...
```bash
$ helm upgrade -i apps-replicaset-editor appscode/apps-replicaset-editor -n default --create-namespace --version=v0.14.0 --set apiVersion=apps/v1
```
...
```bash
$ helm upgrade -i apps-replicaset-editor appscode/apps-replicaset-editor -n default --create-namespace --version=v0.14.0 --values values.yaml
```
