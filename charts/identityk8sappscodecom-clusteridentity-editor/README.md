...
$ helm repo update
$ helm search repo appscode-charts-oci/identityk8sappscodecom-clusteridentity-editor --version=v0.5.0
$ helm upgrade -i identityk8sappscodecom-clusteridentity-editor appscode-charts-oci/identityk8sappscodecom-clusteridentity-editor -n default --create-namespace --version=v0.5.0
```
...
```bash
$ helm upgrade -i identityk8sappscodecom-clusteridentity-editor appscode-charts-oci/identityk8sappscodecom-clusteridentity-editor -n default --create-namespace --version=v0.5.0 --set apiVersion=identity.k8s.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i identityk8sappscodecom-clusteridentity-editor appscode-charts-oci/identityk8sappscodecom-clusteridentity-editor -n default --create-namespace --version=v0.5.0 --values values.yaml
```
