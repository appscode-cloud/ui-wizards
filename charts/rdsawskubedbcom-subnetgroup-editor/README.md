...
$ helm repo update
$ helm search repo appscode-charts-oci/rdsawskubedbcom-subnetgroup-editor --version=v0.4.19
$ helm upgrade -i rdsawskubedbcom-subnetgroup-editor appscode-charts-oci/rdsawskubedbcom-subnetgroup-editor -n default --create-namespace --version=v0.4.19
```
...
```bash
$ helm upgrade -i rdsawskubedbcom-subnetgroup-editor appscode-charts-oci/rdsawskubedbcom-subnetgroup-editor -n default --create-namespace --version=v0.4.19 --set apiVersion=rds.aws.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i rdsawskubedbcom-subnetgroup-editor appscode-charts-oci/rdsawskubedbcom-subnetgroup-editor -n default --create-namespace --version=v0.4.19 --values values.yaml
```
