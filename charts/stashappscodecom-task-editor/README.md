...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/stashappscodecom-task-editor --version=v0.4.17
$ helm upgrade -i stashappscodecom-task-editor bytebuilders-ui-dev/stashappscodecom-task-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i stashappscodecom-task-editor bytebuilders-ui-dev/stashappscodecom-task-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=stash.appscode.com/v1beta1
```
...
```bash
$ helm upgrade -i stashappscodecom-task-editor bytebuilders-ui-dev/stashappscodecom-task-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
