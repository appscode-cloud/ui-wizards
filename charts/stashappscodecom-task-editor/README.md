...
$ helm repo update
$ helm search repo appscode-charts-oci/stashappscodecom-task-editor --version=v0.8.0
$ helm upgrade -i stashappscodecom-task-editor appscode-charts-oci/stashappscodecom-task-editor -n default --create-namespace --version=v0.8.0
```
...
```bash
$ helm upgrade -i stashappscodecom-task-editor appscode-charts-oci/stashappscodecom-task-editor -n default --create-namespace --version=v0.8.0 --set apiVersion=stash.appscode.com/v1beta1
```
...
```bash
$ helm upgrade -i stashappscodecom-task-editor appscode-charts-oci/stashappscodecom-task-editor -n default --create-namespace --version=v0.8.0 --values values.yaml
```
