...
$ helm repo update
$ helm install extensions-ingress-editor bytebuilders-ui-dev/extensions-ingress-editor -n default
```
...
```console
$ helm install extensions-ingress-editor bytebuilders-ui-dev/extensions-ingress-editor -n default --set apiVersion=extensions/v1beta1
```
...
```console
$ helm install extensions-ingress-editor bytebuilders-ui-dev/extensions-ingress-editor -n default --values values.yaml
```
