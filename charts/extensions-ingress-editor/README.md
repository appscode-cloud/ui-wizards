...
$ helm repo update
$ helm search repo appscode-charts-oci/extensions-ingress-editor --version=v0.8.0
$ helm upgrade -i extensions-ingress-editor appscode-charts-oci/extensions-ingress-editor -n default --create-namespace --version=v0.8.0
```
...
```bash
$ helm upgrade -i extensions-ingress-editor appscode-charts-oci/extensions-ingress-editor -n default --create-namespace --version=v0.8.0 --set apiVersion=extensions/v1beta1
```
...
```bash
$ helm upgrade -i extensions-ingress-editor appscode-charts-oci/extensions-ingress-editor -n default --create-namespace --version=v0.8.0 --values values.yaml
```
