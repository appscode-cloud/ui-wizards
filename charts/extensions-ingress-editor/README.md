...
$ helm repo update
$ helm search repo appscode/extensions-ingress-editor --version=v0.32.0
$ helm upgrade -i extensions-ingress-editor appscode/extensions-ingress-editor -n default --create-namespace --version=v0.32.0
```
...
```bash
$ helm upgrade -i extensions-ingress-editor appscode/extensions-ingress-editor -n default --create-namespace --version=v0.32.0 --set apiVersion=extensions/v1beta1
```
...
```bash
$ helm upgrade -i extensions-ingress-editor appscode/extensions-ingress-editor -n default --create-namespace --version=v0.32.0 --values values.yaml
```
