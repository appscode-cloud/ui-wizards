...
$ helm repo update
$ helm search repo bytebuilders-ui/uik8sappscodecom-featureset-opscenter-datastore-editor --version=v0.4.11
$ helm upgrade -i uik8sappscodecom-featureset-opscenter-datastore-editor bytebuilders-ui/uik8sappscodecom-featureset-opscenter-datastore-editor -n default --create-namespace --version=v0.4.11
```
...
```bash
$ helm upgrade -i uik8sappscodecom-featureset-opscenter-datastore-editor bytebuilders-ui/uik8sappscodecom-featureset-opscenter-datastore-editor -n default --create-namespace --version=v0.4.11 --set metadata.resource.group=ui.k8s.appscode.com
```
...
```bash
$ helm upgrade -i uik8sappscodecom-featureset-opscenter-datastore-editor bytebuilders-ui/uik8sappscodecom-featureset-opscenter-datastore-editor -n default --create-namespace --version=v0.4.11 --values values.yaml
```
