...
$ helm repo update
$ helm search repo appscode/corek8sappscodecom-resourcecalculator-editor --version=v0.37.0
$ helm upgrade -i corek8sappscodecom-resourcecalculator-editor appscode/corek8sappscodecom-resourcecalculator-editor -n default --create-namespace --version=v0.37.0
```
...
```bash
$ helm upgrade -i corek8sappscodecom-resourcecalculator-editor appscode/corek8sappscodecom-resourcecalculator-editor -n default --create-namespace --version=v0.37.0 --set apiVersion=core.k8s.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i corek8sappscodecom-resourcecalculator-editor appscode/corek8sappscodecom-resourcecalculator-editor -n default --create-namespace --version=v0.37.0 --values values.yaml
```
