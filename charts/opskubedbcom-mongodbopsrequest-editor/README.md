...
$ helm repo update
$ helm search repo appscode-charts-oci/opskubedbcom-mongodbopsrequest-editor --version=v0.6.0
$ helm upgrade -i opskubedbcom-mongodbopsrequest-editor appscode-charts-oci/opskubedbcom-mongodbopsrequest-editor -n default --create-namespace --version=v0.6.0
```
...
```bash
$ helm upgrade -i opskubedbcom-mongodbopsrequest-editor appscode-charts-oci/opskubedbcom-mongodbopsrequest-editor -n default --create-namespace --version=v0.6.0 --set apiVersion=ops.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i opskubedbcom-mongodbopsrequest-editor appscode-charts-oci/opskubedbcom-mongodbopsrequest-editor -n default --create-namespace --version=v0.6.0 --values values.yaml
```
