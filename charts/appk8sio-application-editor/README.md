...
$ helm repo update
$ helm search repo appscode-charts-oci/appk8sio-application-editor --version=v0.11.0
...
```bash
$ helm upgrade -i appk8sio-application-editor appscode-charts-oci/appk8sio-application-editor -n default --create-namespace --version=v0.11.0 --set apiVersion=app.k8s.io/v1beta1
```
...
```bash
$ helm upgrade -i appk8sio-application-editor appscode-charts-oci/appk8sio-application-editor -n default --create-namespace --version=v0.11.0 --values values.yaml
```
