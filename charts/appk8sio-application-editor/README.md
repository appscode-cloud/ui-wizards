...
$ helm repo update
$ helm search repo appscode/appk8sio-application-editor --version=v0.22.0
$ helm upgrade -i appk8sio-application-editor appscode/appk8sio-application-editor -n default --create-namespace --version=v0.22.0
```
...
```bash
$ helm upgrade -i appk8sio-application-editor appscode/appk8sio-application-editor -n default --create-namespace --version=v0.22.0 --set apiVersion=app.k8s.io/v1beta1
```
...
```bash
$ helm upgrade -i appk8sio-application-editor appscode/appk8sio-application-editor -n default --create-namespace --version=v0.22.0 --values values.yaml
```
