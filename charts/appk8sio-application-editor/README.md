...
$ helm repo update
$ helm search repo bytebuilders-ui/appk8sio-application-editor --version=v0.4.4
$ helm upgrade -i appk8sio-application-editor bytebuilders-ui/appk8sio-application-editor -n default --create-namespace --version=v0.4.4
```
...
```bash
$ helm upgrade -i appk8sio-application-editor bytebuilders-ui/appk8sio-application-editor -n default --create-namespace --version=v0.4.4 --set apiVersion=app.k8s.io/v1beta1
```
...
```bash
$ helm upgrade -i appk8sio-application-editor bytebuilders-ui/appk8sio-application-editor -n default --create-namespace --version=v0.4.4 --values values.yaml
```
