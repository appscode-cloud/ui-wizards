...
$ helm repo update
$ helm search repo appscode/uikubedbcom-redisinsight-editor --version=v0.28.0
$ helm upgrade -i uikubedbcom-redisinsight-editor appscode/uikubedbcom-redisinsight-editor -n default --create-namespace --version=v0.28.0
```
...
```bash
$ helm upgrade -i uikubedbcom-redisinsight-editor appscode/uikubedbcom-redisinsight-editor -n default --create-namespace --version=v0.28.0 --set apiVersion=ui.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i uikubedbcom-redisinsight-editor appscode/uikubedbcom-redisinsight-editor -n default --create-namespace --version=v0.28.0 --values values.yaml
```
