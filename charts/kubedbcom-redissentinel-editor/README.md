...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/kubedbcom-redissentinel-editor --version=v0.4.17
$ helm upgrade -i kubedbcom-redissentinel-editor bytebuilders-ui-dev/kubedbcom-redissentinel-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i kubedbcom-redissentinel-editor bytebuilders-ui-dev/kubedbcom-redissentinel-editor -n default --create-namespace --version=v0.4.17 --set metadata.resource.group=kubedb.com
```
...
```bash
$ helm upgrade -i kubedbcom-redissentinel-editor bytebuilders-ui-dev/kubedbcom-redissentinel-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
