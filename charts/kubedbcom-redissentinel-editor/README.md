...
$ helm repo update
$ helm search repo appscode-charts-oci/kubedbcom-redissentinel-editor --version=v0.13.0
$ helm upgrade -i kubedbcom-redissentinel-editor appscode-charts-oci/kubedbcom-redissentinel-editor -n default --create-namespace --version=v0.13.0
```
...
```bash
$ helm upgrade -i kubedbcom-redissentinel-editor appscode-charts-oci/kubedbcom-redissentinel-editor -n default --create-namespace --version=v0.13.0 --set metadata.resource.group=kubedb.com
```
...
```bash
$ helm upgrade -i kubedbcom-redissentinel-editor appscode-charts-oci/kubedbcom-redissentinel-editor -n default --create-namespace --version=v0.13.0 --values values.yaml
```
