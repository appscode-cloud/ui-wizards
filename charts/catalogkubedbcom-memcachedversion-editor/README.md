...
$ helm repo update
$ helm search repo appscode/catalogkubedbcom-memcachedversion-editor --version=v0.37.0
$ helm upgrade -i catalogkubedbcom-memcachedversion-editor appscode/catalogkubedbcom-memcachedversion-editor -n default --create-namespace --version=v0.37.0
```
...
```bash
$ helm upgrade -i catalogkubedbcom-memcachedversion-editor appscode/catalogkubedbcom-memcachedversion-editor -n default --create-namespace --version=v0.37.0 --set apiVersion=catalog.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i catalogkubedbcom-memcachedversion-editor appscode/catalogkubedbcom-memcachedversion-editor -n default --create-namespace --version=v0.37.0 --values values.yaml
```
