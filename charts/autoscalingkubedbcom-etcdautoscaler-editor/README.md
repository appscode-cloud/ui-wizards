...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/autoscalingkubedbcom-etcdautoscaler-editor --version=v0.4.17
$ helm upgrade -i autoscalingkubedbcom-etcdautoscaler-editor bytebuilders-ui-dev/autoscalingkubedbcom-etcdautoscaler-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i autoscalingkubedbcom-etcdautoscaler-editor bytebuilders-ui-dev/autoscalingkubedbcom-etcdautoscaler-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=autoscaling.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i autoscalingkubedbcom-etcdautoscaler-editor bytebuilders-ui-dev/autoscalingkubedbcom-etcdautoscaler-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
