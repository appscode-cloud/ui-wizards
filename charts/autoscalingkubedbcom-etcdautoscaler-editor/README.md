...
$ helm repo update
$ helm search repo appscode-charts-oci/autoscalingkubedbcom-etcdautoscaler-editor --version=v0.13.0
$ helm upgrade -i autoscalingkubedbcom-etcdautoscaler-editor appscode-charts-oci/autoscalingkubedbcom-etcdautoscaler-editor -n default --create-namespace --version=v0.13.0
```
...
```bash
$ helm upgrade -i autoscalingkubedbcom-etcdautoscaler-editor appscode-charts-oci/autoscalingkubedbcom-etcdautoscaler-editor -n default --create-namespace --version=v0.13.0 --set apiVersion=autoscaling.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i autoscalingkubedbcom-etcdautoscaler-editor appscode-charts-oci/autoscalingkubedbcom-etcdautoscaler-editor -n default --create-namespace --version=v0.13.0 --values values.yaml
```
