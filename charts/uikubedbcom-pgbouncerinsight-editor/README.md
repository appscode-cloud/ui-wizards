...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/uikubedbcom-pgbouncerinsight-editor --version=v0.4.17
$ helm upgrade -i uikubedbcom-pgbouncerinsight-editor bytebuilders-ui-dev/uikubedbcom-pgbouncerinsight-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i uikubedbcom-pgbouncerinsight-editor bytebuilders-ui-dev/uikubedbcom-pgbouncerinsight-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=ui.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i uikubedbcom-pgbouncerinsight-editor bytebuilders-ui-dev/uikubedbcom-pgbouncerinsight-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
