...
$ helm repo update
$ helm search repo bytebuilders-ui/uikubedbcom-pgbouncerinsight-editor --version=v0.4.16
$ helm upgrade -i uikubedbcom-pgbouncerinsight-editor bytebuilders-ui/uikubedbcom-pgbouncerinsight-editor -n default --create-namespace --version=v0.4.16
```
...
```bash
$ helm upgrade -i uikubedbcom-pgbouncerinsight-editor bytebuilders-ui/uikubedbcom-pgbouncerinsight-editor -n default --create-namespace --version=v0.4.16 --set apiVersion=ui.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i uikubedbcom-pgbouncerinsight-editor bytebuilders-ui/uikubedbcom-pgbouncerinsight-editor -n default --create-namespace --version=v0.4.16 --values values.yaml
```
