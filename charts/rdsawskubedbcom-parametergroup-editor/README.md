...
$ helm repo update
$ helm search repo appscode-charts-oci/rdsawskubedbcom-parametergroup-editor --version=v0.4.21
$ helm upgrade -i rdsawskubedbcom-parametergroup-editor appscode-charts-oci/rdsawskubedbcom-parametergroup-editor -n default --create-namespace --version=v0.4.21
```
...
```bash
$ helm upgrade -i rdsawskubedbcom-parametergroup-editor appscode-charts-oci/rdsawskubedbcom-parametergroup-editor -n default --create-namespace --version=v0.4.21 --set apiVersion=rds.aws.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i rdsawskubedbcom-parametergroup-editor appscode-charts-oci/rdsawskubedbcom-parametergroup-editor -n default --create-namespace --version=v0.4.21 --values values.yaml
```
