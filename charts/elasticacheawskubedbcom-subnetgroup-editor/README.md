...
$ helm repo update
$ helm search repo appscode-charts-oci/elasticacheawskubedbcom-subnetgroup-editor --version=v0.4.21
$ helm upgrade -i elasticacheawskubedbcom-subnetgroup-editor appscode-charts-oci/elasticacheawskubedbcom-subnetgroup-editor -n default --create-namespace --version=v0.4.21
```
...
```bash
$ helm upgrade -i elasticacheawskubedbcom-subnetgroup-editor appscode-charts-oci/elasticacheawskubedbcom-subnetgroup-editor -n default --create-namespace --version=v0.4.21 --set apiVersion=elasticache.aws.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i elasticacheawskubedbcom-subnetgroup-editor appscode-charts-oci/elasticacheawskubedbcom-subnetgroup-editor -n default --create-namespace --version=v0.4.21 --values values.yaml
```
