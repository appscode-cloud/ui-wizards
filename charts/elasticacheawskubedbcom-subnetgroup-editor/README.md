...
$ helm repo update
$ helm search repo appscode-charts-oci/elasticacheawskubedbcom-subnetgroup-editor --version=v0.14.0
$ helm upgrade -i elasticacheawskubedbcom-subnetgroup-editor appscode-charts-oci/elasticacheawskubedbcom-subnetgroup-editor -n default --create-namespace --version=v0.14.0
```
...
```bash
$ helm upgrade -i elasticacheawskubedbcom-subnetgroup-editor appscode-charts-oci/elasticacheawskubedbcom-subnetgroup-editor -n default --create-namespace --version=v0.14.0 --set apiVersion=elasticache.aws.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i elasticacheawskubedbcom-subnetgroup-editor appscode-charts-oci/elasticacheawskubedbcom-subnetgroup-editor -n default --create-namespace --version=v0.14.0 --values values.yaml
```
