...
$ helm repo update
$ helm search repo appscode/rdsawskubedbcom-clusterendpoint-editor --version=v0.36.0
$ helm upgrade -i rdsawskubedbcom-clusterendpoint-editor appscode/rdsawskubedbcom-clusterendpoint-editor -n default --create-namespace --version=v0.36.0
```
...
```bash
$ helm upgrade -i rdsawskubedbcom-clusterendpoint-editor appscode/rdsawskubedbcom-clusterendpoint-editor -n default --create-namespace --version=v0.36.0 --set apiVersion=rds.aws.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i rdsawskubedbcom-clusterendpoint-editor appscode/rdsawskubedbcom-clusterendpoint-editor -n default --create-namespace --version=v0.36.0 --values values.yaml
```
