...
$ helm repo update
$ helm search repo bytebuilders-ui/workopenclustermanagementio-appliedmanifestwork-editor --version=v0.4.17
$ helm upgrade -i workopenclustermanagementio-appliedmanifestwork-editor bytebuilders-ui/workopenclustermanagementio-appliedmanifestwork-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i workopenclustermanagementio-appliedmanifestwork-editor bytebuilders-ui/workopenclustermanagementio-appliedmanifestwork-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=work.open-cluster-management.io/v1
```
...
```bash
$ helm upgrade -i workopenclustermanagementio-appliedmanifestwork-editor bytebuilders-ui/workopenclustermanagementio-appliedmanifestwork-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
