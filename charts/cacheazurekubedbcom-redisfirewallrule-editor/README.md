...
$ helm repo update
$ helm search repo appscode/cacheazurekubedbcom-redisfirewallrule-editor --version=v0.14.0
$ helm upgrade -i cacheazurekubedbcom-redisfirewallrule-editor appscode/cacheazurekubedbcom-redisfirewallrule-editor -n default --create-namespace --version=v0.14.0
```
...
```bash
$ helm upgrade -i cacheazurekubedbcom-redisfirewallrule-editor appscode/cacheazurekubedbcom-redisfirewallrule-editor -n default --create-namespace --version=v0.14.0 --set apiVersion=cache.azure.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i cacheazurekubedbcom-redisfirewallrule-editor appscode/cacheazurekubedbcom-redisfirewallrule-editor -n default --create-namespace --version=v0.14.0 --values values.yaml
```
