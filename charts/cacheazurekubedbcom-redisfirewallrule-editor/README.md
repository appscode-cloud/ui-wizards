...
$ helm repo update
$ helm search repo appscode-charts-oci/cacheazurekubedbcom-redisfirewallrule-editor --version=v0.4.19
$ helm upgrade -i cacheazurekubedbcom-redisfirewallrule-editor appscode-charts-oci/cacheazurekubedbcom-redisfirewallrule-editor -n default --create-namespace --version=v0.4.19
```
...
```bash
$ helm upgrade -i cacheazurekubedbcom-redisfirewallrule-editor appscode-charts-oci/cacheazurekubedbcom-redisfirewallrule-editor -n default --create-namespace --version=v0.4.19 --set apiVersion=cache.azure.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i cacheazurekubedbcom-redisfirewallrule-editor appscode-charts-oci/cacheazurekubedbcom-redisfirewallrule-editor -n default --create-namespace --version=v0.4.19 --values values.yaml
```
