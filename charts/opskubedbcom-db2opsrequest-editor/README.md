...
$ helm repo update
$ helm search repo appscode/opskubedbcom-db2opsrequest-editor --version=v0.36.0
$ helm upgrade -i opskubedbcom-db2opsrequest-editor appscode/opskubedbcom-db2opsrequest-editor -n default --create-namespace --version=v0.36.0
```
...
```bash
$ helm upgrade -i opskubedbcom-db2opsrequest-editor appscode/opskubedbcom-db2opsrequest-editor -n default --create-namespace --version=v0.36.0 --set apiVersion=ops.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i opskubedbcom-db2opsrequest-editor appscode/opskubedbcom-db2opsrequest-editor -n default --create-namespace --version=v0.36.0 --values values.yaml
```
