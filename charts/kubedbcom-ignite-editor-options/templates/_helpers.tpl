...
*/}}
{{- define "kubedbcom-ignite-editor-options.name" -}}
...
*/}}
{{- define "kubedbcom-ignite-editor-options.fullname" -}}
...
*/}}
{{- define "kubedbcom-ignite-editor-options.chart" -}}
...
Common labels
*/}}
{{- define "kubedbcom-ignite-editor-options.labels" -}}
{{ include "kubedbcom-ignite-editor-options.selectorLabels" . }}
...
Selector labels
*/}}
{{- define "kubedbcom-ignite-editor-options.selectorLabels" -}}
app.kubernetes.io/name: ignites.kubedb.com
app.kubernetes.io/instance: {{ include "kubedbcom-ignite-editor-options.fullname" . }}
{{- end }}

{{/*
Create the name of the service account to use
*/}}
{{- define "kubedbcom-ignite-editor-options.serviceAccountName" -}}
{{- if .Values.spec.serviceAccount.create }}
{{- default (include "kubedbcom-ignite-editor-options.fullname" .) .Values.spec.serviceAccount.name }}
{{- else }}
...
Common annotations
*/}}
{{- define "kubedbcom-ignite-editor-options.annotations" -}}
...
Alert Enabled
*/}}
{{- define "kubedbcom-ignite-editor-options.alertEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
