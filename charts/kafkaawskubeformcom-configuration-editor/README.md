...
$ helm repo update
$ helm search repo bytebuilders-ui/kafkaawskubeformcom-configuration-editor --version=v0.4.18
$ helm upgrade -i kafkaawskubeformcom-configuration-editor bytebuilders-ui/kafkaawskubeformcom-configuration-editor -n default --create-namespace --version=v0.4.18
```
...
```bash
$ helm upgrade -i kafkaawskubeformcom-configuration-editor bytebuilders-ui/kafkaawskubeformcom-configuration-editor -n default --create-namespace --version=v0.4.18 --set apiVersion=kafka.aws.kubeform.com/v1alpha1
```
...
```bash
$ helm upgrade -i kafkaawskubeformcom-configuration-editor bytebuilders-ui/kafkaawskubeformcom-configuration-editor -n default --create-namespace --version=v0.4.18 --values values.yaml
```
