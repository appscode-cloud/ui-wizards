...
$ helm repo update
$ helm search repo appscode/docdbawskubedbcom-subnetgroup-editor --version=v0.16.0
$ helm upgrade -i docdbawskubedbcom-subnetgroup-editor appscode/docdbawskubedbcom-subnetgroup-editor -n default --create-namespace --version=v0.16.0
```
...
```bash
$ helm upgrade -i docdbawskubedbcom-subnetgroup-editor appscode/docdbawskubedbcom-subnetgroup-editor -n default --create-namespace --version=v0.16.0 --set apiVersion=docdb.aws.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i docdbawskubedbcom-subnetgroup-editor appscode/docdbawskubedbcom-subnetgroup-editor -n default --create-namespace --version=v0.16.0 --values values.yaml
```
