...
$ helm repo update
$ helm search repo appscode-charts-oci/docdbawskubedbcom-subnetgroup-editor --version=v0.6.0
$ helm upgrade -i docdbawskubedbcom-subnetgroup-editor appscode-charts-oci/docdbawskubedbcom-subnetgroup-editor -n default --create-namespace --version=v0.6.0
```
...
```bash
$ helm upgrade -i docdbawskubedbcom-subnetgroup-editor appscode-charts-oci/docdbawskubedbcom-subnetgroup-editor -n default --create-namespace --version=v0.6.0 --set apiVersion=docdb.aws.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i docdbawskubedbcom-subnetgroup-editor appscode-charts-oci/docdbawskubedbcom-subnetgroup-editor -n default --create-namespace --version=v0.6.0 --values values.yaml
```
