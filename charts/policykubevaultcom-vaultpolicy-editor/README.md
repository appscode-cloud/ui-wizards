...
$ helm repo update
$ helm search repo appscode-charts-oci/policykubevaultcom-vaultpolicy-editor --version=v0.13.0
$ helm upgrade -i policykubevaultcom-vaultpolicy-editor appscode-charts-oci/policykubevaultcom-vaultpolicy-editor -n default --create-namespace --version=v0.13.0
```
...
```bash
$ helm upgrade -i policykubevaultcom-vaultpolicy-editor appscode-charts-oci/policykubevaultcom-vaultpolicy-editor -n default --create-namespace --version=v0.13.0 --set apiVersion=policy.kubevault.com/v1alpha1
```
...
```bash
$ helm upgrade -i policykubevaultcom-vaultpolicy-editor appscode-charts-oci/policykubevaultcom-vaultpolicy-editor -n default --create-namespace --version=v0.13.0 --values values.yaml
```
