...
$ helm repo update
$ helm search repo appscode-charts-oci/corek8sappscodecom-podview-editor --version=v0.4.20
$ helm upgrade -i corek8sappscodecom-podview-editor appscode-charts-oci/corek8sappscodecom-podview-editor -n default --create-namespace --version=v0.4.20
```
...
```bash
$ helm upgrade -i corek8sappscodecom-podview-editor appscode-charts-oci/corek8sappscodecom-podview-editor -n default --create-namespace --version=v0.4.20 --set apiVersion=core.k8s.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i corek8sappscodecom-podview-editor appscode-charts-oci/corek8sappscodecom-podview-editor -n default --create-namespace --version=v0.4.20 --values values.yaml
```
