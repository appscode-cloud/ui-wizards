...
$ helm repo update
$ helm search repo bytebuilders-ui/corek8sappscodecom-podview-editor --version=v0.4.3
$ helm upgrade -i corek8sappscodecom-podview-editor bytebuilders-ui/corek8sappscodecom-podview-editor -n default --create-namespace --version=v0.4.3
```
...
```bash
$ helm upgrade -i corek8sappscodecom-podview-editor bytebuilders-ui/corek8sappscodecom-podview-editor -n default --create-namespace --version=v0.4.3 --set apiVersion=core.k8s.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i corek8sappscodecom-podview-editor bytebuilders-ui/corek8sappscodecom-podview-editor -n default --create-namespace --version=v0.4.3 --values values.yaml
```
