...
$ helm repo update
$ helm search repo appscode/catalogkubedbcom-redisversion-editor --version=v0.28.0
$ helm upgrade -i catalogkubedbcom-redisversion-editor appscode/catalogkubedbcom-redisversion-editor -n default --create-namespace --version=v0.28.0
```
...
```bash
$ helm upgrade -i catalogkubedbcom-redisversion-editor appscode/catalogkubedbcom-redisversion-editor -n default --create-namespace --version=v0.28.0 --set apiVersion=catalog.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i catalogkubedbcom-redisversion-editor appscode/catalogkubedbcom-redisversion-editor -n default --create-namespace --version=v0.28.0 --values values.yaml
```
