...
$ helm repo update
$ helm search repo appscode-charts-oci/uikubedbcom-proxysqlsettings-editor --version=v0.13.0
$ helm upgrade -i uikubedbcom-proxysqlsettings-editor appscode-charts-oci/uikubedbcom-proxysqlsettings-editor -n default --create-namespace --version=v0.13.0
```
...
```bash
$ helm upgrade -i uikubedbcom-proxysqlsettings-editor appscode-charts-oci/uikubedbcom-proxysqlsettings-editor -n default --create-namespace --version=v0.13.0 --set apiVersion=ui.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i uikubedbcom-proxysqlsettings-editor appscode-charts-oci/uikubedbcom-proxysqlsettings-editor -n default --create-namespace --version=v0.13.0 --values values.yaml
```
