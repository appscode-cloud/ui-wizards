...
$ helm repo update
$ helm search repo appscode/dbformysqlazurekubedbcom-flexibleserverconfiguration-editor --version=v0.34.0
$ helm upgrade -i dbformysqlazurekubedbcom-flexibleserverconfiguration-editor appscode/dbformysqlazurekubedbcom-flexibleserverconfiguration-editor -n default --create-namespace --version=v0.34.0
```
...
```bash
$ helm upgrade -i dbformysqlazurekubedbcom-flexibleserverconfiguration-editor appscode/dbformysqlazurekubedbcom-flexibleserverconfiguration-editor -n default --create-namespace --version=v0.34.0 --set apiVersion=dbformysql.azure.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i dbformysqlazurekubedbcom-flexibleserverconfiguration-editor appscode/dbformysqlazurekubedbcom-flexibleserverconfiguration-editor -n default --create-namespace --version=v0.34.0 --values values.yaml
```
