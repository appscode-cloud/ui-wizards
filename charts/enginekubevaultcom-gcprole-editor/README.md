...
$ helm repo update
$ helm search repo bytebuilders-ui/enginekubevaultcom-gcprole-editor --version=v0.4.5
$ helm upgrade -i enginekubevaultcom-gcprole-editor bytebuilders-ui/enginekubevaultcom-gcprole-editor -n default --create-namespace --version=v0.4.5
```
...
```bash
$ helm upgrade -i enginekubevaultcom-gcprole-editor bytebuilders-ui/enginekubevaultcom-gcprole-editor -n default --create-namespace --version=v0.4.5 --set apiVersion=engine.kubevault.com/v1alpha1
```
...
```bash
$ helm upgrade -i enginekubevaultcom-gcprole-editor bytebuilders-ui/enginekubevaultcom-gcprole-editor -n default --create-namespace --version=v0.4.5 --values values.yaml
```
