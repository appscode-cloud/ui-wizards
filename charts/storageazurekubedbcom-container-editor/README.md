...
$ helm repo update
$ helm search repo appscode-charts-oci/storageazurekubedbcom-container-editor --version=v0.4.18
$ helm upgrade -i storageazurekubedbcom-container-editor appscode-charts-oci/storageazurekubedbcom-container-editor -n default --create-namespace --version=v0.4.18
```
...
```bash
$ helm upgrade -i storageazurekubedbcom-container-editor appscode-charts-oci/storageazurekubedbcom-container-editor -n default --create-namespace --version=v0.4.18 --set apiVersion=storage.azure.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i storageazurekubedbcom-container-editor appscode-charts-oci/storageazurekubedbcom-container-editor -n default --create-namespace --version=v0.4.18 --values values.yaml
```
