...
$ helm repo update
$ helm search repo appscode-charts-oci/storageazurekubedbcom-container-editor --version=v0.8.0
$ helm upgrade -i storageazurekubedbcom-container-editor appscode-charts-oci/storageazurekubedbcom-container-editor -n default --create-namespace --version=v0.8.0
```
...
```bash
$ helm upgrade -i storageazurekubedbcom-container-editor appscode-charts-oci/storageazurekubedbcom-container-editor -n default --create-namespace --version=v0.8.0 --set apiVersion=storage.azure.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i storageazurekubedbcom-container-editor appscode-charts-oci/storageazurekubedbcom-container-editor -n default --create-namespace --version=v0.8.0 --values values.yaml
```
