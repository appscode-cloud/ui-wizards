...
$ helm repo update
$ helm search repo appscode/storageazurekubedbcom-container-editor --version=v0.15.0
$ helm upgrade -i storageazurekubedbcom-container-editor appscode/storageazurekubedbcom-container-editor -n default --create-namespace --version=v0.15.0
```
...
```bash
$ helm upgrade -i storageazurekubedbcom-container-editor appscode/storageazurekubedbcom-container-editor -n default --create-namespace --version=v0.15.0 --set apiVersion=storage.azure.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i storageazurekubedbcom-container-editor appscode/storageazurekubedbcom-container-editor -n default --create-namespace --version=v0.15.0 --values values.yaml
```
