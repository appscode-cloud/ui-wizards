...
$ helm repo update
$ helm search repo appscode/metak8sappscodecom-project-editor --version=v0.35.0
$ helm upgrade -i metak8sappscodecom-project-editor appscode/metak8sappscodecom-project-editor -n default --create-namespace --version=v0.35.0
```
...
```bash
$ helm upgrade -i metak8sappscodecom-project-editor appscode/metak8sappscodecom-project-editor -n default --create-namespace --version=v0.35.0 --set apiVersion=meta.k8s.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i metak8sappscodecom-project-editor appscode/metak8sappscodecom-project-editor -n default --create-namespace --version=v0.35.0 --values values.yaml
```
