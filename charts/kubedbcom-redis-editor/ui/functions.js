...
export const useFunc = (model) => {
  ...
  function addOrRemoveBinding() {
    ...
    if (value) {
      ...
      commit('wizard/model$delete', '/resources/catalogAppscodeComRedisBinding')
    }
  }
  ...
  function isBindingAlreadyOn() {
    ...
    const isExposeBinding = !!keys.find((str) => str === 'catalogAppscodeComRedisBinding')
  ...
  function onTriggerChange(type) {
    ...
    const commitPath = `/resources/autoscalingKubedbComRedisAutoscaler/spec/${type}/trigger`
  ...
  function hasAnnotations() {
    const annotations =
      getValue(model, '/resources/autoscalingKubedbComRedisAutoscaler/metadata/annotations') || {}
