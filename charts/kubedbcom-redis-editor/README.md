...
$ helm repo update
$ helm search repo appscode/kubedbcom-redis-editor --version=v0.37.0
$ helm upgrade -i kubedbcom-redis-editor appscode/kubedbcom-redis-editor -n default --create-namespace --version=v0.37.0
```
...
| form.alert.groups.database.rules.redisDown.duration                           |             | <code>2m</code>                                                                                                                        |
...
| form.alert.groups.database.rules.redisMissingMaster.duration                  |             | <code>2m</code>                                                                                                                        |
...
```bash
$ helm upgrade -i kubedbcom-redis-editor appscode/kubedbcom-redis-editor -n default --create-namespace --version=v0.37.0 --set form.alert.enabled=warning
```
...
```bash
$ helm upgrade -i kubedbcom-redis-editor appscode/kubedbcom-redis-editor -n default --create-namespace --version=v0.37.0 --values values.yaml
```
