...
$ helm repo update
$ helm install kubedbcom-redis-editor bytebuilders-ui/kubedbcom-redis-editor -n default --version=v0.1.0
```
...
```console
$ helm install kubedbcom-redis-editor bytebuilders-ui/kubedbcom-redis-editor -n default --version=v0.1.0 --set apiVersion=kubedb.com/v1alpha2
```
...
```console
$ helm install kubedbcom-redis-editor bytebuilders-ui/kubedbcom-redis-editor -n default --version=v0.1.0 --values values.yaml
```
