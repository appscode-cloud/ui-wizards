...
$ helm repo update
$ helm search repo appscode/core-node-editor --version=v0.34.0
$ helm upgrade -i core-node-editor appscode/core-node-editor -n default --create-namespace --version=v0.34.0
```
...
```bash
$ helm upgrade -i core-node-editor appscode/core-node-editor -n default --create-namespace --version=v0.34.0 --set apiVersion=v1
```
...
```bash
$ helm upgrade -i core-node-editor appscode/core-node-editor -n default --create-namespace --version=v0.34.0 --values values.yaml
```
