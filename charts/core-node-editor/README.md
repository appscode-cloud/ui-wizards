...
$ helm repo update
$ helm search repo bytebuilders-ui/core-node-editor --version=v0.4.6
$ helm upgrade -i core-node-editor bytebuilders-ui/core-node-editor -n default --create-namespace --version=v0.4.6
```
...
```bash
$ helm upgrade -i core-node-editor bytebuilders-ui/core-node-editor -n default --create-namespace --version=v0.4.6 --set apiVersion=v1
```
...
```bash
$ helm upgrade -i core-node-editor bytebuilders-ui/core-node-editor -n default --create-namespace --version=v0.4.6 --values values.yaml
```
