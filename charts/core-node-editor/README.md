...
$ helm repo update
$ helm search repo bytebuilders-ui/core-node-editor --version=v0.4.14
$ helm upgrade -i core-node-editor bytebuilders-ui/core-node-editor -n default --create-namespace --version=v0.4.14
```
...
```bash
$ helm upgrade -i core-node-editor bytebuilders-ui/core-node-editor -n default --create-namespace --version=v0.4.14 --set apiVersion=v1
```
...
```bash
$ helm upgrade -i core-node-editor bytebuilders-ui/core-node-editor -n default --create-namespace --version=v0.4.14 --values values.yaml
```
