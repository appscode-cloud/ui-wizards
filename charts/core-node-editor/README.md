...
$ helm repo update
$ helm search repo bytebuilders-ui/core-node-editor --version=v0.4.7
$ helm upgrade -i core-node-editor bytebuilders-ui/core-node-editor -n default --create-namespace --version=v0.4.7
```
...
```bash
$ helm upgrade -i core-node-editor bytebuilders-ui/core-node-editor -n default --create-namespace --version=v0.4.7 --set apiVersion=v1
```
...
```bash
$ helm upgrade -i core-node-editor bytebuilders-ui/core-node-editor -n default --create-namespace --version=v0.4.7 --values values.yaml
```
