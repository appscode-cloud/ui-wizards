...
$ helm repo update
$ helm search repo bytebuilders-ui/core-node-editor --version=v0.3.0
$ helm upgrade -i core-node-editor bytebuilders-ui/core-node-editor -n default --create-namespace --version=v0.3.0
```
...
```bash
$ helm upgrade -i core-node-editor bytebuilders-ui/core-node-editor -n default --create-namespace --version=v0.3.0 --set apiVersion=v1
```
...
```bash
$ helm upgrade -i core-node-editor bytebuilders-ui/core-node-editor -n default --create-namespace --version=v0.3.0 --values values.yaml
```
