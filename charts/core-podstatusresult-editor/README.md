...
$ helm repo update
$ helm search repo bytebuilders-ui/core-podstatusresult-editor --version=v0.4.7
$ helm upgrade -i core-podstatusresult-editor bytebuilders-ui/core-podstatusresult-editor -n default --create-namespace --version=v0.4.7
```
...
```bash
$ helm upgrade -i core-podstatusresult-editor bytebuilders-ui/core-podstatusresult-editor -n default --create-namespace --version=v0.4.7 --set apiVersion=v1
```
...
```bash
$ helm upgrade -i core-podstatusresult-editor bytebuilders-ui/core-podstatusresult-editor -n default --create-namespace --version=v0.4.7 --values values.yaml
```
