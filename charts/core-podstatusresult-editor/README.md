...
$ helm repo update
$ helm search repo appscode-charts-oci/core-podstatusresult-editor --version=v0.4.21
$ helm upgrade -i core-podstatusresult-editor appscode-charts-oci/core-podstatusresult-editor -n default --create-namespace --version=v0.4.21
```
...
```bash
$ helm upgrade -i core-podstatusresult-editor appscode-charts-oci/core-podstatusresult-editor -n default --create-namespace --version=v0.4.21 --set apiVersion=v1
```
...
```bash
$ helm upgrade -i core-podstatusresult-editor appscode-charts-oci/core-podstatusresult-editor -n default --create-namespace --version=v0.4.21 --values values.yaml
```
