...
$ helm repo update
$ helm search repo appscode/core-podstatusresult-editor --version=v0.15.0
$ helm upgrade -i core-podstatusresult-editor appscode/core-podstatusresult-editor -n default --create-namespace --version=v0.15.0
```
...
```bash
$ helm upgrade -i core-podstatusresult-editor appscode/core-podstatusresult-editor -n default --create-namespace --version=v0.15.0 --set apiVersion=v1
```
...
```bash
$ helm upgrade -i core-podstatusresult-editor appscode/core-podstatusresult-editor -n default --create-namespace --version=v0.15.0 --values values.yaml
```
