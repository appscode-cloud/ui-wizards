...
$ helm repo update
$ helm search repo bytebuilders-ui/core-podstatusresult-editor --version=v0.4.5
$ helm upgrade -i core-podstatusresult-editor bytebuilders-ui/core-podstatusresult-editor -n default --create-namespace --version=v0.4.5
```
...
```bash
$ helm upgrade -i core-podstatusresult-editor bytebuilders-ui/core-podstatusresult-editor -n default --create-namespace --version=v0.4.5 --set apiVersion=v1
```
...
```bash
$ helm upgrade -i core-podstatusresult-editor bytebuilders-ui/core-podstatusresult-editor -n default --create-namespace --version=v0.4.5 --values values.yaml
```
