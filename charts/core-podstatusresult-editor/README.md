...
$ helm repo update
$ helm search repo appscode-charts-oci/core-podstatusresult-editor --version=v0.12.0
$ helm upgrade -i core-podstatusresult-editor appscode-charts-oci/core-podstatusresult-editor -n default --create-namespace --version=v0.12.0
```
...
```bash
$ helm upgrade -i core-podstatusresult-editor appscode-charts-oci/core-podstatusresult-editor -n default --create-namespace --version=v0.12.0 --set apiVersion=v1
```
...
```bash
$ helm upgrade -i core-podstatusresult-editor appscode-charts-oci/core-podstatusresult-editor -n default --create-namespace --version=v0.12.0 --values values.yaml
```
