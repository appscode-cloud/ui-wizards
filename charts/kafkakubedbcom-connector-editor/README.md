...
$ helm repo update
$ helm search repo appscode/kafkakubedbcom-connector-editor --version=v0.34.0
$ helm upgrade -i kafkakubedbcom-connector-editor appscode/kafkakubedbcom-connector-editor -n default --create-namespace --version=v0.34.0
```
...
```bash
$ helm upgrade -i kafkakubedbcom-connector-editor appscode/kafkakubedbcom-connector-editor -n default --create-namespace --version=v0.34.0 --set apiVersion=kafka.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i kafkakubedbcom-connector-editor appscode/kafkakubedbcom-connector-editor -n default --create-namespace --version=v0.34.0 --values values.yaml
```
