...
$ helm repo update
$ helm search repo appscode/corek8sappscodecom-project-editor --version=v0.19.0
$ helm upgrade -i corek8sappscodecom-project-editor appscode/corek8sappscodecom-project-editor -n default --create-namespace --version=v0.19.0
```
...
```bash
$ helm upgrade -i corek8sappscodecom-project-editor appscode/corek8sappscodecom-project-editor -n default --create-namespace --version=v0.19.0 --set apiVersion=core.k8s.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i corek8sappscodecom-project-editor appscode/corek8sappscodecom-project-editor -n default --create-namespace --version=v0.19.0 --values values.yaml
```
