...
$ helm repo update
$ helm search repo appscode/stashappscodecom-backupsession-editor --version=v0.16.0
$ helm upgrade -i stashappscodecom-backupsession-editor appscode/stashappscodecom-backupsession-editor -n default --create-namespace --version=v0.16.0
```
...
```bash
$ helm upgrade -i stashappscodecom-backupsession-editor appscode/stashappscodecom-backupsession-editor -n default --create-namespace --version=v0.16.0 --set apiVersion=stash.appscode.com/v1beta1
```
...
```bash
$ helm upgrade -i stashappscodecom-backupsession-editor appscode/stashappscodecom-backupsession-editor -n default --create-namespace --version=v0.16.0 --values values.yaml
```
