...
$ helm repo update
$ helm search repo appscode-charts-oci/stashappscodecom-backupsession-editor --version=v0.12.0
$ helm upgrade -i stashappscodecom-backupsession-editor appscode-charts-oci/stashappscodecom-backupsession-editor -n default --create-namespace --version=v0.12.0
```
...
```bash
$ helm upgrade -i stashappscodecom-backupsession-editor appscode-charts-oci/stashappscodecom-backupsession-editor -n default --create-namespace --version=v0.12.0 --set apiVersion=stash.appscode.com/v1beta1
```
...
```bash
$ helm upgrade -i stashappscodecom-backupsession-editor appscode-charts-oci/stashappscodecom-backupsession-editor -n default --create-namespace --version=v0.12.0 --values values.yaml
```
