...
$ helm repo update
$ helm search repo appscode/ipamclusterxk8sio-ipaddressclaim-editor --version=v0.33.0
$ helm upgrade -i ipamclusterxk8sio-ipaddressclaim-editor appscode/ipamclusterxk8sio-ipaddressclaim-editor -n default --create-namespace --version=v0.33.0
```
...
```bash
$ helm upgrade -i ipamclusterxk8sio-ipaddressclaim-editor appscode/ipamclusterxk8sio-ipaddressclaim-editor -n default --create-namespace --version=v0.33.0 --set apiVersion=ipam.cluster.x-k8s.io/v1beta1
```
...
```bash
$ helm upgrade -i ipamclusterxk8sio-ipaddressclaim-editor appscode/ipamclusterxk8sio-ipaddressclaim-editor -n default --create-namespace --version=v0.33.0 --values values.yaml
```
