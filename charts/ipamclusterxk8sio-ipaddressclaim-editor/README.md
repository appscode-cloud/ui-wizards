...
```bash
$ helm upgrade -i ipamclusterxk8sio-ipaddressclaim-editor appscode-charts-oci/ipamclusterxk8sio-ipaddressclaim-editor -n default --create-namespace --version=v0.4.20 --set apiVersion=ipam.cluster.x-k8s.io/v1beta1
```
