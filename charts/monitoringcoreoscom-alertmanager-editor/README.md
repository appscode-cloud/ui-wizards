...
$ helm repo update
$ helm search repo appscode-charts-oci/monitoringcoreoscom-alertmanager-editor --version=v0.4.20
$ helm upgrade -i monitoringcoreoscom-alertmanager-editor appscode-charts-oci/monitoringcoreoscom-alertmanager-editor -n default --create-namespace --version=v0.4.20
```
...
```bash
$ helm upgrade -i monitoringcoreoscom-alertmanager-editor appscode-charts-oci/monitoringcoreoscom-alertmanager-editor -n default --create-namespace --version=v0.4.20 --set apiVersion=monitoring.coreos.com/v1
```
...
```bash
$ helm upgrade -i monitoringcoreoscom-alertmanager-editor appscode-charts-oci/monitoringcoreoscom-alertmanager-editor -n default --create-namespace --version=v0.4.20 --values values.yaml
```
