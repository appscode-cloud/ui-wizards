...
$ helm repo update
$ helm search repo appscode/monitoringcoreoscom-alertmanager-editor --version=v0.20.0
$ helm upgrade -i monitoringcoreoscom-alertmanager-editor appscode/monitoringcoreoscom-alertmanager-editor -n default --create-namespace --version=v0.20.0
```
...
```bash
$ helm upgrade -i monitoringcoreoscom-alertmanager-editor appscode/monitoringcoreoscom-alertmanager-editor -n default --create-namespace --version=v0.20.0 --set apiVersion=monitoring.coreos.com/v1
```
...
```bash
$ helm upgrade -i monitoringcoreoscom-alertmanager-editor appscode/monitoringcoreoscom-alertmanager-editor -n default --create-namespace --version=v0.20.0 --values values.yaml
```
