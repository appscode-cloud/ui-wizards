# PerconaXtraDB Editor UI Options
...
$ helm repo update
$ helm search repo bytebuilders-ui/kubedbcom-perconaxtradb-editor-options --version=v0.4.21
$ helm upgrade -i kubedbcom-perconaxtradb-editor-options bytebuilders-ui/kubedbcom-perconaxtradb-editor-options -n kube-system --create-namespace --version=v0.4.21
```
...
| spec.admin.databases.PerconaXtraDB.versions.default                            |                                                                                                      | <code>"8.0.31"</code>                                     |
...
```bash
$ helm upgrade -i kubedbcom-perconaxtradb-editor-options bytebuilders-ui/kubedbcom-perconaxtradb-editor-options -n kube-system --create-namespace --version=v0.4.21 --set metadata.resource.group=kubedb.com
```
...
```bash
$ helm upgrade -i kubedbcom-perconaxtradb-editor-options bytebuilders-ui/kubedbcom-perconaxtradb-editor-options -n kube-system --create-namespace --version=v0.4.21 --values values.yaml
```
