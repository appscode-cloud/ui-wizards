...
*/}}
{{- define "kubedbcom-perconaxtradb-editor-options.name" -}}
...
*/}}
{{- define "kubedbcom-perconaxtradb-editor-options.fullname" -}}
...
*/}}
{{- define "kubedbcom-perconaxtradb-editor-options.chart" -}}
...
Common labels
*/}}
{{- define "kubedbcom-perconaxtradb-editor-options.labels" -}}
{{ include "kubedbcom-perconaxtradb-editor-options.selectorLabels" . }}
...
Selector labels
*/}}
{{- define "kubedbcom-perconaxtradb-editor-options.selectorLabels" -}}
app.kubernetes.io/name: perconaxtradbs.kubedb.com
app.kubernetes.io/instance: {{ include "kubedbcom-perconaxtradb-editor-options.fullname" . }}
{{- end }}

{{/*
Create the name of the service account to use
*/}}
{{- define "kubedbcom-perconaxtradb-editor-options.serviceAccountName" -}}
{{- if .Values.spec.serviceAccount.create }}
{{- default (include "kubedbcom-perconaxtradb-editor-options.fullname" .) .Values.spec.serviceAccount.name }}
{{- else }}
...
Common annotations
*/}}
{{- define "kubedbcom-perconaxtradb-editor-options.annotations" -}}
...
Alert Enabled
*/}}
{{- define "kubedbcom-perconaxtradb-editor-options.alertEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
