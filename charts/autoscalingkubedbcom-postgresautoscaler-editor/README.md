...
$ helm repo update
$ helm search repo appscode/autoscalingkubedbcom-postgresautoscaler-editor --version=v0.15.0
$ helm upgrade -i autoscalingkubedbcom-postgresautoscaler-editor appscode/autoscalingkubedbcom-postgresautoscaler-editor -n default --create-namespace --version=v0.15.0
```
...
```bash
$ helm upgrade -i autoscalingkubedbcom-postgresautoscaler-editor appscode/autoscalingkubedbcom-postgresautoscaler-editor -n default --create-namespace --version=v0.15.0 --set apiVersion=autoscaling.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i autoscalingkubedbcom-postgresautoscaler-editor appscode/autoscalingkubedbcom-postgresautoscaler-editor -n default --create-namespace --version=v0.15.0 --values values.yaml
```
