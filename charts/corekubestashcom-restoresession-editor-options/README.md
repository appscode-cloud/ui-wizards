...
$ helm repo update
$ helm search repo appscode/corekubestashcom-restoresession-editor-options --version=v0.28.0
$ helm upgrade -i corekubestashcom-restoresession-editor-options appscode/corekubestashcom-restoresession-editor-options -n kube-system --create-namespace --version=v0.28.0
```
...
```bash
$ helm upgrade -i corekubestashcom-restoresession-editor-options appscode/corekubestashcom-restoresession-editor-options -n kube-system --create-namespace --version=v0.28.0 --set metadata.resource.group=core.kubestash.com
```
...
```bash
$ helm upgrade -i corekubestashcom-restoresession-editor-options appscode/corekubestashcom-restoresession-editor-options -n kube-system --create-namespace --version=v0.28.0 --values values.yaml
```
