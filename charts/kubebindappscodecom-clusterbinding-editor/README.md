...
$ helm repo update
$ helm search repo appscode-charts-oci/kubebindappscodecom-clusterbinding-editor --version=v0.7.0
$ helm upgrade -i kubebindappscodecom-clusterbinding-editor appscode-charts-oci/kubebindappscodecom-clusterbinding-editor -n default --create-namespace --version=v0.7.0
```
...
```bash
$ helm upgrade -i kubebindappscodecom-clusterbinding-editor appscode-charts-oci/kubebindappscodecom-clusterbinding-editor -n default --create-namespace --version=v0.7.0 --set apiVersion=kube-bind.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i kubebindappscodecom-clusterbinding-editor appscode-charts-oci/kubebindappscodecom-clusterbinding-editor -n default --create-namespace --version=v0.7.0 --values values.yaml
```
