...
$ helm repo update
$ helm search repo appscode-charts-oci/catalogkubedbcom-pgbouncerversion-editor --version=v0.7.0
$ helm upgrade -i catalogkubedbcom-pgbouncerversion-editor appscode-charts-oci/catalogkubedbcom-pgbouncerversion-editor -n default --create-namespace --version=v0.7.0
```
...
```bash
$ helm upgrade -i catalogkubedbcom-pgbouncerversion-editor appscode-charts-oci/catalogkubedbcom-pgbouncerversion-editor -n default --create-namespace --version=v0.7.0 --set apiVersion=catalog.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i catalogkubedbcom-pgbouncerversion-editor appscode-charts-oci/catalogkubedbcom-pgbouncerversion-editor -n default --create-namespace --version=v0.7.0 --values values.yaml
```
