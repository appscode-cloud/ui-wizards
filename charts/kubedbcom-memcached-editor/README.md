...
$ helm repo update
$ helm install kubedbcom-memcached-editor bytebuilders-ui/kubedbcom-memcached-editor -n default --version=v0.1.0
```
...
```console
$ helm install kubedbcom-memcached-editor bytebuilders-ui/kubedbcom-memcached-editor -n default --version=v0.1.0 --set apiVersion=kubedb.com/v1alpha2
```
...
```console
$ helm install kubedbcom-memcached-editor bytebuilders-ui/kubedbcom-memcached-editor -n default --version=v0.1.0 --values values.yaml
```
