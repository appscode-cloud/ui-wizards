...
$ helm repo update
$ helm search repo appscode/kubedbcom-memcached-editor --version=v0.35.0
$ helm upgrade -i kubedbcom-memcached-editor appscode/kubedbcom-memcached-editor -n default --create-namespace --version=v0.35.0
```
...
```bash
$ helm upgrade -i kubedbcom-memcached-editor appscode/kubedbcom-memcached-editor -n default --create-namespace --version=v0.35.0 --set form.alert.enabled=warning
```
...
```bash
$ helm upgrade -i kubedbcom-memcached-editor appscode/kubedbcom-memcached-editor -n default --create-namespace --version=v0.35.0 --values values.yaml
```
