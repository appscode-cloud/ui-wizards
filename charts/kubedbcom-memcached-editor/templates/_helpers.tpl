...
*/}}
{{- define "kubedbcom-memcached-editor.name" -}}
...
*/}}
{{- define "kubedbcom-memcached-editor.fullname" -}}
...
*/}}
{{- define "kubedbcom-memcached-editor.chart" -}}
...
Common labels
*/}}
{{- define "kubedbcom-memcached-editor.labels" -}}
{{ include "kubedbcom-memcached-editor.selectorLabels" . }}
...
Selector labels
*/}}
{{- define "kubedbcom-memcached-editor.selectorLabels" -}}
app.kubernetes.io/name: memcacheds.kubedb.com
app.kubernetes.io/instance: {{ include "kubedbcom-memcached-editor.fullname" . }}
{{- end }}

{{/*
Create the name of the service account to use
*/}}
{{- define "kubedbcom-memcached-editor.serviceAccountName" -}}
{{- if .Values.spec.serviceAccount.create }}
{{- default (include "kubedbcom-memcached-editor.fullname" .) .Values.spec.serviceAccount.name }}
{{- else }}
...
Common annotations
*/}}
{{- define "kubedbcom-memcached-editor.annotations" -}}
...
Alert Enabled
*/}}
{{- define "kubedbcom-memcached-editor.alertEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
