...
$ helm repo update
$ helm search repo appscode/enginekubevaultcom-secretengine-editor --version=v0.16.0
$ helm upgrade -i enginekubevaultcom-secretengine-editor appscode/enginekubevaultcom-secretengine-editor -n default --create-namespace --version=v0.16.0
```
...
```bash
$ helm upgrade -i enginekubevaultcom-secretengine-editor appscode/enginekubevaultcom-secretengine-editor -n default --create-namespace --version=v0.16.0 --set apiVersion=engine.kubevault.com/v1alpha1
```
...
```bash
$ helm upgrade -i enginekubevaultcom-secretengine-editor appscode/enginekubevaultcom-secretengine-editor -n default --create-namespace --version=v0.16.0 --values values.yaml
```
