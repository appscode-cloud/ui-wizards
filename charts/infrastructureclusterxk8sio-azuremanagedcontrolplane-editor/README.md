...
$ helm repo update
$ helm search repo bytebuilders-ui/infrastructureclusterxk8sio-azuremanagedcontrolplane-editor --version=v0.4.14
$ helm upgrade -i infrastructureclusterxk8sio-azuremanagedcontrolplane-editor bytebuilders-ui/infrastructureclusterxk8sio-azuremanagedcontrolplane-editor -n default --create-namespace --version=v0.4.14
```
...
```bash
$ helm upgrade -i infrastructureclusterxk8sio-azuremanagedcontrolplane-editor bytebuilders-ui/infrastructureclusterxk8sio-azuremanagedcontrolplane-editor -n default --create-namespace --version=v0.4.14 --set apiVersion=infrastructure.cluster.x-k8s.io/v1beta1
```
...
```bash
$ helm upgrade -i infrastructureclusterxk8sio-azuremanagedcontrolplane-editor bytebuilders-ui/infrastructureclusterxk8sio-azuremanagedcontrolplane-editor -n default --create-namespace --version=v0.4.14 --values values.yaml
```
