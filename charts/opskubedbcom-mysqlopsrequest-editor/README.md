...
$ helm repo update
$ helm search repo appscode/opskubedbcom-mysqlopsrequest-editor --version=v0.35.0
$ helm upgrade -i opskubedbcom-mysqlopsrequest-editor appscode/opskubedbcom-mysqlopsrequest-editor -n default --create-namespace --version=v0.35.0
```
...
```bash
$ helm upgrade -i opskubedbcom-mysqlopsrequest-editor appscode/opskubedbcom-mysqlopsrequest-editor -n default --create-namespace --version=v0.35.0 --set apiVersion=ops.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i opskubedbcom-mysqlopsrequest-editor appscode/opskubedbcom-mysqlopsrequest-editor -n default --create-namespace --version=v0.35.0 --values values.yaml
```
