...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/voyagerappscodecom-certificate-editor --version=v0.4.17
$ helm upgrade -i voyagerappscodecom-certificate-editor bytebuilders-ui-dev/voyagerappscodecom-certificate-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i voyagerappscodecom-certificate-editor bytebuilders-ui-dev/voyagerappscodecom-certificate-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=voyager.appscode.com/v1beta1
```
...
```bash
$ helm upgrade -i voyagerappscodecom-certificate-editor bytebuilders-ui-dev/voyagerappscodecom-certificate-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
