...
$ helm repo update
$ helm search repo bytebuilders-ui/voyagerappscodecom-certificate-editor --version=v0.11.0
...
```bash
$ helm upgrade -i voyagerappscodecom-certificate-editor bytebuilders-ui/voyagerappscodecom-certificate-editor -n default --create-namespace --version=v0.11.0 --set apiVersion=voyager.appscode.com/v1beta1
```
...
```bash
$ helm upgrade -i voyagerappscodecom-certificate-editor bytebuilders-ui/voyagerappscodecom-certificate-editor -n default --create-namespace --version=v0.11.0 --values values.yaml
```
