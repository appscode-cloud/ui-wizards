...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/runtimeclusterxk8sio-extensionconfig-editor --version=v0.4.17
$ helm upgrade -i runtimeclusterxk8sio-extensionconfig-editor bytebuilders-ui-dev/runtimeclusterxk8sio-extensionconfig-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i runtimeclusterxk8sio-extensionconfig-editor bytebuilders-ui-dev/runtimeclusterxk8sio-extensionconfig-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=runtime.cluster.x-k8s.io/v1alpha1
```
...
```bash
$ helm upgrade -i runtimeclusterxk8sio-extensionconfig-editor bytebuilders-ui-dev/runtimeclusterxk8sio-extensionconfig-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
