...
$ helm repo update
$ helm search repo appscode-charts-oci/runtimeclusterxk8sio-extensionconfig-editor --version=v0.4.18
$ helm upgrade -i runtimeclusterxk8sio-extensionconfig-editor appscode-charts-oci/runtimeclusterxk8sio-extensionconfig-editor -n default --create-namespace --version=v0.4.18
```
...
```bash
$ helm upgrade -i runtimeclusterxk8sio-extensionconfig-editor appscode-charts-oci/runtimeclusterxk8sio-extensionconfig-editor -n default --create-namespace --version=v0.4.18 --set apiVersion=runtime.cluster.x-k8s.io/v1alpha1
```
...
```bash
$ helm upgrade -i runtimeclusterxk8sio-extensionconfig-editor appscode-charts-oci/runtimeclusterxk8sio-extensionconfig-editor -n default --create-namespace --version=v0.4.18 --values values.yaml
```
