...
$ helm repo update
$ helm search repo appscode/kubedbcom-db2-editor-options --version=v0.34.0
$ helm upgrade -i kubedbcom-db2-editor-options appscode/kubedbcom-db2-editor-options -n kube-system --create-namespace --version=v0.34.0
```
...
```bash
$ helm upgrade -i kubedbcom-db2-editor-options appscode/kubedbcom-db2-editor-options -n kube-system --create-namespace --version=v0.34.0 --set metadata.resource.group=kubedb.com
```
...
```bash
$ helm upgrade -i kubedbcom-db2-editor-options appscode/kubedbcom-db2-editor-options -n kube-system --create-namespace --version=v0.34.0 --values values.yaml
```
