...
*/}}
{{- define "kubedbcom-db2-editor-options.name" -}}
...
*/}}
{{- define "kubedbcom-db2-editor-options.fullname" -}}
...
*/}}
{{- define "kubedbcom-db2-editor-options.chart" -}}
...
Common labels
*/}}
{{- define "kubedbcom-db2-editor-options.labels" -}}
{{ include "kubedbcom-db2-editor-options.selectorLabels" . }}
...
Selector labels
*/}}
{{- define "kubedbcom-db2-editor-options.selectorLabels" -}}
app.kubernetes.io/name: db2s.kubedb.com
app.kubernetes.io/instance: {{ include "kubedbcom-db2-editor-options.fullname" . }}
{{- end }}

{{/*
Create the name of the service account to use
*/}}
{{- define "kubedbcom-db2-editor-options.serviceAccountName" -}}
{{- if .Values.spec.serviceAccount.create }}
{{- default (include "kubedbcom-db2-editor-options.fullname" .) .Values.spec.serviceAccount.name }}
{{- else }}
...
Common annotations
*/}}
{{- define "kubedbcom-db2-editor-options.annotations" -}}
