...
$ helm repo update
$ helm search repo appscode/flowcontrolapiserverk8sio-prioritylevelconfiguration-editor --version=v0.28.0
$ helm upgrade -i flowcontrolapiserverk8sio-prioritylevelconfiguration-editor appscode/flowcontrolapiserverk8sio-prioritylevelconfiguration-editor -n default --create-namespace --version=v0.28.0
```
...
```bash
$ helm upgrade -i flowcontrolapiserverk8sio-prioritylevelconfiguration-editor appscode/flowcontrolapiserverk8sio-prioritylevelconfiguration-editor -n default --create-namespace --version=v0.28.0 --set apiVersion=flowcontrol.apiserver.k8s.io/v1beta1
```
...
```bash
$ helm upgrade -i flowcontrolapiserverk8sio-prioritylevelconfiguration-editor appscode/flowcontrolapiserverk8sio-prioritylevelconfiguration-editor -n default --create-namespace --version=v0.28.0 --values values.yaml
```
