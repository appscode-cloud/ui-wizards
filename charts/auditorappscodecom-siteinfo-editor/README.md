...
$ helm repo update
$ helm search repo appscode-charts-oci/auditorappscodecom-siteinfo-editor --version=v0.4.19
$ helm upgrade -i auditorappscodecom-siteinfo-editor appscode-charts-oci/auditorappscodecom-siteinfo-editor -n default --create-namespace --version=v0.4.19
```
...
```bash
$ helm upgrade -i auditorappscodecom-siteinfo-editor appscode-charts-oci/auditorappscodecom-siteinfo-editor -n default --create-namespace --version=v0.4.19 --set apiVersion=auditor.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i auditorappscodecom-siteinfo-editor appscode-charts-oci/auditorappscodecom-siteinfo-editor -n default --create-namespace --version=v0.4.19 --values values.yaml
```
