...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/auditorappscodecom-siteinfo-editor --version=v0.4.17
$ helm upgrade -i auditorappscodecom-siteinfo-editor bytebuilders-ui-dev/auditorappscodecom-siteinfo-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i auditorappscodecom-siteinfo-editor bytebuilders-ui-dev/auditorappscodecom-siteinfo-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=auditor.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i auditorappscodecom-siteinfo-editor bytebuilders-ui-dev/auditorappscodecom-siteinfo-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
