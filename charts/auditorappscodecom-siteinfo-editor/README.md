...
$ helm repo update
$ helm search repo bytebuilders-ui/auditorappscodecom-siteinfo-editor --version=v0.3.0
$ helm upgrade -i auditorappscodecom-siteinfo-editor bytebuilders-ui/auditorappscodecom-siteinfo-editor -n default --create-namespace --version=v0.3.0
```
...
```bash
$ helm upgrade -i auditorappscodecom-siteinfo-editor bytebuilders-ui/auditorappscodecom-siteinfo-editor -n default --create-namespace --version=v0.3.0 --set apiVersion=auditor.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i auditorappscodecom-siteinfo-editor bytebuilders-ui/auditorappscodecom-siteinfo-editor -n default --create-namespace --version=v0.3.0 --values values.yaml
```
