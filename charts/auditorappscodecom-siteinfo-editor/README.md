...
$ helm repo update
$ helm search repo bytebuilders-ui/auditorappscodecom-siteinfo-editor --version=v0.4.6
$ helm upgrade -i auditorappscodecom-siteinfo-editor bytebuilders-ui/auditorappscodecom-siteinfo-editor -n default --create-namespace --version=v0.4.6
```
...
```bash
$ helm upgrade -i auditorappscodecom-siteinfo-editor bytebuilders-ui/auditorappscodecom-siteinfo-editor -n default --create-namespace --version=v0.4.6 --set apiVersion=auditor.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i auditorappscodecom-siteinfo-editor bytebuilders-ui/auditorappscodecom-siteinfo-editor -n default --create-namespace --version=v0.4.6 --values values.yaml
```
