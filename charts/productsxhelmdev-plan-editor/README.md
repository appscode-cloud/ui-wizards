...
$ helm repo update
$ helm search repo appscode/productsxhelmdev-plan-editor --version=v0.35.0
$ helm upgrade -i productsxhelmdev-plan-editor appscode/productsxhelmdev-plan-editor -n default --create-namespace --version=v0.35.0
```
...
```bash
$ helm upgrade -i productsxhelmdev-plan-editor appscode/productsxhelmdev-plan-editor -n default --create-namespace --version=v0.35.0 --set apiVersion=products.x-helm.dev/v1alpha1
```
...
```bash
$ helm upgrade -i productsxhelmdev-plan-editor appscode/productsxhelmdev-plan-editor -n default --create-namespace --version=v0.35.0 --values values.yaml
```
