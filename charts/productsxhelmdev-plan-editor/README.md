...
$ helm repo update
$ helm search repo bytebuilders-ui/productsxhelmdev-plan-editor --version=v0.4.17
$ helm upgrade -i productsxhelmdev-plan-editor bytebuilders-ui/productsxhelmdev-plan-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i productsxhelmdev-plan-editor bytebuilders-ui/productsxhelmdev-plan-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=products.x-helm.dev/v1alpha1
```
...
```bash
$ helm upgrade -i productsxhelmdev-plan-editor bytebuilders-ui/productsxhelmdev-plan-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
