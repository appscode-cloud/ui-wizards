...
$ helm repo update
$ helm search repo appscode-charts-oci/productsxhelmdev-plan-editor --version=v0.4.18
$ helm upgrade -i productsxhelmdev-plan-editor appscode-charts-oci/productsxhelmdev-plan-editor -n default --create-namespace --version=v0.4.18
```
...
```bash
$ helm upgrade -i productsxhelmdev-plan-editor appscode-charts-oci/productsxhelmdev-plan-editor -n default --create-namespace --version=v0.4.18 --set apiVersion=products.x-helm.dev/v1alpha1
```
...
```bash
$ helm upgrade -i productsxhelmdev-plan-editor appscode-charts-oci/productsxhelmdev-plan-editor -n default --create-namespace --version=v0.4.18 --values values.yaml
```
