...
$ helm repo update
$ helm search repo appscode-charts-oci/corekubestashcom-backupconfiguration-editor --version=v0.4.19
$ helm upgrade -i corekubestashcom-backupconfiguration-editor appscode-charts-oci/corekubestashcom-backupconfiguration-editor -n default --create-namespace --version=v0.4.19
```
...
```bash
$ helm upgrade -i corekubestashcom-backupconfiguration-editor appscode-charts-oci/corekubestashcom-backupconfiguration-editor -n default --create-namespace --version=v0.4.19 --set apiVersion=core.kubestash.com/v1alpha1
```
...
```bash
$ helm upgrade -i corekubestashcom-backupconfiguration-editor appscode-charts-oci/corekubestashcom-backupconfiguration-editor -n default --create-namespace --version=v0.4.19 --values values.yaml
```
