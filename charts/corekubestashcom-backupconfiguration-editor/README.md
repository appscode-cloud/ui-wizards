...
$ helm repo update
$ helm search repo appscode-charts-oci/corekubestashcom-backupconfiguration-editor --version=v0.11.0
...
```bash
$ helm upgrade -i corekubestashcom-backupconfiguration-editor appscode-charts-oci/corekubestashcom-backupconfiguration-editor -n default --create-namespace --version=v0.11.0 --set metadata.resource.group=core.kubestash.com
```
...
```bash
$ helm upgrade -i corekubestashcom-backupconfiguration-editor appscode-charts-oci/corekubestashcom-backupconfiguration-editor -n default --create-namespace --version=v0.11.0 --values values.yaml
```
