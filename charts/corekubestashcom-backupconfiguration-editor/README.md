...
$ helm repo update
$ helm search repo appscode/corekubestashcom-backupconfiguration-editor --version=v0.22.0
$ helm upgrade -i corekubestashcom-backupconfiguration-editor appscode/corekubestashcom-backupconfiguration-editor -n default --create-namespace --version=v0.22.0
```
...
```bash
$ helm upgrade -i corekubestashcom-backupconfiguration-editor appscode/corekubestashcom-backupconfiguration-editor -n default --create-namespace --version=v0.22.0 --set metadata.resource.group=core.kubestash.com
```
...
```bash
$ helm upgrade -i corekubestashcom-backupconfiguration-editor appscode/corekubestashcom-backupconfiguration-editor -n default --create-namespace --version=v0.22.0 --values values.yaml
```
