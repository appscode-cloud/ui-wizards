...
$ helm repo update
$ helm search repo appscode-charts-oci/clusteropenclustermanagementio-managedclusterset-editor --version=v0.11.0
$ helm upgrade -i clusteropenclustermanagementio-managedclusterset-editor appscode-charts-oci/clusteropenclustermanagementio-managedclusterset-editor -n default --create-namespace --version=v0.11.0
```
...
```bash
$ helm upgrade -i clusteropenclustermanagementio-managedclusterset-editor appscode-charts-oci/clusteropenclustermanagementio-managedclusterset-editor -n default --create-namespace --version=v0.11.0 --set apiVersion=cluster.open-cluster-management.io/v1beta2
```
...
```bash
$ helm upgrade -i clusteropenclustermanagementio-managedclusterset-editor appscode-charts-oci/clusteropenclustermanagementio-managedclusterset-editor -n default --create-namespace --version=v0.11.0 --values values.yaml
```
