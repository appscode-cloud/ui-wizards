...
$ helm repo update
$ helm search repo appscode-charts-oci/controlplaneclusterxk8sio-rosacontrolplane-editor --version=v0.14.0
$ helm upgrade -i controlplaneclusterxk8sio-rosacontrolplane-editor appscode-charts-oci/controlplaneclusterxk8sio-rosacontrolplane-editor -n default --create-namespace --version=v0.14.0
```
...
```bash
$ helm upgrade -i controlplaneclusterxk8sio-rosacontrolplane-editor appscode-charts-oci/controlplaneclusterxk8sio-rosacontrolplane-editor -n default --create-namespace --version=v0.14.0 --set apiVersion=controlplane.cluster.x-k8s.io/v1beta2
```
...
```bash
$ helm upgrade -i controlplaneclusterxk8sio-rosacontrolplane-editor appscode-charts-oci/controlplaneclusterxk8sio-rosacontrolplane-editor -n default --create-namespace --version=v0.14.0 --values values.yaml
```
