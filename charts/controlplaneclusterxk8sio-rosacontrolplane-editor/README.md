...
$ helm repo update
$ helm search repo appscode/controlplaneclusterxk8sio-rosacontrolplane-editor --version=v0.32.0
$ helm upgrade -i controlplaneclusterxk8sio-rosacontrolplane-editor appscode/controlplaneclusterxk8sio-rosacontrolplane-editor -n default --create-namespace --version=v0.32.0
```
...
```bash
$ helm upgrade -i controlplaneclusterxk8sio-rosacontrolplane-editor appscode/controlplaneclusterxk8sio-rosacontrolplane-editor -n default --create-namespace --version=v0.32.0 --set apiVersion=controlplane.cluster.x-k8s.io/v1beta2
```
...
```bash
$ helm upgrade -i controlplaneclusterxk8sio-rosacontrolplane-editor appscode/controlplaneclusterxk8sio-rosacontrolplane-editor -n default --create-namespace --version=v0.32.0 --values values.yaml
```
