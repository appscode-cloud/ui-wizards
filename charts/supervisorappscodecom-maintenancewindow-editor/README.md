...
$ helm repo update
$ helm search repo appscode/supervisorappscodecom-maintenancewindow-editor --version=v0.37.0
$ helm upgrade -i supervisorappscodecom-maintenancewindow-editor appscode/supervisorappscodecom-maintenancewindow-editor -n default --create-namespace --version=v0.37.0
```
...
```bash
$ helm upgrade -i supervisorappscodecom-maintenancewindow-editor appscode/supervisorappscodecom-maintenancewindow-editor -n default --create-namespace --version=v0.37.0 --set apiVersion=supervisor.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i supervisorappscodecom-maintenancewindow-editor appscode/supervisorappscodecom-maintenancewindow-editor -n default --create-namespace --version=v0.37.0 --values values.yaml
```
