...
$ helm repo update
$ helm search repo bytebuilders-ui/supervisorappscodecom-maintenancewindow-editor --version=v0.4.17
$ helm upgrade -i supervisorappscodecom-maintenancewindow-editor bytebuilders-ui/supervisorappscodecom-maintenancewindow-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i supervisorappscodecom-maintenancewindow-editor bytebuilders-ui/supervisorappscodecom-maintenancewindow-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=supervisor.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i supervisorappscodecom-maintenancewindow-editor bytebuilders-ui/supervisorappscodecom-maintenancewindow-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
