...
$ helm repo update
$ helm search repo appscode/supervisorappscodecom-maintenancewindow-editor --version=v0.15.0
$ helm upgrade -i supervisorappscodecom-maintenancewindow-editor appscode/supervisorappscodecom-maintenancewindow-editor -n default --create-namespace --version=v0.15.0
```
...
```bash
$ helm upgrade -i supervisorappscodecom-maintenancewindow-editor appscode/supervisorappscodecom-maintenancewindow-editor -n default --create-namespace --version=v0.15.0 --set apiVersion=supervisor.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i supervisorappscodecom-maintenancewindow-editor appscode/supervisorappscodecom-maintenancewindow-editor -n default --create-namespace --version=v0.15.0 --values values.yaml
```
