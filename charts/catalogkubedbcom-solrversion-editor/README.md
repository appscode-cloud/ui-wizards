...
$ helm repo update
$ helm search repo appscode/catalogkubedbcom-solrversion-editor --version=v0.22.0
$ helm upgrade -i catalogkubedbcom-solrversion-editor appscode/catalogkubedbcom-solrversion-editor -n default --create-namespace --version=v0.22.0
```
...
```bash
$ helm upgrade -i catalogkubedbcom-solrversion-editor appscode/catalogkubedbcom-solrversion-editor -n default --create-namespace --version=v0.22.0 --set apiVersion=catalog.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i catalogkubedbcom-solrversion-editor appscode/catalogkubedbcom-solrversion-editor -n default --create-namespace --version=v0.22.0 --values values.yaml
```
