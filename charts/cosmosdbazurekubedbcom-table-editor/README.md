...
$ helm repo update
$ helm search repo appscode-charts-oci/cosmosdbazurekubedbcom-table-editor --version=v0.4.21
$ helm upgrade -i cosmosdbazurekubedbcom-table-editor appscode-charts-oci/cosmosdbazurekubedbcom-table-editor -n default --create-namespace --version=v0.4.21
```
...
```bash
$ helm upgrade -i cosmosdbazurekubedbcom-table-editor appscode-charts-oci/cosmosdbazurekubedbcom-table-editor -n default --create-namespace --version=v0.4.21 --set apiVersion=cosmosdb.azure.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i cosmosdbazurekubedbcom-table-editor appscode-charts-oci/cosmosdbazurekubedbcom-table-editor -n default --create-namespace --version=v0.4.21 --values values.yaml
```
