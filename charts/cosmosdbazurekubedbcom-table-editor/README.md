...
$ helm repo update
$ helm search repo appscode/cosmosdbazurekubedbcom-table-editor --version=v0.33.0
$ helm upgrade -i cosmosdbazurekubedbcom-table-editor appscode/cosmosdbazurekubedbcom-table-editor -n default --create-namespace --version=v0.33.0
```
...
```bash
$ helm upgrade -i cosmosdbazurekubedbcom-table-editor appscode/cosmosdbazurekubedbcom-table-editor -n default --create-namespace --version=v0.33.0 --set apiVersion=cosmosdb.azure.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i cosmosdbazurekubedbcom-table-editor appscode/cosmosdbazurekubedbcom-table-editor -n default --create-namespace --version=v0.33.0 --values values.yaml
```
