...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/memorydbawskubeformcom-cluster-editor --version=v0.4.17
$ helm upgrade -i memorydbawskubeformcom-cluster-editor bytebuilders-ui-dev/memorydbawskubeformcom-cluster-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i memorydbawskubeformcom-cluster-editor bytebuilders-ui-dev/memorydbawskubeformcom-cluster-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=memorydb.aws.kubeform.com/v1alpha1
```
...
```bash
$ helm upgrade -i memorydbawskubeformcom-cluster-editor bytebuilders-ui-dev/memorydbawskubeformcom-cluster-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
