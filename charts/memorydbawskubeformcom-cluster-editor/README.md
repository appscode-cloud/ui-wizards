...
$ helm repo update
$ helm search repo bytebuilders-ui/memorydbawskubeformcom-cluster-editor --version=v0.4.18
$ helm upgrade -i memorydbawskubeformcom-cluster-editor bytebuilders-ui/memorydbawskubeformcom-cluster-editor -n default --create-namespace --version=v0.4.18
```
...
```bash
$ helm upgrade -i memorydbawskubeformcom-cluster-editor bytebuilders-ui/memorydbawskubeformcom-cluster-editor -n default --create-namespace --version=v0.4.18 --set apiVersion=memorydb.aws.kubeform.com/v1alpha1
```
...
```bash
$ helm upgrade -i memorydbawskubeformcom-cluster-editor bytebuilders-ui/memorydbawskubeformcom-cluster-editor -n default --create-namespace --version=v0.4.18 --values values.yaml
```
