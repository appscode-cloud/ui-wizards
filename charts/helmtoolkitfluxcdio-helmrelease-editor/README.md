...
$ helm repo update
$ helm search repo bytebuilders-ui/helmtoolkitfluxcdio-helmrelease-editor --version=v0.4.16
$ helm upgrade -i helmtoolkitfluxcdio-helmrelease-editor bytebuilders-ui/helmtoolkitfluxcdio-helmrelease-editor -n default --create-namespace --version=v0.4.16
```
...
```bash
$ helm upgrade -i helmtoolkitfluxcdio-helmrelease-editor bytebuilders-ui/helmtoolkitfluxcdio-helmrelease-editor -n default --create-namespace --version=v0.4.16 --set apiVersion=helm.toolkit.fluxcd.io/v2beta1
```
...
```bash
$ helm upgrade -i helmtoolkitfluxcdio-helmrelease-editor bytebuilders-ui/helmtoolkitfluxcdio-helmrelease-editor -n default --create-namespace --version=v0.4.16 --values values.yaml
```
