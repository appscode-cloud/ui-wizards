...
$ helm repo update
$ helm search repo appscode-charts-oci/helmtoolkitfluxcdio-helmrelease-editor --version=v0.5.0
$ helm upgrade -i helmtoolkitfluxcdio-helmrelease-editor appscode-charts-oci/helmtoolkitfluxcdio-helmrelease-editor -n default --create-namespace --version=v0.5.0
```
...
```bash
$ helm upgrade -i helmtoolkitfluxcdio-helmrelease-editor appscode-charts-oci/helmtoolkitfluxcdio-helmrelease-editor -n default --create-namespace --version=v0.5.0 --set apiVersion=helm.toolkit.fluxcd.io/v2
```
...
```bash
$ helm upgrade -i helmtoolkitfluxcdio-helmrelease-editor appscode-charts-oci/helmtoolkitfluxcdio-helmrelease-editor -n default --create-namespace --version=v0.5.0 --values values.yaml
```
