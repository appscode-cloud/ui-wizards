...
$ helm repo update
$ helm search repo bytebuilders-ui/docdbawskubeformcom-clusterinstance-editor --version=v0.4.18
$ helm upgrade -i docdbawskubeformcom-clusterinstance-editor bytebuilders-ui/docdbawskubeformcom-clusterinstance-editor -n default --create-namespace --version=v0.4.18
```
...
```bash
$ helm upgrade -i docdbawskubeformcom-clusterinstance-editor bytebuilders-ui/docdbawskubeformcom-clusterinstance-editor -n default --create-namespace --version=v0.4.18 --set apiVersion=docdb.aws.kubeform.com/v1alpha1
```
...
```bash
$ helm upgrade -i docdbawskubeformcom-clusterinstance-editor bytebuilders-ui/docdbawskubeformcom-clusterinstance-editor -n default --create-namespace --version=v0.4.18 --values values.yaml
```
