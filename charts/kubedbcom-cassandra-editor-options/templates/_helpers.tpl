...
*/}}
{{- define "kubedbcom-cassandra-editor-options.name" -}}
...
*/}}
{{- define "kubedbcom-cassandra-editor-options.fullname" -}}
...
*/}}
{{- define "kubedbcom-cassandra-editor-options.chart" -}}
...
Common labels
*/}}
{{- define "kubedbcom-cassandra-editor-options.labels" -}}
{{ include "kubedbcom-cassandra-editor-options.selectorLabels" . }}
...
Selector labels
*/}}
{{- define "kubedbcom-cassandra-editor-options.selectorLabels" -}}
app.kubernetes.io/name: cassandras.kubedb.com
app.kubernetes.io/instance: {{ include "kubedbcom-cassandra-editor-options.fullname" . }}
{{- end }}

{{/*
Create the name of the service account to use
*/}}
{{- define "kubedbcom-cassandra-editor-options.serviceAccountName" -}}
{{- if .Values.spec.serviceAccount.create }}
{{- default (include "kubedbcom-cassandra-editor-options.fullname" .) .Values.spec.serviceAccount.name }}
{{- else }}
...
Common annotations
*/}}
{{- define "kubedbcom-cassandra-editor-options.annotations" -}}
...
Alert labels
*/}}
{{- define "kubedbcom-cassandra-editor-options.alertLabels" -}}
...
Alert Enabled
*/}}
{{- define "kubedbcom-cassandra-editor-options.alertEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
