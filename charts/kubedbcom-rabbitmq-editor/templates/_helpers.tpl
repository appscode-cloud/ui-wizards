...
*/}}
{{- define "kubedbcom-rabbitmq-editor.name" -}}
...
*/}}
{{- define "kubedbcom-rabbitmq-editor.fullname" -}}
...
*/}}
{{- define "kubedbcom-rabbitmq-editor.chart" -}}
...
Alert Enabled
*/}}
{{- define "kubedbcom-rabbitmq-editor.alertEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
