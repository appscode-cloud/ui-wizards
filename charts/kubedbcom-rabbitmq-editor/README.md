...
$ helm repo update
$ helm search repo appscode/kubedbcom-rabbitmq-editor --version=v0.35.0
$ helm upgrade -i kubedbcom-rabbitmq-editor appscode/kubedbcom-rabbitmq-editor -n default --create-namespace --version=v0.35.0
```
...
```bash
$ helm upgrade -i kubedbcom-rabbitmq-editor appscode/kubedbcom-rabbitmq-editor -n default --create-namespace --version=v0.35.0 --values values.yaml
```
