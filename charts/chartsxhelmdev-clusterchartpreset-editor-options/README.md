...
$ helm repo update
$ helm search repo appscode/chartsxhelmdev-clusterchartpreset-editor-options --version=v0.37.0
$ helm upgrade -i chartsxhelmdev-clusterchartpreset-editor-options appscode/chartsxhelmdev-clusterchartpreset-editor-options -n kube-system --create-namespace --version=v0.37.0
```
...
| spec.admin.serviceTemplates                      | Default service templates offered by the preset, keyed by alias.                                     | <code>[]</code>                                                                       |
...
| spec.admin.monitoring.serviceMonitor.interval    | Scrape interval for the generated ServiceMonitor.                                                    | <code>30s</code>                                                                      |
| spec.admin.monitoring.serviceMonitor.labels      | Labels used by Prometheus to select the generated ServiceMonitor.                                    | <code>{}</code>                                                                       |
| spec.admin.monitoring.serviceMonitor.endpoints   | Scrape endpoints, each with optional relabeling rules.                                               | <code>[]</code>                                                                       |
...
```bash
$ helm upgrade -i chartsxhelmdev-clusterchartpreset-editor-options appscode/chartsxhelmdev-clusterchartpreset-editor-options -n kube-system --create-namespace --version=v0.37.0 --set metadata.resource.group=charts.x-helm.dev
```
...
```bash
$ helm upgrade -i chartsxhelmdev-clusterchartpreset-editor-options appscode/chartsxhelmdev-clusterchartpreset-editor-options -n kube-system --create-namespace --version=v0.37.0 --values values.yaml
```
