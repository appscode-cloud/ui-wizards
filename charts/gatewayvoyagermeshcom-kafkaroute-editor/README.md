...
$ helm repo update
$ helm search repo appscode-charts-oci/gatewayvoyagermeshcom-kafkaroute-editor --version=v0.12.0
$ helm upgrade -i gatewayvoyagermeshcom-kafkaroute-editor appscode-charts-oci/gatewayvoyagermeshcom-kafkaroute-editor -n default --create-namespace --version=v0.12.0
```
...
```bash
$ helm upgrade -i gatewayvoyagermeshcom-kafkaroute-editor appscode-charts-oci/gatewayvoyagermeshcom-kafkaroute-editor -n default --create-namespace --version=v0.12.0 --set apiVersion=gateway.voyagermesh.com/v1alpha1
```
...
```bash
$ helm upgrade -i gatewayvoyagermeshcom-kafkaroute-editor appscode-charts-oci/gatewayvoyagermeshcom-kafkaroute-editor -n default --create-namespace --version=v0.12.0 --values values.yaml
```
