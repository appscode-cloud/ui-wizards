...
$ helm repo update
$ helm search repo bytebuilders-ui/gatewayvoyagermeshcom-kafkaroute-editor --version=v0.4.16
$ helm upgrade -i gatewayvoyagermeshcom-kafkaroute-editor bytebuilders-ui/gatewayvoyagermeshcom-kafkaroute-editor -n default --create-namespace --version=v0.4.16
```
...
```bash
$ helm upgrade -i gatewayvoyagermeshcom-kafkaroute-editor bytebuilders-ui/gatewayvoyagermeshcom-kafkaroute-editor -n default --create-namespace --version=v0.4.16 --set apiVersion=gateway.voyagermesh.com/v1alpha1
```
...
```bash
$ helm upgrade -i gatewayvoyagermeshcom-kafkaroute-editor bytebuilders-ui/gatewayvoyagermeshcom-kafkaroute-editor -n default --create-namespace --version=v0.4.16 --values values.yaml
```
