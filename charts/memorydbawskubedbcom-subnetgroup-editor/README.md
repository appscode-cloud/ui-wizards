...
$ helm repo update
$ helm search repo appscode-charts-oci/memorydbawskubedbcom-subnetgroup-editor --version=v0.4.19
$ helm upgrade -i memorydbawskubedbcom-subnetgroup-editor appscode-charts-oci/memorydbawskubedbcom-subnetgroup-editor -n default --create-namespace --version=v0.4.19
```
...
```bash
$ helm upgrade -i memorydbawskubedbcom-subnetgroup-editor appscode-charts-oci/memorydbawskubedbcom-subnetgroup-editor -n default --create-namespace --version=v0.4.19 --set apiVersion=memorydb.aws.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i memorydbawskubedbcom-subnetgroup-editor appscode-charts-oci/memorydbawskubedbcom-subnetgroup-editor -n default --create-namespace --version=v0.4.19 --values values.yaml
```
