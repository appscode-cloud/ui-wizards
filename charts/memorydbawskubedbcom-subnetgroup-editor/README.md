...
$ helm repo update
$ helm search repo appscode-charts-oci/memorydbawskubedbcom-subnetgroup-editor --version=v0.4.18
$ helm upgrade -i memorydbawskubedbcom-subnetgroup-editor appscode-charts-oci/memorydbawskubedbcom-subnetgroup-editor -n default --create-namespace --version=v0.4.18
```
...
```bash
$ helm upgrade -i memorydbawskubedbcom-subnetgroup-editor appscode-charts-oci/memorydbawskubedbcom-subnetgroup-editor -n default --create-namespace --version=v0.4.18 --set apiVersion=memorydb.aws.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i memorydbawskubedbcom-subnetgroup-editor appscode-charts-oci/memorydbawskubedbcom-subnetgroup-editor -n default --create-namespace --version=v0.4.18 --values values.yaml
```
