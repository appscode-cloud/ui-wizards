...
$ helm repo update
$ helm search repo appscode-charts-oci/memorydbawskubedbcom-subnetgroup-editor --version=v0.12.0
$ helm upgrade -i memorydbawskubedbcom-subnetgroup-editor appscode-charts-oci/memorydbawskubedbcom-subnetgroup-editor -n default --create-namespace --version=v0.12.0
```
...
```bash
$ helm upgrade -i memorydbawskubedbcom-subnetgroup-editor appscode-charts-oci/memorydbawskubedbcom-subnetgroup-editor -n default --create-namespace --version=v0.12.0 --set apiVersion=memorydb.aws.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i memorydbawskubedbcom-subnetgroup-editor appscode-charts-oci/memorydbawskubedbcom-subnetgroup-editor -n default --create-namespace --version=v0.12.0 --values values.yaml
```
