...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/nodek8sio-runtimeclass-editor --version=v0.4.17
$ helm upgrade -i nodek8sio-runtimeclass-editor bytebuilders-ui-dev/nodek8sio-runtimeclass-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i nodek8sio-runtimeclass-editor bytebuilders-ui-dev/nodek8sio-runtimeclass-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=node.k8s.io/v1
```
...
```bash
$ helm upgrade -i nodek8sio-runtimeclass-editor bytebuilders-ui-dev/nodek8sio-runtimeclass-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
