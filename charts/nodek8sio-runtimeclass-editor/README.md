...
$ helm repo update
$ helm search repo appscode/nodek8sio-runtimeclass-editor --version=v0.16.0
$ helm upgrade -i nodek8sio-runtimeclass-editor appscode/nodek8sio-runtimeclass-editor -n default --create-namespace --version=v0.16.0
```
...
```bash
$ helm upgrade -i nodek8sio-runtimeclass-editor appscode/nodek8sio-runtimeclass-editor -n default --create-namespace --version=v0.16.0 --set apiVersion=node.k8s.io/v1
```
...
```bash
$ helm upgrade -i nodek8sio-runtimeclass-editor appscode/nodek8sio-runtimeclass-editor -n default --create-namespace --version=v0.16.0 --values values.yaml
```
