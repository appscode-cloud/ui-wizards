...
$ helm repo update
$ helm search repo appscode-charts-oci/gatewaycatalogappscodecom-gatewaypreset-editor --version=v0.13.0
$ helm upgrade -i gatewaycatalogappscodecom-gatewaypreset-editor appscode-charts-oci/gatewaycatalogappscodecom-gatewaypreset-editor -n default --create-namespace --version=v0.13.0
```
...
```bash
$ helm upgrade -i gatewaycatalogappscodecom-gatewaypreset-editor appscode-charts-oci/gatewaycatalogappscodecom-gatewaypreset-editor -n default --create-namespace --version=v0.13.0 --set apiVersion=gateway.catalog.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i gatewaycatalogappscodecom-gatewaypreset-editor appscode-charts-oci/gatewaycatalogappscodecom-gatewaypreset-editor -n default --create-namespace --version=v0.13.0 --values values.yaml
```
