...
$ helm repo update
$ helm search repo bytebuilders-ui/metak8sappscodecom-resourceeditor-editor --version=v0.4.6
$ helm upgrade -i metak8sappscodecom-resourceeditor-editor bytebuilders-ui/metak8sappscodecom-resourceeditor-editor -n default --create-namespace --version=v0.4.6
```
...
```bash
$ helm upgrade -i metak8sappscodecom-resourceeditor-editor bytebuilders-ui/metak8sappscodecom-resourceeditor-editor -n default --create-namespace --version=v0.4.6 --set apiVersion=meta.k8s.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i metak8sappscodecom-resourceeditor-editor bytebuilders-ui/metak8sappscodecom-resourceeditor-editor -n default --create-namespace --version=v0.4.6 --values values.yaml
```
