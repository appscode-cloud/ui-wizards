...
$ helm repo update
$ helm search repo appscode/kafkakubedbcom-restproxy-editor --version=v0.37.0
$ helm upgrade -i kafkakubedbcom-restproxy-editor appscode/kafkakubedbcom-restproxy-editor -n default --create-namespace --version=v0.37.0
```
...
```bash
$ helm upgrade -i kafkakubedbcom-restproxy-editor appscode/kafkakubedbcom-restproxy-editor -n default --create-namespace --version=v0.37.0 --set apiVersion=kafka.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i kafkakubedbcom-restproxy-editor appscode/kafkakubedbcom-restproxy-editor -n default --create-namespace --version=v0.37.0 --values values.yaml
```
