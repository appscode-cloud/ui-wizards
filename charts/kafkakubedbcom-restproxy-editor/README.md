...
$ helm repo update
$ helm search repo appscode-charts-oci/kafkakubedbcom-restproxy-editor --version=v0.6.0
$ helm upgrade -i kafkakubedbcom-restproxy-editor appscode-charts-oci/kafkakubedbcom-restproxy-editor -n default --create-namespace --version=v0.6.0
```
...
```bash
$ helm upgrade -i kafkakubedbcom-restproxy-editor appscode-charts-oci/kafkakubedbcom-restproxy-editor -n default --create-namespace --version=v0.6.0 --set apiVersion=kafka.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i kafkakubedbcom-restproxy-editor appscode-charts-oci/kafkakubedbcom-restproxy-editor -n default --create-namespace --version=v0.6.0 --values values.yaml
```
