...
$ helm repo update
$ helm search repo appscode-charts-oci/storageazurekubedbcom-account-editor --version=v0.11.0
...
```bash
$ helm upgrade -i storageazurekubedbcom-account-editor appscode-charts-oci/storageazurekubedbcom-account-editor -n default --create-namespace --version=v0.11.0 --set apiVersion=storage.azure.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i storageazurekubedbcom-account-editor appscode-charts-oci/storageazurekubedbcom-account-editor -n default --create-namespace --version=v0.11.0 --values values.yaml
```
