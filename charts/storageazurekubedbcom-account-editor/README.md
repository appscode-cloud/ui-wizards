...
$ helm repo update
$ helm search repo appscode/storageazurekubedbcom-account-editor --version=v0.26.0
$ helm upgrade -i storageazurekubedbcom-account-editor appscode/storageazurekubedbcom-account-editor -n default --create-namespace --version=v0.26.0
```
...
```bash
$ helm upgrade -i storageazurekubedbcom-account-editor appscode/storageazurekubedbcom-account-editor -n default --create-namespace --version=v0.26.0 --set apiVersion=storage.azure.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i storageazurekubedbcom-account-editor appscode/storageazurekubedbcom-account-editor -n default --create-namespace --version=v0.26.0 --values values.yaml
```
