...
$ helm repo update
$ helm search repo bytebuilders-ui/clusteropenclustermanagementio-managedclustersetbinding-editor --version=v0.4.17
$ helm upgrade -i clusteropenclustermanagementio-managedclustersetbinding-editor bytebuilders-ui/clusteropenclustermanagementio-managedclustersetbinding-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i clusteropenclustermanagementio-managedclustersetbinding-editor bytebuilders-ui/clusteropenclustermanagementio-managedclustersetbinding-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=cluster.open-cluster-management.io/v1beta2
```
...
```bash
$ helm upgrade -i clusteropenclustermanagementio-managedclustersetbinding-editor bytebuilders-ui/clusteropenclustermanagementio-managedclustersetbinding-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
