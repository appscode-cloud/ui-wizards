...
$ helm repo update
$ helm search repo appscode/dbforpostgresqlazurekubedbcom-database-editor --version=v0.37.0
$ helm upgrade -i dbforpostgresqlazurekubedbcom-database-editor appscode/dbforpostgresqlazurekubedbcom-database-editor -n default --create-namespace --version=v0.37.0
```
...
```bash
$ helm upgrade -i dbforpostgresqlazurekubedbcom-database-editor appscode/dbforpostgresqlazurekubedbcom-database-editor -n default --create-namespace --version=v0.37.0 --set apiVersion=dbforpostgresql.azure.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i dbforpostgresqlazurekubedbcom-database-editor appscode/dbforpostgresqlazurekubedbcom-database-editor -n default --create-namespace --version=v0.37.0 --values values.yaml
```
