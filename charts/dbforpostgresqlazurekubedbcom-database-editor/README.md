...
$ helm repo update
$ helm search repo appscode-charts-oci/dbforpostgresqlazurekubedbcom-database-editor --version=v0.4.21
$ helm upgrade -i dbforpostgresqlazurekubedbcom-database-editor appscode-charts-oci/dbforpostgresqlazurekubedbcom-database-editor -n default --create-namespace --version=v0.4.21
```
...
```bash
$ helm upgrade -i dbforpostgresqlazurekubedbcom-database-editor appscode-charts-oci/dbforpostgresqlazurekubedbcom-database-editor -n default --create-namespace --version=v0.4.21 --set apiVersion=dbforpostgresql.azure.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i dbforpostgresqlazurekubedbcom-database-editor appscode-charts-oci/dbforpostgresqlazurekubedbcom-database-editor -n default --create-namespace --version=v0.4.21 --values values.yaml
```
