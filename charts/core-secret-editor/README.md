...
$ helm repo update
$ helm search repo appscode/core-secret-editor --version=v0.19.0
$ helm upgrade -i core-secret-editor appscode/core-secret-editor -n default --create-namespace --version=v0.19.0
```
...
```bash
$ helm upgrade -i core-secret-editor appscode/core-secret-editor -n default --create-namespace --version=v0.19.0 --set apiVersion=v1
```
...
```bash
$ helm upgrade -i core-secret-editor appscode/core-secret-editor -n default --create-namespace --version=v0.19.0 --values values.yaml
```
