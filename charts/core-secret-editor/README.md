...
$ helm repo update
$ helm search repo appscode-charts-oci/core-secret-editor --version=v0.4.20
$ helm upgrade -i core-secret-editor appscode-charts-oci/core-secret-editor -n default --create-namespace --version=v0.4.20
```
...
```bash
$ helm upgrade -i core-secret-editor appscode-charts-oci/core-secret-editor -n default --create-namespace --version=v0.4.20 --set apiVersion=v1
```
...
```bash
$ helm upgrade -i core-secret-editor appscode-charts-oci/core-secret-editor -n default --create-namespace --version=v0.4.20 --values values.yaml
```
