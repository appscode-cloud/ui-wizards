...
$ helm repo update
$ helm search repo bytebuilders-ui/core-secret-editor --version=v0.4.1
$ helm upgrade -i core-secret-editor bytebuilders-ui/core-secret-editor -n default --create-namespace --version=v0.4.1
```
...
```bash
$ helm upgrade -i core-secret-editor bytebuilders-ui/core-secret-editor -n default --create-namespace --version=v0.4.1 --set apiVersion=v1
```
...
```bash
$ helm upgrade -i core-secret-editor bytebuilders-ui/core-secret-editor -n default --create-namespace --version=v0.4.1 --values values.yaml
```
