...
$ helm repo update
$ helm search repo bytebuilders-ui/core-secret-editor --version=v0.4.4
$ helm upgrade -i core-secret-editor bytebuilders-ui/core-secret-editor -n default --create-namespace --version=v0.4.4
```
...
```bash
$ helm upgrade -i core-secret-editor bytebuilders-ui/core-secret-editor -n default --create-namespace --version=v0.4.4 --set apiVersion=v1
```
...
```bash
$ helm upgrade -i core-secret-editor bytebuilders-ui/core-secret-editor -n default --create-namespace --version=v0.4.4 --values values.yaml
```
