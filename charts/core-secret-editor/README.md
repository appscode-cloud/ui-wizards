...
$ helm repo update
$ helm install core-secret-editor bytebuilders-ui-dev/core-secret-editor -n default
```
...
```console
$ helm install core-secret-editor bytebuilders-ui-dev/core-secret-editor -n default --set apiVersion=/v1
```
...
```console
$ helm install core-secret-editor bytebuilders-ui-dev/core-secret-editor -n default --values values.yaml
```
