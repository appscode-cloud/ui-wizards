...
$ helm repo update
$ helm search repo appscode/kubedbcom-milvus-editor --version=v0.35.0
$ helm upgrade -i kubedbcom-milvus-editor appscode/kubedbcom-milvus-editor -n default --create-namespace --version=v0.35.0
```
...
| form.alert.groups.database.rules.milvusHighProcessMemoryUsage.val      |             | <code>8e+08</code>                                                                                                                      |
...
```bash
$ helm upgrade -i kubedbcom-milvus-editor appscode/kubedbcom-milvus-editor -n default --create-namespace --version=v0.35.0 --values values.yaml
```
