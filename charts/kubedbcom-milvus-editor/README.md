...
$ helm repo update
$ helm search repo appscode/kubedbcom-milvus-editor --version=v0.36.0
$ helm upgrade -i kubedbcom-milvus-editor appscode/kubedbcom-milvus-editor -n default --create-namespace --version=v0.36.0
```
...
```bash
$ helm upgrade -i kubedbcom-milvus-editor appscode/kubedbcom-milvus-editor -n default --create-namespace --version=v0.36.0 --values values.yaml
```
