...
*/}}
{{- define "kubedbcom-milvus-editor.name" -}}
...
*/}}
{{- define "kubedbcom-milvus-editor.fullname" -}}
...
*/}}
{{- define "kubedbcom-milvus-editor.chart" -}}
...
Common labels
*/}}
{{- define "kubedbcom-milvus-editor.labels" -}}
{{ include "kubedbcom-milvus-editor.selectorLabels" . }}
...
Selector labels
*/}}
{{- define "kubedbcom-milvus-editor.selectorLabels" -}}
app.kubernetes.io/name: milvuss.kubedb.com
app.kubernetes.io/instance: {{ include "kubedbcom-milvus-editor.fullname" . }}
{{- end }}

{{/*
Create the name of the service account to use
*/}}
{{- define "kubedbcom-milvus-editor.serviceAccountName" -}}
{{- if .Values.spec.serviceAccount.create }}
{{- default (include "kubedbcom-milvus-editor.fullname" .) .Values.spec.serviceAccount.name }}
{{- else }}
...
Common annotations
*/}}
{{- define "kubedbcom-milvus-editor.annotations" -}}
...
Alert Enabled
*/}}
{{- define "kubedbcom-milvus-editor.alertEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
{{- $key := mustLast . -}}
{{- $rest := mustInitial . -}}
{{- $rules := mustLast $rest -}}
