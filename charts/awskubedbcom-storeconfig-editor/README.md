...
$ helm repo update
$ helm search repo appscode-charts-oci/awskubedbcom-storeconfig-editor --version=v0.13.0
$ helm upgrade -i awskubedbcom-storeconfig-editor appscode-charts-oci/awskubedbcom-storeconfig-editor -n default --create-namespace --version=v0.13.0
```
...
```bash
$ helm upgrade -i awskubedbcom-storeconfig-editor appscode-charts-oci/awskubedbcom-storeconfig-editor -n default --create-namespace --version=v0.13.0 --set apiVersion=aws.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i awskubedbcom-storeconfig-editor appscode-charts-oci/awskubedbcom-storeconfig-editor -n default --create-namespace --version=v0.13.0 --values values.yaml
```
