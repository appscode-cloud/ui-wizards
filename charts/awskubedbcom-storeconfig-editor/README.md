...
$ helm repo update
$ helm search repo appscode/awskubedbcom-storeconfig-editor --version=v0.25.0
$ helm upgrade -i awskubedbcom-storeconfig-editor appscode/awskubedbcom-storeconfig-editor -n default --create-namespace --version=v0.25.0
```
...
```bash
$ helm upgrade -i awskubedbcom-storeconfig-editor appscode/awskubedbcom-storeconfig-editor -n default --create-namespace --version=v0.25.0 --set apiVersion=aws.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i awskubedbcom-storeconfig-editor appscode/awskubedbcom-storeconfig-editor -n default --create-namespace --version=v0.25.0 --values values.yaml
```
