...
$ helm repo update
$ helm search repo appscode-charts-oci/azurekubedbcom-providerregistration-editor --version=v0.14.0
$ helm upgrade -i azurekubedbcom-providerregistration-editor appscode-charts-oci/azurekubedbcom-providerregistration-editor -n default --create-namespace --version=v0.14.0
```
...
```bash
$ helm upgrade -i azurekubedbcom-providerregistration-editor appscode-charts-oci/azurekubedbcom-providerregistration-editor -n default --create-namespace --version=v0.14.0 --set apiVersion=azure.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i azurekubedbcom-providerregistration-editor appscode-charts-oci/azurekubedbcom-providerregistration-editor -n default --create-namespace --version=v0.14.0 --values values.yaml
```
