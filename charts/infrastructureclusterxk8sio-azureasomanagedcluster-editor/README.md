# AzureASOManagedCluster Editor

[AzureASOManagedCluster Editor by AppsCode](https://byte.builders) - AzureASOManagedCluster Editor
...
$ helm repo update
$ helm search repo appscode-charts-oci/infrastructureclusterxk8sio-azureasomanagedcluster-editor --version=v0.4.21
$ helm upgrade -i infrastructureclusterxk8sio-azureasomanagedcluster-editor appscode-charts-oci/infrastructureclusterxk8sio-azureasomanagedcluster-editor -n default --create-namespace --version=v0.4.21
```
...
```bash
$ helm upgrade -i infrastructureclusterxk8sio-azureasomanagedcluster-editor appscode-charts-oci/infrastructureclusterxk8sio-azureasomanagedcluster-editor -n default --create-namespace --version=v0.4.21 --set apiVersion=infrastructure.cluster.x-k8s.io/v1alpha1
```
...
```bash
$ helm upgrade -i infrastructureclusterxk8sio-azureasomanagedcluster-editor appscode-charts-oci/infrastructureclusterxk8sio-azureasomanagedcluster-editor -n default --create-namespace --version=v0.4.21 --values values.yaml
```
