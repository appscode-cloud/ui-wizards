...
$ helm repo update
$ helm search repo appscode-charts-oci/storagekubestashcom-repository-editor --version=v0.12.0
$ helm upgrade -i storagekubestashcom-repository-editor appscode-charts-oci/storagekubestashcom-repository-editor -n default --create-namespace --version=v0.12.0
```
...
```bash
$ helm upgrade -i storagekubestashcom-repository-editor appscode-charts-oci/storagekubestashcom-repository-editor -n default --create-namespace --version=v0.12.0 --set metadata.resource.group=storage.kubestash.com
```
...
```bash
$ helm upgrade -i storagekubestashcom-repository-editor appscode-charts-oci/storagekubestashcom-repository-editor -n default --create-namespace --version=v0.12.0 --values values.yaml
```
