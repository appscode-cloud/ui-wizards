...
$ helm repo update
$ helm search repo appscode-charts-oci/storagekubestashcom-repository-editor --version=v0.4.19
$ helm upgrade -i storagekubestashcom-repository-editor appscode-charts-oci/storagekubestashcom-repository-editor -n default --create-namespace --version=v0.4.19
```
...
```bash
$ helm upgrade -i storagekubestashcom-repository-editor appscode-charts-oci/storagekubestashcom-repository-editor -n default --create-namespace --version=v0.4.19 --set apiVersion=storage.kubestash.com/v1alpha1
```
...
```bash
$ helm upgrade -i storagekubestashcom-repository-editor appscode-charts-oci/storagekubestashcom-repository-editor -n default --create-namespace --version=v0.4.19 --values values.yaml
```
