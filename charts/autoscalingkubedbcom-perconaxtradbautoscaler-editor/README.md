...
$ helm repo update
$ helm install autoscalingkubedbcom-perconaxtradbautoscaler-editor bytebuilders-ui-dev/autoscalingkubedbcom-perconaxtradbautoscaler-editor -n default
```
...
```console
$ helm install autoscalingkubedbcom-perconaxtradbautoscaler-editor bytebuilders-ui-dev/autoscalingkubedbcom-perconaxtradbautoscaler-editor -n default --set apiVersion=autoscaling.kubedb.com/v1alpha1
```
...
```console
$ helm install autoscalingkubedbcom-perconaxtradbautoscaler-editor bytebuilders-ui-dev/autoscalingkubedbcom-perconaxtradbautoscaler-editor -n default --values values.yaml
```
