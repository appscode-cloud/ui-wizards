...
$ helm repo update
$ helm search repo appscode-charts-oci/catalogappscodecom-mssqlserverbinding-editor --version=v0.4.21
$ helm upgrade -i catalogappscodecom-mssqlserverbinding-editor appscode-charts-oci/catalogappscodecom-mssqlserverbinding-editor -n default --create-namespace --version=v0.4.21
```
...
```bash
$ helm upgrade -i catalogappscodecom-mssqlserverbinding-editor appscode-charts-oci/catalogappscodecom-mssqlserverbinding-editor -n default --create-namespace --version=v0.4.21 --set apiVersion=catalog.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i catalogappscodecom-mssqlserverbinding-editor appscode-charts-oci/catalogappscodecom-mssqlserverbinding-editor -n default --create-namespace --version=v0.4.21 --values values.yaml
```
