...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/uikubedbcom-pgbouncerpooloverview-editor --version=v0.4.17
$ helm upgrade -i uikubedbcom-pgbouncerpooloverview-editor bytebuilders-ui-dev/uikubedbcom-pgbouncerpooloverview-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i uikubedbcom-pgbouncerpooloverview-editor bytebuilders-ui-dev/uikubedbcom-pgbouncerpooloverview-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=ui.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i uikubedbcom-pgbouncerpooloverview-editor bytebuilders-ui-dev/uikubedbcom-pgbouncerpooloverview-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
