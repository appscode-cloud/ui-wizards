...
$ helm repo update
$ helm search repo appscode-charts-oci/memorydbawskubedbcom-acl-editor --version=v0.4.19
$ helm upgrade -i memorydbawskubedbcom-acl-editor appscode-charts-oci/memorydbawskubedbcom-acl-editor -n default --create-namespace --version=v0.4.19
```
...
```bash
$ helm upgrade -i memorydbawskubedbcom-acl-editor appscode-charts-oci/memorydbawskubedbcom-acl-editor -n default --create-namespace --version=v0.4.19 --set apiVersion=memorydb.aws.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i memorydbawskubedbcom-acl-editor appscode-charts-oci/memorydbawskubedbcom-acl-editor -n default --create-namespace --version=v0.4.19 --values values.yaml
```
