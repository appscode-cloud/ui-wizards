...
$ helm repo update
$ helm search repo appscode/admissionregistrationk8sio-mutatingwebhookconfiguration-editor --version=v0.16.0
$ helm upgrade -i admissionregistrationk8sio-mutatingwebhookconfiguration-editor appscode/admissionregistrationk8sio-mutatingwebhookconfiguration-editor -n default --create-namespace --version=v0.16.0
```
...
```bash
$ helm upgrade -i admissionregistrationk8sio-mutatingwebhookconfiguration-editor appscode/admissionregistrationk8sio-mutatingwebhookconfiguration-editor -n default --create-namespace --version=v0.16.0 --set apiVersion=admissionregistration.k8s.io/v1
```
...
```bash
$ helm upgrade -i admissionregistrationk8sio-mutatingwebhookconfiguration-editor appscode/admissionregistrationk8sio-mutatingwebhookconfiguration-editor -n default --create-namespace --version=v0.16.0 --values values.yaml
```
