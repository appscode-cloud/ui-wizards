...
*/}}
{{- define "kubedbcom-documentdb-editor-options.name" -}}
...
*/}}
{{- define "kubedbcom-documentdb-editor-options.fullname" -}}
...
*/}}
{{- define "kubedbcom-documentdb-editor-options.chart" -}}
...
Common labels
*/}}
{{- define "kubedbcom-documentdb-editor-options.labels" -}}
{{ include "kubedbcom-documentdb-editor-options.selectorLabels" . }}
...
Selector labels
*/}}
{{- define "kubedbcom-documentdb-editor-options.selectorLabels" -}}
app.kubernetes.io/name: documentdbs.kubedb.com
app.kubernetes.io/instance: {{ include "kubedbcom-documentdb-editor-options.fullname" . }}
{{- end }}

{{/*
Create the name of the service account to use
*/}}
{{- define "kubedbcom-documentdb-editor-options.serviceAccountName" -}}
{{- if .Values.spec.serviceAccount.create }}
{{- default (include "kubedbcom-documentdb-editor-options.fullname" .) .Values.spec.serviceAccount.name }}
{{- else }}
...
Common annotations
*/}}
{{- define "kubedbcom-documentdb-editor-options.annotations" -}}
