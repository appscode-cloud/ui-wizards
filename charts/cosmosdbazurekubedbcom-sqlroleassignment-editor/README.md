...
$ helm repo update
$ helm search repo appscode/cosmosdbazurekubedbcom-sqlroleassignment-editor --version=v0.36.0
$ helm upgrade -i cosmosdbazurekubedbcom-sqlroleassignment-editor appscode/cosmosdbazurekubedbcom-sqlroleassignment-editor -n default --create-namespace --version=v0.36.0
```
...
```bash
$ helm upgrade -i cosmosdbazurekubedbcom-sqlroleassignment-editor appscode/cosmosdbazurekubedbcom-sqlroleassignment-editor -n default --create-namespace --version=v0.36.0 --set apiVersion=cosmosdb.azure.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i cosmosdbazurekubedbcom-sqlroleassignment-editor appscode/cosmosdbazurekubedbcom-sqlroleassignment-editor -n default --create-namespace --version=v0.36.0 --values values.yaml
```
