...
$ helm repo update
$ helm search repo appscode-charts-oci/autoscalingkubedbcom-proxysqlautoscaler-editor --version=v0.6.0
$ helm upgrade -i autoscalingkubedbcom-proxysqlautoscaler-editor appscode-charts-oci/autoscalingkubedbcom-proxysqlautoscaler-editor -n default --create-namespace --version=v0.6.0
```
...
```bash
$ helm upgrade -i autoscalingkubedbcom-proxysqlautoscaler-editor appscode-charts-oci/autoscalingkubedbcom-proxysqlautoscaler-editor -n default --create-namespace --version=v0.6.0 --set apiVersion=autoscaling.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i autoscalingkubedbcom-proxysqlautoscaler-editor appscode-charts-oci/autoscalingkubedbcom-proxysqlautoscaler-editor -n default --create-namespace --version=v0.6.0 --values values.yaml
```
