...
$ helm repo update
$ helm search repo appscode-charts-oci/mutationsgatekeepersh-assignmetadata-editor --version=v0.12.0
$ helm upgrade -i mutationsgatekeepersh-assignmetadata-editor appscode-charts-oci/mutationsgatekeepersh-assignmetadata-editor -n default --create-namespace --version=v0.12.0
```
...
```bash
$ helm upgrade -i mutationsgatekeepersh-assignmetadata-editor appscode-charts-oci/mutationsgatekeepersh-assignmetadata-editor -n default --create-namespace --version=v0.12.0 --set apiVersion=mutations.gatekeeper.sh/v1
```
...
```bash
$ helm upgrade -i mutationsgatekeepersh-assignmetadata-editor appscode-charts-oci/mutationsgatekeepersh-assignmetadata-editor -n default --create-namespace --version=v0.12.0 --values values.yaml
```
