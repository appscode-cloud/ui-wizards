...
$ helm repo update
$ helm search repo bytebuilders-ui/mutationsgatekeepersh-assignmetadata-editor --version=v0.4.15
$ helm upgrade -i mutationsgatekeepersh-assignmetadata-editor bytebuilders-ui/mutationsgatekeepersh-assignmetadata-editor -n default --create-namespace --version=v0.4.15
```
...
```bash
$ helm upgrade -i mutationsgatekeepersh-assignmetadata-editor bytebuilders-ui/mutationsgatekeepersh-assignmetadata-editor -n default --create-namespace --version=v0.4.15 --set apiVersion=mutations.gatekeeper.sh/v1
```
...
```bash
$ helm upgrade -i mutationsgatekeepersh-assignmetadata-editor bytebuilders-ui/mutationsgatekeepersh-assignmetadata-editor -n default --create-namespace --version=v0.4.15 --values values.yaml
```
