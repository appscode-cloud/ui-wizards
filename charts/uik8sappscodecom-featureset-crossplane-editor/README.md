...
$ helm repo update
$ helm search repo appscode-charts-oci/uik8sappscodecom-featureset-crossplane-editor --version=v0.4.18
$ helm upgrade -i uik8sappscodecom-featureset-crossplane-editor appscode-charts-oci/uik8sappscodecom-featureset-crossplane-editor -n default --create-namespace --version=v0.4.18
```
...
```bash
$ helm upgrade -i uik8sappscodecom-featureset-crossplane-editor appscode-charts-oci/uik8sappscodecom-featureset-crossplane-editor -n default --create-namespace --version=v0.4.18 --values values.yaml
```
