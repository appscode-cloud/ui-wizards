...
*/}}
{{- define "kubedbcom-qdrant-editor-options.name" -}}
...
*/}}
{{- define "kubedbcom-qdrant-editor-options.fullname" -}}
...
*/}}
{{- define "kubedbcom-qdrant-editor-options.chart" -}}
...
Common labels
*/}}
{{- define "kubedbcom-qdrant-editor-options.labels" -}}
{{ include "kubedbcom-qdrant-editor-options.selectorLabels" . }}
...
Selector labels
*/}}
{{- define "kubedbcom-qdrant-editor-options.selectorLabels" -}}
app.kubernetes.io/name: qdrants.kubedb.com
app.kubernetes.io/instance: {{ include "kubedbcom-qdrant-editor-options.fullname" . }}
{{- end }}

{{/*
Create the name of the service account to use
*/}}
{{- define "kubedbcom-qdrant-editor-options.serviceAccountName" -}}
{{- if .Values.spec.serviceAccount.create }}
{{- default (include "kubedbcom-qdrant-editor-options.fullname" .) .Values.spec.serviceAccount.name }}
{{- else }}
...
Common annotations
*/}}
{{- define "kubedbcom-qdrant-editor-options.annotations" -}}
...
Alert Enabled
*/}}
{{- define "kubedbcom-qdrant-editor-options.alertEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
