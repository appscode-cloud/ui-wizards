...
$ helm repo update
$ helm search repo appscode/sourcetoolkitfluxcdio-helmrepository-editor --version=v0.15.0
$ helm upgrade -i sourcetoolkitfluxcdio-helmrepository-editor appscode/sourcetoolkitfluxcdio-helmrepository-editor -n default --create-namespace --version=v0.15.0
```
...
```bash
$ helm upgrade -i sourcetoolkitfluxcdio-helmrepository-editor appscode/sourcetoolkitfluxcdio-helmrepository-editor -n default --create-namespace --version=v0.15.0 --set apiVersion=source.toolkit.fluxcd.io/v1
```
...
```bash
$ helm upgrade -i sourcetoolkitfluxcdio-helmrepository-editor appscode/sourcetoolkitfluxcdio-helmrepository-editor -n default --create-namespace --version=v0.15.0 --values values.yaml
```
