...
$ helm repo update
$ helm search repo bytebuilders-ui/sourcetoolkitfluxcdio-helmrepository-editor --version=v0.4.18
$ helm upgrade -i sourcetoolkitfluxcdio-helmrepository-editor bytebuilders-ui/sourcetoolkitfluxcdio-helmrepository-editor -n default --create-namespace --version=v0.4.18
```
...
```bash
$ helm upgrade -i sourcetoolkitfluxcdio-helmrepository-editor bytebuilders-ui/sourcetoolkitfluxcdio-helmrepository-editor -n default --create-namespace --version=v0.4.18 --set apiVersion=source.toolkit.fluxcd.io/v1beta2
```
...
```bash
$ helm upgrade -i sourcetoolkitfluxcdio-helmrepository-editor bytebuilders-ui/sourcetoolkitfluxcdio-helmrepository-editor -n default --create-namespace --version=v0.4.18 --values values.yaml
```
