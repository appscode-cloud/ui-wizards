...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/sourcetoolkitfluxcdio-helmrepository-editor --version=v0.4.17
$ helm upgrade -i sourcetoolkitfluxcdio-helmrepository-editor bytebuilders-ui-dev/sourcetoolkitfluxcdio-helmrepository-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i sourcetoolkitfluxcdio-helmrepository-editor bytebuilders-ui-dev/sourcetoolkitfluxcdio-helmrepository-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=source.toolkit.fluxcd.io/v1beta2
```
...
```bash
$ helm upgrade -i sourcetoolkitfluxcdio-helmrepository-editor bytebuilders-ui-dev/sourcetoolkitfluxcdio-helmrepository-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
