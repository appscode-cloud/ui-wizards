...
$ helm repo update
$ helm search repo bytebuilders-ui/stashappscodecom-repository-editor-options --version=v0.4.20
$ helm upgrade -i stashappscodecom-repository-editor-options bytebuilders-ui/stashappscodecom-repository-editor-options -n kube-system --create-namespace --version=v0.4.20
```
...
```bash
$ helm upgrade -i stashappscodecom-repository-editor-options bytebuilders-ui/stashappscodecom-repository-editor-options -n kube-system --create-namespace --version=v0.4.20 --set metadata.resource.group=stash.appscode.com
```
...
```bash
$ helm upgrade -i stashappscodecom-repository-editor-options bytebuilders-ui/stashappscodecom-repository-editor-options -n kube-system --create-namespace --version=v0.4.20 --values values.yaml
```
