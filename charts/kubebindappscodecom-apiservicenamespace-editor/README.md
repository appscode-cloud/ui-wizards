...
$ helm repo update
$ helm search repo appscode/kubebindappscodecom-apiservicenamespace-editor --version=v0.14.0
$ helm upgrade -i kubebindappscodecom-apiservicenamespace-editor appscode/kubebindappscodecom-apiservicenamespace-editor -n default --create-namespace --version=v0.14.0
```
...
```bash
$ helm upgrade -i kubebindappscodecom-apiservicenamespace-editor appscode/kubebindappscodecom-apiservicenamespace-editor -n default --create-namespace --version=v0.14.0 --set apiVersion=kube-bind.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i kubebindappscodecom-apiservicenamespace-editor appscode/kubebindappscodecom-apiservicenamespace-editor -n default --create-namespace --version=v0.14.0 --values values.yaml
```
