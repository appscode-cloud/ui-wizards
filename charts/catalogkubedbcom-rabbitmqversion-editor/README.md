...
$ helm repo update
$ helm search repo appscode/catalogkubedbcom-rabbitmqversion-editor --version=v0.20.0
$ helm upgrade -i catalogkubedbcom-rabbitmqversion-editor appscode/catalogkubedbcom-rabbitmqversion-editor -n default --create-namespace --version=v0.20.0
```
...
```bash
$ helm upgrade -i catalogkubedbcom-rabbitmqversion-editor appscode/catalogkubedbcom-rabbitmqversion-editor -n default --create-namespace --version=v0.20.0 --set apiVersion=catalog.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i catalogkubedbcom-rabbitmqversion-editor appscode/catalogkubedbcom-rabbitmqversion-editor -n default --create-namespace --version=v0.20.0 --values values.yaml
```
