...
$ helm repo update
$ helm search repo appscode-charts-oci/uikubedbcom-redisqueries-editor --version=v0.6.0
$ helm upgrade -i uikubedbcom-redisqueries-editor appscode-charts-oci/uikubedbcom-redisqueries-editor -n default --create-namespace --version=v0.6.0
```
...
```bash
$ helm upgrade -i uikubedbcom-redisqueries-editor appscode-charts-oci/uikubedbcom-redisqueries-editor -n default --create-namespace --version=v0.6.0 --set apiVersion=ui.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i uikubedbcom-redisqueries-editor appscode-charts-oci/uikubedbcom-redisqueries-editor -n default --create-namespace --version=v0.6.0 --values values.yaml
```
