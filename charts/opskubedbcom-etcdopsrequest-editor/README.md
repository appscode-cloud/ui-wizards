...
$ helm repo update
$ helm search repo appscode/opskubedbcom-etcdopsrequest-editor --version=v0.15.0
$ helm upgrade -i opskubedbcom-etcdopsrequest-editor appscode/opskubedbcom-etcdopsrequest-editor -n default --create-namespace --version=v0.15.0
```
...
```bash
$ helm upgrade -i opskubedbcom-etcdopsrequest-editor appscode/opskubedbcom-etcdopsrequest-editor -n default --create-namespace --version=v0.15.0 --set apiVersion=ops.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i opskubedbcom-etcdopsrequest-editor appscode/opskubedbcom-etcdopsrequest-editor -n default --create-namespace --version=v0.15.0 --values values.yaml
```
