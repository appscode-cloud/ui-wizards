...
$ helm repo update
$ helm search repo appscode-charts-oci/sqlgcpkubedbcom-user-editor --version=v0.13.0
$ helm upgrade -i sqlgcpkubedbcom-user-editor appscode-charts-oci/sqlgcpkubedbcom-user-editor -n default --create-namespace --version=v0.13.0
```
...
```bash
$ helm upgrade -i sqlgcpkubedbcom-user-editor appscode-charts-oci/sqlgcpkubedbcom-user-editor -n default --create-namespace --version=v0.13.0 --set apiVersion=sql.gcp.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i sqlgcpkubedbcom-user-editor appscode-charts-oci/sqlgcpkubedbcom-user-editor -n default --create-namespace --version=v0.13.0 --values values.yaml
```
