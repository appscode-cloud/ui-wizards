...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/uik8sappscodecom-featureset-opscenter-manageddb-editor --version=v0.4.17
$ helm upgrade -i uik8sappscodecom-featureset-opscenter-manageddb-editor bytebuilders-ui-dev/uik8sappscodecom-featureset-opscenter-manageddb-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i uik8sappscodecom-featureset-opscenter-manageddb-editor bytebuilders-ui-dev/uik8sappscodecom-featureset-opscenter-manageddb-editor -n default --create-namespace --version=v0.4.17 --set metadata.resource.group=ui.k8s.appscode.com
```
...
```bash
$ helm upgrade -i uik8sappscodecom-featureset-opscenter-manageddb-editor bytebuilders-ui-dev/uik8sappscodecom-featureset-opscenter-manageddb-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
