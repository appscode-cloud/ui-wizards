...
$ helm repo update
$ helm search repo bytebuilders-ui/appcatalogappscodecom-appbinding-editor --version=v0.4.5
$ helm upgrade -i appcatalogappscodecom-appbinding-editor bytebuilders-ui/appcatalogappscodecom-appbinding-editor -n default --create-namespace --version=v0.4.5
```
...
```bash
$ helm upgrade -i appcatalogappscodecom-appbinding-editor bytebuilders-ui/appcatalogappscodecom-appbinding-editor -n default --create-namespace --version=v0.4.5 --set apiVersion=appcatalog.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i appcatalogappscodecom-appbinding-editor bytebuilders-ui/appcatalogappscodecom-appbinding-editor -n default --create-namespace --version=v0.4.5 --values values.yaml
```
