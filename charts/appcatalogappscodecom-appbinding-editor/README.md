...
$ helm repo update
$ helm search repo appscode-charts-oci/appcatalogappscodecom-appbinding-editor --version=v0.6.0
$ helm upgrade -i appcatalogappscodecom-appbinding-editor appscode-charts-oci/appcatalogappscodecom-appbinding-editor -n default --create-namespace --version=v0.6.0
```
...
```bash
$ helm upgrade -i appcatalogappscodecom-appbinding-editor appscode-charts-oci/appcatalogappscodecom-appbinding-editor -n default --create-namespace --version=v0.6.0 --set apiVersion=appcatalog.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i appcatalogappscodecom-appbinding-editor appscode-charts-oci/appcatalogappscodecom-appbinding-editor -n default --create-namespace --version=v0.6.0 --values values.yaml
```
