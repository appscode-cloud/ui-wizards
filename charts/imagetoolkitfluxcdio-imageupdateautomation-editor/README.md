...
$ helm repo update
$ helm search repo appscode/imagetoolkitfluxcdio-imageupdateautomation-editor --version=v0.20.0
$ helm upgrade -i imagetoolkitfluxcdio-imageupdateautomation-editor appscode/imagetoolkitfluxcdio-imageupdateautomation-editor -n default --create-namespace --version=v0.20.0
```
...
```bash
$ helm upgrade -i imagetoolkitfluxcdio-imageupdateautomation-editor appscode/imagetoolkitfluxcdio-imageupdateautomation-editor -n default --create-namespace --version=v0.20.0 --set apiVersion=image.toolkit.fluxcd.io/v1beta2
```
...
```bash
$ helm upgrade -i imagetoolkitfluxcdio-imageupdateautomation-editor appscode/imagetoolkitfluxcdio-imageupdateautomation-editor -n default --create-namespace --version=v0.20.0 --values values.yaml
```
