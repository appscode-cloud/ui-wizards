...
$ helm repo update
$ helm search repo appscode-charts-oci/imagetoolkitfluxcdio-imageupdateautomation-editor --version=v0.8.0
$ helm upgrade -i imagetoolkitfluxcdio-imageupdateautomation-editor appscode-charts-oci/imagetoolkitfluxcdio-imageupdateautomation-editor -n default --create-namespace --version=v0.8.0
```
...
```bash
$ helm upgrade -i imagetoolkitfluxcdio-imageupdateautomation-editor appscode-charts-oci/imagetoolkitfluxcdio-imageupdateautomation-editor -n default --create-namespace --version=v0.8.0 --set apiVersion=image.toolkit.fluxcd.io/v1beta2
```
...
```bash
$ helm upgrade -i imagetoolkitfluxcdio-imageupdateautomation-editor appscode-charts-oci/imagetoolkitfluxcdio-imageupdateautomation-editor -n default --create-namespace --version=v0.8.0 --values values.yaml
```
