...
$ helm repo update
$ helm search repo bytebuilders-ui/imagetoolkitfluxcdio-imageupdateautomation-editor --version=v0.4.18
$ helm upgrade -i imagetoolkitfluxcdio-imageupdateautomation-editor bytebuilders-ui/imagetoolkitfluxcdio-imageupdateautomation-editor -n default --create-namespace --version=v0.4.18
```
...
```bash
$ helm upgrade -i imagetoolkitfluxcdio-imageupdateautomation-editor bytebuilders-ui/imagetoolkitfluxcdio-imageupdateautomation-editor -n default --create-namespace --version=v0.4.18 --set apiVersion=image.toolkit.fluxcd.io/v1beta1
```
...
```bash
$ helm upgrade -i imagetoolkitfluxcdio-imageupdateautomation-editor bytebuilders-ui/imagetoolkitfluxcdio-imageupdateautomation-editor -n default --create-namespace --version=v0.4.18 --values values.yaml
```
