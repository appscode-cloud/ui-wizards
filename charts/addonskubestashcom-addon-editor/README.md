...
$ helm repo update
$ helm search repo appscode-charts-oci/addonskubestashcom-addon-editor --version=v0.4.21
$ helm upgrade -i addonskubestashcom-addon-editor appscode-charts-oci/addonskubestashcom-addon-editor -n default --create-namespace --version=v0.4.21
```
...
```bash
$ helm upgrade -i addonskubestashcom-addon-editor appscode-charts-oci/addonskubestashcom-addon-editor -n default --create-namespace --version=v0.4.21 --set apiVersion=addons.kubestash.com/v1alpha1
```
...
```bash
$ helm upgrade -i addonskubestashcom-addon-editor appscode-charts-oci/addonskubestashcom-addon-editor -n default --create-namespace --version=v0.4.21 --values values.yaml
```
