...
$ helm repo update
$ helm search repo appscode/addonskubestashcom-addon-editor --version=v0.26.0
$ helm upgrade -i addonskubestashcom-addon-editor appscode/addonskubestashcom-addon-editor -n default --create-namespace --version=v0.26.0
```
...
```bash
$ helm upgrade -i addonskubestashcom-addon-editor appscode/addonskubestashcom-addon-editor -n default --create-namespace --version=v0.26.0 --set apiVersion=addons.kubestash.com/v1alpha1
```
...
```bash
$ helm upgrade -i addonskubestashcom-addon-editor appscode/addonskubestashcom-addon-editor -n default --create-namespace --version=v0.26.0 --values values.yaml
```
