...
$ helm repo update
$ helm search repo appscode-charts-oci/addonskubestashcom-addon-editor --version=v0.5.0
$ helm upgrade -i addonskubestashcom-addon-editor appscode-charts-oci/addonskubestashcom-addon-editor -n default --create-namespace --version=v0.5.0
```
...
```bash
$ helm upgrade -i addonskubestashcom-addon-editor appscode-charts-oci/addonskubestashcom-addon-editor -n default --create-namespace --version=v0.5.0 --set apiVersion=addons.kubestash.com/v1alpha1
```
...
```bash
$ helm upgrade -i addonskubestashcom-addon-editor appscode-charts-oci/addonskubestashcom-addon-editor -n default --create-namespace --version=v0.5.0 --values values.yaml
```
