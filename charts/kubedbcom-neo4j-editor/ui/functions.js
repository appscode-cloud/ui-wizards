...
export const useFunc = (model) => {
  ...
  function onScheduleBackupChange() {
    ...
    if (scheduleBackup === 'no') {
      ...
      deleteKubeDbComNeo4jDbAnnotation()
    } else {
  ...
  function getBackupConfigsAndAnnotations(getValue, model) {
    ...
    const kubedbComNeo4jAnnotations =
      getValue(model, '/resources/kubedbComNeo4j/metadata/annotations') || {}

    const isBluePrint = Object.keys(kubedbComNeo4jAnnotations).some(
      (k) =>
  ...
  function deleteKubeDbComNeo4jDbAnnotation() {
    ...
    commit('wizard/model$update', {
      path: '/resources/kubedbComNeo4j/metadata/annotations',
  ...
  async function initBackupData() {
    ...
    dbResource = getValue(model, '/resources/kubedbComNeo4j')
  ...
  function onArchiverChange() {
    ...
    const path = 'resources/kubedbComNeo4j/spec/archiver'
    if (archiverSwitch) {
      commit('wizard/model$update', {
        path: path,
  ...
  function addLabelAnnotation(type) {
    ...
    commit('wizard/model$update', {
      path: `/resources/kubedbComNeo4j/metadata/${type}`,
      value: obj,
      force: true,
    })
  }
  ...
  function addOrRemoveBinding() {
    ...
    const labels = getValue(model, '/resources/kubedbComNeo4j/metadata/labels')
    const bindingValues = {
    ...
    if (value) {
      commit('wizard/model$update', {
        path: '/resources/catalogAppscodeComNeo4jBinding',
        value: bindingValues,
        force: true,
      })
    } else {
      commit('wizard/model$delete', '/resources/catalogAppscodeComNeo4jBinding')
    }
  }
  ...
  function isBindingAlreadyOn() {
    ...
    const isExposeBinding = !!keys.find((str) => str === 'catalogAppscodeComNeo4jBinding')
  ...
  async function getDbDetails() {
    const annotations = getValue(
      model,
      '/resources/autoscalingKubedbComNeo4jAutoscaler/metadata/annotations',
    )
    ...
    const namespace =
      ...
      getValue(model, '/resources/autoscalingKubedbComNeo4jAutoscaler/metadata/namespace') ||
      ''
    const name =
      storeGet('/route/params/name') ||
      getValue(model, '/resources/autoscalingKubedbComNeo4jAutoscaler/spec/databaseRef/name') ||
      ''

    if (namespace && name) {
      try {
        const resp = await axios.get(
          `/clusters/${owner}/${cluster}/proxy/kubedb.com/v1alpha2/namespaces/${namespace}/neo4jes/${name}`,
        )
        dbDetails = resp.data || {}
    ...
    commit('wizard/model$update', {
      path: `/resources/autoscalingKubedbComNeo4jAutoscaler/spec/databaseRef/name`,
      value: name,
      force: true,
    })
    commit('wizard/model$update', {
      path: `/resources/autoscalingKubedbComNeo4jAutoscaler/metadata/labels`,
  ...
  function isConsole() {
    ...
    if (isKube) {
      ...
      commit('wizard/model$update', {
        path: '/resources/autoscalingKubedbComNeo4jAutoscaler/metadata/name',
        value: modifiedName,
        force: true,
      })
      const namespace = storeGet('/route/query/namespace') || ''
      if (namespace) {
        commit('wizard/model$update', {
          path: '/resources/autoscalingKubedbComNeo4jAutoscaler/metadata/namespace',
          value: namespace,
          force: true,
        })
      }
  ...
  //   const agent = getValue(model, '/resources/kubedbComNeo4j/spec/monitor/agent')
  ...
  async function getNeo4jDbs() {
    ...
    const namespace = getValue(
      model,
      '/resources/autoscalingKubedbComNeo4jAutoscaler/metadata/namespace',
    )
    const owner = storeGet('/route/params/user')
    const cluster = storeGet('/route/params/cluster')

    const resp = await axios.get(
      `/clusters/${owner}/${cluster}/proxy/kubedb.com/v1alpha2/namespaces/${namespace}/neo4jes`,
      {
        params: { filter: { items: { metadata: { name: null } } } },
      },
    )
  ...
  function initMetadata() {
    ...
    if (type === 'compute')
      commit('wizard/model$delete', '/resources/autoscalingKubedbComNeo4jAutoscaler/spec/storage')
    if (type === 'storage')
      commit('wizard/model$delete', '/resources/autoscalingKubedbComNeo4jAutoscaler/spec/compute')
  }
  ...
  function onTriggerChange(type) {
    ...
    const commitPath = `/resources/autoscalingKubedbComNeo4jAutoscaler/spec/${type}/trigger`
  ...
  function hasAnnotations() {
    const annotations =
      getValue(model, '/resources/autoscalingKubedbComNeo4jAutoscaler/metadata/annotations') || {}
  ...
  function onMachineChange(type) {
    const annoPath = '/resources/autoscalingKubedbComNeo4jAutoscaler/metadata/annotations'
    ...
    const maxMachineAllocatable = maxMachineObj
      ...
      : null
    const allowedPath = `/resources/autoscalingKubedbComNeo4jAutoscaler/spec/compute/${type}`
  ...
  function setControlledResources(type) {
    ...
    const path = `/resources/autoscalingKubedbComNeo4jAutoscaler/spec/compute/${type}/controlledResources`
    commit('wizard/model$update', {
      path: path,
      value: list,
      force: true,
  ...
  function isNodeTopologySelected() {
    // watchDependency(
    //   'model#/resources/autoscalingKubedbComNeo4jAutoscaler/spec/compute/nodeTopology/name',
    // )
    const nodeTopologyName =
      getValue(
        model,
        '/resources/autoscalingKubedbComNeo4jAutoscaler/spec/compute/nodeTopology/name',
      ) || ''
  ...
  function showOpsRequestOptions() {
    ...
    // watchDependency('model#/resources/autoscalingKubedbComNeo4jAutoscaler/spec/databaseRef/name')
  ...
  function onEnableMonitoringChange() {
    ...
    if (configureStatus) {
      commit('wizard/model$update', {
        path: '/resources/kubedbComNeo4j/spec/monitor',
        value: {},
        force: true,
      })
    } else {
      commit('wizard/model$delete', '/resources/kubedbComNeo4j/spec/monitor')
    }
  ...
  function onCustomizeExporterChange() {
    ...
    if (configureStatus) {
      commit('wizard/model$update', {
        path: '/resources/kubedbComNeo4j/spec/monitor/prometheus/exporter',
        value: {},
        force: true,
      })
    } else {
      commit('wizard/model$delete', '/resources/kubedbComNeo4j/spec/monitor/prometheus/exporter')
    }
  }
  ...
  function onLabelChange() {
    const labels = getValue(model, '/resources/kubedbComNeo4j/spec/metadata/labels')
  ...
  function onNamespaceChange() {
    ...
    if (!namespace) {
      commit(
        'wizard/model$delete',
        '/resources/autoscalingKubedbComNeo4jAutoscaler/spec/databaseRef/name',
      )
    }
  }
  ...
  async function getConfigMapKeys(index) {
    ...
    const configMapName = getValue(
      model,
      `/resources/kubedbComNeo4j/spec/monitor/prometheus/exporter/env/${index}/valueFrom/configMapKeyRef/name`,
    )
  ...
  async function getSecretKeys(index) {
    ...
    const secretName = getValue(
      model,
      `/resources/kubedbComNeo4j/spec/monitor/prometheus/exporter/env/${index}/valueFrom/secretKeyRef/name`,
    )
  ...
  function onEnvArrayChange() {
    ...
    if (filteredEnv.length)
      commit('wizard/model$update', {
        path: '/resources/kubedbComNeo4j/spec/monitor/prometheus/exporter/env',
        value: filteredEnv,
        force: true,
      })
  }
  ...
  function initEnvArray() {
    const env = getValue(model, '/resources/kubedbComNeo4j/spec/monitor/prometheus/exporter/env')
  ...
  function initMonitoring() {
    const env =
      getValue(model, '/resources/kubedbComNeo4j/spec/monitor/prometheus/exporter/env') || []
