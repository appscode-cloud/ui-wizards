...
$ helm repo update
$ helm search repo appscode/kubedbcom-neo4j-editor --version=v0.36.0
$ helm upgrade -i kubedbcom-neo4j-editor appscode/kubedbcom-neo4j-editor -n default --create-namespace --version=v0.36.0
```
...
```bash
$ helm upgrade -i kubedbcom-neo4j-editor appscode/kubedbcom-neo4j-editor -n default --create-namespace --version=v0.36.0 --values values.yaml
```
