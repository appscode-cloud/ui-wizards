...
*/}}
{{- define "kubedbcom-neo4j-editor.name" -}}
...
*/}}
{{- define "kubedbcom-neo4j-editor.fullname" -}}
...
*/}}
{{- define "kubedbcom-neo4j-editor.chart" -}}
...
Common labels
*/}}
{{- define "kubedbcom-neo4j-editor.labels" -}}
{{ include "kubedbcom-neo4j-editor.selectorLabels" . }}
...
Selector labels
*/}}
{{- define "kubedbcom-neo4j-editor.selectorLabels" -}}
app.kubernetes.io/name: neo4js.kubedb.com
app.kubernetes.io/instance: {{ include "kubedbcom-neo4j-editor.fullname" . }}
{{- end }}

{{/*
Create the name of the service account to use
*/}}
{{- define "kubedbcom-neo4j-editor.serviceAccountName" -}}
{{- if .Values.spec.serviceAccount.create }}
{{- default (include "kubedbcom-neo4j-editor.fullname" .) .Values.spec.serviceAccount.name }}
{{- else }}
...
Common annotations
*/}}
{{- define "kubedbcom-neo4j-editor.annotations" -}}
...
Alert Enabled
*/}}
{{- define "kubedbcom-neo4j-editor.alertEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
{{- $key := mustLast . -}}
{{- $rest := mustInitial . -}}
{{- $rules := mustLast $rest -}}
