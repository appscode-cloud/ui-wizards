...
$ helm repo update
$ helm search repo appscode-charts-oci/monitoringcoreoscom-alertmanagerconfig-editor --version=v0.4.19
$ helm upgrade -i monitoringcoreoscom-alertmanagerconfig-editor appscode-charts-oci/monitoringcoreoscom-alertmanagerconfig-editor -n default --create-namespace --version=v0.4.19
```
...
```bash
$ helm upgrade -i monitoringcoreoscom-alertmanagerconfig-editor appscode-charts-oci/monitoringcoreoscom-alertmanagerconfig-editor -n default --create-namespace --version=v0.4.19 --set apiVersion=monitoring.coreos.com/v1alpha1
```
...
```bash
$ helm upgrade -i monitoringcoreoscom-alertmanagerconfig-editor appscode-charts-oci/monitoringcoreoscom-alertmanagerconfig-editor -n default --create-namespace --version=v0.4.19 --values values.yaml
```
