...
$ helm repo update
$ helm search repo appscode/gatewaynetworkingk8sio-gateway-editor --version=v0.36.0
$ helm upgrade -i gatewaynetworkingk8sio-gateway-editor appscode/gatewaynetworkingk8sio-gateway-editor -n default --create-namespace --version=v0.36.0
```
...
```bash
$ helm upgrade -i gatewaynetworkingk8sio-gateway-editor appscode/gatewaynetworkingk8sio-gateway-editor -n default --create-namespace --version=v0.36.0 --set apiVersion=gateway.networking.k8s.io/v1
```
...
```bash
$ helm upgrade -i gatewaynetworkingk8sio-gateway-editor appscode/gatewaynetworkingk8sio-gateway-editor -n default --create-namespace --version=v0.36.0 --values values.yaml
```
