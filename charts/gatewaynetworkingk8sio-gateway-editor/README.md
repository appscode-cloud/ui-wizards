...
$ helm repo update
$ helm search repo appscode-charts-oci/gatewaynetworkingk8sio-gateway-editor --version=v0.4.21
$ helm upgrade -i gatewaynetworkingk8sio-gateway-editor appscode-charts-oci/gatewaynetworkingk8sio-gateway-editor -n default --create-namespace --version=v0.4.21
```
...
```bash
$ helm upgrade -i gatewaynetworkingk8sio-gateway-editor appscode-charts-oci/gatewaynetworkingk8sio-gateway-editor -n default --create-namespace --version=v0.4.21 --set apiVersion=gateway.networking.k8s.io/v1
```
...
```bash
$ helm upgrade -i gatewaynetworkingk8sio-gateway-editor appscode-charts-oci/gatewaynetworkingk8sio-gateway-editor -n default --create-namespace --version=v0.4.21 --values values.yaml
```
