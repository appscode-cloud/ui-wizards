...
$ helm repo update
$ helm install kubedbcom-elasticsearch-editor bytebuilders-ui-dev/kubedbcom-elasticsearch-editor -n default
```
...
```console
$ helm install kubedbcom-elasticsearch-editor bytebuilders-ui-dev/kubedbcom-elasticsearch-editor -n default --set apiVersion=kubedb.com/v1alpha2
```
...
```console
$ helm install kubedbcom-elasticsearch-editor bytebuilders-ui-dev/kubedbcom-elasticsearch-editor -n default --values values.yaml
```
