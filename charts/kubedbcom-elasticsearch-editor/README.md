...
$ helm repo update
$ helm search repo appscode/kubedbcom-elasticsearch-editor --version=v0.35.0
$ helm upgrade -i kubedbcom-elasticsearch-editor appscode/kubedbcom-elasticsearch-editor -n default --create-namespace --version=v0.35.0
```
...
```bash
$ helm upgrade -i kubedbcom-elasticsearch-editor appscode/kubedbcom-elasticsearch-editor -n default --create-namespace --version=v0.35.0 --values values.yaml
```
