...
$ helm repo update
$ helm search repo appscode/kubedbcom-mongodb-editor --version=v0.36.0
$ helm upgrade -i kubedbcom-mongodb-editor appscode/kubedbcom-mongodb-editor -n default --create-namespace --version=v0.36.0
```
...
```bash
$ helm upgrade -i kubedbcom-mongodb-editor appscode/kubedbcom-mongodb-editor -n default --create-namespace --version=v0.36.0 --values values.yaml
```
