...
$ helm repo update
$ helm search repo appscode/catalogkubewaredev-postgresbinding-editor --version=v0.28.0
$ helm upgrade -i catalogkubewaredev-postgresbinding-editor appscode/catalogkubewaredev-postgresbinding-editor -n default --create-namespace --version=v0.28.0
```
...
```bash
$ helm upgrade -i catalogkubewaredev-postgresbinding-editor appscode/catalogkubewaredev-postgresbinding-editor -n default --create-namespace --version=v0.28.0 --set apiVersion=catalog.kubeware.dev/v1alpha1
```
...
```bash
$ helm upgrade -i catalogkubewaredev-postgresbinding-editor appscode/catalogkubewaredev-postgresbinding-editor -n default --create-namespace --version=v0.28.0 --values values.yaml
```
