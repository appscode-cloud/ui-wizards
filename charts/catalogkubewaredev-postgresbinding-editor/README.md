...
$ helm repo update
$ helm search repo appscode-charts-oci/catalogkubewaredev-postgresbinding-editor --version=v0.5.0
$ helm upgrade -i catalogkubewaredev-postgresbinding-editor appscode-charts-oci/catalogkubewaredev-postgresbinding-editor -n default --create-namespace --version=v0.5.0
```
...
```bash
$ helm upgrade -i catalogkubewaredev-postgresbinding-editor appscode-charts-oci/catalogkubewaredev-postgresbinding-editor -n default --create-namespace --version=v0.5.0 --set apiVersion=catalog.kubeware.dev/v1alpha1
```
...
```bash
$ helm upgrade -i catalogkubewaredev-postgresbinding-editor appscode-charts-oci/catalogkubewaredev-postgresbinding-editor -n default --create-namespace --version=v0.5.0 --values values.yaml
```
