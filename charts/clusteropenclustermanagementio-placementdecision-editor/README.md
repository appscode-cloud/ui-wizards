...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/clusteropenclustermanagementio-placementdecision-editor --version=v0.4.17
$ helm upgrade -i clusteropenclustermanagementio-placementdecision-editor bytebuilders-ui-dev/clusteropenclustermanagementio-placementdecision-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i clusteropenclustermanagementio-placementdecision-editor bytebuilders-ui-dev/clusteropenclustermanagementio-placementdecision-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=cluster.open-cluster-management.io/v1beta1
```
...
```bash
$ helm upgrade -i clusteropenclustermanagementio-placementdecision-editor bytebuilders-ui-dev/clusteropenclustermanagementio-placementdecision-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
