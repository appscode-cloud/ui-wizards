...
$ helm repo update
$ helm search repo appscode/clusteropenclustermanagementio-placementdecision-editor --version=v0.16.0
$ helm upgrade -i clusteropenclustermanagementio-placementdecision-editor appscode/clusteropenclustermanagementio-placementdecision-editor -n default --create-namespace --version=v0.16.0
```
...
```bash
$ helm upgrade -i clusteropenclustermanagementio-placementdecision-editor appscode/clusteropenclustermanagementio-placementdecision-editor -n default --create-namespace --version=v0.16.0 --set apiVersion=cluster.open-cluster-management.io/v1beta1
```
...
```bash
$ helm upgrade -i clusteropenclustermanagementio-placementdecision-editor appscode/clusteropenclustermanagementio-placementdecision-editor -n default --create-namespace --version=v0.16.0 --values values.yaml
```
