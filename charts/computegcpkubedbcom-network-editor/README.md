...
$ helm repo update
$ helm search repo appscode/computegcpkubedbcom-network-editor --version=v0.16.0
$ helm upgrade -i computegcpkubedbcom-network-editor appscode/computegcpkubedbcom-network-editor -n default --create-namespace --version=v0.16.0
```
...
```bash
$ helm upgrade -i computegcpkubedbcom-network-editor appscode/computegcpkubedbcom-network-editor -n default --create-namespace --version=v0.16.0 --set apiVersion=compute.gcp.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i computegcpkubedbcom-network-editor appscode/computegcpkubedbcom-network-editor -n default --create-namespace --version=v0.16.0 --values values.yaml
```
