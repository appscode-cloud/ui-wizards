...
$ helm repo update
$ helm search repo appscode/catalogkubedbcom-aerospikeversion-editor --version=v0.37.0
$ helm upgrade -i catalogkubedbcom-aerospikeversion-editor appscode/catalogkubedbcom-aerospikeversion-editor -n default --create-namespace --version=v0.37.0
```
...
```bash
$ helm upgrade -i catalogkubedbcom-aerospikeversion-editor appscode/catalogkubedbcom-aerospikeversion-editor -n default --create-namespace --version=v0.37.0 --set apiVersion=catalog.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i catalogkubedbcom-aerospikeversion-editor appscode/catalogkubedbcom-aerospikeversion-editor -n default --create-namespace --version=v0.37.0 --values values.yaml
```
