...
```bash
$ helm upgrade -i kubedbcom-aerospike-editor appscode/kubedbcom-aerospike-editor -n default --create-namespace --version=v0.35.0 --set apiVersion=kubedb.com/v1alpha2
```
