...
$ helm repo update
$ helm search repo appscode/kubedbcom-aerospike-editor --version=v0.37.0
$ helm upgrade -i kubedbcom-aerospike-editor appscode/kubedbcom-aerospike-editor -n default --create-namespace --version=v0.37.0
```
...
To uninstall the `kubedbcom-aerospike-editor`:

```bash
$ helm uninstall kubedbcom-aerospike-editor -n default
```
...
```bash
$ helm upgrade -i kubedbcom-aerospike-editor appscode/kubedbcom-aerospike-editor -n default --create-namespace --version=v0.37.0 --set metadata.resource.group=kubedb.com
```
...
```bash
$ helm upgrade -i kubedbcom-aerospike-editor appscode/kubedbcom-aerospike-editor -n default --create-namespace --version=v0.37.0 --values values.yaml
```
