...
$ helm repo update
$ helm search repo appscode/kubedbcom-aerospike-editor --version=v0.36.0
$ helm upgrade -i kubedbcom-aerospike-editor appscode/kubedbcom-aerospike-editor -n default --create-namespace --version=v0.36.0
```
...
```bash
$ helm upgrade -i kubedbcom-aerospike-editor appscode/kubedbcom-aerospike-editor -n default --create-namespace --version=v0.36.0 --values values.yaml
```
