...
$ helm repo update
$ helm search repo appscode/opskubedbcom-druidopsrequest-editor --version=v0.18.0
$ helm upgrade -i opskubedbcom-druidopsrequest-editor appscode/opskubedbcom-druidopsrequest-editor -n default --create-namespace --version=v0.18.0
```
...
```bash
$ helm upgrade -i opskubedbcom-druidopsrequest-editor appscode/opskubedbcom-druidopsrequest-editor -n default --create-namespace --version=v0.18.0 --set apiVersion=ops.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i opskubedbcom-druidopsrequest-editor appscode/opskubedbcom-druidopsrequest-editor -n default --create-namespace --version=v0.18.0 --values values.yaml
```
