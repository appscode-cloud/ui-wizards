...
export const useFunc = (model) => {
  ...
  async function getDbVersions() {
    ...
    try {
      ...
      const versionsToShow = filteredMSSQLServerVersions.length
        ? filteredMSSQLServerVersions
  ...
  function versionCompare(v1, v2) {
    // MSSQL versions use a year and cumulative update format
    // Extracting numeric parts supports both formats.
