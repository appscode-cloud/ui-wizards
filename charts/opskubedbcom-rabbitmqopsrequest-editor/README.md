...
$ helm repo update
$ helm search repo appscode/opskubedbcom-rabbitmqopsrequest-editor --version=v0.20.0
$ helm upgrade -i opskubedbcom-rabbitmqopsrequest-editor appscode/opskubedbcom-rabbitmqopsrequest-editor -n default --create-namespace --version=v0.20.0
```
...
```bash
$ helm upgrade -i opskubedbcom-rabbitmqopsrequest-editor appscode/opskubedbcom-rabbitmqopsrequest-editor -n default --create-namespace --version=v0.20.0 --set apiVersion=ops.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i opskubedbcom-rabbitmqopsrequest-editor appscode/opskubedbcom-rabbitmqopsrequest-editor -n default --create-namespace --version=v0.20.0 --values values.yaml
```
