...
$ helm repo update
$ helm search repo appscode/kubedbcom-mysql-editor --version=v0.36.0
$ helm upgrade -i kubedbcom-mysql-editor appscode/kubedbcom-mysql-editor -n default --create-namespace --version=v0.36.0
```
...
```bash
$ helm upgrade -i kubedbcom-mysql-editor appscode/kubedbcom-mysql-editor -n default --create-namespace --version=v0.36.0 --values values.yaml
```
