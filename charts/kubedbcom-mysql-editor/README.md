...
$ helm repo update
$ helm install kubedbcom-mysql-editor bytebuilders-ui-dev/kubedbcom-mysql-editor -n default
```
...
```console
$ helm install kubedbcom-mysql-editor bytebuilders-ui-dev/kubedbcom-mysql-editor -n default --set apiVersion=kubedb.com/v1alpha2
```
...
```console
$ helm install kubedbcom-mysql-editor bytebuilders-ui-dev/kubedbcom-mysql-editor -n default --values values.yaml
```
