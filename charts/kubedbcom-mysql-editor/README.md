...
```bash
$ helm upgrade -i kubedbcom-mysql-editor bytebuilders-ui/kubedbcom-mysql-editor -n default --create-namespace --version=v0.4.3 --set apiVersion=kubedb.com/v1alpha2
```
