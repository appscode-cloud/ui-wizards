...
$ helm repo update
$ helm search repo appscode/chartsxhelmdev-chartpreset-editor --version=v0.34.0
$ helm upgrade -i chartsxhelmdev-chartpreset-editor appscode/chartsxhelmdev-chartpreset-editor -n default --create-namespace --version=v0.34.0
```
...
```bash
$ helm upgrade -i chartsxhelmdev-chartpreset-editor appscode/chartsxhelmdev-chartpreset-editor -n default --create-namespace --version=v0.34.0 --set apiVersion=charts.x-helm.dev/v1alpha1
```
...
```bash
$ helm upgrade -i chartsxhelmdev-chartpreset-editor appscode/chartsxhelmdev-chartpreset-editor -n default --create-namespace --version=v0.34.0 --values values.yaml
```
