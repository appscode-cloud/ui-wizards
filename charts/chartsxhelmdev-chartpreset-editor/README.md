...
$ helm repo update
$ helm search repo appscode-charts-oci/chartsxhelmdev-chartpreset-editor --version=v0.7.0
$ helm upgrade -i chartsxhelmdev-chartpreset-editor appscode-charts-oci/chartsxhelmdev-chartpreset-editor -n default --create-namespace --version=v0.7.0
```
...
```bash
$ helm upgrade -i chartsxhelmdev-chartpreset-editor appscode-charts-oci/chartsxhelmdev-chartpreset-editor -n default --create-namespace --version=v0.7.0 --set apiVersion=charts.x-helm.dev/v1alpha1
```
...
```bash
$ helm upgrade -i chartsxhelmdev-chartpreset-editor appscode-charts-oci/chartsxhelmdev-chartpreset-editor -n default --create-namespace --version=v0.7.0 --values values.yaml
```
