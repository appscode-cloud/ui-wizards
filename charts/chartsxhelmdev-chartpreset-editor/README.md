...
$ helm repo update
$ helm search repo bytebuilders-ui/chartsxhelmdev-chartpreset-editor --version=v0.4.14
$ helm upgrade -i chartsxhelmdev-chartpreset-editor bytebuilders-ui/chartsxhelmdev-chartpreset-editor -n default --create-namespace --version=v0.4.14
```
...
```bash
$ helm upgrade -i chartsxhelmdev-chartpreset-editor bytebuilders-ui/chartsxhelmdev-chartpreset-editor -n default --create-namespace --version=v0.4.14 --set apiVersion=charts.x-helm.dev/v1alpha1
```
...
```bash
$ helm upgrade -i chartsxhelmdev-chartpreset-editor bytebuilders-ui/chartsxhelmdev-chartpreset-editor -n default --create-namespace --version=v0.4.14 --values values.yaml
```
