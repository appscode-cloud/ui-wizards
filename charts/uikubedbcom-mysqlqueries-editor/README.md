...
$ helm repo update
$ helm search repo appscode/uikubedbcom-mysqlqueries-editor --version=v0.20.0
$ helm upgrade -i uikubedbcom-mysqlqueries-editor appscode/uikubedbcom-mysqlqueries-editor -n default --create-namespace --version=v0.20.0
```
...
```bash
$ helm upgrade -i uikubedbcom-mysqlqueries-editor appscode/uikubedbcom-mysqlqueries-editor -n default --create-namespace --version=v0.20.0 --set apiVersion=ui.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i uikubedbcom-mysqlqueries-editor appscode/uikubedbcom-mysqlqueries-editor -n default --create-namespace --version=v0.20.0 --values values.yaml
```
