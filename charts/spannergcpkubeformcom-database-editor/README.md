...
$ helm repo update
$ helm search repo bytebuilders-ui/spannergcpkubeformcom-database-editor --version=v0.4.18
$ helm upgrade -i spannergcpkubeformcom-database-editor bytebuilders-ui/spannergcpkubeformcom-database-editor -n default --create-namespace --version=v0.4.18
```
...
```bash
$ helm upgrade -i spannergcpkubeformcom-database-editor bytebuilders-ui/spannergcpkubeformcom-database-editor -n default --create-namespace --version=v0.4.18 --set apiVersion=spanner.gcp.kubeform.com/v1alpha1
```
...
```bash
$ helm upgrade -i spannergcpkubeformcom-database-editor bytebuilders-ui/spannergcpkubeformcom-database-editor -n default --create-namespace --version=v0.4.18 --values values.yaml
```
