...
*/}}
{{- define "kubedbcom-neo4j-editor-options.name" -}}
...
*/}}
{{- define "kubedbcom-neo4j-editor-options.fullname" -}}
...
*/}}
{{- define "kubedbcom-neo4j-editor-options.chart" -}}
...
Common labels
*/}}
{{- define "kubedbcom-neo4j-editor-options.labels" -}}
{{ include "kubedbcom-neo4j-editor-options.selectorLabels" . }}
...
Selector labels
*/}}
{{- define "kubedbcom-neo4j-editor-options.selectorLabels" -}}
app.kubernetes.io/name: neo4js.kubedb.com
app.kubernetes.io/instance: {{ include "kubedbcom-neo4j-editor-options.fullname" . }}
{{- end }}

{{/*
Create the name of the service account to use
*/}}
{{- define "kubedbcom-neo4j-editor-options.serviceAccountName" -}}
{{- if .Values.spec.serviceAccount.create }}
{{- default (include "kubedbcom-neo4j-editor-options.fullname" .) .Values.spec.serviceAccount.name }}
{{- else }}
...
Common annotations
*/}}
{{- define "kubedbcom-neo4j-editor-options.annotations" -}}
...
Alert Enabled
*/}}
{{- define "kubedbcom-neo4j-editor-options.alertEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
