...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/rbacauthorizationk8sio-rolebinding-editor --version=v0.4.17
$ helm upgrade -i rbacauthorizationk8sio-rolebinding-editor bytebuilders-ui-dev/rbacauthorizationk8sio-rolebinding-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i rbacauthorizationk8sio-rolebinding-editor bytebuilders-ui-dev/rbacauthorizationk8sio-rolebinding-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=rbac.authorization.k8s.io/v1
```
...
```bash
$ helm upgrade -i rbacauthorizationk8sio-rolebinding-editor bytebuilders-ui-dev/rbacauthorizationk8sio-rolebinding-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
