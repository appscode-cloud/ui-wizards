...
$ helm repo update
$ helm search repo appscode-charts-oci/spannergcpkubedbcom-database-editor --version=v0.13.0
$ helm upgrade -i spannergcpkubedbcom-database-editor appscode-charts-oci/spannergcpkubedbcom-database-editor -n default --create-namespace --version=v0.13.0
```
...
```bash
$ helm upgrade -i spannergcpkubedbcom-database-editor appscode-charts-oci/spannergcpkubedbcom-database-editor -n default --create-namespace --version=v0.13.0 --set apiVersion=spanner.gcp.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i spannergcpkubedbcom-database-editor appscode-charts-oci/spannergcpkubedbcom-database-editor -n default --create-namespace --version=v0.13.0 --values values.yaml
```
