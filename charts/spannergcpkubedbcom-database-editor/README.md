...
$ helm repo update
$ helm search repo appscode/spannergcpkubedbcom-database-editor --version=v0.34.0
$ helm upgrade -i spannergcpkubedbcom-database-editor appscode/spannergcpkubedbcom-database-editor -n default --create-namespace --version=v0.34.0
```
...
```bash
$ helm upgrade -i spannergcpkubedbcom-database-editor appscode/spannergcpkubedbcom-database-editor -n default --create-namespace --version=v0.34.0 --set apiVersion=spanner.gcp.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i spannergcpkubedbcom-database-editor appscode/spannergcpkubedbcom-database-editor -n default --create-namespace --version=v0.34.0 --values values.yaml
```
