...
$ helm repo update
$ helm search repo appscode-charts-oci/uikubedbcom-mysqlinsight-editor --version=v0.8.0
$ helm upgrade -i uikubedbcom-mysqlinsight-editor appscode-charts-oci/uikubedbcom-mysqlinsight-editor -n default --create-namespace --version=v0.8.0
```
...
```bash
$ helm upgrade -i uikubedbcom-mysqlinsight-editor appscode-charts-oci/uikubedbcom-mysqlinsight-editor -n default --create-namespace --version=v0.8.0 --set apiVersion=ui.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i uikubedbcom-mysqlinsight-editor appscode-charts-oci/uikubedbcom-mysqlinsight-editor -n default --create-namespace --version=v0.8.0 --values values.yaml
```
