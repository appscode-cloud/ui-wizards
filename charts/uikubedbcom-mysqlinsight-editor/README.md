...
$ helm repo update
$ helm search repo appscode/uikubedbcom-mysqlinsight-editor --version=v0.20.0
$ helm upgrade -i uikubedbcom-mysqlinsight-editor appscode/uikubedbcom-mysqlinsight-editor -n default --create-namespace --version=v0.20.0
```
...
```bash
$ helm upgrade -i uikubedbcom-mysqlinsight-editor appscode/uikubedbcom-mysqlinsight-editor -n default --create-namespace --version=v0.20.0 --set apiVersion=ui.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i uikubedbcom-mysqlinsight-editor appscode/uikubedbcom-mysqlinsight-editor -n default --create-namespace --version=v0.20.0 --values values.yaml
```
