...
$ helm repo update
$ helm search repo appscode/courierkubedbcom-branchwork-editor --version=v0.36.0
$ helm upgrade -i courierkubedbcom-branchwork-editor appscode/courierkubedbcom-branchwork-editor -n default --create-namespace --version=v0.36.0
```
...
```bash
$ helm upgrade -i courierkubedbcom-branchwork-editor appscode/courierkubedbcom-branchwork-editor -n default --create-namespace --version=v0.36.0 --set apiVersion=courier.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i courierkubedbcom-branchwork-editor appscode/courierkubedbcom-branchwork-editor -n default --create-namespace --version=v0.36.0 --values values.yaml
```
