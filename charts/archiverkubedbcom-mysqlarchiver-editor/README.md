...
$ helm repo update
$ helm search repo appscode-charts-oci/archiverkubedbcom-mysqlarchiver-editor --version=v0.4.18
$ helm upgrade -i archiverkubedbcom-mysqlarchiver-editor appscode-charts-oci/archiverkubedbcom-mysqlarchiver-editor -n default --create-namespace --version=v0.4.18
```
...
```bash
$ helm upgrade -i archiverkubedbcom-mysqlarchiver-editor appscode-charts-oci/archiverkubedbcom-mysqlarchiver-editor -n default --create-namespace --version=v0.4.18 --set apiVersion=archiver.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i archiverkubedbcom-mysqlarchiver-editor appscode-charts-oci/archiverkubedbcom-mysqlarchiver-editor -n default --create-namespace --version=v0.4.18 --values values.yaml
```
