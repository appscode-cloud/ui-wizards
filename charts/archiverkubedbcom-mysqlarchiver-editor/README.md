...
$ helm repo update
$ helm search repo appscode-charts-oci/archiverkubedbcom-mysqlarchiver-editor --version=v0.8.0
$ helm upgrade -i archiverkubedbcom-mysqlarchiver-editor appscode-charts-oci/archiverkubedbcom-mysqlarchiver-editor -n default --create-namespace --version=v0.8.0
```
...
```bash
$ helm upgrade -i archiverkubedbcom-mysqlarchiver-editor appscode-charts-oci/archiverkubedbcom-mysqlarchiver-editor -n default --create-namespace --version=v0.8.0 --set apiVersion=archiver.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i archiverkubedbcom-mysqlarchiver-editor appscode-charts-oci/archiverkubedbcom-mysqlarchiver-editor -n default --create-namespace --version=v0.8.0 --values values.yaml
```
