...
$ helm repo update
$ helm search repo appscode/openvizdev-grafanadashboardtemplate-editor --version=v0.22.0
$ helm upgrade -i openvizdev-grafanadashboardtemplate-editor appscode/openvizdev-grafanadashboardtemplate-editor -n default --create-namespace --version=v0.22.0
```
...
```bash
$ helm upgrade -i openvizdev-grafanadashboardtemplate-editor appscode/openvizdev-grafanadashboardtemplate-editor -n default --create-namespace --version=v0.22.0 --set apiVersion=openviz.dev/v1alpha1
```
...
```bash
$ helm upgrade -i openvizdev-grafanadashboardtemplate-editor appscode/openvizdev-grafanadashboardtemplate-editor -n default --create-namespace --version=v0.22.0 --values values.yaml
```
