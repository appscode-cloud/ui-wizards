...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/openvizdev-grafanadashboardtemplate-editor --version=v0.4.17
$ helm upgrade -i openvizdev-grafanadashboardtemplate-editor bytebuilders-ui-dev/openvizdev-grafanadashboardtemplate-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i openvizdev-grafanadashboardtemplate-editor bytebuilders-ui-dev/openvizdev-grafanadashboardtemplate-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=openviz.dev/v1alpha1
```
...
```bash
$ helm upgrade -i openvizdev-grafanadashboardtemplate-editor bytebuilders-ui-dev/openvizdev-grafanadashboardtemplate-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
