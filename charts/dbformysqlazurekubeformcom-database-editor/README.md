...
$ helm repo update
$ helm search repo bytebuilders-ui/dbformysqlazurekubeformcom-database-editor --version=v0.4.17
$ helm upgrade -i dbformysqlazurekubeformcom-database-editor bytebuilders-ui/dbformysqlazurekubeformcom-database-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i dbformysqlazurekubeformcom-database-editor bytebuilders-ui/dbformysqlazurekubeformcom-database-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=dbformysql.azure.kubeform.com/v1alpha1
```
...
```bash
$ helm upgrade -i dbformysqlazurekubeformcom-database-editor bytebuilders-ui/dbformysqlazurekubeformcom-database-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
