...
$ helm repo update
$ helm search repo appscode-charts-oci/rdsawskubedbcom-instance-editor --version=v0.4.21
$ helm upgrade -i rdsawskubedbcom-instance-editor appscode-charts-oci/rdsawskubedbcom-instance-editor -n default --create-namespace --version=v0.4.21
```
...
```bash
$ helm upgrade -i rdsawskubedbcom-instance-editor appscode-charts-oci/rdsawskubedbcom-instance-editor -n default --create-namespace --version=v0.4.21 --set apiVersion=rds.aws.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i rdsawskubedbcom-instance-editor appscode-charts-oci/rdsawskubedbcom-instance-editor -n default --create-namespace --version=v0.4.21 --values values.yaml
```
