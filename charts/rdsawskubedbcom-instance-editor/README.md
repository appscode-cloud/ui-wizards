...
$ helm repo update
$ helm search repo appscode-charts-oci/rdsawskubedbcom-instance-editor --version=v0.13.0
$ helm upgrade -i rdsawskubedbcom-instance-editor appscode-charts-oci/rdsawskubedbcom-instance-editor -n default --create-namespace --version=v0.13.0
```
...
```bash
$ helm upgrade -i rdsawskubedbcom-instance-editor appscode-charts-oci/rdsawskubedbcom-instance-editor -n default --create-namespace --version=v0.13.0 --set apiVersion=rds.aws.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i rdsawskubedbcom-instance-editor appscode-charts-oci/rdsawskubedbcom-instance-editor -n default --create-namespace --version=v0.13.0 --values values.yaml
```
