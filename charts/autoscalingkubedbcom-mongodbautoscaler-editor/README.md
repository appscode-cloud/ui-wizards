...
$ helm repo update
$ helm search repo appscode-charts-oci/autoscalingkubedbcom-mongodbautoscaler-editor --version=v0.4.18
$ helm upgrade -i autoscalingkubedbcom-mongodbautoscaler-editor appscode-charts-oci/autoscalingkubedbcom-mongodbautoscaler-editor -n default --create-namespace --version=v0.4.18
```
...
```bash
$ helm upgrade -i autoscalingkubedbcom-mongodbautoscaler-editor appscode-charts-oci/autoscalingkubedbcom-mongodbautoscaler-editor -n default --create-namespace --version=v0.4.18 --set apiVersion=autoscaling.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i autoscalingkubedbcom-mongodbautoscaler-editor appscode-charts-oci/autoscalingkubedbcom-mongodbautoscaler-editor -n default --create-namespace --version=v0.4.18 --values values.yaml
```
