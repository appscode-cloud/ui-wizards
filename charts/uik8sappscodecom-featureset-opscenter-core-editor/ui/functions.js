...
export const useFunc = (model) => {
  ...
  function disableFeatures() {
    ...
    if (getRoute.fullPath.includes('/hubs/')) {
      ...
      featureSet = getFeatureSetDetails()
  ...
  function onEnabledFeaturesChange() {
    ...
    allFeatures.forEach((item) => {
      ...
      if (enabledFeatures.includes(featureName) && checkSpecialOcmCase(featureName)) {
        const featureSet = storeGet('/route/params/featureset') || ''
  ...
  function checkSpecialOcmCase(featureName) {
    const getRoute = storeGet('/route')
  ...
  function getFeatureSetDetailsOcm() {
