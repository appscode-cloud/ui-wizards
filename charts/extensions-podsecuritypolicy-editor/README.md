...
$ helm repo update
$ helm search repo bytebuilders-ui/extensions-podsecuritypolicy-editor --version=v0.4.14
$ helm upgrade -i extensions-podsecuritypolicy-editor bytebuilders-ui/extensions-podsecuritypolicy-editor -n default --create-namespace --version=v0.4.14
```
...
```bash
$ helm upgrade -i extensions-podsecuritypolicy-editor bytebuilders-ui/extensions-podsecuritypolicy-editor -n default --create-namespace --version=v0.4.14 --set apiVersion=extensions/v1beta1
```
...
```bash
$ helm upgrade -i extensions-podsecuritypolicy-editor bytebuilders-ui/extensions-podsecuritypolicy-editor -n default --create-namespace --version=v0.4.14 --values values.yaml
```
