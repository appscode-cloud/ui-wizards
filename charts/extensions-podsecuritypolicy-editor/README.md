...
$ helm repo update
$ helm search repo bytebuilders-ui/extensions-podsecuritypolicy-editor --version=v0.4.13
$ helm upgrade -i extensions-podsecuritypolicy-editor bytebuilders-ui/extensions-podsecuritypolicy-editor -n default --create-namespace --version=v0.4.13
```
...
```bash
$ helm upgrade -i extensions-podsecuritypolicy-editor bytebuilders-ui/extensions-podsecuritypolicy-editor -n default --create-namespace --version=v0.4.13 --set apiVersion=extensions/v1beta1
```
...
```bash
$ helm upgrade -i extensions-podsecuritypolicy-editor bytebuilders-ui/extensions-podsecuritypolicy-editor -n default --create-namespace --version=v0.4.13 --values values.yaml
```
