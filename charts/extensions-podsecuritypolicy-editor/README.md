...
$ helm repo update
$ helm search repo appscode/extensions-podsecuritypolicy-editor --version=v0.16.0
$ helm upgrade -i extensions-podsecuritypolicy-editor appscode/extensions-podsecuritypolicy-editor -n default --create-namespace --version=v0.16.0
```
...
```bash
$ helm upgrade -i extensions-podsecuritypolicy-editor appscode/extensions-podsecuritypolicy-editor -n default --create-namespace --version=v0.16.0 --set apiVersion=extensions/v1beta1
```
...
```bash
$ helm upgrade -i extensions-podsecuritypolicy-editor appscode/extensions-podsecuritypolicy-editor -n default --create-namespace --version=v0.16.0 --values values.yaml
```
