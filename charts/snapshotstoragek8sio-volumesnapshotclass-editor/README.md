...
$ helm repo update
$ helm search repo appscode/snapshotstoragek8sio-volumesnapshotclass-editor --version=v0.34.0
$ helm upgrade -i snapshotstoragek8sio-volumesnapshotclass-editor appscode/snapshotstoragek8sio-volumesnapshotclass-editor -n default --create-namespace --version=v0.34.0
```
...
```bash
$ helm upgrade -i snapshotstoragek8sio-volumesnapshotclass-editor appscode/snapshotstoragek8sio-volumesnapshotclass-editor -n default --create-namespace --version=v0.34.0 --set apiVersion=snapshot.storage.k8s.io/v1
```
...
```bash
$ helm upgrade -i snapshotstoragek8sio-volumesnapshotclass-editor appscode/snapshotstoragek8sio-volumesnapshotclass-editor -n default --create-namespace --version=v0.34.0 --values values.yaml
```
