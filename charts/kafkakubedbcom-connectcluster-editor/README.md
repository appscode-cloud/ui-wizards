...
$ helm repo update
$ helm search repo appscode/kafkakubedbcom-connectcluster-editor --version=v0.22.0
$ helm upgrade -i kafkakubedbcom-connectcluster-editor appscode/kafkakubedbcom-connectcluster-editor -n default --create-namespace --version=v0.22.0
```
...
```bash
$ helm upgrade -i kafkakubedbcom-connectcluster-editor appscode/kafkakubedbcom-connectcluster-editor -n default --create-namespace --version=v0.22.0 --set apiVersion=kafka.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i kafkakubedbcom-connectcluster-editor appscode/kafkakubedbcom-connectcluster-editor -n default --create-namespace --version=v0.22.0 --values values.yaml
```
