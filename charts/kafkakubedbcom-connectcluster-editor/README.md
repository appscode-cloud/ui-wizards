...
$ helm repo update
$ helm search repo appscode-charts-oci/kafkakubedbcom-connectcluster-editor --version=v0.4.18
$ helm upgrade -i kafkakubedbcom-connectcluster-editor appscode-charts-oci/kafkakubedbcom-connectcluster-editor -n default --create-namespace --version=v0.4.18
```
...
```bash
$ helm upgrade -i kafkakubedbcom-connectcluster-editor appscode-charts-oci/kafkakubedbcom-connectcluster-editor -n default --create-namespace --version=v0.4.18 --set apiVersion=kafka.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i kafkakubedbcom-connectcluster-editor appscode-charts-oci/kafkakubedbcom-connectcluster-editor -n default --create-namespace --version=v0.4.18 --values values.yaml
```
