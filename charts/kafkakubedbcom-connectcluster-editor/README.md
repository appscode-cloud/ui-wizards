...
$ helm repo update
$ helm search repo appscode-charts-oci/kafkakubedbcom-connectcluster-editor --version=v0.11.0
$ helm upgrade -i kafkakubedbcom-connectcluster-editor appscode-charts-oci/kafkakubedbcom-connectcluster-editor -n default --create-namespace --version=v0.11.0
```
...
```bash
$ helm upgrade -i kafkakubedbcom-connectcluster-editor appscode-charts-oci/kafkakubedbcom-connectcluster-editor -n default --create-namespace --version=v0.11.0 --set apiVersion=kafka.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i kafkakubedbcom-connectcluster-editor appscode-charts-oci/kafkakubedbcom-connectcluster-editor -n default --create-namespace --version=v0.11.0 --values values.yaml
```
