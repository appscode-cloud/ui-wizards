...
const modeDetails = {
  ...
  DataGuard: {
    description: 'Milvus Data Guard for high availability, data protection, and disaster recovery',
    text: 'DataGuard',
  },
}
...
export const useFunc = (model) => {
  ...
  async function initBundle() {
    ...
    if (!getValue(model, `/spec/admin/databases/Milvus/mode/toggle`)) {
      ...
      if (defMode === '') {
        const arr = getValue(model, '/spec/databases/Milvus/mode/available') || []
