...
$ helm repo update
$ helm search repo appscode-charts-oci/authenticationk8sio-tokenrequest-editor --version=v0.4.21
$ helm upgrade -i authenticationk8sio-tokenrequest-editor appscode-charts-oci/authenticationk8sio-tokenrequest-editor -n default --create-namespace --version=v0.4.21
```
...
```bash
$ helm upgrade -i authenticationk8sio-tokenrequest-editor appscode-charts-oci/authenticationk8sio-tokenrequest-editor -n default --create-namespace --version=v0.4.21 --set apiVersion=authentication.k8s.io/v1
```
...
```bash
$ helm upgrade -i authenticationk8sio-tokenrequest-editor appscode-charts-oci/authenticationk8sio-tokenrequest-editor -n default --create-namespace --version=v0.4.21 --values values.yaml
```
