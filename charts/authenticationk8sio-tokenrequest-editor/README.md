...
$ helm repo update
$ helm search repo bytebuilders-ui/authenticationk8sio-tokenrequest-editor --version=v0.4.18
$ helm upgrade -i authenticationk8sio-tokenrequest-editor bytebuilders-ui/authenticationk8sio-tokenrequest-editor -n default --create-namespace --version=v0.4.18
```
...
```bash
$ helm upgrade -i authenticationk8sio-tokenrequest-editor bytebuilders-ui/authenticationk8sio-tokenrequest-editor -n default --create-namespace --version=v0.4.18 --set apiVersion=authentication.k8s.io/v1
```
...
```bash
$ helm upgrade -i authenticationk8sio-tokenrequest-editor bytebuilders-ui/authenticationk8sio-tokenrequest-editor -n default --create-namespace --version=v0.4.18 --values values.yaml
```
