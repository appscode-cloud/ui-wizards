...
$ helm repo update
$ helm search repo appscode/kubevaultcom-vaultserver-editor --version=v0.37.0
$ helm upgrade -i kubevaultcom-vaultserver-editor appscode/kubevaultcom-vaultserver-editor -n default --create-namespace --version=v0.37.0
```
...
```bash
$ helm upgrade -i kubevaultcom-vaultserver-editor appscode/kubevaultcom-vaultserver-editor -n default --create-namespace --version=v0.37.0 --set form.alert.enabled=warning
```
...
```bash
$ helm upgrade -i kubevaultcom-vaultserver-editor appscode/kubevaultcom-vaultserver-editor -n default --create-namespace --version=v0.37.0 --values values.yaml
```
