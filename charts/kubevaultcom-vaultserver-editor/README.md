...
|--------------------|-------------|-------------------------------------|
| apiVersion         |             | <code>kubevault.com/v1alpha1</code> |
| kind               |             | <code>VaultServer</code>            |
| metadata.name      |             | <code>vaultserver</code>            |
...
```bash
$ helm upgrade -i kubevaultcom-vaultserver-editor bytebuilders-ui/kubevaultcom-vaultserver-editor -n default --create-namespace --version=v0.4.3 --set apiVersion=kubevault.com/v1alpha1
```
