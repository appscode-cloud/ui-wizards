...
$ helm repo update
$ helm search repo bytebuilders-ui/core-serviceaccount-editor --version=v0.4.16
$ helm upgrade -i core-serviceaccount-editor bytebuilders-ui/core-serviceaccount-editor -n default --create-namespace --version=v0.4.16
```
...
```bash
$ helm upgrade -i core-serviceaccount-editor bytebuilders-ui/core-serviceaccount-editor -n default --create-namespace --version=v0.4.16 --set apiVersion=v1
```
...
```bash
$ helm upgrade -i core-serviceaccount-editor bytebuilders-ui/core-serviceaccount-editor -n default --create-namespace --version=v0.4.16 --values values.yaml
```
