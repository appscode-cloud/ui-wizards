...
$ helm repo update
$ helm search repo appscode-charts-oci/core-serviceaccount-editor --version=v0.4.18
$ helm upgrade -i core-serviceaccount-editor appscode-charts-oci/core-serviceaccount-editor -n default --create-namespace --version=v0.4.18
```
...
```bash
$ helm upgrade -i core-serviceaccount-editor appscode-charts-oci/core-serviceaccount-editor -n default --create-namespace --version=v0.4.18 --set apiVersion=v1
```
...
```bash
$ helm upgrade -i core-serviceaccount-editor appscode-charts-oci/core-serviceaccount-editor -n default --create-namespace --version=v0.4.18 --values values.yaml
```
