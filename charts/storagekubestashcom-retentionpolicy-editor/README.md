...
$ helm repo update
$ helm search repo appscode/storagekubestashcom-retentionpolicy-editor --version=v0.29.0
$ helm upgrade -i storagekubestashcom-retentionpolicy-editor appscode/storagekubestashcom-retentionpolicy-editor -n default --create-namespace --version=v0.29.0
```
...
```bash
$ helm upgrade -i storagekubestashcom-retentionpolicy-editor appscode/storagekubestashcom-retentionpolicy-editor -n default --create-namespace --version=v0.29.0 --set apiVersion=storage.kubestash.com/v1alpha1
```
...
```bash
$ helm upgrade -i storagekubestashcom-retentionpolicy-editor appscode/storagekubestashcom-retentionpolicy-editor -n default --create-namespace --version=v0.29.0 --values values.yaml
```
