...
*/}}
{{- define "kubedbcom-proxysql-editor-options.name" -}}
...
*/}}
{{- define "kubedbcom-proxysql-editor-options.fullname" -}}
...
*/}}
{{- define "kubedbcom-proxysql-editor-options.chart" -}}
...
Common labels
*/}}
{{- define "kubedbcom-proxysql-editor-options.labels" -}}
{{ include "kubedbcom-proxysql-editor-options.selectorLabels" . }}
...
Selector labels
*/}}
{{- define "kubedbcom-proxysql-editor-options.selectorLabels" -}}
app.kubernetes.io/name: proxysqls.kubedb.com
app.kubernetes.io/instance: {{ include "kubedbcom-proxysql-editor-options.fullname" . }}
{{- end }}

{{/*
Create the name of the service account to use
*/}}
{{- define "kubedbcom-proxysql-editor-options.serviceAccountName" -}}
{{- if .Values.spec.serviceAccount.create }}
{{- default (include "kubedbcom-proxysql-editor-options.fullname" .) .Values.spec.serviceAccount.name }}
{{- else }}
...
Common annotations
*/}}
{{- define "kubedbcom-proxysql-editor-options.annotations" -}}
...
Alert Enabled
*/}}
{{- define "kubedbcom-proxysql-editor-options.alertEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
