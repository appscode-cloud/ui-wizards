...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/kubedbcom-proxysql-editor-options --version=v0.4.17
$ helm upgrade -i kubedbcom-proxysql-editor-options bytebuilders-ui-dev/kubedbcom-proxysql-editor-options -n kube-system --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i kubedbcom-proxysql-editor-options bytebuilders-ui-dev/kubedbcom-proxysql-editor-options -n kube-system --create-namespace --version=v0.4.17 --set metadata.resource.group=kubedb.com
```
...
```bash
$ helm upgrade -i kubedbcom-proxysql-editor-options bytebuilders-ui-dev/kubedbcom-proxysql-editor-options -n kube-system --create-namespace --version=v0.4.17 --values values.yaml
```
