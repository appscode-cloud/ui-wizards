...
$ helm repo update
$ helm search repo bytebuilders-ui/certmanagerio-certificaterequest-editor --version=v0.4.16
$ helm upgrade -i certmanagerio-certificaterequest-editor bytebuilders-ui/certmanagerio-certificaterequest-editor -n default --create-namespace --version=v0.4.16
```
...
```bash
$ helm upgrade -i certmanagerio-certificaterequest-editor bytebuilders-ui/certmanagerio-certificaterequest-editor -n default --create-namespace --version=v0.4.16 --set apiVersion=cert-manager.io/v1
```
...
```bash
$ helm upgrade -i certmanagerio-certificaterequest-editor bytebuilders-ui/certmanagerio-certificaterequest-editor -n default --create-namespace --version=v0.4.16 --values values.yaml
```
