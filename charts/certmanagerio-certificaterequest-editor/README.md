...
$ helm repo update
$ helm search repo appscode-charts-oci/certmanagerio-certificaterequest-editor --version=v0.4.20
$ helm upgrade -i certmanagerio-certificaterequest-editor appscode-charts-oci/certmanagerio-certificaterequest-editor -n default --create-namespace --version=v0.4.20
```
...
```bash
$ helm upgrade -i certmanagerio-certificaterequest-editor appscode-charts-oci/certmanagerio-certificaterequest-editor -n default --create-namespace --version=v0.4.20 --set apiVersion=cert-manager.io/v1
```
...
```bash
$ helm upgrade -i certmanagerio-certificaterequest-editor appscode-charts-oci/certmanagerio-certificaterequest-editor -n default --create-namespace --version=v0.4.20 --values values.yaml
```
