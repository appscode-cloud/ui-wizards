...
$ helm repo update
$ helm search repo appscode-charts-oci/certmanagerio-certificaterequest-editor --version=v0.4.19
$ helm upgrade -i certmanagerio-certificaterequest-editor appscode-charts-oci/certmanagerio-certificaterequest-editor -n default --create-namespace --version=v0.4.19
```
...
```bash
$ helm upgrade -i certmanagerio-certificaterequest-editor appscode-charts-oci/certmanagerio-certificaterequest-editor -n default --create-namespace --version=v0.4.19 --set apiVersion=cert-manager.io/v1
```
...
```bash
$ helm upgrade -i certmanagerio-certificaterequest-editor appscode-charts-oci/certmanagerio-certificaterequest-editor -n default --create-namespace --version=v0.4.19 --values values.yaml
```
