...
$ helm repo update
$ helm search repo appscode-charts-oci/certmanagerio-certificaterequest-editor --version=v0.6.0
$ helm upgrade -i certmanagerio-certificaterequest-editor appscode-charts-oci/certmanagerio-certificaterequest-editor -n default --create-namespace --version=v0.6.0
```
...
```bash
$ helm upgrade -i certmanagerio-certificaterequest-editor appscode-charts-oci/certmanagerio-certificaterequest-editor -n default --create-namespace --version=v0.6.0 --set apiVersion=cert-manager.io/v1
```
...
```bash
$ helm upgrade -i certmanagerio-certificaterequest-editor appscode-charts-oci/certmanagerio-certificaterequest-editor -n default --create-namespace --version=v0.6.0 --values values.yaml
```
