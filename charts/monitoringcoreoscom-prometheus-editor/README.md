...
$ helm repo update
$ helm install monitoringcoreoscom-prometheus-editor bytebuilders-ui/monitoringcoreoscom-prometheus-editor -n default
```
...
```console
$ helm install monitoringcoreoscom-prometheus-editor bytebuilders-ui/monitoringcoreoscom-prometheus-editor -n default --set apiVersion=monitoring.coreos.com/v1
```
...
```console
$ helm install monitoringcoreoscom-prometheus-editor bytebuilders-ui/monitoringcoreoscom-prometheus-editor -n default --values values.yaml
```
