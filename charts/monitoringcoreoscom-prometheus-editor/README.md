...
$ helm repo update
$ helm search repo appscode-charts-oci/monitoringcoreoscom-prometheus-editor --version=v0.14.0
$ helm upgrade -i monitoringcoreoscom-prometheus-editor appscode-charts-oci/monitoringcoreoscom-prometheus-editor -n default --create-namespace --version=v0.14.0
```
...
```bash
$ helm upgrade -i monitoringcoreoscom-prometheus-editor appscode-charts-oci/monitoringcoreoscom-prometheus-editor -n default --create-namespace --version=v0.14.0 --set apiVersion=monitoring.coreos.com/v1
```
...
```bash
$ helm upgrade -i monitoringcoreoscom-prometheus-editor appscode-charts-oci/monitoringcoreoscom-prometheus-editor -n default --create-namespace --version=v0.14.0 --values values.yaml
```
