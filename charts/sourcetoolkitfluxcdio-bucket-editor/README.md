...
$ helm repo update
$ helm search repo bytebuilders-ui/sourcetoolkitfluxcdio-bucket-editor --version=v0.4.17
$ helm upgrade -i sourcetoolkitfluxcdio-bucket-editor bytebuilders-ui/sourcetoolkitfluxcdio-bucket-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i sourcetoolkitfluxcdio-bucket-editor bytebuilders-ui/sourcetoolkitfluxcdio-bucket-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=source.toolkit.fluxcd.io/v1beta2
```
...
```bash
$ helm upgrade -i sourcetoolkitfluxcdio-bucket-editor bytebuilders-ui/sourcetoolkitfluxcdio-bucket-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
