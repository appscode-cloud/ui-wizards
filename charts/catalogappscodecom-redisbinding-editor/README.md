...
$ helm repo update
$ helm search repo appscode-charts-oci/catalogappscodecom-redisbinding-editor --version=v0.13.0
$ helm upgrade -i catalogappscodecom-redisbinding-editor appscode-charts-oci/catalogappscodecom-redisbinding-editor -n default --create-namespace --version=v0.13.0
```
...
```bash
$ helm upgrade -i catalogappscodecom-redisbinding-editor appscode-charts-oci/catalogappscodecom-redisbinding-editor -n default --create-namespace --version=v0.13.0 --set apiVersion=catalog.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i catalogappscodecom-redisbinding-editor appscode-charts-oci/catalogappscodecom-redisbinding-editor -n default --create-namespace --version=v0.13.0 --values values.yaml
```
