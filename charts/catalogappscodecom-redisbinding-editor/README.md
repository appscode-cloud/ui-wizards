...
$ helm repo update
$ helm search repo appscode/catalogappscodecom-redisbinding-editor --version=v0.21.0
$ helm upgrade -i catalogappscodecom-redisbinding-editor appscode/catalogappscodecom-redisbinding-editor -n default --create-namespace --version=v0.21.0
```
...
```bash
$ helm upgrade -i catalogappscodecom-redisbinding-editor appscode/catalogappscodecom-redisbinding-editor -n default --create-namespace --version=v0.21.0 --set apiVersion=catalog.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i catalogappscodecom-redisbinding-editor appscode/catalogappscodecom-redisbinding-editor -n default --create-namespace --version=v0.21.0 --values values.yaml
```
