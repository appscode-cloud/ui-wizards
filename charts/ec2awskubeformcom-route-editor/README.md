...
$ helm repo update
$ helm search repo bytebuilders-ui/ec2awskubeformcom-route-editor --version=v0.4.18
$ helm upgrade -i ec2awskubeformcom-route-editor bytebuilders-ui/ec2awskubeformcom-route-editor -n default --create-namespace --version=v0.4.18
```
...
```bash
$ helm upgrade -i ec2awskubeformcom-route-editor bytebuilders-ui/ec2awskubeformcom-route-editor -n default --create-namespace --version=v0.4.18 --set apiVersion=ec2.aws.kubeform.com/v1alpha1
```
...
```bash
$ helm upgrade -i ec2awskubeformcom-route-editor bytebuilders-ui/ec2awskubeformcom-route-editor -n default --create-namespace --version=v0.4.18 --values values.yaml
```
