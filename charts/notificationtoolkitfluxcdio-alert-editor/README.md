...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/notificationtoolkitfluxcdio-alert-editor --version=v0.4.17
$ helm upgrade -i notificationtoolkitfluxcdio-alert-editor bytebuilders-ui-dev/notificationtoolkitfluxcdio-alert-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i notificationtoolkitfluxcdio-alert-editor bytebuilders-ui-dev/notificationtoolkitfluxcdio-alert-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=notification.toolkit.fluxcd.io/v1beta1
```
...
```bash
$ helm upgrade -i notificationtoolkitfluxcdio-alert-editor bytebuilders-ui-dev/notificationtoolkitfluxcdio-alert-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
