...
$ helm repo add  
$ helm repo update
$ helm search repo /stashappscodecom-restoresession-editor-options --version=v0.4.11
$ helm upgrade -i stashappscodecom-restoresession-editor-options /stashappscodecom-restoresession-editor-options -n kube-system --create-namespace --version=v0.4.11
```
...
```bash
$ helm upgrade -i stashappscodecom-restoresession-editor-options /stashappscodecom-restoresession-editor-options -n kube-system --create-namespace --version=v0.4.11 --set metadata.resource.group=stash.appscode.com
```
...
```bash
$ helm upgrade -i stashappscodecom-restoresession-editor-options /stashappscodecom-restoresession-editor-options -n kube-system --create-namespace --version=v0.4.11 --values values.yaml
```
