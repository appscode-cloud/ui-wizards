...
$ helm repo update
$ helm search repo appscode/uikubedbcom-mariadbschemaoverview-editor --version=v0.16.0
$ helm upgrade -i uikubedbcom-mariadbschemaoverview-editor appscode/uikubedbcom-mariadbschemaoverview-editor -n default --create-namespace --version=v0.16.0
```
...
```bash
$ helm upgrade -i uikubedbcom-mariadbschemaoverview-editor appscode/uikubedbcom-mariadbschemaoverview-editor -n default --create-namespace --version=v0.16.0 --set apiVersion=ui.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i uikubedbcom-mariadbschemaoverview-editor appscode/uikubedbcom-mariadbschemaoverview-editor -n default --create-namespace --version=v0.16.0 --values values.yaml
```
