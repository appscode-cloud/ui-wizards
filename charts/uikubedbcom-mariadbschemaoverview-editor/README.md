...
$ helm repo update
$ helm search repo appscode-charts-oci/uikubedbcom-mariadbschemaoverview-editor --version=v0.13.0
$ helm upgrade -i uikubedbcom-mariadbschemaoverview-editor appscode-charts-oci/uikubedbcom-mariadbschemaoverview-editor -n default --create-namespace --version=v0.13.0
```
...
```bash
$ helm upgrade -i uikubedbcom-mariadbschemaoverview-editor appscode-charts-oci/uikubedbcom-mariadbschemaoverview-editor -n default --create-namespace --version=v0.13.0 --set apiVersion=ui.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i uikubedbcom-mariadbschemaoverview-editor appscode-charts-oci/uikubedbcom-mariadbschemaoverview-editor -n default --create-namespace --version=v0.13.0 --values values.yaml
```
