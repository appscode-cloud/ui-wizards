...
$ helm repo update
$ helm search repo appscode/sourcetoolkitfluxcdio-ocirepository-editor --version=v0.37.0
$ helm upgrade -i sourcetoolkitfluxcdio-ocirepository-editor appscode/sourcetoolkitfluxcdio-ocirepository-editor -n default --create-namespace --version=v0.37.0
```
...
```bash
$ helm upgrade -i sourcetoolkitfluxcdio-ocirepository-editor appscode/sourcetoolkitfluxcdio-ocirepository-editor -n default --create-namespace --version=v0.37.0 --set apiVersion=source.toolkit.fluxcd.io/v1beta2
```
...
```bash
$ helm upgrade -i sourcetoolkitfluxcdio-ocirepository-editor appscode/sourcetoolkitfluxcdio-ocirepository-editor -n default --create-namespace --version=v0.37.0 --values values.yaml
```
