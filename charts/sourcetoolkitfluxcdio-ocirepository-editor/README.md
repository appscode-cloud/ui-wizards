...
$ helm repo update
$ helm search repo bytebuilders-ui/sourcetoolkitfluxcdio-ocirepository-editor --version=v0.4.14
$ helm upgrade -i sourcetoolkitfluxcdio-ocirepository-editor bytebuilders-ui/sourcetoolkitfluxcdio-ocirepository-editor -n default --create-namespace --version=v0.4.14
```
...
```bash
$ helm upgrade -i sourcetoolkitfluxcdio-ocirepository-editor bytebuilders-ui/sourcetoolkitfluxcdio-ocirepository-editor -n default --create-namespace --version=v0.4.14 --set apiVersion=source.toolkit.fluxcd.io/v1beta2
```
...
```bash
$ helm upgrade -i sourcetoolkitfluxcdio-ocirepository-editor bytebuilders-ui/sourcetoolkitfluxcdio-ocirepository-editor -n default --create-namespace --version=v0.4.14 --values values.yaml
```
