...
$ helm repo update
$ helm search repo appscode-charts-oci/kinesisawskubedbcom-stream-editor --version=v0.11.0
...
```bash
$ helm upgrade -i kinesisawskubedbcom-stream-editor appscode-charts-oci/kinesisawskubedbcom-stream-editor -n default --create-namespace --version=v0.11.0 --set apiVersion=kinesis.aws.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i kinesisawskubedbcom-stream-editor appscode-charts-oci/kinesisawskubedbcom-stream-editor -n default --create-namespace --version=v0.11.0 --values values.yaml
```
