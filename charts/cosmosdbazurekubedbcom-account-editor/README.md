...
$ helm repo update
$ helm search repo appscode/cosmosdbazurekubedbcom-account-editor --version=v0.17.0
$ helm upgrade -i cosmosdbazurekubedbcom-account-editor appscode/cosmosdbazurekubedbcom-account-editor -n default --create-namespace --version=v0.17.0
```
...
```bash
$ helm upgrade -i cosmosdbazurekubedbcom-account-editor appscode/cosmosdbazurekubedbcom-account-editor -n default --create-namespace --version=v0.17.0 --set apiVersion=cosmosdb.azure.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i cosmosdbazurekubedbcom-account-editor appscode/cosmosdbazurekubedbcom-account-editor -n default --create-namespace --version=v0.17.0 --values values.yaml
```
