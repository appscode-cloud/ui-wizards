...
$ helm repo update
$ helm search repo appscode-charts-oci/catalogkubedbcom-kafkaconnectorversion-editor --version=v0.12.0
$ helm upgrade -i catalogkubedbcom-kafkaconnectorversion-editor appscode-charts-oci/catalogkubedbcom-kafkaconnectorversion-editor -n default --create-namespace --version=v0.12.0
```
...
```bash
$ helm upgrade -i catalogkubedbcom-kafkaconnectorversion-editor appscode-charts-oci/catalogkubedbcom-kafkaconnectorversion-editor -n default --create-namespace --version=v0.12.0 --set apiVersion=catalog.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i catalogkubedbcom-kafkaconnectorversion-editor appscode-charts-oci/catalogkubedbcom-kafkaconnectorversion-editor -n default --create-namespace --version=v0.12.0 --values values.yaml
```
