...
$ helm repo update
$ helm search repo appscode-charts-oci/sqlazurekubedbcom-mssqldatabase-editor --version=v0.6.0
$ helm upgrade -i sqlazurekubedbcom-mssqldatabase-editor appscode-charts-oci/sqlazurekubedbcom-mssqldatabase-editor -n default --create-namespace --version=v0.6.0
```
...
```bash
$ helm upgrade -i sqlazurekubedbcom-mssqldatabase-editor appscode-charts-oci/sqlazurekubedbcom-mssqldatabase-editor -n default --create-namespace --version=v0.6.0 --set apiVersion=sql.azure.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i sqlazurekubedbcom-mssqldatabase-editor appscode-charts-oci/sqlazurekubedbcom-mssqldatabase-editor -n default --create-namespace --version=v0.6.0 --values values.yaml
```
