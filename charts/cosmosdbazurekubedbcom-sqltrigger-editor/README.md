...
$ helm repo update
$ helm search repo appscode/cosmosdbazurekubedbcom-sqltrigger-editor --version=v0.20.0
$ helm upgrade -i cosmosdbazurekubedbcom-sqltrigger-editor appscode/cosmosdbazurekubedbcom-sqltrigger-editor -n default --create-namespace --version=v0.20.0
```
...
```bash
$ helm upgrade -i cosmosdbazurekubedbcom-sqltrigger-editor appscode/cosmosdbazurekubedbcom-sqltrigger-editor -n default --create-namespace --version=v0.20.0 --set apiVersion=cosmosdb.azure.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i cosmosdbazurekubedbcom-sqltrigger-editor appscode/cosmosdbazurekubedbcom-sqltrigger-editor -n default --create-namespace --version=v0.20.0 --values values.yaml
```
