...
$ helm repo update
$ helm search repo appscode/authorizationk8sio-selfsubjectrulesreview-editor --version=v0.29.0
$ helm upgrade -i authorizationk8sio-selfsubjectrulesreview-editor appscode/authorizationk8sio-selfsubjectrulesreview-editor -n default --create-namespace --version=v0.29.0
```
...
```bash
$ helm upgrade -i authorizationk8sio-selfsubjectrulesreview-editor appscode/authorizationk8sio-selfsubjectrulesreview-editor -n default --create-namespace --version=v0.29.0 --set apiVersion=authorization.k8s.io/v1
```
...
```bash
$ helm upgrade -i authorizationk8sio-selfsubjectrulesreview-editor appscode/authorizationk8sio-selfsubjectrulesreview-editor -n default --create-namespace --version=v0.29.0 --values values.yaml
```
