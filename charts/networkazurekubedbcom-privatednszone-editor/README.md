...
$ helm repo update
$ helm search repo appscode-charts-oci/networkazurekubedbcom-privatednszone-editor --version=v0.8.0
$ helm upgrade -i networkazurekubedbcom-privatednszone-editor appscode-charts-oci/networkazurekubedbcom-privatednszone-editor -n default --create-namespace --version=v0.8.0
```
...
```bash
$ helm upgrade -i networkazurekubedbcom-privatednszone-editor appscode-charts-oci/networkazurekubedbcom-privatednszone-editor -n default --create-namespace --version=v0.8.0 --set apiVersion=network.azure.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i networkazurekubedbcom-privatednszone-editor appscode-charts-oci/networkazurekubedbcom-privatednszone-editor -n default --create-namespace --version=v0.8.0 --values values.yaml
```
