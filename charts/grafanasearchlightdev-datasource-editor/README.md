...
$ helm repo update
$ helm search repo appscode/grafanasearchlightdev-datasource-editor --version=v0.25.0
$ helm upgrade -i grafanasearchlightdev-datasource-editor appscode/grafanasearchlightdev-datasource-editor -n default --create-namespace --version=v0.25.0
```
...
```bash
$ helm upgrade -i grafanasearchlightdev-datasource-editor appscode/grafanasearchlightdev-datasource-editor -n default --create-namespace --version=v0.25.0 --set apiVersion=grafana.searchlight.dev/v1alpha1
```
...
```bash
$ helm upgrade -i grafanasearchlightdev-datasource-editor appscode/grafanasearchlightdev-datasource-editor -n default --create-namespace --version=v0.25.0 --values values.yaml
```
