...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/grafanasearchlightdev-datasource-editor --version=v0.4.17
$ helm upgrade -i grafanasearchlightdev-datasource-editor bytebuilders-ui-dev/grafanasearchlightdev-datasource-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i grafanasearchlightdev-datasource-editor bytebuilders-ui-dev/grafanasearchlightdev-datasource-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=grafana.searchlight.dev/v1alpha1
```
...
```bash
$ helm upgrade -i grafanasearchlightdev-datasource-editor bytebuilders-ui-dev/grafanasearchlightdev-datasource-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
