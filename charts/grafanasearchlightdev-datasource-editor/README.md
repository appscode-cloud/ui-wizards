...
$ helm repo update
$ helm search repo bytebuilders-ui/grafanasearchlightdev-datasource-editor --version=v0.4.21
$ helm upgrade -i grafanasearchlightdev-datasource-editor bytebuilders-ui/grafanasearchlightdev-datasource-editor -n default --create-namespace --version=v0.4.21
```
...
```bash
$ helm upgrade -i grafanasearchlightdev-datasource-editor bytebuilders-ui/grafanasearchlightdev-datasource-editor -n default --create-namespace --version=v0.4.21 --set apiVersion=grafana.searchlight.dev/v1alpha1
```
...
```bash
$ helm upgrade -i grafanasearchlightdev-datasource-editor bytebuilders-ui/grafanasearchlightdev-datasource-editor -n default --create-namespace --version=v0.4.21 --values values.yaml
```
