...
$ helm repo update
$ helm search repo appscode/metak8sappscodecom-resourcecalculator-editor --version=v0.20.0
$ helm upgrade -i metak8sappscodecom-resourcecalculator-editor appscode/metak8sappscodecom-resourcecalculator-editor -n default --create-namespace --version=v0.20.0
```
...
```bash
$ helm upgrade -i metak8sappscodecom-resourcecalculator-editor appscode/metak8sappscodecom-resourcecalculator-editor -n default --create-namespace --version=v0.20.0 --set apiVersion=meta.k8s.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i metak8sappscodecom-resourcecalculator-editor appscode/metak8sappscodecom-resourcecalculator-editor -n default --create-namespace --version=v0.20.0 --values values.yaml
```
