...
$ helm repo update
$ helm search repo appscode-charts-oci/stashappscodecom-restorebatch-editor --version=v0.6.0
$ helm upgrade -i stashappscodecom-restorebatch-editor appscode-charts-oci/stashappscodecom-restorebatch-editor -n default --create-namespace --version=v0.6.0
```
...
```bash
$ helm upgrade -i stashappscodecom-restorebatch-editor appscode-charts-oci/stashappscodecom-restorebatch-editor -n default --create-namespace --version=v0.6.0 --set apiVersion=stash.appscode.com/v1beta1
```
...
```bash
$ helm upgrade -i stashappscodecom-restorebatch-editor appscode-charts-oci/stashappscodecom-restorebatch-editor -n default --create-namespace --version=v0.6.0 --values values.yaml
```
