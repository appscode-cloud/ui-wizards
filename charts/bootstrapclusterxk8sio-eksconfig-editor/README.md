...
$ helm repo update
$ helm search repo appscode/bootstrapclusterxk8sio-eksconfig-editor --version=v0.34.0
$ helm upgrade -i bootstrapclusterxk8sio-eksconfig-editor appscode/bootstrapclusterxk8sio-eksconfig-editor -n default --create-namespace --version=v0.34.0
```
...
```bash
$ helm upgrade -i bootstrapclusterxk8sio-eksconfig-editor appscode/bootstrapclusterxk8sio-eksconfig-editor -n default --create-namespace --version=v0.34.0 --set apiVersion=bootstrap.cluster.x-k8s.io/v1beta2
```
...
```bash
$ helm upgrade -i bootstrapclusterxk8sio-eksconfig-editor appscode/bootstrapclusterxk8sio-eksconfig-editor -n default --create-namespace --version=v0.34.0 --values values.yaml
```
