...
$ helm repo update
$ helm search repo bytebuilders-ui/bootstrapclusterxk8sio-eksconfig-editor --version=v0.4.15
$ helm upgrade -i bootstrapclusterxk8sio-eksconfig-editor bytebuilders-ui/bootstrapclusterxk8sio-eksconfig-editor -n default --create-namespace --version=v0.4.15
```
...
```bash
$ helm upgrade -i bootstrapclusterxk8sio-eksconfig-editor bytebuilders-ui/bootstrapclusterxk8sio-eksconfig-editor -n default --create-namespace --version=v0.4.15 --set apiVersion=bootstrap.cluster.x-k8s.io/v1beta2
```
...
```bash
$ helm upgrade -i bootstrapclusterxk8sio-eksconfig-editor bytebuilders-ui/bootstrapclusterxk8sio-eksconfig-editor -n default --create-namespace --version=v0.4.15 --values values.yaml
```
