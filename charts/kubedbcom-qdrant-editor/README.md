...
$ helm repo update
$ helm search repo appscode/kubedbcom-qdrant-editor --version=v0.35.0
$ helm upgrade -i kubedbcom-qdrant-editor appscode/kubedbcom-qdrant-editor -n default --create-namespace --version=v0.35.0
```
...
```bash
$ helm upgrade -i kubedbcom-qdrant-editor appscode/kubedbcom-qdrant-editor -n default --create-namespace --version=v0.35.0 --values values.yaml
```
