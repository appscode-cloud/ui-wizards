...
```bash
$ helm upgrade -i kubedbcom-druid-editor appscode-charts-oci/kubedbcom-druid-editor -n default --create-namespace --version=v0.4.18 --set apiVersion=kubedb.com/v1alpha2
```
