...
$ helm repo update
$ helm search repo appscode/kubedbcom-druid-editor --version=v0.36.0
$ helm upgrade -i kubedbcom-druid-editor appscode/kubedbcom-druid-editor -n default --create-namespace --version=v0.36.0
```
...
```bash
$ helm upgrade -i kubedbcom-druid-editor appscode/kubedbcom-druid-editor -n default --create-namespace --version=v0.36.0 --values values.yaml
```
