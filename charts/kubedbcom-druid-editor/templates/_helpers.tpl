...
*/}}
{{- define "kubedbcom-druid-editor.name" -}}
...
*/}}
{{- define "kubedbcom-druid-editor.fullname" -}}
...
*/}}
{{- define "kubedbcom-druid-editor.chart" -}}
...
Common labels
*/}}
{{- define "kubedbcom-druid-editor.labels" -}}
{{ include "kubedbcom-druid-editor.selectorLabels" . }}
...
Selector labels
*/}}
{{- define "kubedbcom-druid-editor.selectorLabels" -}}
app.kubernetes.io/name: druids.kubedb.com
app.kubernetes.io/instance: {{ include "kubedbcom-druid-editor.fullname" . }}
{{- end }}

{{/*
Create the name of the service account to use
*/}}
{{- define "kubedbcom-druid-editor.serviceAccountName" -}}
{{- if .Values.spec.serviceAccount.create }}
{{- default (include "kubedbcom-druid-editor.fullname" .) .Values.spec.serviceAccount.name }}
{{- else }}
...
Common annotations
*/}}
{{- define "kubedbcom-druid-editor.annotations" -}}
...
Alert Enabled
*/}}
{{- define "kubedbcom-druid-editor.alertEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
