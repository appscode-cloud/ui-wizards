...
$ helm repo update
$ helm search repo appscode/karpentersh-nodeclaim-editor --version=v0.22.0
$ helm upgrade -i karpentersh-nodeclaim-editor appscode/karpentersh-nodeclaim-editor -n default --create-namespace --version=v0.22.0
```
...
```bash
$ helm upgrade -i karpentersh-nodeclaim-editor appscode/karpentersh-nodeclaim-editor -n default --create-namespace --version=v0.22.0 --set apiVersion=karpenter.sh/v1beta1
```
...
```bash
$ helm upgrade -i karpentersh-nodeclaim-editor appscode/karpentersh-nodeclaim-editor -n default --create-namespace --version=v0.22.0 --values values.yaml
```
