...
$ helm repo update
$ helm search repo bytebuilders-ui/operatoropenclustermanagementio-klusterlet-editor --version=v0.4.16
$ helm upgrade -i operatoropenclustermanagementio-klusterlet-editor bytebuilders-ui/operatoropenclustermanagementio-klusterlet-editor -n default --create-namespace --version=v0.4.16
```
...
```bash
$ helm upgrade -i operatoropenclustermanagementio-klusterlet-editor bytebuilders-ui/operatoropenclustermanagementio-klusterlet-editor -n default --create-namespace --version=v0.4.16 --set apiVersion=operator.open-cluster-management.io/v1
```
...
```bash
$ helm upgrade -i operatoropenclustermanagementio-klusterlet-editor bytebuilders-ui/operatoropenclustermanagementio-klusterlet-editor -n default --create-namespace --version=v0.4.16 --values values.yaml
```
