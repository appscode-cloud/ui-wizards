...
$ helm repo update
$ helm search repo appscode/operatoropenclustermanagementio-klusterlet-editor --version=v0.17.0
$ helm upgrade -i operatoropenclustermanagementio-klusterlet-editor appscode/operatoropenclustermanagementio-klusterlet-editor -n default --create-namespace --version=v0.17.0
```
...
```bash
$ helm upgrade -i operatoropenclustermanagementio-klusterlet-editor appscode/operatoropenclustermanagementio-klusterlet-editor -n default --create-namespace --version=v0.17.0 --set apiVersion=operator.open-cluster-management.io/v1
```
...
```bash
$ helm upgrade -i operatoropenclustermanagementio-klusterlet-editor appscode/operatoropenclustermanagementio-klusterlet-editor -n default --create-namespace --version=v0.17.0 --values values.yaml
```
