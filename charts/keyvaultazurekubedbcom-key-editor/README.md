...
$ helm repo update
$ helm search repo appscode-charts-oci/keyvaultazurekubedbcom-key-editor --version=v0.4.20
$ helm upgrade -i keyvaultazurekubedbcom-key-editor appscode-charts-oci/keyvaultazurekubedbcom-key-editor -n default --create-namespace --version=v0.4.20
```
...
```bash
$ helm upgrade -i keyvaultazurekubedbcom-key-editor appscode-charts-oci/keyvaultazurekubedbcom-key-editor -n default --create-namespace --version=v0.4.20 --set apiVersion=keyvault.azure.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i keyvaultazurekubedbcom-key-editor appscode-charts-oci/keyvaultazurekubedbcom-key-editor -n default --create-namespace --version=v0.4.20 --values values.yaml
```
