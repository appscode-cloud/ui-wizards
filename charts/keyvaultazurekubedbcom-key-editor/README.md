...
$ helm repo update
$ helm search repo appscode-charts-oci/keyvaultazurekubedbcom-key-editor --version=v0.14.0
$ helm upgrade -i keyvaultazurekubedbcom-key-editor appscode-charts-oci/keyvaultazurekubedbcom-key-editor -n default --create-namespace --version=v0.14.0
```
...
```bash
$ helm upgrade -i keyvaultazurekubedbcom-key-editor appscode-charts-oci/keyvaultazurekubedbcom-key-editor -n default --create-namespace --version=v0.14.0 --set apiVersion=keyvault.azure.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i keyvaultazurekubedbcom-key-editor appscode-charts-oci/keyvaultazurekubedbcom-key-editor -n default --create-namespace --version=v0.14.0 --values values.yaml
```
