...
$ helm repo update
$ helm search repo appscode/kubedbcom-oracle-editor --version=v0.35.0
$ helm upgrade -i kubedbcom-oracle-editor appscode/kubedbcom-oracle-editor -n default --create-namespace --version=v0.35.0
```
...
```bash
$ helm upgrade -i kubedbcom-oracle-editor appscode/kubedbcom-oracle-editor -n default --create-namespace --version=v0.35.0 --set form.alert.enabled=warning
```
...
```bash
$ helm upgrade -i kubedbcom-oracle-editor appscode/kubedbcom-oracle-editor -n default --create-namespace --version=v0.35.0 --values values.yaml
```
