...
*/}}
{{- define "kubedbcom-oracle-editor.name" -}}
...
*/}}
{{- define "kubedbcom-oracle-editor.fullname" -}}
...
*/}}
{{- define "kubedbcom-oracle-editor.chart" -}}
...
Common labels
*/}}
{{- define "kubedbcom-oracle-editor.labels" -}}
{{ include "kubedbcom-oracle-editor.selectorLabels" . }}
...
Selector labels
*/}}
{{- define "kubedbcom-oracle-editor.selectorLabels" -}}
app.kubernetes.io/name: oracles.kubedb.com
app.kubernetes.io/instance: {{ include "kubedbcom-oracle-editor.fullname" . }}
{{- end }}

{{/*
Create the name of the service account to use
*/}}
{{- define "kubedbcom-oracle-editor.serviceAccountName" -}}
{{- if .Values.spec.serviceAccount.create }}
{{- default (include "kubedbcom-oracle-editor.fullname" .) .Values.spec.serviceAccount.name }}
{{- else }}
...
Common annotations
*/}}
{{- define "kubedbcom-oracle-editor.annotations" -}}
