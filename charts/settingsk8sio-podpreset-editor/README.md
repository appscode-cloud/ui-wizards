...
$ helm repo update
$ helm search repo appscode-charts-oci/settingsk8sio-podpreset-editor --version=v0.13.0
$ helm upgrade -i settingsk8sio-podpreset-editor appscode-charts-oci/settingsk8sio-podpreset-editor -n default --create-namespace --version=v0.13.0
```
...
```bash
$ helm upgrade -i settingsk8sio-podpreset-editor appscode-charts-oci/settingsk8sio-podpreset-editor -n default --create-namespace --version=v0.13.0 --set apiVersion=settings.k8s.io/v1alpha1
```
...
```bash
$ helm upgrade -i settingsk8sio-podpreset-editor appscode-charts-oci/settingsk8sio-podpreset-editor -n default --create-namespace --version=v0.13.0 --values values.yaml
```
