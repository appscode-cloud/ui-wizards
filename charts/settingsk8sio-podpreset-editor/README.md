...
$ helm repo update
$ helm search repo bytebuilders-ui/settingsk8sio-podpreset-editor --version=v0.4.15
$ helm upgrade -i settingsk8sio-podpreset-editor bytebuilders-ui/settingsk8sio-podpreset-editor -n default --create-namespace --version=v0.4.15
```
...
```bash
$ helm upgrade -i settingsk8sio-podpreset-editor bytebuilders-ui/settingsk8sio-podpreset-editor -n default --create-namespace --version=v0.4.15 --set apiVersion=settings.k8s.io/v1alpha1
```
...
```bash
$ helm upgrade -i settingsk8sio-podpreset-editor bytebuilders-ui/settingsk8sio-podpreset-editor -n default --create-namespace --version=v0.4.15 --values values.yaml
```
