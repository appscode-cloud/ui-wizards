...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/apps-deployment-editor --version=v0.4.17
$ helm upgrade -i apps-deployment-editor bytebuilders-ui-dev/apps-deployment-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i apps-deployment-editor bytebuilders-ui-dev/apps-deployment-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=apps/v1
```
...
```bash
$ helm upgrade -i apps-deployment-editor bytebuilders-ui-dev/apps-deployment-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
