...
$ helm repo update
$ helm search repo appscode-charts-oci/apps-deployment-editor --version=v0.7.0
$ helm upgrade -i apps-deployment-editor appscode-charts-oci/apps-deployment-editor -n default --create-namespace --version=v0.7.0
```
...
```bash
$ helm upgrade -i apps-deployment-editor appscode-charts-oci/apps-deployment-editor -n default --create-namespace --version=v0.7.0 --set apiVersion=apps/v1
```
...
```bash
$ helm upgrade -i apps-deployment-editor appscode-charts-oci/apps-deployment-editor -n default --create-namespace --version=v0.7.0 --values values.yaml
```
