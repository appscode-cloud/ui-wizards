...
$ helm repo update
$ helm install apps-deployment-editor bytebuilders-ui-dev/apps-deployment-editor -n default
```
...
```console
$ helm install apps-deployment-editor bytebuilders-ui-dev/apps-deployment-editor -n default --set apiVersion=apps/v1
```
...
```console
$ helm install apps-deployment-editor bytebuilders-ui-dev/apps-deployment-editor -n default --values values.yaml
```
