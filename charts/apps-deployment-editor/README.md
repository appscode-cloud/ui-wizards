...
$ helm repo update
$ helm search repo appscode/apps-deployment-editor --version=v0.28.0
$ helm upgrade -i apps-deployment-editor appscode/apps-deployment-editor -n default --create-namespace --version=v0.28.0
```
...
```bash
$ helm upgrade -i apps-deployment-editor appscode/apps-deployment-editor -n default --create-namespace --version=v0.28.0 --set apiVersion=apps/v1
```
...
```bash
$ helm upgrade -i apps-deployment-editor appscode/apps-deployment-editor -n default --create-namespace --version=v0.28.0 --values values.yaml
```
