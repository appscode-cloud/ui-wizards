...
$ helm repo update
$ helm search repo appscode-charts-oci/secretsstorecsixk8sio-secretproviderclasspodstatus-editor --version=v0.12.0
$ helm upgrade -i secretsstorecsixk8sio-secretproviderclasspodstatus-editor appscode-charts-oci/secretsstorecsixk8sio-secretproviderclasspodstatus-editor -n default --create-namespace --version=v0.12.0
```
...
```bash
$ helm upgrade -i secretsstorecsixk8sio-secretproviderclasspodstatus-editor appscode-charts-oci/secretsstorecsixk8sio-secretproviderclasspodstatus-editor -n default --create-namespace --version=v0.12.0 --set apiVersion=secrets-store.csi.x-k8s.io/v1alpha1
```
...
```bash
$ helm upgrade -i secretsstorecsixk8sio-secretproviderclasspodstatus-editor appscode-charts-oci/secretsstorecsixk8sio-secretproviderclasspodstatus-editor -n default --create-namespace --version=v0.12.0 --values values.yaml
```
