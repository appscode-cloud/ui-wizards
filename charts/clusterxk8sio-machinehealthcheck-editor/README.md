...
$ helm repo update
$ helm search repo appscode-charts-oci/clusterxk8sio-machinehealthcheck-editor --version=v0.4.19
$ helm upgrade -i clusterxk8sio-machinehealthcheck-editor appscode-charts-oci/clusterxk8sio-machinehealthcheck-editor -n default --create-namespace --version=v0.4.19
```
...
```bash
$ helm upgrade -i clusterxk8sio-machinehealthcheck-editor appscode-charts-oci/clusterxk8sio-machinehealthcheck-editor -n default --create-namespace --version=v0.4.19 --set apiVersion=cluster.x-k8s.io/v1beta1
```
...
```bash
$ helm upgrade -i clusterxk8sio-machinehealthcheck-editor appscode-charts-oci/clusterxk8sio-machinehealthcheck-editor -n default --create-namespace --version=v0.4.19 --values values.yaml
```
