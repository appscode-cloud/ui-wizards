...
$ helm repo update
$ helm search repo appscode/clusterxk8sio-machinehealthcheck-editor --version=v0.14.0
$ helm upgrade -i clusterxk8sio-machinehealthcheck-editor appscode/clusterxk8sio-machinehealthcheck-editor -n default --create-namespace --version=v0.14.0
```
...
```bash
$ helm upgrade -i clusterxk8sio-machinehealthcheck-editor appscode/clusterxk8sio-machinehealthcheck-editor -n default --create-namespace --version=v0.14.0 --set apiVersion=cluster.x-k8s.io/v1beta1
```
...
```bash
$ helm upgrade -i clusterxk8sio-machinehealthcheck-editor appscode/clusterxk8sio-machinehealthcheck-editor -n default --create-namespace --version=v0.14.0 --values values.yaml
```
