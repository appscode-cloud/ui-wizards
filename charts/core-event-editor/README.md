...
$ helm repo update
$ helm search repo bytebuilders-ui/core-event-editor --version=v0.4.4
$ helm upgrade -i core-event-editor bytebuilders-ui/core-event-editor -n default --create-namespace --version=v0.4.4
```
...
```bash
$ helm upgrade -i core-event-editor bytebuilders-ui/core-event-editor -n default --create-namespace --version=v0.4.4 --set apiVersion=v1
```
...
```bash
$ helm upgrade -i core-event-editor bytebuilders-ui/core-event-editor -n default --create-namespace --version=v0.4.4 --values values.yaml
```
