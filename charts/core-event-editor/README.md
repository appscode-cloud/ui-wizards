...
$ helm repo update
$ helm search repo bytebuilders-ui/core-event-editor --version=v0.4.12
$ helm upgrade -i core-event-editor bytebuilders-ui/core-event-editor -n default --create-namespace --version=v0.4.12
```
...
```bash
$ helm upgrade -i core-event-editor bytebuilders-ui/core-event-editor -n default --create-namespace --version=v0.4.12 --set apiVersion=v1
```
...
```bash
$ helm upgrade -i core-event-editor bytebuilders-ui/core-event-editor -n default --create-namespace --version=v0.4.12 --values values.yaml
```
