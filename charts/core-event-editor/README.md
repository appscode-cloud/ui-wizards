...
$ helm repo update
$ helm search repo appscode/core-event-editor --version=v0.33.0
$ helm upgrade -i core-event-editor appscode/core-event-editor -n default --create-namespace --version=v0.33.0
```
...
```bash
$ helm upgrade -i core-event-editor appscode/core-event-editor -n default --create-namespace --version=v0.33.0 --set apiVersion=v1
```
...
```bash
$ helm upgrade -i core-event-editor appscode/core-event-editor -n default --create-namespace --version=v0.33.0 --values values.yaml
```
