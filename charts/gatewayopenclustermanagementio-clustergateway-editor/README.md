...
$ helm repo update
$ helm search repo appscode-charts-oci/gatewayopenclustermanagementio-clustergateway-editor --version=v0.7.0
$ helm upgrade -i gatewayopenclustermanagementio-clustergateway-editor appscode-charts-oci/gatewayopenclustermanagementio-clustergateway-editor -n default --create-namespace --version=v0.7.0
```
...
```bash
$ helm upgrade -i gatewayopenclustermanagementio-clustergateway-editor appscode-charts-oci/gatewayopenclustermanagementio-clustergateway-editor -n default --create-namespace --version=v0.7.0 --set apiVersion=gateway.open-cluster-management.io/v1alpha1
```
...
```bash
$ helm upgrade -i gatewayopenclustermanagementio-clustergateway-editor appscode-charts-oci/gatewayopenclustermanagementio-clustergateway-editor -n default --create-namespace --version=v0.7.0 --values values.yaml
```
