...
$ helm repo update
$ helm search repo appscode-charts-oci/falcoappscodecom-falcoevent-editor --version=v0.4.21
$ helm upgrade -i falcoappscodecom-falcoevent-editor appscode-charts-oci/falcoappscodecom-falcoevent-editor -n default --create-namespace --version=v0.4.21
```
...
```bash
$ helm upgrade -i falcoappscodecom-falcoevent-editor appscode-charts-oci/falcoappscodecom-falcoevent-editor -n default --create-namespace --version=v0.4.21 --set apiVersion=falco.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i falcoappscodecom-falcoevent-editor appscode-charts-oci/falcoappscodecom-falcoevent-editor -n default --create-namespace --version=v0.4.21 --values values.yaml
```
