...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/falcoappscodecom-falcoevent-editor --version=v0.4.17
$ helm upgrade -i falcoappscodecom-falcoevent-editor bytebuilders-ui-dev/falcoappscodecom-falcoevent-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i falcoappscodecom-falcoevent-editor bytebuilders-ui-dev/falcoappscodecom-falcoevent-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=falco.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i falcoappscodecom-falcoevent-editor bytebuilders-ui-dev/falcoappscodecom-falcoevent-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
