...
$ helm repo update
$ helm search repo appscode-charts-oci/falcoappscodecom-falcoevent-editor --version=v0.5.0
$ helm upgrade -i falcoappscodecom-falcoevent-editor appscode-charts-oci/falcoappscodecom-falcoevent-editor -n default --create-namespace --version=v0.5.0
```
...
```bash
$ helm upgrade -i falcoappscodecom-falcoevent-editor appscode-charts-oci/falcoappscodecom-falcoevent-editor -n default --create-namespace --version=v0.5.0 --set apiVersion=falco.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i falcoappscodecom-falcoevent-editor appscode-charts-oci/falcoappscodecom-falcoevent-editor -n default --create-namespace --version=v0.5.0 --values values.yaml
```
