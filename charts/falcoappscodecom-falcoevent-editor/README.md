...
$ helm repo update
$ helm search repo bytebuilders-ui/falcoappscodecom-falcoevent-editor --version=v0.4.18
$ helm upgrade -i falcoappscodecom-falcoevent-editor bytebuilders-ui/falcoappscodecom-falcoevent-editor -n default --create-namespace --version=v0.4.18
```
...
```bash
$ helm upgrade -i falcoappscodecom-falcoevent-editor bytebuilders-ui/falcoappscodecom-falcoevent-editor -n default --create-namespace --version=v0.4.18 --set apiVersion=falco.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i falcoappscodecom-falcoevent-editor bytebuilders-ui/falcoappscodecom-falcoevent-editor -n default --create-namespace --version=v0.4.18 --values values.yaml
```
