...
$ helm repo update
$ helm search repo appscode-charts-oci/monitoringcoreoscom-prometheusagent-editor --version=v0.6.0
$ helm upgrade -i monitoringcoreoscom-prometheusagent-editor appscode-charts-oci/monitoringcoreoscom-prometheusagent-editor -n default --create-namespace --version=v0.6.0
```
...
```bash
$ helm upgrade -i monitoringcoreoscom-prometheusagent-editor appscode-charts-oci/monitoringcoreoscom-prometheusagent-editor -n default --create-namespace --version=v0.6.0 --set apiVersion=monitoring.coreos.com/v1alpha1
```
...
```bash
$ helm upgrade -i monitoringcoreoscom-prometheusagent-editor appscode-charts-oci/monitoringcoreoscom-prometheusagent-editor -n default --create-namespace --version=v0.6.0 --values values.yaml
```
