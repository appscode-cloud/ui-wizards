...
$ helm repo update
$ helm search repo appscode-charts-oci/catalogappscodecom-elasticsearchbinding-editor --version=v0.6.0
$ helm upgrade -i catalogappscodecom-elasticsearchbinding-editor appscode-charts-oci/catalogappscodecom-elasticsearchbinding-editor -n default --create-namespace --version=v0.6.0
```
...
```bash
$ helm upgrade -i catalogappscodecom-elasticsearchbinding-editor appscode-charts-oci/catalogappscodecom-elasticsearchbinding-editor -n default --create-namespace --version=v0.6.0 --set apiVersion=catalog.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i catalogappscodecom-elasticsearchbinding-editor appscode-charts-oci/catalogappscodecom-elasticsearchbinding-editor -n default --create-namespace --version=v0.6.0 --values values.yaml
```
