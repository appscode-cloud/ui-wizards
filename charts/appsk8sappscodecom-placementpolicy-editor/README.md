...
$ helm repo update
$ helm search repo appscode/appsk8sappscodecom-placementpolicy-editor --version=v0.19.0
$ helm upgrade -i appsk8sappscodecom-placementpolicy-editor appscode/appsk8sappscodecom-placementpolicy-editor -n default --create-namespace --version=v0.19.0
```
...
```bash
$ helm upgrade -i appsk8sappscodecom-placementpolicy-editor appscode/appsk8sappscodecom-placementpolicy-editor -n default --create-namespace --version=v0.19.0 --set apiVersion=apps.k8s.appscode.com/v1
```
...
```bash
$ helm upgrade -i appsk8sappscodecom-placementpolicy-editor appscode/appsk8sappscodecom-placementpolicy-editor -n default --create-namespace --version=v0.19.0 --values values.yaml
```
