...
$ helm repo update
$ helm search repo appscode-charts-oci/sqlazurekubedbcom-mssqlfirewallrule-editor --version=v0.5.0
$ helm upgrade -i sqlazurekubedbcom-mssqlfirewallrule-editor appscode-charts-oci/sqlazurekubedbcom-mssqlfirewallrule-editor -n default --create-namespace --version=v0.5.0
```
...
```bash
$ helm upgrade -i sqlazurekubedbcom-mssqlfirewallrule-editor appscode-charts-oci/sqlazurekubedbcom-mssqlfirewallrule-editor -n default --create-namespace --version=v0.5.0 --set apiVersion=sql.azure.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i sqlazurekubedbcom-mssqlfirewallrule-editor appscode-charts-oci/sqlazurekubedbcom-mssqlfirewallrule-editor -n default --create-namespace --version=v0.5.0 --values values.yaml
```
