...
$ helm repo update
$ helm search repo bytebuilders-ui/batch-jobtemplate-editor --version=v0.4.14
$ helm upgrade -i batch-jobtemplate-editor bytebuilders-ui/batch-jobtemplate-editor -n default --create-namespace --version=v0.4.14
```
...
```bash
$ helm upgrade -i batch-jobtemplate-editor bytebuilders-ui/batch-jobtemplate-editor -n default --create-namespace --version=v0.4.14 --set apiVersion=batch/v1beta1
```
...
```bash
$ helm upgrade -i batch-jobtemplate-editor bytebuilders-ui/batch-jobtemplate-editor -n default --create-namespace --version=v0.4.14 --values values.yaml
```
