...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/batch-jobtemplate-editor --version=v0.4.17
$ helm upgrade -i batch-jobtemplate-editor bytebuilders-ui-dev/batch-jobtemplate-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i batch-jobtemplate-editor bytebuilders-ui-dev/batch-jobtemplate-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=batch/v1beta1
```
...
```bash
$ helm upgrade -i batch-jobtemplate-editor bytebuilders-ui-dev/batch-jobtemplate-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
