...
$ helm repo update
$ helm search repo appscode/autoscalingkubedbcom-druidautoscaler-editor --version=v0.28.0
$ helm upgrade -i autoscalingkubedbcom-druidautoscaler-editor appscode/autoscalingkubedbcom-druidautoscaler-editor -n default --create-namespace --version=v0.28.0
```
...
```bash
$ helm upgrade -i autoscalingkubedbcom-druidautoscaler-editor appscode/autoscalingkubedbcom-druidautoscaler-editor -n default --create-namespace --version=v0.28.0 --set apiVersion=autoscaling.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i autoscalingkubedbcom-druidautoscaler-editor appscode/autoscalingkubedbcom-druidautoscaler-editor -n default --create-namespace --version=v0.28.0 --values values.yaml
```
