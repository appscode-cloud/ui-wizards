...
$ helm repo update
$ helm search repo appscode/azurekubedbcom-subscription-editor --version=v0.16.0
$ helm upgrade -i azurekubedbcom-subscription-editor appscode/azurekubedbcom-subscription-editor -n default --create-namespace --version=v0.16.0
```
...
```bash
$ helm upgrade -i azurekubedbcom-subscription-editor appscode/azurekubedbcom-subscription-editor -n default --create-namespace --version=v0.16.0 --set apiVersion=azure.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i azurekubedbcom-subscription-editor appscode/azurekubedbcom-subscription-editor -n default --create-namespace --version=v0.16.0 --values values.yaml
```
