...
$ helm repo update
$ helm search repo appscode/core-configmap-editor --version=v0.27.0
...
```bash
$ helm upgrade -i core-configmap-editor appscode/core-configmap-editor -n default --create-namespace --version=v0.27.0 --set apiVersion=v1
```
...
```bash
$ helm upgrade -i core-configmap-editor appscode/core-configmap-editor -n default --create-namespace --version=v0.27.0 --values values.yaml
```
