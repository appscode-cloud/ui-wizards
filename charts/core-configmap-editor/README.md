...
$ helm repo update
$ helm search repo bytebuilders-ui/core-configmap-editor --version=v0.4.1
$ helm upgrade -i core-configmap-editor bytebuilders-ui/core-configmap-editor -n default --create-namespace --version=v0.4.1
```
...
```bash
$ helm upgrade -i core-configmap-editor bytebuilders-ui/core-configmap-editor -n default --create-namespace --version=v0.4.1 --set apiVersion=v1
```
...
```bash
$ helm upgrade -i core-configmap-editor bytebuilders-ui/core-configmap-editor -n default --create-namespace --version=v0.4.1 --values values.yaml
```
