...
$ helm repo update
$ helm search repo appscode-charts-oci/gitopskubedbcom-mysql-editor --version=v0.14.0
$ helm upgrade -i gitopskubedbcom-mysql-editor appscode-charts-oci/gitopskubedbcom-mysql-editor -n default --create-namespace --version=v0.14.0
```
...
```bash
$ helm upgrade -i gitopskubedbcom-mysql-editor appscode-charts-oci/gitopskubedbcom-mysql-editor -n default --create-namespace --version=v0.14.0 --set apiVersion=gitops.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i gitopskubedbcom-mysql-editor appscode-charts-oci/gitopskubedbcom-mysql-editor -n default --create-namespace --version=v0.14.0 --values values.yaml
```
