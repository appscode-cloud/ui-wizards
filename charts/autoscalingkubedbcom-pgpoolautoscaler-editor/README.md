...
$ helm repo update
$ helm search repo appscode-charts-oci/autoscalingkubedbcom-pgpoolautoscaler-editor --version=v0.8.0
$ helm upgrade -i autoscalingkubedbcom-pgpoolautoscaler-editor appscode-charts-oci/autoscalingkubedbcom-pgpoolautoscaler-editor -n default --create-namespace --version=v0.8.0
```
...
```bash
$ helm upgrade -i autoscalingkubedbcom-pgpoolautoscaler-editor appscode-charts-oci/autoscalingkubedbcom-pgpoolautoscaler-editor -n default --create-namespace --version=v0.8.0 --set apiVersion=autoscaling.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i autoscalingkubedbcom-pgpoolautoscaler-editor appscode-charts-oci/autoscalingkubedbcom-pgpoolautoscaler-editor -n default --create-namespace --version=v0.8.0 --values values.yaml
```
