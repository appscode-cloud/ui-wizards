...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/pkgcrossplaneio-lock-editor --version=v0.4.17
$ helm upgrade -i pkgcrossplaneio-lock-editor bytebuilders-ui-dev/pkgcrossplaneio-lock-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i pkgcrossplaneio-lock-editor bytebuilders-ui-dev/pkgcrossplaneio-lock-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=pkg.crossplane.io/v1beta1
```
...
```bash
$ helm upgrade -i pkgcrossplaneio-lock-editor bytebuilders-ui-dev/pkgcrossplaneio-lock-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
