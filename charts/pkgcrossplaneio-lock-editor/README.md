...
$ helm repo update
$ helm search repo appscode/pkgcrossplaneio-lock-editor --version=v0.26.0
$ helm upgrade -i pkgcrossplaneio-lock-editor appscode/pkgcrossplaneio-lock-editor -n default --create-namespace --version=v0.26.0
```
...
```bash
$ helm upgrade -i pkgcrossplaneio-lock-editor appscode/pkgcrossplaneio-lock-editor -n default --create-namespace --version=v0.26.0 --set apiVersion=pkg.crossplane.io/v1beta1
```
...
```bash
$ helm upgrade -i pkgcrossplaneio-lock-editor appscode/pkgcrossplaneio-lock-editor -n default --create-namespace --version=v0.26.0 --values values.yaml
```
