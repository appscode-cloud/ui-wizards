...
$ helm repo update
$ helm search repo bytebuilders-ui/pkgcrossplaneio-lock-editor --version=v0.4.18
$ helm upgrade -i pkgcrossplaneio-lock-editor bytebuilders-ui/pkgcrossplaneio-lock-editor -n default --create-namespace --version=v0.4.18
```
...
```bash
$ helm upgrade -i pkgcrossplaneio-lock-editor bytebuilders-ui/pkgcrossplaneio-lock-editor -n default --create-namespace --version=v0.4.18 --set apiVersion=pkg.crossplane.io/v1beta1
```
...
```bash
$ helm upgrade -i pkgcrossplaneio-lock-editor bytebuilders-ui/pkgcrossplaneio-lock-editor -n default --create-namespace --version=v0.4.18 --values values.yaml
```
