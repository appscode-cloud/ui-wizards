...
$ helm repo update
$ helm search repo appscode-charts-oci/pkgcrossplaneio-lock-editor --version=v0.4.20
$ helm upgrade -i pkgcrossplaneio-lock-editor appscode-charts-oci/pkgcrossplaneio-lock-editor -n default --create-namespace --version=v0.4.20
```
...
```bash
$ helm upgrade -i pkgcrossplaneio-lock-editor appscode-charts-oci/pkgcrossplaneio-lock-editor -n default --create-namespace --version=v0.4.20 --set apiVersion=pkg.crossplane.io/v1beta1
```
...
```bash
$ helm upgrade -i pkgcrossplaneio-lock-editor appscode-charts-oci/pkgcrossplaneio-lock-editor -n default --create-namespace --version=v0.4.20 --values values.yaml
```
