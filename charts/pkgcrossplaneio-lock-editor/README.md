...
$ helm repo update
$ helm search repo bytebuilders-ui/pkgcrossplaneio-lock-editor --version=v0.4.16
$ helm upgrade -i pkgcrossplaneio-lock-editor bytebuilders-ui/pkgcrossplaneio-lock-editor -n default --create-namespace --version=v0.4.16
```
...
```bash
$ helm upgrade -i pkgcrossplaneio-lock-editor bytebuilders-ui/pkgcrossplaneio-lock-editor -n default --create-namespace --version=v0.4.16 --set apiVersion=pkg.crossplane.io/v1beta1
```
...
```bash
$ helm upgrade -i pkgcrossplaneio-lock-editor bytebuilders-ui/pkgcrossplaneio-lock-editor -n default --create-namespace --version=v0.4.16 --values values.yaml
```
