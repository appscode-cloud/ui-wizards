...
$ helm repo update
$ helm search repo bytebuilders-ui/mutationsgatekeepersh-assign-editor --version=v0.4.16
$ helm upgrade -i mutationsgatekeepersh-assign-editor bytebuilders-ui/mutationsgatekeepersh-assign-editor -n default --create-namespace --version=v0.4.16
```
...
```bash
$ helm upgrade -i mutationsgatekeepersh-assign-editor bytebuilders-ui/mutationsgatekeepersh-assign-editor -n default --create-namespace --version=v0.4.16 --set apiVersion=mutations.gatekeeper.sh/v1
```
...
```bash
$ helm upgrade -i mutationsgatekeepersh-assign-editor bytebuilders-ui/mutationsgatekeepersh-assign-editor -n default --create-namespace --version=v0.4.16 --values values.yaml
```
