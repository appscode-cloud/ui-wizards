...
$ helm repo update
$ helm search repo appscode-charts-oci/mutationsgatekeepersh-assign-editor --version=v0.4.19
$ helm upgrade -i mutationsgatekeepersh-assign-editor appscode-charts-oci/mutationsgatekeepersh-assign-editor -n default --create-namespace --version=v0.4.19
```
...
```bash
$ helm upgrade -i mutationsgatekeepersh-assign-editor appscode-charts-oci/mutationsgatekeepersh-assign-editor -n default --create-namespace --version=v0.4.19 --set apiVersion=mutations.gatekeeper.sh/v1
```
...
```bash
$ helm upgrade -i mutationsgatekeepersh-assign-editor appscode-charts-oci/mutationsgatekeepersh-assign-editor -n default --create-namespace --version=v0.4.19 --values values.yaml
```
