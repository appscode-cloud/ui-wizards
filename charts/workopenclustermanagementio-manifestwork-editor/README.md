...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/workopenclustermanagementio-manifestwork-editor --version=v0.4.17
$ helm upgrade -i workopenclustermanagementio-manifestwork-editor bytebuilders-ui-dev/workopenclustermanagementio-manifestwork-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i workopenclustermanagementio-manifestwork-editor bytebuilders-ui-dev/workopenclustermanagementio-manifestwork-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=work.open-cluster-management.io/v1
```
...
```bash
$ helm upgrade -i workopenclustermanagementio-manifestwork-editor bytebuilders-ui-dev/workopenclustermanagementio-manifestwork-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
