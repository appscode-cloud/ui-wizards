...
$ helm repo update
$ helm search repo appscode/workopenclustermanagementio-manifestwork-editor --version=v0.14.0
$ helm upgrade -i workopenclustermanagementio-manifestwork-editor appscode/workopenclustermanagementio-manifestwork-editor -n default --create-namespace --version=v0.14.0
```
...
```bash
$ helm upgrade -i workopenclustermanagementio-manifestwork-editor appscode/workopenclustermanagementio-manifestwork-editor -n default --create-namespace --version=v0.14.0 --set apiVersion=work.open-cluster-management.io/v1
```
...
```bash
$ helm upgrade -i workopenclustermanagementio-manifestwork-editor appscode/workopenclustermanagementio-manifestwork-editor -n default --create-namespace --version=v0.14.0 --values values.yaml
```
