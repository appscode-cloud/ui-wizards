...
$ helm repo update
$ helm search repo appscode/statusgatekeepersh-mutatorpodstatus-editor --version=v0.14.0
$ helm upgrade -i statusgatekeepersh-mutatorpodstatus-editor appscode/statusgatekeepersh-mutatorpodstatus-editor -n default --create-namespace --version=v0.14.0
```
...
```bash
$ helm upgrade -i statusgatekeepersh-mutatorpodstatus-editor appscode/statusgatekeepersh-mutatorpodstatus-editor -n default --create-namespace --version=v0.14.0 --set apiVersion=status.gatekeeper.sh/v1beta1
```
...
```bash
$ helm upgrade -i statusgatekeepersh-mutatorpodstatus-editor appscode/statusgatekeepersh-mutatorpodstatus-editor -n default --create-namespace --version=v0.14.0 --values values.yaml
```
