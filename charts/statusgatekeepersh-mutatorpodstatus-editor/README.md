...
$ helm repo update
$ helm search repo appscode-charts-oci/statusgatekeepersh-mutatorpodstatus-editor --version=v0.4.20
$ helm upgrade -i statusgatekeepersh-mutatorpodstatus-editor appscode-charts-oci/statusgatekeepersh-mutatorpodstatus-editor -n default --create-namespace --version=v0.4.20
```
...
```bash
$ helm upgrade -i statusgatekeepersh-mutatorpodstatus-editor appscode-charts-oci/statusgatekeepersh-mutatorpodstatus-editor -n default --create-namespace --version=v0.4.20 --set apiVersion=status.gatekeeper.sh/v1beta1
```
...
```bash
$ helm upgrade -i statusgatekeepersh-mutatorpodstatus-editor appscode-charts-oci/statusgatekeepersh-mutatorpodstatus-editor -n default --create-namespace --version=v0.4.20 --values values.yaml
```
