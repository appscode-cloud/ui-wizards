...
$ helm repo update
$ helm search repo appscode-charts-oci/catalogappscodecom-postgresbinding-editor --version=v0.4.18
$ helm upgrade -i catalogappscodecom-postgresbinding-editor appscode-charts-oci/catalogappscodecom-postgresbinding-editor -n default --create-namespace --version=v0.4.18
```
...
```bash
$ helm upgrade -i catalogappscodecom-postgresbinding-editor appscode-charts-oci/catalogappscodecom-postgresbinding-editor -n default --create-namespace --version=v0.4.18 --set apiVersion=catalog.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i catalogappscodecom-postgresbinding-editor appscode-charts-oci/catalogappscodecom-postgresbinding-editor -n default --create-namespace --version=v0.4.18 --values values.yaml
```
