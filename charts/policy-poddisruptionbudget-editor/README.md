...
$ helm repo update
$ helm search repo bytebuilders-ui/policy-poddisruptionbudget-editor --version=v0.3.1
$ helm upgrade -i policy-poddisruptionbudget-editor bytebuilders-ui/policy-poddisruptionbudget-editor -n default --create-namespace --version=v0.3.1
```
...
```bash
$ helm upgrade -i policy-poddisruptionbudget-editor bytebuilders-ui/policy-poddisruptionbudget-editor -n default --create-namespace --version=v0.3.1 --set apiVersion=policy/v1beta1
```
...
```bash
$ helm upgrade -i policy-poddisruptionbudget-editor bytebuilders-ui/policy-poddisruptionbudget-editor -n default --create-namespace --version=v0.3.1 --values values.yaml
```
