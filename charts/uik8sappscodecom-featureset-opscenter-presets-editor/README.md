...
$ helm repo update
$ helm search repo bytebuilders-ui/uik8sappscodecom-featureset-opscenter-presets-editor --version=v0.4.17
$ helm upgrade -i uik8sappscodecom-featureset-opscenter-presets-editor bytebuilders-ui/uik8sappscodecom-featureset-opscenter-presets-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i uik8sappscodecom-featureset-opscenter-presets-editor bytebuilders-ui/uik8sappscodecom-featureset-opscenter-presets-editor -n default --create-namespace --version=v0.4.17 --set metadata.resource.group=ui.k8s.appscode.com
```
...
```bash
$ helm upgrade -i uik8sappscodecom-featureset-opscenter-presets-editor bytebuilders-ui/uik8sappscodecom-featureset-opscenter-presets-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
