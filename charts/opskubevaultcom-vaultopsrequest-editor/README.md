...
$ helm repo update
$ helm search repo appscode-charts-oci/opskubevaultcom-vaultopsrequest-editor --version=v0.7.0
$ helm upgrade -i opskubevaultcom-vaultopsrequest-editor appscode-charts-oci/opskubevaultcom-vaultopsrequest-editor -n default --create-namespace --version=v0.7.0
```
...
```bash
$ helm upgrade -i opskubevaultcom-vaultopsrequest-editor appscode-charts-oci/opskubevaultcom-vaultopsrequest-editor -n default --create-namespace --version=v0.7.0 --set apiVersion=ops.kubevault.com/v1alpha1
```
...
```bash
$ helm upgrade -i opskubevaultcom-vaultopsrequest-editor appscode-charts-oci/opskubevaultcom-vaultopsrequest-editor -n default --create-namespace --version=v0.7.0 --values values.yaml
```
