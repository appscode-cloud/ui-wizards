...
$ helm repo update
$ helm search repo bytebuilders-ui/opskubevaultcom-vaultopsrequest-editor --version=v0.4.10
$ helm upgrade -i opskubevaultcom-vaultopsrequest-editor bytebuilders-ui/opskubevaultcom-vaultopsrequest-editor -n default --create-namespace --version=v0.4.10
```
...
```bash
$ helm upgrade -i opskubevaultcom-vaultopsrequest-editor bytebuilders-ui/opskubevaultcom-vaultopsrequest-editor -n default --create-namespace --version=v0.4.10 --set apiVersion=ops.kubevault.com/v1alpha1
```
...
```bash
$ helm upgrade -i opskubevaultcom-vaultopsrequest-editor bytebuilders-ui/opskubevaultcom-vaultopsrequest-editor -n default --create-namespace --version=v0.4.10 --values values.yaml
```
