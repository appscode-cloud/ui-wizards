...
$ helm repo update
$ helm search repo appscode-charts-oci/infrastructureclusterxk8sio-azureserviceprincipal-editor --version=v0.4.19
$ helm upgrade -i infrastructureclusterxk8sio-azureserviceprincipal-editor appscode-charts-oci/infrastructureclusterxk8sio-azureserviceprincipal-editor -n default --create-namespace --version=v0.4.19
```
...
```bash
$ helm upgrade -i infrastructureclusterxk8sio-azureserviceprincipal-editor appscode-charts-oci/infrastructureclusterxk8sio-azureserviceprincipal-editor -n default --create-namespace --version=v0.4.19 --set apiVersion=infrastructure.cluster.x-k8s.io/v1alpha3
```
...
```bash
$ helm upgrade -i infrastructureclusterxk8sio-azureserviceprincipal-editor appscode-charts-oci/infrastructureclusterxk8sio-azureserviceprincipal-editor -n default --create-namespace --version=v0.4.19 --values values.yaml
```
