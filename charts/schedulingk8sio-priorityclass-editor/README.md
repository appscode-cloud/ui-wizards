...
$ helm repo update
$ helm search repo appscode-charts-oci/schedulingk8sio-priorityclass-editor --version=v0.4.20
$ helm upgrade -i schedulingk8sio-priorityclass-editor appscode-charts-oci/schedulingk8sio-priorityclass-editor -n default --create-namespace --version=v0.4.20
```
...
```bash
$ helm upgrade -i schedulingk8sio-priorityclass-editor appscode-charts-oci/schedulingk8sio-priorityclass-editor -n default --create-namespace --version=v0.4.20 --set apiVersion=scheduling.k8s.io/v1
```
...
```bash
$ helm upgrade -i schedulingk8sio-priorityclass-editor appscode-charts-oci/schedulingk8sio-priorityclass-editor -n default --create-namespace --version=v0.4.20 --values values.yaml
```
