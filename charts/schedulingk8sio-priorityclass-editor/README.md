...
$ helm repo update
$ helm search repo bytebuilders-ui/schedulingk8sio-priorityclass-editor --version=v0.4.4
$ helm upgrade -i schedulingk8sio-priorityclass-editor bytebuilders-ui/schedulingk8sio-priorityclass-editor -n default --create-namespace --version=v0.4.4
```
...
```bash
$ helm upgrade -i schedulingk8sio-priorityclass-editor bytebuilders-ui/schedulingk8sio-priorityclass-editor -n default --create-namespace --version=v0.4.4 --set apiVersion=scheduling.k8s.io/v1
```
...
```bash
$ helm upgrade -i schedulingk8sio-priorityclass-editor bytebuilders-ui/schedulingk8sio-priorityclass-editor -n default --create-namespace --version=v0.4.4 --values values.yaml
```
