...
$ helm repo update
$ helm search repo appscode-charts-oci/schedulingk8sio-priorityclass-editor --version=v0.11.0
...
```bash
$ helm upgrade -i schedulingk8sio-priorityclass-editor appscode-charts-oci/schedulingk8sio-priorityclass-editor -n default --create-namespace --version=v0.11.0 --set apiVersion=scheduling.k8s.io/v1
```
...
```bash
$ helm upgrade -i schedulingk8sio-priorityclass-editor appscode-charts-oci/schedulingk8sio-priorityclass-editor -n default --create-namespace --version=v0.11.0 --values values.yaml
```
