...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/schedulingk8sio-priorityclass-editor --version=v0.4.17
$ helm upgrade -i schedulingk8sio-priorityclass-editor bytebuilders-ui-dev/schedulingk8sio-priorityclass-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i schedulingk8sio-priorityclass-editor bytebuilders-ui-dev/schedulingk8sio-priorityclass-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=scheduling.k8s.io/v1
```
...
```bash
$ helm upgrade -i schedulingk8sio-priorityclass-editor bytebuilders-ui-dev/schedulingk8sio-priorityclass-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
