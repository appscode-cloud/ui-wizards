...
$ helm repo update
$ helm search repo appscode-charts-oci/kubedbcom-clickhouse-editor --version=v0.4.21
$ helm upgrade -i kubedbcom-clickhouse-editor appscode-charts-oci/kubedbcom-clickhouse-editor -n default --create-namespace --version=v0.4.21
```
...
```bash
$ helm upgrade -i kubedbcom-clickhouse-editor appscode-charts-oci/kubedbcom-clickhouse-editor -n default --create-namespace --version=v0.4.21 --set apiVersion=kubedb.com/v1alpha2
```
...
```bash
$ helm upgrade -i kubedbcom-clickhouse-editor appscode-charts-oci/kubedbcom-clickhouse-editor -n default --create-namespace --version=v0.4.21 --values values.yaml
```
