...
$ helm repo update
$ helm search repo appscode-charts-oci/kubedbcom-clickhouse-editor --version=v0.4.20
$ helm upgrade -i kubedbcom-clickhouse-editor appscode-charts-oci/kubedbcom-clickhouse-editor -n default --create-namespace --version=v0.4.20
```
...
```bash
$ helm upgrade -i kubedbcom-clickhouse-editor appscode-charts-oci/kubedbcom-clickhouse-editor -n default --create-namespace --version=v0.4.20 --set apiVersion=kubedb.com/v1alpha2
```
...
```bash
$ helm upgrade -i kubedbcom-clickhouse-editor appscode-charts-oci/kubedbcom-clickhouse-editor -n default --create-namespace --version=v0.4.20 --values values.yaml
```
