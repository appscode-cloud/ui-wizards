...
*/}}
{{- define "kubedbcom-clickhouse-editor.name" -}}
...
*/}}
{{- define "kubedbcom-clickhouse-editor.fullname" -}}
...
*/}}
{{- define "kubedbcom-clickhouse-editor.chart" -}}
...
Common labels
*/}}
{{- define "kubedbcom-clickhouse-editor.labels" -}}
{{ include "kubedbcom-clickhouse-editor.selectorLabels" . }}
...
Selector labels
*/}}
{{- define "kubedbcom-clickhouse-editor.selectorLabels" -}}
app.kubernetes.io/name: clickhouses.kubedb.com
app.kubernetes.io/instance: {{ include "kubedbcom-clickhouse-editor.fullname" . }}
{{- end }}

{{/*
Create the name of the service account to use
*/}}
{{- define "kubedbcom-clickhouse-editor.serviceAccountName" -}}
{{- if .Values.spec.serviceAccount.create }}
{{- default (include "kubedbcom-clickhouse-editor.fullname" .) .Values.spec.serviceAccount.name }}
{{- else }}
...
Common annotations
*/}}
{{- define "kubedbcom-clickhouse-editor.annotations" -}}
