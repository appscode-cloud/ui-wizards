...
$ helm repo update
$ helm search repo appscode-charts-oci/stashappscodecom-recovery-editor --version=v0.4.18
$ helm upgrade -i stashappscodecom-recovery-editor appscode-charts-oci/stashappscodecom-recovery-editor -n default --create-namespace --version=v0.4.18
```
...
```bash
$ helm upgrade -i stashappscodecom-recovery-editor appscode-charts-oci/stashappscodecom-recovery-editor -n default --create-namespace --version=v0.4.18 --set apiVersion=stash.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i stashappscodecom-recovery-editor appscode-charts-oci/stashappscodecom-recovery-editor -n default --create-namespace --version=v0.4.18 --values values.yaml
```
