...
$ helm repo update
$ helm search repo appscode/stashappscodecom-recovery-editor --version=v0.35.0
$ helm upgrade -i stashappscodecom-recovery-editor appscode/stashappscodecom-recovery-editor -n default --create-namespace --version=v0.35.0
```
...
```bash
$ helm upgrade -i stashappscodecom-recovery-editor appscode/stashappscodecom-recovery-editor -n default --create-namespace --version=v0.35.0 --set apiVersion=stash.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i stashappscodecom-recovery-editor appscode/stashappscodecom-recovery-editor -n default --create-namespace --version=v0.35.0 --values values.yaml
```
