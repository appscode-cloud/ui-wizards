...
$ helm repo update
$ helm install stashappscodecom-recovery-editor bytebuilders-ui-dev/stashappscodecom-recovery-editor -n default
```
...
```console
$ helm install stashappscodecom-recovery-editor bytebuilders-ui-dev/stashappscodecom-recovery-editor -n default --set apiVersion=stash.appscode.com/v1alpha1
```
...
```console
$ helm install stashappscodecom-recovery-editor bytebuilders-ui-dev/stashappscodecom-recovery-editor -n default --values values.yaml
```
