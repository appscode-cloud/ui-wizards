...
$ helm repo update
$ helm search repo bytebuilders-ui/stashappscodecom-recovery-editor --version=v0.4.15
$ helm upgrade -i stashappscodecom-recovery-editor bytebuilders-ui/stashappscodecom-recovery-editor -n default --create-namespace --version=v0.4.15
```
...
```bash
$ helm upgrade -i stashappscodecom-recovery-editor bytebuilders-ui/stashappscodecom-recovery-editor -n default --create-namespace --version=v0.4.15 --set apiVersion=stash.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i stashappscodecom-recovery-editor bytebuilders-ui/stashappscodecom-recovery-editor -n default --create-namespace --version=v0.4.15 --values values.yaml
```
