...
$ helm repo update
$ helm search repo bytebuilders-ui/storagekubestashcom-repository-editor-options --version=v0.12.0
$ helm upgrade -i storagekubestashcom-repository-editor-options bytebuilders-ui/storagekubestashcom-repository-editor-options -n kube-system --create-namespace --version=v0.12.0
```
...
```bash
$ helm upgrade -i storagekubestashcom-repository-editor-options bytebuilders-ui/storagekubestashcom-repository-editor-options -n kube-system --create-namespace --version=v0.12.0 --set metadata.resource.group=storage.kubestash.com
```
...
```bash
$ helm upgrade -i storagekubestashcom-repository-editor-options bytebuilders-ui/storagekubestashcom-repository-editor-options -n kube-system --create-namespace --version=v0.12.0 --values values.yaml
```
