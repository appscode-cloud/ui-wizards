...
$ helm repo update
$ helm install autoscalingkubedbcom-memcachedautoscaler-editor bytebuilders-ui-dev/autoscalingkubedbcom-memcachedautoscaler-editor -n default
```
...
```console
$ helm install autoscalingkubedbcom-memcachedautoscaler-editor bytebuilders-ui-dev/autoscalingkubedbcom-memcachedautoscaler-editor -n default --set apiVersion=autoscaling.kubedb.com/v1alpha1
```
...
```console
$ helm install autoscalingkubedbcom-memcachedautoscaler-editor bytebuilders-ui-dev/autoscalingkubedbcom-memcachedautoscaler-editor -n default --values values.yaml
```
