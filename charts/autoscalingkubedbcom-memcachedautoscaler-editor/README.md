...
$ helm repo update
$ helm search repo appscode-charts-oci/autoscalingkubedbcom-memcachedautoscaler-editor --version=v0.5.0
$ helm upgrade -i autoscalingkubedbcom-memcachedautoscaler-editor appscode-charts-oci/autoscalingkubedbcom-memcachedautoscaler-editor -n default --create-namespace --version=v0.5.0
```
...
```bash
$ helm upgrade -i autoscalingkubedbcom-memcachedautoscaler-editor appscode-charts-oci/autoscalingkubedbcom-memcachedautoscaler-editor -n default --create-namespace --version=v0.5.0 --set apiVersion=autoscaling.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i autoscalingkubedbcom-memcachedautoscaler-editor appscode-charts-oci/autoscalingkubedbcom-memcachedautoscaler-editor -n default --create-namespace --version=v0.5.0 --values values.yaml
```
