...
$ helm repo update
$ helm search repo bytebuilders-ui/externaldnsappscodecom-externaldns-editor --version=v0.4.18
$ helm upgrade -i externaldnsappscodecom-externaldns-editor bytebuilders-ui/externaldnsappscodecom-externaldns-editor -n default --create-namespace --version=v0.4.18
```
...
```bash
$ helm upgrade -i externaldnsappscodecom-externaldns-editor bytebuilders-ui/externaldnsappscodecom-externaldns-editor -n default --create-namespace --version=v0.4.18 --set apiVersion=external-dns.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i externaldnsappscodecom-externaldns-editor bytebuilders-ui/externaldnsappscodecom-externaldns-editor -n default --create-namespace --version=v0.4.18 --values values.yaml
```
