...
$ helm repo update
$ helm search repo bytebuilders-ui/bootstrapclusterxk8sio-eksconfigtemplate-editor --version=v0.4.18
$ helm upgrade -i bootstrapclusterxk8sio-eksconfigtemplate-editor bytebuilders-ui/bootstrapclusterxk8sio-eksconfigtemplate-editor -n default --create-namespace --version=v0.4.18
```
...
```bash
$ helm upgrade -i bootstrapclusterxk8sio-eksconfigtemplate-editor bytebuilders-ui/bootstrapclusterxk8sio-eksconfigtemplate-editor -n default --create-namespace --version=v0.4.18 --set apiVersion=bootstrap.cluster.x-k8s.io/v1beta2
```
...
```bash
$ helm upgrade -i bootstrapclusterxk8sio-eksconfigtemplate-editor bytebuilders-ui/bootstrapclusterxk8sio-eksconfigtemplate-editor -n default --create-namespace --version=v0.4.18 --values values.yaml
```
