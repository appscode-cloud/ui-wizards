...
$ helm repo update
$ helm search repo bytebuilders-ui/catalogkubedbcom-kafkaversion-editor --version=v0.4.15
$ helm upgrade -i catalogkubedbcom-kafkaversion-editor bytebuilders-ui/catalogkubedbcom-kafkaversion-editor -n default --create-namespace --version=v0.4.15
```
...
```bash
$ helm upgrade -i catalogkubedbcom-kafkaversion-editor bytebuilders-ui/catalogkubedbcom-kafkaversion-editor -n default --create-namespace --version=v0.4.15 --set apiVersion=catalog.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i catalogkubedbcom-kafkaversion-editor bytebuilders-ui/catalogkubedbcom-kafkaversion-editor -n default --create-namespace --version=v0.4.15 --values values.yaml
```
