...
$ helm repo update
$ helm search repo bytebuilders-ui/catalogkubedbcom-kafkaversion-editor --version=v0.4.18
$ helm upgrade -i catalogkubedbcom-kafkaversion-editor bytebuilders-ui/catalogkubedbcom-kafkaversion-editor -n default --create-namespace --version=v0.4.18
```
...
```bash
$ helm upgrade -i catalogkubedbcom-kafkaversion-editor bytebuilders-ui/catalogkubedbcom-kafkaversion-editor -n default --create-namespace --version=v0.4.18 --set apiVersion=catalog.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i catalogkubedbcom-kafkaversion-editor bytebuilders-ui/catalogkubedbcom-kafkaversion-editor -n default --create-namespace --version=v0.4.18 --values values.yaml
```
