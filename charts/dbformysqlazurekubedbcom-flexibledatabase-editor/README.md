...
$ helm repo update
$ helm search repo appscode-charts-oci/dbformysqlazurekubedbcom-flexibledatabase-editor --version=v0.11.0
...
```bash
$ helm upgrade -i dbformysqlazurekubedbcom-flexibledatabase-editor appscode-charts-oci/dbformysqlazurekubedbcom-flexibledatabase-editor -n default --create-namespace --version=v0.11.0 --set apiVersion=dbformysql.azure.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i dbformysqlazurekubedbcom-flexibledatabase-editor appscode-charts-oci/dbformysqlazurekubedbcom-flexibledatabase-editor -n default --create-namespace --version=v0.11.0 --values values.yaml
```
