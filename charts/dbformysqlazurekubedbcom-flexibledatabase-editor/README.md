...
$ helm repo update
$ helm search repo appscode/dbformysqlazurekubedbcom-flexibledatabase-editor --version=v0.35.0
$ helm upgrade -i dbformysqlazurekubedbcom-flexibledatabase-editor appscode/dbformysqlazurekubedbcom-flexibledatabase-editor -n default --create-namespace --version=v0.35.0
```
...
```bash
$ helm upgrade -i dbformysqlazurekubedbcom-flexibledatabase-editor appscode/dbformysqlazurekubedbcom-flexibledatabase-editor -n default --create-namespace --version=v0.35.0 --set apiVersion=dbformysql.azure.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i dbformysqlazurekubedbcom-flexibledatabase-editor appscode/dbformysqlazurekubedbcom-flexibledatabase-editor -n default --create-namespace --version=v0.35.0 --values values.yaml
```
