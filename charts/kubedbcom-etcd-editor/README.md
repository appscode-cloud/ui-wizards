...
$ helm repo update
$ helm install kubedbcom-etcd-editor bytebuilders-ui-dev/kubedbcom-etcd-editor -n default
```
...
```console
$ helm install kubedbcom-etcd-editor bytebuilders-ui-dev/kubedbcom-etcd-editor -n default --set apiVersion=kubedb.com/v1alpha2
```
...
```console
$ helm install kubedbcom-etcd-editor bytebuilders-ui-dev/kubedbcom-etcd-editor -n default --values values.yaml
```
