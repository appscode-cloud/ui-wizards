...
$ helm repo update
$ helm search repo appscode/kubedbcom-etcd-editor --version=v0.37.0
$ helm upgrade -i kubedbcom-etcd-editor appscode/kubedbcom-etcd-editor -n default --create-namespace --version=v0.37.0
```
...
```bash
$ helm upgrade -i kubedbcom-etcd-editor appscode/kubedbcom-etcd-editor -n default --create-namespace --version=v0.37.0 --set apiVersion=kubedb.com/v1alpha2
```
...
```bash
$ helm upgrade -i kubedbcom-etcd-editor appscode/kubedbcom-etcd-editor -n default --create-namespace --version=v0.37.0 --values values.yaml
```
