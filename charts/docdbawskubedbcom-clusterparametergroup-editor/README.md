...
$ helm repo update
$ helm search repo appscode-charts-oci/docdbawskubedbcom-clusterparametergroup-editor --version=v0.4.18
$ helm upgrade -i docdbawskubedbcom-clusterparametergroup-editor appscode-charts-oci/docdbawskubedbcom-clusterparametergroup-editor -n default --create-namespace --version=v0.4.18
```
...
```bash
$ helm upgrade -i docdbawskubedbcom-clusterparametergroup-editor appscode-charts-oci/docdbawskubedbcom-clusterparametergroup-editor -n default --create-namespace --version=v0.4.18 --set apiVersion=docdb.aws.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i docdbawskubedbcom-clusterparametergroup-editor appscode-charts-oci/docdbawskubedbcom-clusterparametergroup-editor -n default --create-namespace --version=v0.4.18 --values values.yaml
```
