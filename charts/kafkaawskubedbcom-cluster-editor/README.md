...
$ helm repo update
$ helm search repo appscode-charts-oci/kafkaawskubedbcom-cluster-editor --version=v0.4.21
$ helm upgrade -i kafkaawskubedbcom-cluster-editor appscode-charts-oci/kafkaawskubedbcom-cluster-editor -n default --create-namespace --version=v0.4.21
```
...
```bash
$ helm upgrade -i kafkaawskubedbcom-cluster-editor appscode-charts-oci/kafkaawskubedbcom-cluster-editor -n default --create-namespace --version=v0.4.21 --set apiVersion=kafka.aws.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i kafkaawskubedbcom-cluster-editor appscode-charts-oci/kafkaawskubedbcom-cluster-editor -n default --create-namespace --version=v0.4.21 --values values.yaml
```
