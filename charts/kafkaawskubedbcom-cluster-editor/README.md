...
$ helm repo update
$ helm search repo appscode/kafkaawskubedbcom-cluster-editor --version=v0.33.0
$ helm upgrade -i kafkaawskubedbcom-cluster-editor appscode/kafkaawskubedbcom-cluster-editor -n default --create-namespace --version=v0.33.0
```
...
```bash
$ helm upgrade -i kafkaawskubedbcom-cluster-editor appscode/kafkaawskubedbcom-cluster-editor -n default --create-namespace --version=v0.33.0 --set apiVersion=kafka.aws.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i kafkaawskubedbcom-cluster-editor appscode/kafkaawskubedbcom-cluster-editor -n default --create-namespace --version=v0.33.0 --values values.yaml
```
