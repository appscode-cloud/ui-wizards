...
$ helm repo update
$ helm install core-service-editor bytebuilders-ui-dev/core-service-editor -n default
```
...
```console
$ helm install core-service-editor bytebuilders-ui-dev/core-service-editor -n default --set apiVersion=/v1
```
...
```console
$ helm install core-service-editor bytebuilders-ui-dev/core-service-editor -n default --values values.yaml
```
