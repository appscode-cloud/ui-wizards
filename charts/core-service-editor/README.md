...
$ helm repo update
$ helm search repo appscode/core-service-editor --version=v0.35.0
$ helm upgrade -i core-service-editor appscode/core-service-editor -n default --create-namespace --version=v0.35.0
```
...
```bash
$ helm upgrade -i core-service-editor appscode/core-service-editor -n default --create-namespace --version=v0.35.0 --set apiVersion=v1
```
...
```bash
$ helm upgrade -i core-service-editor appscode/core-service-editor -n default --create-namespace --version=v0.35.0 --values values.yaml
```
