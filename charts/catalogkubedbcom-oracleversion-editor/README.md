...
$ helm repo update
$ helm search repo appscode/catalogkubedbcom-oracleversion-editor --version=v0.28.0
$ helm upgrade -i catalogkubedbcom-oracleversion-editor appscode/catalogkubedbcom-oracleversion-editor -n default --create-namespace --version=v0.28.0
```
...
```bash
$ helm upgrade -i catalogkubedbcom-oracleversion-editor appscode/catalogkubedbcom-oracleversion-editor -n default --create-namespace --version=v0.28.0 --set apiVersion=catalog.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i catalogkubedbcom-oracleversion-editor appscode/catalogkubedbcom-oracleversion-editor -n default --create-namespace --version=v0.28.0 --values values.yaml
```
