...
$ helm repo update
$ helm search repo appscode/docdbawskubedbcom-clusterinstance-editor --version=v0.27.0
...
```bash
$ helm upgrade -i docdbawskubedbcom-clusterinstance-editor appscode/docdbawskubedbcom-clusterinstance-editor -n default --create-namespace --version=v0.27.0 --set apiVersion=docdb.aws.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i docdbawskubedbcom-clusterinstance-editor appscode/docdbawskubedbcom-clusterinstance-editor -n default --create-namespace --version=v0.27.0 --values values.yaml
```
