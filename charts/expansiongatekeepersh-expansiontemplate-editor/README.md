...
$ helm repo update
$ helm search repo appscode-charts-oci/expansiongatekeepersh-expansiontemplate-editor --version=v0.14.0
$ helm upgrade -i expansiongatekeepersh-expansiontemplate-editor appscode-charts-oci/expansiongatekeepersh-expansiontemplate-editor -n default --create-namespace --version=v0.14.0
```
...
```bash
$ helm upgrade -i expansiongatekeepersh-expansiontemplate-editor appscode-charts-oci/expansiongatekeepersh-expansiontemplate-editor -n default --create-namespace --version=v0.14.0 --set apiVersion=expansion.gatekeeper.sh/v1alpha1
```
...
```bash
$ helm upgrade -i expansiongatekeepersh-expansiontemplate-editor appscode-charts-oci/expansiongatekeepersh-expansiontemplate-editor -n default --create-namespace --version=v0.14.0 --values values.yaml
```
