...
$ helm repo update
$ helm search repo bytebuilders-ui/expansiongatekeepersh-expansiontemplate-editor --version=v0.4.16
$ helm upgrade -i expansiongatekeepersh-expansiontemplate-editor bytebuilders-ui/expansiongatekeepersh-expansiontemplate-editor -n default --create-namespace --version=v0.4.16
```
...
```bash
$ helm upgrade -i expansiongatekeepersh-expansiontemplate-editor bytebuilders-ui/expansiongatekeepersh-expansiontemplate-editor -n default --create-namespace --version=v0.4.16 --set apiVersion=expansion.gatekeeper.sh/v1alpha1
```
...
```bash
$ helm upgrade -i expansiongatekeepersh-expansiontemplate-editor bytebuilders-ui/expansiongatekeepersh-expansiontemplate-editor -n default --create-namespace --version=v0.4.16 --values values.yaml
```
