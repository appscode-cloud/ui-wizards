...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/expansiongatekeepersh-expansiontemplate-editor --version=v0.4.17
$ helm upgrade -i expansiongatekeepersh-expansiontemplate-editor bytebuilders-ui-dev/expansiongatekeepersh-expansiontemplate-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i expansiongatekeepersh-expansiontemplate-editor bytebuilders-ui-dev/expansiongatekeepersh-expansiontemplate-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=expansion.gatekeeper.sh/v1alpha1
```
...
```bash
$ helm upgrade -i expansiongatekeepersh-expansiontemplate-editor bytebuilders-ui-dev/expansiongatekeepersh-expansiontemplate-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
