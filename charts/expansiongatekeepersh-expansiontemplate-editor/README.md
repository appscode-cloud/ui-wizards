...
$ helm repo update
$ helm search repo appscode-charts-oci/expansiongatekeepersh-expansiontemplate-editor --version=v0.4.21
$ helm upgrade -i expansiongatekeepersh-expansiontemplate-editor appscode-charts-oci/expansiongatekeepersh-expansiontemplate-editor -n default --create-namespace --version=v0.4.21
```
...
```bash
$ helm upgrade -i expansiongatekeepersh-expansiontemplate-editor appscode-charts-oci/expansiongatekeepersh-expansiontemplate-editor -n default --create-namespace --version=v0.4.21 --set apiVersion=expansion.gatekeeper.sh/v1alpha1
```
...
```bash
$ helm upgrade -i expansiongatekeepersh-expansiontemplate-editor appscode-charts-oci/expansiongatekeepersh-expansiontemplate-editor -n default --create-namespace --version=v0.4.21 --values values.yaml
```
