...
$ helm repo update
$ helm search repo appscode/addonopenclustermanagementio-clustermanagementaddon-editor --version=v0.16.0
$ helm upgrade -i addonopenclustermanagementio-clustermanagementaddon-editor appscode/addonopenclustermanagementio-clustermanagementaddon-editor -n default --create-namespace --version=v0.16.0
```
...
```bash
$ helm upgrade -i addonopenclustermanagementio-clustermanagementaddon-editor appscode/addonopenclustermanagementio-clustermanagementaddon-editor -n default --create-namespace --version=v0.16.0 --set apiVersion=addon.open-cluster-management.io/v1alpha1
```
...
```bash
$ helm upgrade -i addonopenclustermanagementio-clustermanagementaddon-editor appscode/addonopenclustermanagementio-clustermanagementaddon-editor -n default --create-namespace --version=v0.16.0 --values values.yaml
```
