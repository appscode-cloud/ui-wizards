...
$ helm repo update
$ helm search repo bytebuilders-ui/addonopenclustermanagementio-clustermanagementaddon-editor --version=v0.4.17
$ helm upgrade -i addonopenclustermanagementio-clustermanagementaddon-editor bytebuilders-ui/addonopenclustermanagementio-clustermanagementaddon-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i addonopenclustermanagementio-clustermanagementaddon-editor bytebuilders-ui/addonopenclustermanagementio-clustermanagementaddon-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=addon.open-cluster-management.io/v1alpha1
```
...
```bash
$ helm upgrade -i addonopenclustermanagementio-clustermanagementaddon-editor bytebuilders-ui/addonopenclustermanagementio-clustermanagementaddon-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
