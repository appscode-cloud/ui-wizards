...
$ helm repo update
$ helm search repo appscode/ec2awskubedbcom-subnet-editor --version=v0.28.0
$ helm upgrade -i ec2awskubedbcom-subnet-editor appscode/ec2awskubedbcom-subnet-editor -n default --create-namespace --version=v0.28.0
```
...
```bash
$ helm upgrade -i ec2awskubedbcom-subnet-editor appscode/ec2awskubedbcom-subnet-editor -n default --create-namespace --version=v0.28.0 --set apiVersion=ec2.aws.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i ec2awskubedbcom-subnet-editor appscode/ec2awskubedbcom-subnet-editor -n default --create-namespace --version=v0.28.0 --values values.yaml
```
