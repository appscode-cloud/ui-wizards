...
$ helm repo update
$ helm search repo appscode-charts-oci/dbformariadbazurekubedbcom-server-editor --version=v0.14.0
$ helm upgrade -i dbformariadbazurekubedbcom-server-editor appscode-charts-oci/dbformariadbazurekubedbcom-server-editor -n default --create-namespace --version=v0.14.0
```
...
```bash
$ helm upgrade -i dbformariadbazurekubedbcom-server-editor appscode-charts-oci/dbformariadbazurekubedbcom-server-editor -n default --create-namespace --version=v0.14.0 --set apiVersion=dbformariadb.azure.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i dbformariadbazurekubedbcom-server-editor appscode-charts-oci/dbformariadbazurekubedbcom-server-editor -n default --create-namespace --version=v0.14.0 --values values.yaml
```
