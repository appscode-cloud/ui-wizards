...
$ helm repo update
$ helm search repo appscode/dbformariadbazurekubedbcom-server-editor --version=v0.25.0
$ helm upgrade -i dbformariadbazurekubedbcom-server-editor appscode/dbformariadbazurekubedbcom-server-editor -n default --create-namespace --version=v0.25.0
```
...
```bash
$ helm upgrade -i dbformariadbazurekubedbcom-server-editor appscode/dbformariadbazurekubedbcom-server-editor -n default --create-namespace --version=v0.25.0 --set apiVersion=dbformariadb.azure.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i dbformariadbazurekubedbcom-server-editor appscode/dbformariadbazurekubedbcom-server-editor -n default --create-namespace --version=v0.25.0 --values values.yaml
```
