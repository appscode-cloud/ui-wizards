...
$ helm repo update
$ helm search repo appscode/clusterxk8sio-machinedeployment-editor --version=v0.19.0
$ helm upgrade -i clusterxk8sio-machinedeployment-editor appscode/clusterxk8sio-machinedeployment-editor -n default --create-namespace --version=v0.19.0
```
...
```bash
$ helm upgrade -i clusterxk8sio-machinedeployment-editor appscode/clusterxk8sio-machinedeployment-editor -n default --create-namespace --version=v0.19.0 --set apiVersion=cluster.x-k8s.io/v1beta1
```
...
```bash
$ helm upgrade -i clusterxk8sio-machinedeployment-editor appscode/clusterxk8sio-machinedeployment-editor -n default --create-namespace --version=v0.19.0 --values values.yaml
```
