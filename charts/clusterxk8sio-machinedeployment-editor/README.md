...
$ helm repo update
$ helm search repo appscode-charts-oci/clusterxk8sio-machinedeployment-editor --version=v0.4.21
$ helm upgrade -i clusterxk8sio-machinedeployment-editor appscode-charts-oci/clusterxk8sio-machinedeployment-editor -n default --create-namespace --version=v0.4.21
```
...
```bash
$ helm upgrade -i clusterxk8sio-machinedeployment-editor appscode-charts-oci/clusterxk8sio-machinedeployment-editor -n default --create-namespace --version=v0.4.21 --set apiVersion=cluster.x-k8s.io/v1beta1
```
...
```bash
$ helm upgrade -i clusterxk8sio-machinedeployment-editor appscode-charts-oci/clusterxk8sio-machinedeployment-editor -n default --create-namespace --version=v0.4.21 --values values.yaml
```
