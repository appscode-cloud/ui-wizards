...
$ helm repo update
$ helm search repo bytebuilders-ui/clusterxk8sio-clusterclass-editor --version=v0.4.16
$ helm upgrade -i clusterxk8sio-clusterclass-editor bytebuilders-ui/clusterxk8sio-clusterclass-editor -n default --create-namespace --version=v0.4.16
```
...
```bash
$ helm upgrade -i clusterxk8sio-clusterclass-editor bytebuilders-ui/clusterxk8sio-clusterclass-editor -n default --create-namespace --version=v0.4.16 --set apiVersion=cluster.x-k8s.io/v1beta1
```
...
```bash
$ helm upgrade -i clusterxk8sio-clusterclass-editor bytebuilders-ui/clusterxk8sio-clusterclass-editor -n default --create-namespace --version=v0.4.16 --values values.yaml
```
