...
$ helm repo update
$ helm search repo appscode/clusterxk8sio-clusterclass-editor --version=v0.35.0
$ helm upgrade -i clusterxk8sio-clusterclass-editor appscode/clusterxk8sio-clusterclass-editor -n default --create-namespace --version=v0.35.0
```
...
```bash
$ helm upgrade -i clusterxk8sio-clusterclass-editor appscode/clusterxk8sio-clusterclass-editor -n default --create-namespace --version=v0.35.0 --set apiVersion=cluster.x-k8s.io/v1beta1
```
...
```bash
$ helm upgrade -i clusterxk8sio-clusterclass-editor appscode/clusterxk8sio-clusterclass-editor -n default --create-namespace --version=v0.35.0 --values values.yaml
```
