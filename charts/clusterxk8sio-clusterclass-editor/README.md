...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/clusterxk8sio-clusterclass-editor --version=v0.4.17
$ helm upgrade -i clusterxk8sio-clusterclass-editor bytebuilders-ui-dev/clusterxk8sio-clusterclass-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i clusterxk8sio-clusterclass-editor bytebuilders-ui-dev/clusterxk8sio-clusterclass-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=cluster.x-k8s.io/v1beta1
```
...
```bash
$ helm upgrade -i clusterxk8sio-clusterclass-editor bytebuilders-ui-dev/clusterxk8sio-clusterclass-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
