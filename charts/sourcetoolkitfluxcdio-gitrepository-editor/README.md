...
$ helm repo update
$ helm search repo bytebuilders-ui/sourcetoolkitfluxcdio-gitrepository-editor --version=v0.4.16
$ helm upgrade -i sourcetoolkitfluxcdio-gitrepository-editor bytebuilders-ui/sourcetoolkitfluxcdio-gitrepository-editor -n default --create-namespace --version=v0.4.16
```
...
```bash
$ helm upgrade -i sourcetoolkitfluxcdio-gitrepository-editor bytebuilders-ui/sourcetoolkitfluxcdio-gitrepository-editor -n default --create-namespace --version=v0.4.16 --set apiVersion=source.toolkit.fluxcd.io/v1beta2
```
...
```bash
$ helm upgrade -i sourcetoolkitfluxcdio-gitrepository-editor bytebuilders-ui/sourcetoolkitfluxcdio-gitrepository-editor -n default --create-namespace --version=v0.4.16 --values values.yaml
```
