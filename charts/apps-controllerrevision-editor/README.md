...
$ helm repo update
$ helm search repo bytebuilders-ui/apps-controllerrevision-editor --version=v0.4.17
$ helm upgrade -i apps-controllerrevision-editor bytebuilders-ui/apps-controllerrevision-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i apps-controllerrevision-editor bytebuilders-ui/apps-controllerrevision-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=apps/v1
```
...
```bash
$ helm upgrade -i apps-controllerrevision-editor bytebuilders-ui/apps-controllerrevision-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
