...
$ helm repo update
$ helm search repo appscode-charts-oci/apps-controllerrevision-editor --version=v0.14.0
$ helm upgrade -i apps-controllerrevision-editor appscode-charts-oci/apps-controllerrevision-editor -n default --create-namespace --version=v0.14.0
```
...
```bash
$ helm upgrade -i apps-controllerrevision-editor appscode-charts-oci/apps-controllerrevision-editor -n default --create-namespace --version=v0.14.0 --set apiVersion=apps/v1
```
...
```bash
$ helm upgrade -i apps-controllerrevision-editor appscode-charts-oci/apps-controllerrevision-editor -n default --create-namespace --version=v0.14.0 --values values.yaml
```
