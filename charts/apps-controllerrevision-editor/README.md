...
$ helm repo update
$ helm search repo appscode-charts-oci/apps-controllerrevision-editor --version=v0.4.19
$ helm upgrade -i apps-controllerrevision-editor appscode-charts-oci/apps-controllerrevision-editor -n default --create-namespace --version=v0.4.19
```
...
```bash
$ helm upgrade -i apps-controllerrevision-editor appscode-charts-oci/apps-controllerrevision-editor -n default --create-namespace --version=v0.4.19 --set apiVersion=apps/v1
```
...
```bash
$ helm upgrade -i apps-controllerrevision-editor appscode-charts-oci/apps-controllerrevision-editor -n default --create-namespace --version=v0.4.19 --values values.yaml
```
