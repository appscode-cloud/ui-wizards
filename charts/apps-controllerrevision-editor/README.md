...
$ helm repo update
$ helm search repo appscode/apps-controllerrevision-editor --version=v0.22.0
$ helm upgrade -i apps-controllerrevision-editor appscode/apps-controllerrevision-editor -n default --create-namespace --version=v0.22.0
```
...
```bash
$ helm upgrade -i apps-controllerrevision-editor appscode/apps-controllerrevision-editor -n default --create-namespace --version=v0.22.0 --set apiVersion=apps/v1
```
...
```bash
$ helm upgrade -i apps-controllerrevision-editor appscode/apps-controllerrevision-editor -n default --create-namespace --version=v0.22.0 --values values.yaml
```
