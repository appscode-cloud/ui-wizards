...
$ helm repo update
$ helm search repo appscode/stashappscodecom-restoresession-editor --version=v0.18.0
$ helm upgrade -i stashappscodecom-restoresession-editor appscode/stashappscodecom-restoresession-editor -n default --create-namespace --version=v0.18.0
```
...
```bash
$ helm upgrade -i stashappscodecom-restoresession-editor appscode/stashappscodecom-restoresession-editor -n default --create-namespace --version=v0.18.0 --set apiVersion=stash.appscode.com/v1beta1
```
...
```bash
$ helm upgrade -i stashappscodecom-restoresession-editor appscode/stashappscodecom-restoresession-editor -n default --create-namespace --version=v0.18.0 --values values.yaml
```
