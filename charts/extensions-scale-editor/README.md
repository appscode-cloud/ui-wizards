...
$ helm repo update
$ helm search repo appscode/extensions-scale-editor --version=v0.28.0
$ helm upgrade -i extensions-scale-editor appscode/extensions-scale-editor -n default --create-namespace --version=v0.28.0
```
...
```bash
$ helm upgrade -i extensions-scale-editor appscode/extensions-scale-editor -n default --create-namespace --version=v0.28.0 --set apiVersion=extensions/v1beta1
```
...
```bash
$ helm upgrade -i extensions-scale-editor appscode/extensions-scale-editor -n default --create-namespace --version=v0.28.0 --values values.yaml
```
