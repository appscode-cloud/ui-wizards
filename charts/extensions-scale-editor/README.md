...
$ helm repo update
$ helm install extensions-scale-editor bytebuilders-ui-dev/extensions-scale-editor -n default
```
...
```console
$ helm install extensions-scale-editor bytebuilders-ui-dev/extensions-scale-editor -n default --set apiVersion=extensions/v1beta1
```
...
```console
$ helm install extensions-scale-editor bytebuilders-ui-dev/extensions-scale-editor -n default --values values.yaml
```
