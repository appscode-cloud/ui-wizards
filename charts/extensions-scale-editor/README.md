...
$ helm repo update
$ helm search repo appscode-charts-oci/extensions-scale-editor --version=v0.14.0
$ helm upgrade -i extensions-scale-editor appscode-charts-oci/extensions-scale-editor -n default --create-namespace --version=v0.14.0
```
...
```bash
$ helm upgrade -i extensions-scale-editor appscode-charts-oci/extensions-scale-editor -n default --create-namespace --version=v0.14.0 --set apiVersion=extensions/v1beta1
```
...
```bash
$ helm upgrade -i extensions-scale-editor appscode-charts-oci/extensions-scale-editor -n default --create-namespace --version=v0.14.0 --values values.yaml
```
