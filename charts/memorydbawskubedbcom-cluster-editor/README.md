...
$ helm repo update
$ helm search repo appscode-charts-oci/memorydbawskubedbcom-cluster-editor --version=v0.4.21
$ helm upgrade -i memorydbawskubedbcom-cluster-editor appscode-charts-oci/memorydbawskubedbcom-cluster-editor -n default --create-namespace --version=v0.4.21
```
...
```bash
$ helm upgrade -i memorydbawskubedbcom-cluster-editor appscode-charts-oci/memorydbawskubedbcom-cluster-editor -n default --create-namespace --version=v0.4.21 --set apiVersion=memorydb.aws.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i memorydbawskubedbcom-cluster-editor appscode-charts-oci/memorydbawskubedbcom-cluster-editor -n default --create-namespace --version=v0.4.21 --values values.yaml
```
