...
$ helm repo update
$ helm search repo appscode/memorydbawskubedbcom-cluster-editor --version=v0.29.0
$ helm upgrade -i memorydbawskubedbcom-cluster-editor appscode/memorydbawskubedbcom-cluster-editor -n default --create-namespace --version=v0.29.0
```
...
```bash
$ helm upgrade -i memorydbawskubedbcom-cluster-editor appscode/memorydbawskubedbcom-cluster-editor -n default --create-namespace --version=v0.29.0 --set apiVersion=memorydb.aws.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i memorydbawskubedbcom-cluster-editor appscode/memorydbawskubedbcom-cluster-editor -n default --create-namespace --version=v0.29.0 --values values.yaml
```
