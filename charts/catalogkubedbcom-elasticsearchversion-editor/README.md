...
$ helm repo update
$ helm search repo appscode-charts-oci/catalogkubedbcom-elasticsearchversion-editor --version=v0.6.0
$ helm upgrade -i catalogkubedbcom-elasticsearchversion-editor appscode-charts-oci/catalogkubedbcom-elasticsearchversion-editor -n default --create-namespace --version=v0.6.0
```
...
```bash
$ helm upgrade -i catalogkubedbcom-elasticsearchversion-editor appscode-charts-oci/catalogkubedbcom-elasticsearchversion-editor -n default --create-namespace --version=v0.6.0 --set apiVersion=catalog.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i catalogkubedbcom-elasticsearchversion-editor appscode-charts-oci/catalogkubedbcom-elasticsearchversion-editor -n default --create-namespace --version=v0.6.0 --values values.yaml
```
