...
$ helm repo update
$ helm search repo appscode-charts-oci/uikubedbcom-mariadbqueries-editor --version=v0.4.20
$ helm upgrade -i uikubedbcom-mariadbqueries-editor appscode-charts-oci/uikubedbcom-mariadbqueries-editor -n default --create-namespace --version=v0.4.20
```
...
```bash
$ helm upgrade -i uikubedbcom-mariadbqueries-editor appscode-charts-oci/uikubedbcom-mariadbqueries-editor -n default --create-namespace --version=v0.4.20 --set apiVersion=ui.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i uikubedbcom-mariadbqueries-editor appscode-charts-oci/uikubedbcom-mariadbqueries-editor -n default --create-namespace --version=v0.4.20 --values values.yaml
```
