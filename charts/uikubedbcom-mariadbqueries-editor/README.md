...
$ helm repo update
$ helm search repo appscode/uikubedbcom-mariadbqueries-editor --version=v0.17.0
$ helm upgrade -i uikubedbcom-mariadbqueries-editor appscode/uikubedbcom-mariadbqueries-editor -n default --create-namespace --version=v0.17.0
```
...
```bash
$ helm upgrade -i uikubedbcom-mariadbqueries-editor appscode/uikubedbcom-mariadbqueries-editor -n default --create-namespace --version=v0.17.0 --set apiVersion=ui.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i uikubedbcom-mariadbqueries-editor appscode/uikubedbcom-mariadbqueries-editor -n default --create-namespace --version=v0.17.0 --values values.yaml
```
