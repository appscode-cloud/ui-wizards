...
$ helm repo update
$ helm search repo appscode-charts-oci/uikubedbcom-mariadbqueries-editor --version=v0.4.18
$ helm upgrade -i uikubedbcom-mariadbqueries-editor appscode-charts-oci/uikubedbcom-mariadbqueries-editor -n default --create-namespace --version=v0.4.18
```
...
```bash
$ helm upgrade -i uikubedbcom-mariadbqueries-editor appscode-charts-oci/uikubedbcom-mariadbqueries-editor -n default --create-namespace --version=v0.4.18 --set apiVersion=ui.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i uikubedbcom-mariadbqueries-editor appscode-charts-oci/uikubedbcom-mariadbqueries-editor -n default --create-namespace --version=v0.4.18 --values values.yaml
```
