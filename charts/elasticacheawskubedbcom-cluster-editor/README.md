...
$ helm repo update
$ helm search repo appscode/elasticacheawskubedbcom-cluster-editor --version=v0.28.0
$ helm upgrade -i elasticacheawskubedbcom-cluster-editor appscode/elasticacheawskubedbcom-cluster-editor -n default --create-namespace --version=v0.28.0
```
...
```bash
$ helm upgrade -i elasticacheawskubedbcom-cluster-editor appscode/elasticacheawskubedbcom-cluster-editor -n default --create-namespace --version=v0.28.0 --set apiVersion=elasticache.aws.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i elasticacheawskubedbcom-cluster-editor appscode/elasticacheawskubedbcom-cluster-editor -n default --create-namespace --version=v0.28.0 --values values.yaml
```
