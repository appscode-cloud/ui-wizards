...
$ helm repo update
$ helm search repo appscode/core-resourcequota-editor --version=v0.29.0
$ helm upgrade -i core-resourcequota-editor appscode/core-resourcequota-editor -n default --create-namespace --version=v0.29.0
```
...
```bash
$ helm upgrade -i core-resourcequota-editor appscode/core-resourcequota-editor -n default --create-namespace --version=v0.29.0 --set apiVersion=v1
```
...
```bash
$ helm upgrade -i core-resourcequota-editor appscode/core-resourcequota-editor -n default --create-namespace --version=v0.29.0 --values values.yaml
```
