...
$ helm repo update
$ helm search repo bytebuilders-ui/core-resourcequota-editor --version=v0.4.0
$ helm upgrade -i core-resourcequota-editor bytebuilders-ui/core-resourcequota-editor -n default --create-namespace --version=v0.4.0
```
...
```bash
$ helm upgrade -i core-resourcequota-editor bytebuilders-ui/core-resourcequota-editor -n default --create-namespace --version=v0.4.0 --set apiVersion=v1
```
...
```bash
$ helm upgrade -i core-resourcequota-editor bytebuilders-ui/core-resourcequota-editor -n default --create-namespace --version=v0.4.0 --values values.yaml
```
