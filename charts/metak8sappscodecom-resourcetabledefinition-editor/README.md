...
$ helm repo update
$ helm search repo appscode/metak8sappscodecom-resourcetabledefinition-editor --version=v0.34.0
$ helm upgrade -i metak8sappscodecom-resourcetabledefinition-editor appscode/metak8sappscodecom-resourcetabledefinition-editor -n default --create-namespace --version=v0.34.0
```
...
```bash
$ helm upgrade -i metak8sappscodecom-resourcetabledefinition-editor appscode/metak8sappscodecom-resourcetabledefinition-editor -n default --create-namespace --version=v0.34.0 --set apiVersion=meta.k8s.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i metak8sappscodecom-resourcetabledefinition-editor appscode/metak8sappscodecom-resourcetabledefinition-editor -n default --create-namespace --version=v0.34.0 --values values.yaml
```
