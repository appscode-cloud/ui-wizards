...
```bash
$ helm upgrade -i storagekubestashcom-backupstorage-editor appscode-charts-oci/storagekubestashcom-backupstorage-editor -n default --create-namespace --version=v0.5.0 --set apiVersion=storage.kubestash.com/v1alpha1
```
