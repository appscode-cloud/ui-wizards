...
$ helm repo update
$ helm search repo appscode/storagekubestashcom-backupstorage-editor --version=v0.32.0
$ helm upgrade -i storagekubestashcom-backupstorage-editor appscode/storagekubestashcom-backupstorage-editor -n default --create-namespace --version=v0.32.0
```
...
```bash
$ helm upgrade -i storagekubestashcom-backupstorage-editor appscode/storagekubestashcom-backupstorage-editor -n default --create-namespace --version=v0.32.0 --set metadata.resource.group=storage.kubestash.com
```
...
```bash
$ helm upgrade -i storagekubestashcom-backupstorage-editor appscode/storagekubestashcom-backupstorage-editor -n default --create-namespace --version=v0.32.0 --values values.yaml
```
