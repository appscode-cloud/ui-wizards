...
$ helm repo update
$ helm search repo appscode/statusgatekeepersh-expansiontemplatepodstatus-editor --version=v0.16.0
$ helm upgrade -i statusgatekeepersh-expansiontemplatepodstatus-editor appscode/statusgatekeepersh-expansiontemplatepodstatus-editor -n default --create-namespace --version=v0.16.0
```
...
```bash
$ helm upgrade -i statusgatekeepersh-expansiontemplatepodstatus-editor appscode/statusgatekeepersh-expansiontemplatepodstatus-editor -n default --create-namespace --version=v0.16.0 --set apiVersion=status.gatekeeper.sh/v1beta1
```
...
```bash
$ helm upgrade -i statusgatekeepersh-expansiontemplatepodstatus-editor appscode/statusgatekeepersh-expansiontemplatepodstatus-editor -n default --create-namespace --version=v0.16.0 --values values.yaml
```
