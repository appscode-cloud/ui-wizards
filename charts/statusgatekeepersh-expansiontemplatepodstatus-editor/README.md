...
$ helm repo update
$ helm search repo appscode-charts-oci/statusgatekeepersh-expansiontemplatepodstatus-editor --version=v0.7.0
$ helm upgrade -i statusgatekeepersh-expansiontemplatepodstatus-editor appscode-charts-oci/statusgatekeepersh-expansiontemplatepodstatus-editor -n default --create-namespace --version=v0.7.0
```
...
```bash
$ helm upgrade -i statusgatekeepersh-expansiontemplatepodstatus-editor appscode-charts-oci/statusgatekeepersh-expansiontemplatepodstatus-editor -n default --create-namespace --version=v0.7.0 --set apiVersion=status.gatekeeper.sh/v1beta1
```
...
```bash
$ helm upgrade -i statusgatekeepersh-expansiontemplatepodstatus-editor appscode-charts-oci/statusgatekeepersh-expansiontemplatepodstatus-editor -n default --create-namespace --version=v0.7.0 --values values.yaml
```
