...
$ helm repo update
$ helm search repo bytebuilders-ui/statusgatekeepersh-expansiontemplatepodstatus-editor --version=v0.4.18
$ helm upgrade -i statusgatekeepersh-expansiontemplatepodstatus-editor bytebuilders-ui/statusgatekeepersh-expansiontemplatepodstatus-editor -n default --create-namespace --version=v0.4.18
```
...
```bash
$ helm upgrade -i statusgatekeepersh-expansiontemplatepodstatus-editor bytebuilders-ui/statusgatekeepersh-expansiontemplatepodstatus-editor -n default --create-namespace --version=v0.4.18 --set apiVersion=status.gatekeeper.sh/v1beta1
```
...
```bash
$ helm upgrade -i statusgatekeepersh-expansiontemplatepodstatus-editor bytebuilders-ui/statusgatekeepersh-expansiontemplatepodstatus-editor -n default --create-namespace --version=v0.4.18 --values values.yaml
```
