...
$ helm repo update
$ helm search repo appscode/rdsawskubedbcom-eventsubscription-editor --version=v0.33.0
$ helm upgrade -i rdsawskubedbcom-eventsubscription-editor appscode/rdsawskubedbcom-eventsubscription-editor -n default --create-namespace --version=v0.33.0
```
...
```bash
$ helm upgrade -i rdsawskubedbcom-eventsubscription-editor appscode/rdsawskubedbcom-eventsubscription-editor -n default --create-namespace --version=v0.33.0 --set apiVersion=rds.aws.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i rdsawskubedbcom-eventsubscription-editor appscode/rdsawskubedbcom-eventsubscription-editor -n default --create-namespace --version=v0.33.0 --values values.yaml
```
