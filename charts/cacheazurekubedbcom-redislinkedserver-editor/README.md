...
$ helm repo update
$ helm search repo appscode-charts-oci/cacheazurekubedbcom-redislinkedserver-editor --version=v0.6.0
$ helm upgrade -i cacheazurekubedbcom-redislinkedserver-editor appscode-charts-oci/cacheazurekubedbcom-redislinkedserver-editor -n default --create-namespace --version=v0.6.0
```
...
```bash
$ helm upgrade -i cacheazurekubedbcom-redislinkedserver-editor appscode-charts-oci/cacheazurekubedbcom-redislinkedserver-editor -n default --create-namespace --version=v0.6.0 --set apiVersion=cache.azure.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i cacheazurekubedbcom-redislinkedserver-editor appscode-charts-oci/cacheazurekubedbcom-redislinkedserver-editor -n default --create-namespace --version=v0.6.0 --values values.yaml
```
