...
$ helm repo update
$ helm search repo appscode/corekubestashcom-backupbatch-editor --version=v0.22.0
$ helm upgrade -i corekubestashcom-backupbatch-editor appscode/corekubestashcom-backupbatch-editor -n default --create-namespace --version=v0.22.0
```
...
```bash
$ helm upgrade -i corekubestashcom-backupbatch-editor appscode/corekubestashcom-backupbatch-editor -n default --create-namespace --version=v0.22.0 --set apiVersion=core.kubestash.com/v1alpha1
```
...
```bash
$ helm upgrade -i corekubestashcom-backupbatch-editor appscode/corekubestashcom-backupbatch-editor -n default --create-namespace --version=v0.22.0 --values values.yaml
```
