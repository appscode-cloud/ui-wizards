...
$ helm repo update
$ helm search repo bytebuilders-ui/networkingk8sio-ingress-editor --version=v0.4.15
$ helm upgrade -i networkingk8sio-ingress-editor bytebuilders-ui/networkingk8sio-ingress-editor -n default --create-namespace --version=v0.4.15
```
...
```bash
$ helm upgrade -i networkingk8sio-ingress-editor bytebuilders-ui/networkingk8sio-ingress-editor -n default --create-namespace --version=v0.4.15 --set apiVersion=networking.k8s.io/v1
```
...
```bash
$ helm upgrade -i networkingk8sio-ingress-editor bytebuilders-ui/networkingk8sio-ingress-editor -n default --create-namespace --version=v0.4.15 --values values.yaml
```
