...
$ helm repo update
$ helm search repo appscode/networkingk8sio-ingress-editor --version=v0.37.0
$ helm upgrade -i networkingk8sio-ingress-editor appscode/networkingk8sio-ingress-editor -n default --create-namespace --version=v0.37.0
```
...
```bash
$ helm upgrade -i networkingk8sio-ingress-editor appscode/networkingk8sio-ingress-editor -n default --create-namespace --version=v0.37.0 --set apiVersion=networking.k8s.io/v1
```
...
```bash
$ helm upgrade -i networkingk8sio-ingress-editor appscode/networkingk8sio-ingress-editor -n default --create-namespace --version=v0.37.0 --values values.yaml
```
