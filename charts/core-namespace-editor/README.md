...
$ helm repo update
$ helm search repo appscode-charts-oci/core-namespace-editor --version=v0.8.0
$ helm upgrade -i core-namespace-editor appscode-charts-oci/core-namespace-editor -n default --create-namespace --version=v0.8.0
```
...
```bash
$ helm upgrade -i core-namespace-editor appscode-charts-oci/core-namespace-editor -n default --create-namespace --version=v0.8.0 --set apiVersion=v1
```
...
```bash
$ helm upgrade -i core-namespace-editor appscode-charts-oci/core-namespace-editor -n default --create-namespace --version=v0.8.0 --values values.yaml
```
