...
$ helm repo update
$ helm search repo appscode/core-namespace-editor --version=v0.37.0
$ helm upgrade -i core-namespace-editor appscode/core-namespace-editor -n default --create-namespace --version=v0.37.0
```
...
```bash
$ helm upgrade -i core-namespace-editor appscode/core-namespace-editor -n default --create-namespace --version=v0.37.0 --set apiVersion=v1
```
...
```bash
$ helm upgrade -i core-namespace-editor appscode/core-namespace-editor -n default --create-namespace --version=v0.37.0 --values values.yaml
```
