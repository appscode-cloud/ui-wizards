...
$ helm repo update
$ helm search repo appscode/sourcetoolkitfluxcdio-helmchart-editor --version=v0.36.0
$ helm upgrade -i sourcetoolkitfluxcdio-helmchart-editor appscode/sourcetoolkitfluxcdio-helmchart-editor -n default --create-namespace --version=v0.36.0
```
...
```bash
$ helm upgrade -i sourcetoolkitfluxcdio-helmchart-editor appscode/sourcetoolkitfluxcdio-helmchart-editor -n default --create-namespace --version=v0.36.0 --set apiVersion=source.toolkit.fluxcd.io/v1
```
...
```bash
$ helm upgrade -i sourcetoolkitfluxcdio-helmchart-editor appscode/sourcetoolkitfluxcdio-helmchart-editor -n default --create-namespace --version=v0.36.0 --values values.yaml
```
