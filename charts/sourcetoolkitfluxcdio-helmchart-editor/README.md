...
$ helm repo update
$ helm search repo bytebuilders-ui/sourcetoolkitfluxcdio-helmchart-editor --version=v0.4.15
$ helm upgrade -i sourcetoolkitfluxcdio-helmchart-editor bytebuilders-ui/sourcetoolkitfluxcdio-helmchart-editor -n default --create-namespace --version=v0.4.15
```
...
```bash
$ helm upgrade -i sourcetoolkitfluxcdio-helmchart-editor bytebuilders-ui/sourcetoolkitfluxcdio-helmchart-editor -n default --create-namespace --version=v0.4.15 --set apiVersion=source.toolkit.fluxcd.io/v1beta2
```
...
```bash
$ helm upgrade -i sourcetoolkitfluxcdio-helmchart-editor bytebuilders-ui/sourcetoolkitfluxcdio-helmchart-editor -n default --create-namespace --version=v0.4.15 --values values.yaml
```
