...
$ helm repo update
$ helm search repo appscode-charts-oci/spannergcpkubedbcom-databaseiammember-editor --version=v0.4.20
$ helm upgrade -i spannergcpkubedbcom-databaseiammember-editor appscode-charts-oci/spannergcpkubedbcom-databaseiammember-editor -n default --create-namespace --version=v0.4.20
```
...
```bash
$ helm upgrade -i spannergcpkubedbcom-databaseiammember-editor appscode-charts-oci/spannergcpkubedbcom-databaseiammember-editor -n default --create-namespace --version=v0.4.20 --set apiVersion=spanner.gcp.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i spannergcpkubedbcom-databaseiammember-editor appscode-charts-oci/spannergcpkubedbcom-databaseiammember-editor -n default --create-namespace --version=v0.4.20 --values values.yaml
```
