...
$ helm repo update
$ helm search repo appscode-charts-oci/extensions-deployment-editor --version=v0.4.21
$ helm upgrade -i extensions-deployment-editor appscode-charts-oci/extensions-deployment-editor -n default --create-namespace --version=v0.4.21
```
...
```bash
$ helm upgrade -i extensions-deployment-editor appscode-charts-oci/extensions-deployment-editor -n default --create-namespace --version=v0.4.21 --set apiVersion=extensions/v1beta1
```
...
```bash
$ helm upgrade -i extensions-deployment-editor appscode-charts-oci/extensions-deployment-editor -n default --create-namespace --version=v0.4.21 --values values.yaml
```
