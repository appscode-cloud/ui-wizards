...
$ helm repo update
$ helm search repo bytebuilders-ui/extensions-deployment-editor --version=v0.4.16
$ helm upgrade -i extensions-deployment-editor bytebuilders-ui/extensions-deployment-editor -n default --create-namespace --version=v0.4.16
```
...
```bash
$ helm upgrade -i extensions-deployment-editor bytebuilders-ui/extensions-deployment-editor -n default --create-namespace --version=v0.4.16 --set apiVersion=extensions/v1beta1
```
...
```bash
$ helm upgrade -i extensions-deployment-editor bytebuilders-ui/extensions-deployment-editor -n default --create-namespace --version=v0.4.16 --values values.yaml
```
