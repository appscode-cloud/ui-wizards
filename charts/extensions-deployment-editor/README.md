...
$ helm repo update
$ helm search repo appscode-charts-oci/extensions-deployment-editor --version=v0.4.19
$ helm upgrade -i extensions-deployment-editor appscode-charts-oci/extensions-deployment-editor -n default --create-namespace --version=v0.4.19
```
...
```bash
$ helm upgrade -i extensions-deployment-editor appscode-charts-oci/extensions-deployment-editor -n default --create-namespace --version=v0.4.19 --set apiVersion=extensions/v1beta1
```
...
```bash
$ helm upgrade -i extensions-deployment-editor appscode-charts-oci/extensions-deployment-editor -n default --create-namespace --version=v0.4.19 --values values.yaml
```
