...
$ helm repo update
$ helm search repo appscode-charts-oci/chartsxhelmdev-clusterchartpreset-editor --version=v0.5.0
$ helm upgrade -i chartsxhelmdev-clusterchartpreset-editor appscode-charts-oci/chartsxhelmdev-clusterchartpreset-editor -n default --create-namespace --version=v0.5.0
```
...
```bash
$ helm upgrade -i chartsxhelmdev-clusterchartpreset-editor appscode-charts-oci/chartsxhelmdev-clusterchartpreset-editor -n default --create-namespace --version=v0.5.0 --set apiVersion=charts.x-helm.dev/v1alpha1
```
...
```bash
$ helm upgrade -i chartsxhelmdev-clusterchartpreset-editor appscode-charts-oci/chartsxhelmdev-clusterchartpreset-editor -n default --create-namespace --version=v0.5.0 --values values.yaml
```
