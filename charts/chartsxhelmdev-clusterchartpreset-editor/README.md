...
$ helm repo update
$ helm search repo appscode/chartsxhelmdev-clusterchartpreset-editor --version=v0.25.0
$ helm upgrade -i chartsxhelmdev-clusterchartpreset-editor appscode/chartsxhelmdev-clusterchartpreset-editor -n default --create-namespace --version=v0.25.0
```
...
```bash
$ helm upgrade -i chartsxhelmdev-clusterchartpreset-editor appscode/chartsxhelmdev-clusterchartpreset-editor -n default --create-namespace --version=v0.25.0 --set apiVersion=charts.x-helm.dev/v1alpha1
```
...
```bash
$ helm upgrade -i chartsxhelmdev-clusterchartpreset-editor appscode/chartsxhelmdev-clusterchartpreset-editor -n default --create-namespace --version=v0.25.0 --values values.yaml
```
