...
$ helm repo update
$ helm search repo appscode-charts-oci/opskubedbcom-redisopsrequest-editor --version=v0.4.21
$ helm upgrade -i opskubedbcom-redisopsrequest-editor appscode-charts-oci/opskubedbcom-redisopsrequest-editor -n default --create-namespace --version=v0.4.21
```
...
```bash
$ helm upgrade -i opskubedbcom-redisopsrequest-editor appscode-charts-oci/opskubedbcom-redisopsrequest-editor -n default --create-namespace --version=v0.4.21 --set apiVersion=ops.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i opskubedbcom-redisopsrequest-editor appscode-charts-oci/opskubedbcom-redisopsrequest-editor -n default --create-namespace --version=v0.4.21 --values values.yaml
```
