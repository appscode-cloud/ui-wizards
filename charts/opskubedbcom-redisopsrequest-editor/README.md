...
$ helm repo update
$ helm search repo appscode-charts-oci/opskubedbcom-redisopsrequest-editor --version=v0.12.0
$ helm upgrade -i opskubedbcom-redisopsrequest-editor appscode-charts-oci/opskubedbcom-redisopsrequest-editor -n default --create-namespace --version=v0.12.0
```
...
```bash
$ helm upgrade -i opskubedbcom-redisopsrequest-editor appscode-charts-oci/opskubedbcom-redisopsrequest-editor -n default --create-namespace --version=v0.12.0 --set apiVersion=ops.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i opskubedbcom-redisopsrequest-editor appscode-charts-oci/opskubedbcom-redisopsrequest-editor -n default --create-namespace --version=v0.12.0 --values values.yaml
```
