...
$ helm repo update
$ helm search repo bytebuilders-ui/kubedbcom-mariadb-editor-options --version=v0.4.21
$ helm upgrade -i kubedbcom-mariadb-editor-options bytebuilders-ui/kubedbcom-mariadb-editor-options -n kube-system --create-namespace --version=v0.4.21
```
...
| spec.admin.databases.MariaDB.versions.default                                  |                                                                                                      | <code>"10.6.16"</code>                                    |
...
```bash
$ helm upgrade -i kubedbcom-mariadb-editor-options bytebuilders-ui/kubedbcom-mariadb-editor-options -n kube-system --create-namespace --version=v0.4.21 --set metadata.resource.group=kubedb.com
```
...
```bash
$ helm upgrade -i kubedbcom-mariadb-editor-options bytebuilders-ui/kubedbcom-mariadb-editor-options -n kube-system --create-namespace --version=v0.4.21 --values values.yaml
```
