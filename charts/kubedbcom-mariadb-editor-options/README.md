...
$ helm repo update
$ helm install kubedbcom-mariadb-editor-options bytebuilders-ui/kubedbcom-mariadb-editor-options -n kube-system
```
...
```console
$ helm install kubedbcom-mariadb-editor-options bytebuilders-ui/kubedbcom-mariadb-editor-options -n kube-system --set metadata.resource.group=kubedb.com
```
...
```console
$ helm install kubedbcom-mariadb-editor-options bytebuilders-ui/kubedbcom-mariadb-editor-options -n kube-system --values values.yaml
```
