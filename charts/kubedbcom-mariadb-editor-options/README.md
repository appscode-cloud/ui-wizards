...
$ helm repo update
$ helm search repo bytebuilders-ui/kubedbcom-mariadb-editor-options --version=v0.4.1
$ helm upgrade -i kubedbcom-mariadb-editor-options bytebuilders-ui/kubedbcom-mariadb-editor-options -n kube-system --create-namespace --version=v0.4.1
```
...
```bash
$ helm upgrade -i kubedbcom-mariadb-editor-options bytebuilders-ui/kubedbcom-mariadb-editor-options -n kube-system --create-namespace --version=v0.4.1 --set metadata.resource.group=kubedb.com
```
...
```bash
$ helm upgrade -i kubedbcom-mariadb-editor-options bytebuilders-ui/kubedbcom-mariadb-editor-options -n kube-system --create-namespace --version=v0.4.1 --values values.yaml
```
