...
$ helm repo update
$ helm search repo appscode-charts-oci/notificationtoolkitfluxcdio-receiver-editor --version=v0.4.19
$ helm upgrade -i notificationtoolkitfluxcdio-receiver-editor appscode-charts-oci/notificationtoolkitfluxcdio-receiver-editor -n default --create-namespace --version=v0.4.19
```
...
```bash
$ helm upgrade -i notificationtoolkitfluxcdio-receiver-editor appscode-charts-oci/notificationtoolkitfluxcdio-receiver-editor -n default --create-namespace --version=v0.4.19 --set apiVersion=notification.toolkit.fluxcd.io/v1
```
...
```bash
$ helm upgrade -i notificationtoolkitfluxcdio-receiver-editor appscode-charts-oci/notificationtoolkitfluxcdio-receiver-editor -n default --create-namespace --version=v0.4.19 --values values.yaml
```
