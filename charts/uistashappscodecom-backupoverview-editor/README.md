...
$ helm repo update
$ helm search repo appscode-charts-oci/uistashappscodecom-backupoverview-editor --version=v0.4.18
$ helm upgrade -i uistashappscodecom-backupoverview-editor appscode-charts-oci/uistashappscodecom-backupoverview-editor -n default --create-namespace --version=v0.4.18
```
...
```bash
$ helm upgrade -i uistashappscodecom-backupoverview-editor appscode-charts-oci/uistashappscodecom-backupoverview-editor -n default --create-namespace --version=v0.4.18 --set apiVersion=ui.stash.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i uistashappscodecom-backupoverview-editor appscode-charts-oci/uistashappscodecom-backupoverview-editor -n default --create-namespace --version=v0.4.18 --values values.yaml
```
