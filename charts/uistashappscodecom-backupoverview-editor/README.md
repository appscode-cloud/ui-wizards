...
$ helm repo update
$ helm search repo bytebuilders-ui/uistashappscodecom-backupoverview-editor --version=v0.4.7
$ helm upgrade -i uistashappscodecom-backupoverview-editor bytebuilders-ui/uistashappscodecom-backupoverview-editor -n default --create-namespace --version=v0.4.7
```
...
```bash
$ helm upgrade -i uistashappscodecom-backupoverview-editor bytebuilders-ui/uistashappscodecom-backupoverview-editor -n default --create-namespace --version=v0.4.7 --set apiVersion=ui.stash.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i uistashappscodecom-backupoverview-editor bytebuilders-ui/uistashappscodecom-backupoverview-editor -n default --create-namespace --version=v0.4.7 --values values.yaml
```
