...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/uistashappscodecom-backupoverview-editor --version=v0.4.17
$ helm upgrade -i uistashappscodecom-backupoverview-editor bytebuilders-ui-dev/uistashappscodecom-backupoverview-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i uistashappscodecom-backupoverview-editor bytebuilders-ui-dev/uistashappscodecom-backupoverview-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=ui.stash.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i uistashappscodecom-backupoverview-editor bytebuilders-ui-dev/uistashappscodecom-backupoverview-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
