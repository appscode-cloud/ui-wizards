...
$ helm repo update
$ helm search repo appscode/kubedbcom-weaviate-editor --version=v0.35.0
$ helm upgrade -i kubedbcom-weaviate-editor appscode/kubedbcom-weaviate-editor -n default --create-namespace --version=v0.35.0
```
...
```bash
$ helm upgrade -i kubedbcom-weaviate-editor appscode/kubedbcom-weaviate-editor -n default --create-namespace --version=v0.35.0 --set metadata.resource.group=kubedb.com
```
...
```bash
$ helm upgrade -i kubedbcom-weaviate-editor appscode/kubedbcom-weaviate-editor -n default --create-namespace --version=v0.35.0 --values values.yaml
```
