...
$ helm repo update
$ helm search repo appscode-charts-oci/sqlgcpkubedbcom-sslcert-editor --version=v0.6.0
$ helm upgrade -i sqlgcpkubedbcom-sslcert-editor appscode-charts-oci/sqlgcpkubedbcom-sslcert-editor -n default --create-namespace --version=v0.6.0
```
...
```bash
$ helm upgrade -i sqlgcpkubedbcom-sslcert-editor appscode-charts-oci/sqlgcpkubedbcom-sslcert-editor -n default --create-namespace --version=v0.6.0 --set apiVersion=sql.gcp.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i sqlgcpkubedbcom-sslcert-editor appscode-charts-oci/sqlgcpkubedbcom-sslcert-editor -n default --create-namespace --version=v0.6.0 --values values.yaml
```
