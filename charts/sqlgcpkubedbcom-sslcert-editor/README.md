...
$ helm repo update
$ helm search repo appscode/sqlgcpkubedbcom-sslcert-editor --version=v0.16.0
$ helm upgrade -i sqlgcpkubedbcom-sslcert-editor appscode/sqlgcpkubedbcom-sslcert-editor -n default --create-namespace --version=v0.16.0
```
...
```bash
$ helm upgrade -i sqlgcpkubedbcom-sslcert-editor appscode/sqlgcpkubedbcom-sslcert-editor -n default --create-namespace --version=v0.16.0 --set apiVersion=sql.gcp.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i sqlgcpkubedbcom-sslcert-editor appscode/sqlgcpkubedbcom-sslcert-editor -n default --create-namespace --version=v0.16.0 --values values.yaml
```
