...
$ helm repo update
$ helm search repo appscode/extensions-replicaset-editor --version=v0.29.0
$ helm upgrade -i extensions-replicaset-editor appscode/extensions-replicaset-editor -n default --create-namespace --version=v0.29.0
```
...
```bash
$ helm upgrade -i extensions-replicaset-editor appscode/extensions-replicaset-editor -n default --create-namespace --version=v0.29.0 --set apiVersion=extensions/v1beta1
```
...
```bash
$ helm upgrade -i extensions-replicaset-editor appscode/extensions-replicaset-editor -n default --create-namespace --version=v0.29.0 --values values.yaml
```
