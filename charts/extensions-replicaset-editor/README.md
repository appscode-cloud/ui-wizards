...
$ helm repo update
$ helm search repo appscode-charts-oci/extensions-replicaset-editor --version=v0.13.0
$ helm upgrade -i extensions-replicaset-editor appscode-charts-oci/extensions-replicaset-editor -n default --create-namespace --version=v0.13.0
```
...
```bash
$ helm upgrade -i extensions-replicaset-editor appscode-charts-oci/extensions-replicaset-editor -n default --create-namespace --version=v0.13.0 --set apiVersion=extensions/v1beta1
```
...
```bash
$ helm upgrade -i extensions-replicaset-editor appscode-charts-oci/extensions-replicaset-editor -n default --create-namespace --version=v0.13.0 --values values.yaml
```
