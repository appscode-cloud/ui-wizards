...
$ helm repo update
$ helm install extensions-replicaset-editor bytebuilders-ui/extensions-replicaset-editor -n default
```
...
```console
$ helm install extensions-replicaset-editor bytebuilders-ui/extensions-replicaset-editor -n default --set apiVersion=extensions/v1beta1
```
...
```console
$ helm install extensions-replicaset-editor bytebuilders-ui/extensions-replicaset-editor -n default --values values.yaml
```
