...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/extensions-replicaset-editor --version=v0.4.17
$ helm upgrade -i extensions-replicaset-editor bytebuilders-ui-dev/extensions-replicaset-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i extensions-replicaset-editor bytebuilders-ui-dev/extensions-replicaset-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=extensions/v1beta1
```
...
```bash
$ helm upgrade -i extensions-replicaset-editor bytebuilders-ui-dev/extensions-replicaset-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
