...
$ helm repo update
$ helm search repo appscode-charts-oci/uik8sappscodecom-featureset-dbaas-capg-editor --version=v0.4.18
$ helm upgrade -i uik8sappscodecom-featureset-dbaas-capg-editor appscode-charts-oci/uik8sappscodecom-featureset-dbaas-capg-editor -n default --create-namespace --version=v0.4.18
```
...
```bash
$ helm upgrade -i uik8sappscodecom-featureset-dbaas-capg-editor appscode-charts-oci/uik8sappscodecom-featureset-dbaas-capg-editor -n default --create-namespace --version=v0.4.18 --set metadata.resource.group=ui.k8s.appscode.com
```
...
```bash
$ helm upgrade -i uik8sappscodecom-featureset-dbaas-capg-editor appscode-charts-oci/uik8sappscodecom-featureset-dbaas-capg-editor -n default --create-namespace --version=v0.4.18 --values values.yaml
```
