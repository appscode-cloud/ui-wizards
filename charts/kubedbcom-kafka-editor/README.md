...
$ helm repo update
$ helm search repo appscode-charts-oci/kubedbcom-kafka-editor --version=v0.4.18
$ helm upgrade -i kubedbcom-kafka-editor appscode-charts-oci/kubedbcom-kafka-editor -n default --create-namespace --version=v0.4.18
```
...
```bash
$ helm upgrade -i kubedbcom-kafka-editor appscode-charts-oci/kubedbcom-kafka-editor -n default --create-namespace --version=v0.4.18 --set metadata.resource.group=kubedb.com
```
...
```bash
$ helm upgrade -i kubedbcom-kafka-editor appscode-charts-oci/kubedbcom-kafka-editor -n default --create-namespace --version=v0.4.18 --values values.yaml
```
