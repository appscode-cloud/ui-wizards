...
$ helm repo update
$ helm search repo appscode/authorizationk8sio-localsubjectaccessreview-editor --version=v0.17.0
$ helm upgrade -i authorizationk8sio-localsubjectaccessreview-editor appscode/authorizationk8sio-localsubjectaccessreview-editor -n default --create-namespace --version=v0.17.0
```
...
```bash
$ helm upgrade -i authorizationk8sio-localsubjectaccessreview-editor appscode/authorizationk8sio-localsubjectaccessreview-editor -n default --create-namespace --version=v0.17.0 --set apiVersion=authorization.k8s.io/v1
```
...
```bash
$ helm upgrade -i authorizationk8sio-localsubjectaccessreview-editor appscode/authorizationk8sio-localsubjectaccessreview-editor -n default --create-namespace --version=v0.17.0 --values values.yaml
```
