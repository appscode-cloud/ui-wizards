...
$ helm repo update
$ helm search repo appscode/coordinationk8sio-lease-editor --version=v0.36.0
$ helm upgrade -i coordinationk8sio-lease-editor appscode/coordinationk8sio-lease-editor -n default --create-namespace --version=v0.36.0
```
...
```bash
$ helm upgrade -i coordinationk8sio-lease-editor appscode/coordinationk8sio-lease-editor -n default --create-namespace --version=v0.36.0 --set apiVersion=coordination.k8s.io/v1
```
...
```bash
$ helm upgrade -i coordinationk8sio-lease-editor appscode/coordinationk8sio-lease-editor -n default --create-namespace --version=v0.36.0 --values values.yaml
```
