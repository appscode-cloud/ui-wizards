...
$ helm repo update
$ helm search repo appscode-charts-oci/coordinationk8sio-lease-editor --version=v0.4.19
$ helm upgrade -i coordinationk8sio-lease-editor appscode-charts-oci/coordinationk8sio-lease-editor -n default --create-namespace --version=v0.4.19
```
...
```bash
$ helm upgrade -i coordinationk8sio-lease-editor appscode-charts-oci/coordinationk8sio-lease-editor -n default --create-namespace --version=v0.4.19 --set apiVersion=coordination.k8s.io/v1
```
...
```bash
$ helm upgrade -i coordinationk8sio-lease-editor appscode-charts-oci/coordinationk8sio-lease-editor -n default --create-namespace --version=v0.4.19 --values values.yaml
```
