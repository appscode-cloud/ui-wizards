...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/coordinationk8sio-lease-editor --version=v0.4.17
$ helm upgrade -i coordinationk8sio-lease-editor bytebuilders-ui-dev/coordinationk8sio-lease-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i coordinationk8sio-lease-editor bytebuilders-ui-dev/coordinationk8sio-lease-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=coordination.k8s.io/v1
```
...
```bash
$ helm upgrade -i coordinationk8sio-lease-editor bytebuilders-ui-dev/coordinationk8sio-lease-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
