...
$ helm repo update
$ helm search repo appscode-charts-oci/catalogkubedbcom-mssqlserverversion-editor --version=v0.4.21
$ helm upgrade -i catalogkubedbcom-mssqlserverversion-editor appscode-charts-oci/catalogkubedbcom-mssqlserverversion-editor -n default --create-namespace --version=v0.4.21
```
...
```bash
$ helm upgrade -i catalogkubedbcom-mssqlserverversion-editor appscode-charts-oci/catalogkubedbcom-mssqlserverversion-editor -n default --create-namespace --version=v0.4.21 --set apiVersion=catalog.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i catalogkubedbcom-mssqlserverversion-editor appscode-charts-oci/catalogkubedbcom-mssqlserverversion-editor -n default --create-namespace --version=v0.4.21 --values values.yaml
```
