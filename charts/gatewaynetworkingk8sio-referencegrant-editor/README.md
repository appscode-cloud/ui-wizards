...
$ helm repo update
$ helm search repo appscode/gatewaynetworkingk8sio-referencegrant-editor --version=v0.20.0
$ helm upgrade -i gatewaynetworkingk8sio-referencegrant-editor appscode/gatewaynetworkingk8sio-referencegrant-editor -n default --create-namespace --version=v0.20.0
```
...
```bash
$ helm upgrade -i gatewaynetworkingk8sio-referencegrant-editor appscode/gatewaynetworkingk8sio-referencegrant-editor -n default --create-namespace --version=v0.20.0 --set apiVersion=gateway.networking.k8s.io/v1beta1
```
...
```bash
$ helm upgrade -i gatewaynetworkingk8sio-referencegrant-editor appscode/gatewaynetworkingk8sio-referencegrant-editor -n default --create-namespace --version=v0.20.0 --values values.yaml
```
