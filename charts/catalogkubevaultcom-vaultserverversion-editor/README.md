...
$ helm repo update
$ helm search repo appscode-charts-oci/catalogkubevaultcom-vaultserverversion-editor --version=v0.4.19
$ helm upgrade -i catalogkubevaultcom-vaultserverversion-editor appscode-charts-oci/catalogkubevaultcom-vaultserverversion-editor -n default --create-namespace --version=v0.4.19
```
...
```bash
$ helm upgrade -i catalogkubevaultcom-vaultserverversion-editor appscode-charts-oci/catalogkubevaultcom-vaultserverversion-editor -n default --create-namespace --version=v0.4.19 --set apiVersion=catalog.kubevault.com/v1alpha1
```
...
```bash
$ helm upgrade -i catalogkubevaultcom-vaultserverversion-editor appscode-charts-oci/catalogkubevaultcom-vaultserverversion-editor -n default --create-namespace --version=v0.4.19 --values values.yaml
```
