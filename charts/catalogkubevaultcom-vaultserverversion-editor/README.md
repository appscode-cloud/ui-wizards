...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/catalogkubevaultcom-vaultserverversion-editor --version=v0.4.17
$ helm upgrade -i catalogkubevaultcom-vaultserverversion-editor bytebuilders-ui-dev/catalogkubevaultcom-vaultserverversion-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i catalogkubevaultcom-vaultserverversion-editor bytebuilders-ui-dev/catalogkubevaultcom-vaultserverversion-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=catalog.kubevault.com/v1alpha1
```
...
```bash
$ helm upgrade -i catalogkubevaultcom-vaultserverversion-editor bytebuilders-ui-dev/catalogkubevaultcom-vaultserverversion-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
