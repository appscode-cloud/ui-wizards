...
$ helm repo update
$ helm search repo appscode-charts-oci/schemakubedbcom-postgresdatabase-editor --version=v0.4.19
$ helm upgrade -i schemakubedbcom-postgresdatabase-editor appscode-charts-oci/schemakubedbcom-postgresdatabase-editor -n default --create-namespace --version=v0.4.19
```
...
```bash
$ helm upgrade -i schemakubedbcom-postgresdatabase-editor appscode-charts-oci/schemakubedbcom-postgresdatabase-editor -n default --create-namespace --version=v0.4.19 --set apiVersion=schema.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i schemakubedbcom-postgresdatabase-editor appscode-charts-oci/schemakubedbcom-postgresdatabase-editor -n default --create-namespace --version=v0.4.19 --values values.yaml
```
