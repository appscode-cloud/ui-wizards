...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/schemakubedbcom-postgresdatabase-editor --version=v0.4.17
$ helm upgrade -i schemakubedbcom-postgresdatabase-editor bytebuilders-ui-dev/schemakubedbcom-postgresdatabase-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i schemakubedbcom-postgresdatabase-editor bytebuilders-ui-dev/schemakubedbcom-postgresdatabase-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=schema.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i schemakubedbcom-postgresdatabase-editor bytebuilders-ui-dev/schemakubedbcom-postgresdatabase-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
