...
$ helm repo update
$ helm search repo bytebuilders-ui/schemakubedbcom-postgresdatabase-editor --version=v0.4.13
$ helm upgrade -i schemakubedbcom-postgresdatabase-editor bytebuilders-ui/schemakubedbcom-postgresdatabase-editor -n default --create-namespace --version=v0.4.13
```
...
```bash
$ helm upgrade -i schemakubedbcom-postgresdatabase-editor bytebuilders-ui/schemakubedbcom-postgresdatabase-editor -n default --create-namespace --version=v0.4.13 --set apiVersion=schema.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i schemakubedbcom-postgresdatabase-editor bytebuilders-ui/schemakubedbcom-postgresdatabase-editor -n default --create-namespace --version=v0.4.13 --values values.yaml
```
