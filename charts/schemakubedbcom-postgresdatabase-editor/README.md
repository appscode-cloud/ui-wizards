...
$ helm repo update
$ helm search repo bytebuilders-ui/schemakubedbcom-postgresdatabase-editor --version=v0.4.15
$ helm upgrade -i schemakubedbcom-postgresdatabase-editor bytebuilders-ui/schemakubedbcom-postgresdatabase-editor -n default --create-namespace --version=v0.4.15
```
...
```bash
$ helm upgrade -i schemakubedbcom-postgresdatabase-editor bytebuilders-ui/schemakubedbcom-postgresdatabase-editor -n default --create-namespace --version=v0.4.15 --set apiVersion=schema.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i schemakubedbcom-postgresdatabase-editor bytebuilders-ui/schemakubedbcom-postgresdatabase-editor -n default --create-namespace --version=v0.4.15 --values values.yaml
```
