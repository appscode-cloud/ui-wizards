...
$ helm repo update
$ helm search repo appscode/schemakubedbcom-postgresdatabase-editor --version=v0.17.0
$ helm upgrade -i schemakubedbcom-postgresdatabase-editor appscode/schemakubedbcom-postgresdatabase-editor -n default --create-namespace --version=v0.17.0
```
...
```bash
$ helm upgrade -i schemakubedbcom-postgresdatabase-editor appscode/schemakubedbcom-postgresdatabase-editor -n default --create-namespace --version=v0.17.0 --set apiVersion=schema.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i schemakubedbcom-postgresdatabase-editor appscode/schemakubedbcom-postgresdatabase-editor -n default --create-namespace --version=v0.17.0 --values values.yaml
```
