...
$ helm repo update
$ helm search repo appscode-charts-oci/batch-cronjob-editor --version=v0.14.0
$ helm upgrade -i batch-cronjob-editor appscode-charts-oci/batch-cronjob-editor -n default --create-namespace --version=v0.14.0
```
...
```bash
$ helm upgrade -i batch-cronjob-editor appscode-charts-oci/batch-cronjob-editor -n default --create-namespace --version=v0.14.0 --set apiVersion=batch/v1
```
...
```bash
$ helm upgrade -i batch-cronjob-editor appscode-charts-oci/batch-cronjob-editor -n default --create-namespace --version=v0.14.0 --values values.yaml
```
