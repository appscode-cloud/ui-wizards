...
$ helm repo update
$ helm search repo appscode/batch-cronjob-editor --version=v0.37.0
$ helm upgrade -i batch-cronjob-editor appscode/batch-cronjob-editor -n default --create-namespace --version=v0.37.0
```
...
```bash
$ helm upgrade -i batch-cronjob-editor appscode/batch-cronjob-editor -n default --create-namespace --version=v0.37.0 --set apiVersion=batch/v1
```
...
```bash
$ helm upgrade -i batch-cronjob-editor appscode/batch-cronjob-editor -n default --create-namespace --version=v0.37.0 --values values.yaml
```
