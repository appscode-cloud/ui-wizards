...
$ helm repo update
$ helm search repo bytebuilders-ui/batch-cronjob-editor --version=v0.4.2
$ helm upgrade -i batch-cronjob-editor bytebuilders-ui/batch-cronjob-editor -n default --create-namespace --version=v0.4.2
```
...
```bash
$ helm upgrade -i batch-cronjob-editor bytebuilders-ui/batch-cronjob-editor -n default --create-namespace --version=v0.4.2 --set apiVersion=batch/v1
```
...
```bash
$ helm upgrade -i batch-cronjob-editor bytebuilders-ui/batch-cronjob-editor -n default --create-namespace --version=v0.4.2 --values values.yaml
```
