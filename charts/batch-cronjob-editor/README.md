...
$ helm repo update
$ helm search repo bytebuilders-ui/batch-cronjob-editor --version=v0.4.17
$ helm upgrade -i batch-cronjob-editor bytebuilders-ui/batch-cronjob-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i batch-cronjob-editor bytebuilders-ui/batch-cronjob-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=batch/v1
```
...
```bash
$ helm upgrade -i batch-cronjob-editor bytebuilders-ui/batch-cronjob-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
