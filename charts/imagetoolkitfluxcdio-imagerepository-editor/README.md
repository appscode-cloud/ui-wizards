...
$ helm repo update
$ helm search repo appscode/imagetoolkitfluxcdio-imagerepository-editor --version=v0.34.0
$ helm upgrade -i imagetoolkitfluxcdio-imagerepository-editor appscode/imagetoolkitfluxcdio-imagerepository-editor -n default --create-namespace --version=v0.34.0
```
...
```bash
$ helm upgrade -i imagetoolkitfluxcdio-imagerepository-editor appscode/imagetoolkitfluxcdio-imagerepository-editor -n default --create-namespace --version=v0.34.0 --set apiVersion=image.toolkit.fluxcd.io/v1beta2
```
...
```bash
$ helm upgrade -i imagetoolkitfluxcdio-imagerepository-editor appscode/imagetoolkitfluxcdio-imagerepository-editor -n default --create-namespace --version=v0.34.0 --values values.yaml
```
