...
$ helm repo update
$ helm search repo appscode-charts-oci/imagetoolkitfluxcdio-imagerepository-editor --version=v0.8.0
$ helm upgrade -i imagetoolkitfluxcdio-imagerepository-editor appscode-charts-oci/imagetoolkitfluxcdio-imagerepository-editor -n default --create-namespace --version=v0.8.0
```
...
```bash
$ helm upgrade -i imagetoolkitfluxcdio-imagerepository-editor appscode-charts-oci/imagetoolkitfluxcdio-imagerepository-editor -n default --create-namespace --version=v0.8.0 --set apiVersion=image.toolkit.fluxcd.io/v1beta2
```
...
```bash
$ helm upgrade -i imagetoolkitfluxcdio-imagerepository-editor appscode-charts-oci/imagetoolkitfluxcdio-imagerepository-editor -n default --create-namespace --version=v0.8.0 --values values.yaml
```
