...
$ helm repo update
$ helm search repo bytebuilders-ui/infrastructureclusterxk8sio-azuremachine-editor --version=v0.4.15
$ helm upgrade -i infrastructureclusterxk8sio-azuremachine-editor bytebuilders-ui/infrastructureclusterxk8sio-azuremachine-editor -n default --create-namespace --version=v0.4.15
```
...
```bash
$ helm upgrade -i infrastructureclusterxk8sio-azuremachine-editor bytebuilders-ui/infrastructureclusterxk8sio-azuremachine-editor -n default --create-namespace --version=v0.4.15 --set apiVersion=infrastructure.cluster.x-k8s.io/v1beta1
```
...
```bash
$ helm upgrade -i infrastructureclusterxk8sio-azuremachine-editor bytebuilders-ui/infrastructureclusterxk8sio-azuremachine-editor -n default --create-namespace --version=v0.4.15 --values values.yaml
```
