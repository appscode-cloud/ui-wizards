...
$ helm repo update
$ helm search repo bytebuilders-ui/infrastructureclusterxk8sio-azurecluster-editor --version=v0.4.16
$ helm upgrade -i infrastructureclusterxk8sio-azurecluster-editor bytebuilders-ui/infrastructureclusterxk8sio-azurecluster-editor -n default --create-namespace --version=v0.4.16
```
...
```bash
$ helm upgrade -i infrastructureclusterxk8sio-azurecluster-editor bytebuilders-ui/infrastructureclusterxk8sio-azurecluster-editor -n default --create-namespace --version=v0.4.16 --set apiVersion=infrastructure.cluster.x-k8s.io/v1beta1
```
...
```bash
$ helm upgrade -i infrastructureclusterxk8sio-azurecluster-editor bytebuilders-ui/infrastructureclusterxk8sio-azurecluster-editor -n default --create-namespace --version=v0.4.16 --values values.yaml
```
