...
$ helm repo update
$ helm search repo appscode-charts-oci/supervisorappscodecom-clustermaintenancewindow-editor --version=v0.4.20
$ helm upgrade -i supervisorappscodecom-clustermaintenancewindow-editor appscode-charts-oci/supervisorappscodecom-clustermaintenancewindow-editor -n default --create-namespace --version=v0.4.20
```
...
```bash
$ helm upgrade -i supervisorappscodecom-clustermaintenancewindow-editor appscode-charts-oci/supervisorappscodecom-clustermaintenancewindow-editor -n default --create-namespace --version=v0.4.20 --set apiVersion=supervisor.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i supervisorappscodecom-clustermaintenancewindow-editor appscode-charts-oci/supervisorappscodecom-clustermaintenancewindow-editor -n default --create-namespace --version=v0.4.20 --values values.yaml
```
