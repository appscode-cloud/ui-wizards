...
$ helm repo update
$ helm search repo appscode-charts-oci/supervisorappscodecom-clustermaintenancewindow-editor --version=v0.5.0
$ helm upgrade -i supervisorappscodecom-clustermaintenancewindow-editor appscode-charts-oci/supervisorappscodecom-clustermaintenancewindow-editor -n default --create-namespace --version=v0.5.0
```
...
```bash
$ helm upgrade -i supervisorappscodecom-clustermaintenancewindow-editor appscode-charts-oci/supervisorappscodecom-clustermaintenancewindow-editor -n default --create-namespace --version=v0.5.0 --set apiVersion=supervisor.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i supervisorappscodecom-clustermaintenancewindow-editor appscode-charts-oci/supervisorappscodecom-clustermaintenancewindow-editor -n default --create-namespace --version=v0.5.0 --values values.yaml
```
