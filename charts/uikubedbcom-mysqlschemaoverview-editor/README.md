...
$ helm repo update
$ helm search repo appscode-charts-oci/uikubedbcom-mysqlschemaoverview-editor --version=v0.4.21
$ helm upgrade -i uikubedbcom-mysqlschemaoverview-editor appscode-charts-oci/uikubedbcom-mysqlschemaoverview-editor -n default --create-namespace --version=v0.4.21
```
...
```bash
$ helm upgrade -i uikubedbcom-mysqlschemaoverview-editor appscode-charts-oci/uikubedbcom-mysqlschemaoverview-editor -n default --create-namespace --version=v0.4.21 --set apiVersion=ui.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i uikubedbcom-mysqlschemaoverview-editor appscode-charts-oci/uikubedbcom-mysqlschemaoverview-editor -n default --create-namespace --version=v0.4.21 --values values.yaml
```
