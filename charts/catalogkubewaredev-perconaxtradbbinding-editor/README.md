...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/catalogkubewaredev-perconaxtradbbinding-editor --version=v0.4.17
$ helm upgrade -i catalogkubewaredev-perconaxtradbbinding-editor bytebuilders-ui-dev/catalogkubewaredev-perconaxtradbbinding-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i catalogkubewaredev-perconaxtradbbinding-editor bytebuilders-ui-dev/catalogkubewaredev-perconaxtradbbinding-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=catalog.kubeware.dev/v1alpha1
```
...
```bash
$ helm upgrade -i catalogkubewaredev-perconaxtradbbinding-editor bytebuilders-ui-dev/catalogkubewaredev-perconaxtradbbinding-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
