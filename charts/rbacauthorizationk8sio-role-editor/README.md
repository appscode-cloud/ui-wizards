...
$ helm repo update
$ helm search repo appscode-charts-oci/rbacauthorizationk8sio-role-editor --version=v0.4.20
$ helm upgrade -i rbacauthorizationk8sio-role-editor appscode-charts-oci/rbacauthorizationk8sio-role-editor -n default --create-namespace --version=v0.4.20
```
...
```bash
$ helm upgrade -i rbacauthorizationk8sio-role-editor appscode-charts-oci/rbacauthorizationk8sio-role-editor -n default --create-namespace --version=v0.4.20 --set apiVersion=rbac.authorization.k8s.io/v1
```
...
```bash
$ helm upgrade -i rbacauthorizationk8sio-role-editor appscode-charts-oci/rbacauthorizationk8sio-role-editor -n default --create-namespace --version=v0.4.20 --values values.yaml
```
