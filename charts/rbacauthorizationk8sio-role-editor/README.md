...
$ helm repo update
$ helm install rbacauthorizationk8sio-role-editor bytebuilders-ui-dev/rbacauthorizationk8sio-role-editor -n default
```
...
```console
$ helm install rbacauthorizationk8sio-role-editor bytebuilders-ui-dev/rbacauthorizationk8sio-role-editor -n default --set apiVersion=rbac.authorization.k8s.io/v1
```
...
```console
$ helm install rbacauthorizationk8sio-role-editor bytebuilders-ui-dev/rbacauthorizationk8sio-role-editor -n default --values values.yaml
```
