...
$ helm repo update
$ helm search repo bytebuilders-ui/rbacauthorizationk8sio-role-editor --version=v0.4.15
$ helm upgrade -i rbacauthorizationk8sio-role-editor bytebuilders-ui/rbacauthorizationk8sio-role-editor -n default --create-namespace --version=v0.4.15
```
...
```bash
$ helm upgrade -i rbacauthorizationk8sio-role-editor bytebuilders-ui/rbacauthorizationk8sio-role-editor -n default --create-namespace --version=v0.4.15 --set apiVersion=rbac.authorization.k8s.io/v1
```
...
```bash
$ helm upgrade -i rbacauthorizationk8sio-role-editor bytebuilders-ui/rbacauthorizationk8sio-role-editor -n default --create-namespace --version=v0.4.15 --values values.yaml
```
