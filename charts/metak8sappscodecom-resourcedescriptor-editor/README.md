...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/metak8sappscodecom-resourcedescriptor-editor --version=v0.4.17
$ helm upgrade -i metak8sappscodecom-resourcedescriptor-editor bytebuilders-ui-dev/metak8sappscodecom-resourcedescriptor-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i metak8sappscodecom-resourcedescriptor-editor bytebuilders-ui-dev/metak8sappscodecom-resourcedescriptor-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=meta.k8s.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i metak8sappscodecom-resourcedescriptor-editor bytebuilders-ui-dev/metak8sappscodecom-resourcedescriptor-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
