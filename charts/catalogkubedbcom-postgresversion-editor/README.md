...
$ helm repo update
$ helm search repo appscode-charts-oci/catalogkubedbcom-postgresversion-editor --version=v0.13.0
$ helm upgrade -i catalogkubedbcom-postgresversion-editor appscode-charts-oci/catalogkubedbcom-postgresversion-editor -n default --create-namespace --version=v0.13.0
```
...
```bash
$ helm upgrade -i catalogkubedbcom-postgresversion-editor appscode-charts-oci/catalogkubedbcom-postgresversion-editor -n default --create-namespace --version=v0.13.0 --set apiVersion=catalog.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i catalogkubedbcom-postgresversion-editor appscode-charts-oci/catalogkubedbcom-postgresversion-editor -n default --create-namespace --version=v0.13.0 --values values.yaml
```
