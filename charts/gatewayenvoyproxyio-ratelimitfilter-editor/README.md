...
$ helm repo update
$ helm search repo appscode/gatewayenvoyproxyio-ratelimitfilter-editor --version=v0.16.0
$ helm upgrade -i gatewayenvoyproxyio-ratelimitfilter-editor appscode/gatewayenvoyproxyio-ratelimitfilter-editor -n default --create-namespace --version=v0.16.0
```
...
```bash
$ helm upgrade -i gatewayenvoyproxyio-ratelimitfilter-editor appscode/gatewayenvoyproxyio-ratelimitfilter-editor -n default --create-namespace --version=v0.16.0 --set apiVersion=gateway.envoyproxy.io/v1alpha1
```
...
```bash
$ helm upgrade -i gatewayenvoyproxyio-ratelimitfilter-editor appscode/gatewayenvoyproxyio-ratelimitfilter-editor -n default --create-namespace --version=v0.16.0 --values values.yaml
```
