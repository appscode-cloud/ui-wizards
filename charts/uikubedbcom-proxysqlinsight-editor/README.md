...
$ helm repo update
$ helm search repo appscode/uikubedbcom-proxysqlinsight-editor --version=v0.29.0
$ helm upgrade -i uikubedbcom-proxysqlinsight-editor appscode/uikubedbcom-proxysqlinsight-editor -n default --create-namespace --version=v0.29.0
```
...
```bash
$ helm upgrade -i uikubedbcom-proxysqlinsight-editor appscode/uikubedbcom-proxysqlinsight-editor -n default --create-namespace --version=v0.29.0 --set apiVersion=ui.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i uikubedbcom-proxysqlinsight-editor appscode/uikubedbcom-proxysqlinsight-editor -n default --create-namespace --version=v0.29.0 --values values.yaml
```
