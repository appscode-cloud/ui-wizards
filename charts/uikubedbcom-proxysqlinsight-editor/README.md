...
$ helm repo update
$ helm search repo bytebuilders-ui/uikubedbcom-proxysqlinsight-editor --version=v0.4.18
$ helm upgrade -i uikubedbcom-proxysqlinsight-editor bytebuilders-ui/uikubedbcom-proxysqlinsight-editor -n default --create-namespace --version=v0.4.18
```
...
```bash
$ helm upgrade -i uikubedbcom-proxysqlinsight-editor bytebuilders-ui/uikubedbcom-proxysqlinsight-editor -n default --create-namespace --version=v0.4.18 --set apiVersion=ui.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i uikubedbcom-proxysqlinsight-editor bytebuilders-ui/uikubedbcom-proxysqlinsight-editor -n default --create-namespace --version=v0.4.18 --values values.yaml
```
