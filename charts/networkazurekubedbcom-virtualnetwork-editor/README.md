...
$ helm repo update
$ helm search repo appscode/networkazurekubedbcom-virtualnetwork-editor --version=v0.36.0
$ helm upgrade -i networkazurekubedbcom-virtualnetwork-editor appscode/networkazurekubedbcom-virtualnetwork-editor -n default --create-namespace --version=v0.36.0
```
...
```bash
$ helm upgrade -i networkazurekubedbcom-virtualnetwork-editor appscode/networkazurekubedbcom-virtualnetwork-editor -n default --create-namespace --version=v0.36.0 --set apiVersion=network.azure.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i networkazurekubedbcom-virtualnetwork-editor appscode/networkazurekubedbcom-virtualnetwork-editor -n default --create-namespace --version=v0.36.0 --values values.yaml
```
