...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/snapshotstoragek8sio-volumesnapshot-editor --version=v0.4.17
$ helm upgrade -i snapshotstoragek8sio-volumesnapshot-editor bytebuilders-ui-dev/snapshotstoragek8sio-volumesnapshot-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i snapshotstoragek8sio-volumesnapshot-editor bytebuilders-ui-dev/snapshotstoragek8sio-volumesnapshot-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=snapshot.storage.k8s.io/v1
```
...
```bash
$ helm upgrade -i snapshotstoragek8sio-volumesnapshot-editor bytebuilders-ui-dev/snapshotstoragek8sio-volumesnapshot-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
