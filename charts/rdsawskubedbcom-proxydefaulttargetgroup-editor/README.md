...
$ helm repo update
$ helm search repo appscode/rdsawskubedbcom-proxydefaulttargetgroup-editor --version=v0.34.0
$ helm upgrade -i rdsawskubedbcom-proxydefaulttargetgroup-editor appscode/rdsawskubedbcom-proxydefaulttargetgroup-editor -n default --create-namespace --version=v0.34.0
```
...
```bash
$ helm upgrade -i rdsawskubedbcom-proxydefaulttargetgroup-editor appscode/rdsawskubedbcom-proxydefaulttargetgroup-editor -n default --create-namespace --version=v0.34.0 --set apiVersion=rds.aws.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i rdsawskubedbcom-proxydefaulttargetgroup-editor appscode/rdsawskubedbcom-proxydefaulttargetgroup-editor -n default --create-namespace --version=v0.34.0 --values values.yaml
```
