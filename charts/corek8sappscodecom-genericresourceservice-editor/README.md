...
$ helm repo update
$ helm search repo appscode-charts-oci/corek8sappscodecom-genericresourceservice-editor --version=v0.7.0
$ helm upgrade -i corek8sappscodecom-genericresourceservice-editor appscode-charts-oci/corek8sappscodecom-genericresourceservice-editor -n default --create-namespace --version=v0.7.0
```
...
```bash
$ helm upgrade -i corek8sappscodecom-genericresourceservice-editor appscode-charts-oci/corek8sappscodecom-genericresourceservice-editor -n default --create-namespace --version=v0.7.0 --set apiVersion=core.k8s.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i corek8sappscodecom-genericresourceservice-editor appscode-charts-oci/corek8sappscodecom-genericresourceservice-editor -n default --create-namespace --version=v0.7.0 --values values.yaml
```
