...
$ helm repo update
$ helm search repo appscode/enginekubevaultcom-redisrole-editor --version=v0.27.0
...
```bash
$ helm upgrade -i enginekubevaultcom-redisrole-editor appscode/enginekubevaultcom-redisrole-editor -n default --create-namespace --version=v0.27.0 --set apiVersion=engine.kubevault.com/v1alpha1
```
...
```bash
$ helm upgrade -i enginekubevaultcom-redisrole-editor appscode/enginekubevaultcom-redisrole-editor -n default --create-namespace --version=v0.27.0 --values values.yaml
```
