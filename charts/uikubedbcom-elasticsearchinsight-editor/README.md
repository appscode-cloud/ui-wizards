...
$ helm repo update
$ helm search repo appscode-charts-oci/uikubedbcom-elasticsearchinsight-editor --version=v0.11.0
...
```bash
$ helm upgrade -i uikubedbcom-elasticsearchinsight-editor appscode-charts-oci/uikubedbcom-elasticsearchinsight-editor -n default --create-namespace --version=v0.11.0 --set apiVersion=ui.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i uikubedbcom-elasticsearchinsight-editor appscode-charts-oci/uikubedbcom-elasticsearchinsight-editor -n default --create-namespace --version=v0.11.0 --values values.yaml
```
