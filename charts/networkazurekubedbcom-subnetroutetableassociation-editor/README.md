...
$ helm repo update
$ helm search repo appscode/networkazurekubedbcom-subnetroutetableassociation-editor --version=v0.15.0
$ helm upgrade -i networkazurekubedbcom-subnetroutetableassociation-editor appscode/networkazurekubedbcom-subnetroutetableassociation-editor -n default --create-namespace --version=v0.15.0
```
...
```bash
$ helm upgrade -i networkazurekubedbcom-subnetroutetableassociation-editor appscode/networkazurekubedbcom-subnetroutetableassociation-editor -n default --create-namespace --version=v0.15.0 --set apiVersion=network.azure.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i networkazurekubedbcom-subnetroutetableassociation-editor appscode/networkazurekubedbcom-subnetroutetableassociation-editor -n default --create-namespace --version=v0.15.0 --values values.yaml
```
