...
$ helm repo update
$ helm search repo appscode-charts-oci/networkazurekubedbcom-subnetroutetableassociation-editor --version=v0.6.0
$ helm upgrade -i networkazurekubedbcom-subnetroutetableassociation-editor appscode-charts-oci/networkazurekubedbcom-subnetroutetableassociation-editor -n default --create-namespace --version=v0.6.0
```
...
```bash
$ helm upgrade -i networkazurekubedbcom-subnetroutetableassociation-editor appscode-charts-oci/networkazurekubedbcom-subnetroutetableassociation-editor -n default --create-namespace --version=v0.6.0 --set apiVersion=network.azure.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i networkazurekubedbcom-subnetroutetableassociation-editor appscode-charts-oci/networkazurekubedbcom-subnetroutetableassociation-editor -n default --create-namespace --version=v0.6.0 --values values.yaml
```
