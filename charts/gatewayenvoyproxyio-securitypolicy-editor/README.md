...
$ helm repo update
$ helm search repo appscode-charts-oci/gatewayenvoyproxyio-securitypolicy-editor --version=v0.14.0
$ helm upgrade -i gatewayenvoyproxyio-securitypolicy-editor appscode-charts-oci/gatewayenvoyproxyio-securitypolicy-editor -n default --create-namespace --version=v0.14.0
```
...
```bash
$ helm upgrade -i gatewayenvoyproxyio-securitypolicy-editor appscode-charts-oci/gatewayenvoyproxyio-securitypolicy-editor -n default --create-namespace --version=v0.14.0 --set apiVersion=gateway.envoyproxy.io/v1alpha1
```
...
```bash
$ helm upgrade -i gatewayenvoyproxyio-securitypolicy-editor appscode-charts-oci/gatewayenvoyproxyio-securitypolicy-editor -n default --create-namespace --version=v0.14.0 --values values.yaml
```
