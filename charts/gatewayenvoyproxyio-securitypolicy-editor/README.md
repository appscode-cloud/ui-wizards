...
$ helm repo update
$ helm search repo appscode/gatewayenvoyproxyio-securitypolicy-editor --version=v0.33.0
$ helm upgrade -i gatewayenvoyproxyio-securitypolicy-editor appscode/gatewayenvoyproxyio-securitypolicy-editor -n default --create-namespace --version=v0.33.0
```
...
```bash
$ helm upgrade -i gatewayenvoyproxyio-securitypolicy-editor appscode/gatewayenvoyproxyio-securitypolicy-editor -n default --create-namespace --version=v0.33.0 --set apiVersion=gateway.envoyproxy.io/v1alpha1
```
...
```bash
$ helm upgrade -i gatewayenvoyproxyio-securitypolicy-editor appscode/gatewayenvoyproxyio-securitypolicy-editor -n default --create-namespace --version=v0.33.0 --values values.yaml
```
