...
*/}}
{{- define "kubedbcom-db2-editor.name" -}}
...
*/}}
{{- define "kubedbcom-db2-editor.fullname" -}}
...
*/}}
{{- define "kubedbcom-db2-editor.chart" -}}
...
Common labels
*/}}
{{- define "kubedbcom-db2-editor.labels" -}}
{{ include "kubedbcom-db2-editor.selectorLabels" . }}
...
Selector labels
*/}}
{{- define "kubedbcom-db2-editor.selectorLabels" -}}
app.kubernetes.io/name: db2s.kubedb.com
app.kubernetes.io/instance: {{ include "kubedbcom-db2-editor.fullname" . }}
{{- end }}

{{/*
Create the name of the service account to use
*/}}
{{- define "kubedbcom-db2-editor.serviceAccountName" -}}
{{- if .Values.spec.serviceAccount.create }}
{{- default (include "kubedbcom-db2-editor.fullname" .) .Values.spec.serviceAccount.name }}
{{- else }}
...
Common annotations
*/}}
{{- define "kubedbcom-db2-editor.annotations" -}}
