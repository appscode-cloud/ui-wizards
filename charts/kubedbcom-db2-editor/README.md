...
$ helm repo update
$ helm search repo appscode/kubedbcom-db2-editor --version=v0.37.0
$ helm upgrade -i kubedbcom-db2-editor appscode/kubedbcom-db2-editor -n default --create-namespace --version=v0.37.0
```
...
```bash
$ helm upgrade -i kubedbcom-db2-editor appscode/kubedbcom-db2-editor -n default --create-namespace --version=v0.37.0 --set metadata.resource.group=kubedb.com
```
...
```bash
$ helm upgrade -i kubedbcom-db2-editor appscode/kubedbcom-db2-editor -n default --create-namespace --version=v0.37.0 --values values.yaml
```
