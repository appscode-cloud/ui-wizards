...
$ helm repo update
$ helm search repo bytebuilders-ui/workopenclustermanagementio-manifestworkreplicaset-editor --version=v0.4.16
$ helm upgrade -i workopenclustermanagementio-manifestworkreplicaset-editor bytebuilders-ui/workopenclustermanagementio-manifestworkreplicaset-editor -n default --create-namespace --version=v0.4.16
```
...
```bash
$ helm upgrade -i workopenclustermanagementio-manifestworkreplicaset-editor bytebuilders-ui/workopenclustermanagementio-manifestworkreplicaset-editor -n default --create-namespace --version=v0.4.16 --set apiVersion=work.open-cluster-management.io/v1alpha1
```
...
```bash
$ helm upgrade -i workopenclustermanagementio-manifestworkreplicaset-editor bytebuilders-ui/workopenclustermanagementio-manifestworkreplicaset-editor -n default --create-namespace --version=v0.4.16 --values values.yaml
```
