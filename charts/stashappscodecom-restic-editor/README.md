...
$ helm repo update
$ helm search repo appscode-charts-oci/stashappscodecom-restic-editor --version=v0.4.20
$ helm upgrade -i stashappscodecom-restic-editor appscode-charts-oci/stashappscodecom-restic-editor -n default --create-namespace --version=v0.4.20
```
...
```bash
$ helm upgrade -i stashappscodecom-restic-editor appscode-charts-oci/stashappscodecom-restic-editor -n default --create-namespace --version=v0.4.20 --set apiVersion=stash.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i stashappscodecom-restic-editor appscode-charts-oci/stashappscodecom-restic-editor -n default --create-namespace --version=v0.4.20 --values values.yaml
```
