...
$ helm repo update
$ helm search repo bytebuilders-ui/stashappscodecom-restic-editor --version=v0.4.16
$ helm upgrade -i stashappscodecom-restic-editor bytebuilders-ui/stashappscodecom-restic-editor -n default --create-namespace --version=v0.4.16
```
...
```bash
$ helm upgrade -i stashappscodecom-restic-editor bytebuilders-ui/stashappscodecom-restic-editor -n default --create-namespace --version=v0.4.16 --set apiVersion=stash.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i stashappscodecom-restic-editor bytebuilders-ui/stashappscodecom-restic-editor -n default --create-namespace --version=v0.4.16 --values values.yaml
```
