...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/postgreskubedbcom-subscriber-editor --version=v0.4.17
$ helm upgrade -i postgreskubedbcom-subscriber-editor bytebuilders-ui-dev/postgreskubedbcom-subscriber-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i postgreskubedbcom-subscriber-editor bytebuilders-ui-dev/postgreskubedbcom-subscriber-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=postgres.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i postgreskubedbcom-subscriber-editor bytebuilders-ui-dev/postgreskubedbcom-subscriber-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
