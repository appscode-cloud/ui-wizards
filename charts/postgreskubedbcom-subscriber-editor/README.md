...
$ helm repo update
$ helm search repo appscode/postgreskubedbcom-subscriber-editor --version=v0.33.0
$ helm upgrade -i postgreskubedbcom-subscriber-editor appscode/postgreskubedbcom-subscriber-editor -n default --create-namespace --version=v0.33.0
```
...
```bash
$ helm upgrade -i postgreskubedbcom-subscriber-editor appscode/postgreskubedbcom-subscriber-editor -n default --create-namespace --version=v0.33.0 --set apiVersion=postgres.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i postgreskubedbcom-subscriber-editor appscode/postgreskubedbcom-subscriber-editor -n default --create-namespace --version=v0.33.0 --values values.yaml
```
