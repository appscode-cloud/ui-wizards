...
$ helm repo update
$ helm search repo bytebuilders-ui/postgreskubedbcom-subscriber-editor --version=v0.4.16
$ helm upgrade -i postgreskubedbcom-subscriber-editor bytebuilders-ui/postgreskubedbcom-subscriber-editor -n default --create-namespace --version=v0.4.16
```
...
```bash
$ helm upgrade -i postgreskubedbcom-subscriber-editor bytebuilders-ui/postgreskubedbcom-subscriber-editor -n default --create-namespace --version=v0.4.16 --set apiVersion=postgres.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i postgreskubedbcom-subscriber-editor bytebuilders-ui/postgreskubedbcom-subscriber-editor -n default --create-namespace --version=v0.4.16 --values values.yaml
```
