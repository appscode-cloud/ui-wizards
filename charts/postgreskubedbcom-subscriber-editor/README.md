...
$ helm repo update
$ helm search repo bytebuilders-ui/postgreskubedbcom-subscriber-editor --version=v0.4.18
$ helm upgrade -i postgreskubedbcom-subscriber-editor bytebuilders-ui/postgreskubedbcom-subscriber-editor -n default --create-namespace --version=v0.4.18
```
...
```bash
$ helm upgrade -i postgreskubedbcom-subscriber-editor bytebuilders-ui/postgreskubedbcom-subscriber-editor -n default --create-namespace --version=v0.4.18 --set apiVersion=postgres.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i postgreskubedbcom-subscriber-editor bytebuilders-ui/postgreskubedbcom-subscriber-editor -n default --create-namespace --version=v0.4.18 --values values.yaml
```
