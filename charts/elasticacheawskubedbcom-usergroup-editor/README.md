...
$ helm repo update
$ helm search repo appscode-charts-oci/elasticacheawskubedbcom-usergroup-editor --version=v0.4.20
$ helm upgrade -i elasticacheawskubedbcom-usergroup-editor appscode-charts-oci/elasticacheawskubedbcom-usergroup-editor -n default --create-namespace --version=v0.4.20
```
...
```bash
$ helm upgrade -i elasticacheawskubedbcom-usergroup-editor appscode-charts-oci/elasticacheawskubedbcom-usergroup-editor -n default --create-namespace --version=v0.4.20 --set apiVersion=elasticache.aws.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i elasticacheawskubedbcom-usergroup-editor appscode-charts-oci/elasticacheawskubedbcom-usergroup-editor -n default --create-namespace --version=v0.4.20 --values values.yaml
```
