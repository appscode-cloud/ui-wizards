...
$ helm repo update
$ helm search repo appscode-charts-oci/batch-job-editor --version=v0.4.21
$ helm upgrade -i batch-job-editor appscode-charts-oci/batch-job-editor -n default --create-namespace --version=v0.4.21
```
...
```bash
$ helm upgrade -i batch-job-editor appscode-charts-oci/batch-job-editor -n default --create-namespace --version=v0.4.21 --set apiVersion=batch/v1
```
...
```bash
$ helm upgrade -i batch-job-editor appscode-charts-oci/batch-job-editor -n default --create-namespace --version=v0.4.21 --values values.yaml
```
