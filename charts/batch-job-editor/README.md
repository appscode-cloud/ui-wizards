...
$ helm repo update
$ helm search repo appscode-charts-oci/batch-job-editor --version=v0.13.0
$ helm upgrade -i batch-job-editor appscode-charts-oci/batch-job-editor -n default --create-namespace --version=v0.13.0
```
...
```bash
$ helm upgrade -i batch-job-editor appscode-charts-oci/batch-job-editor -n default --create-namespace --version=v0.13.0 --set apiVersion=batch/v1
```
...
```bash
$ helm upgrade -i batch-job-editor appscode-charts-oci/batch-job-editor -n default --create-namespace --version=v0.13.0 --values values.yaml
```
