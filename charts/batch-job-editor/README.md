...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/batch-job-editor --version=v0.4.17
$ helm upgrade -i batch-job-editor bytebuilders-ui-dev/batch-job-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i batch-job-editor bytebuilders-ui-dev/batch-job-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=batch/v1
```
...
```bash
$ helm upgrade -i batch-job-editor bytebuilders-ui-dev/batch-job-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
