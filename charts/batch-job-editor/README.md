...
$ helm repo update
$ helm search repo bytebuilders-ui/batch-job-editor --version=v0.3.1
$ helm upgrade -i batch-job-editor bytebuilders-ui/batch-job-editor -n default --create-namespace --version=v0.3.1
```
...
```bash
$ helm upgrade -i batch-job-editor bytebuilders-ui/batch-job-editor -n default --create-namespace --version=v0.3.1 --set apiVersion=batch/v1
```
...
```bash
$ helm upgrade -i batch-job-editor bytebuilders-ui/batch-job-editor -n default --create-namespace --version=v0.3.1 --values values.yaml
```
