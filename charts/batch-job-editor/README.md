...
$ helm repo update
$ helm search repo appscode-charts-oci/batch-job-editor --version=v0.4.18
$ helm upgrade -i batch-job-editor appscode-charts-oci/batch-job-editor -n default --create-namespace --version=v0.4.18
```
...
```bash
$ helm upgrade -i batch-job-editor appscode-charts-oci/batch-job-editor -n default --create-namespace --version=v0.4.18 --set apiVersion=batch/v1
```
...
```bash
$ helm upgrade -i batch-job-editor appscode-charts-oci/batch-job-editor -n default --create-namespace --version=v0.4.18 --values values.yaml
```
