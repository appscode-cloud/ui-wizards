...
$ helm repo update
$ helm search repo bytebuilders-ui/batch-job-editor --version=v0.4.6
$ helm upgrade -i batch-job-editor bytebuilders-ui/batch-job-editor -n default --create-namespace --version=v0.4.6
```
...
```bash
$ helm upgrade -i batch-job-editor bytebuilders-ui/batch-job-editor -n default --create-namespace --version=v0.4.6 --set apiVersion=batch/v1
```
...
```bash
$ helm upgrade -i batch-job-editor bytebuilders-ui/batch-job-editor -n default --create-namespace --version=v0.4.6 --values values.yaml
```
