...
$ helm repo update
$ helm search repo appscode-charts-oci/policykubevaultcom-vaultpolicybinding-editor --version=v0.4.21
$ helm upgrade -i policykubevaultcom-vaultpolicybinding-editor appscode-charts-oci/policykubevaultcom-vaultpolicybinding-editor -n default --create-namespace --version=v0.4.21
```
...
```bash
$ helm upgrade -i policykubevaultcom-vaultpolicybinding-editor appscode-charts-oci/policykubevaultcom-vaultpolicybinding-editor -n default --create-namespace --version=v0.4.21 --set apiVersion=policy.kubevault.com/v1alpha1
```
...
```bash
$ helm upgrade -i policykubevaultcom-vaultpolicybinding-editor appscode-charts-oci/policykubevaultcom-vaultpolicybinding-editor -n default --create-namespace --version=v0.4.21 --values values.yaml
```
