...
$ helm repo update
$ helm search repo appscode-charts-oci/policykubevaultcom-vaultpolicybinding-editor --version=v0.6.0
$ helm upgrade -i policykubevaultcom-vaultpolicybinding-editor appscode-charts-oci/policykubevaultcom-vaultpolicybinding-editor -n default --create-namespace --version=v0.6.0
```
...
```bash
$ helm upgrade -i policykubevaultcom-vaultpolicybinding-editor appscode-charts-oci/policykubevaultcom-vaultpolicybinding-editor -n default --create-namespace --version=v0.6.0 --set apiVersion=policy.kubevault.com/v1alpha1
```
...
```bash
$ helm upgrade -i policykubevaultcom-vaultpolicybinding-editor appscode-charts-oci/policykubevaultcom-vaultpolicybinding-editor -n default --create-namespace --version=v0.6.0 --values values.yaml
```
