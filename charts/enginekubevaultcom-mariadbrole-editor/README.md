...
$ helm repo update
$ helm search repo appscode/enginekubevaultcom-mariadbrole-editor --version=v0.34.0
$ helm upgrade -i enginekubevaultcom-mariadbrole-editor appscode/enginekubevaultcom-mariadbrole-editor -n default --create-namespace --version=v0.34.0
```
...
```bash
$ helm upgrade -i enginekubevaultcom-mariadbrole-editor appscode/enginekubevaultcom-mariadbrole-editor -n default --create-namespace --version=v0.34.0 --set apiVersion=engine.kubevault.com/v1alpha1
```
...
```bash
$ helm upgrade -i enginekubevaultcom-mariadbrole-editor appscode/enginekubevaultcom-mariadbrole-editor -n default --create-namespace --version=v0.34.0 --values values.yaml
```
