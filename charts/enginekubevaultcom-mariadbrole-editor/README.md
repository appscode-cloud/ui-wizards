...
$ helm repo update
$ helm search repo bytebuilders-ui/enginekubevaultcom-mariadbrole-editor --version=v0.4.13
$ helm upgrade -i enginekubevaultcom-mariadbrole-editor bytebuilders-ui/enginekubevaultcom-mariadbrole-editor -n default --create-namespace --version=v0.4.13
```
...
```bash
$ helm upgrade -i enginekubevaultcom-mariadbrole-editor bytebuilders-ui/enginekubevaultcom-mariadbrole-editor -n default --create-namespace --version=v0.4.13 --set apiVersion=engine.kubevault.com/v1alpha1
```
...
```bash
$ helm upgrade -i enginekubevaultcom-mariadbrole-editor bytebuilders-ui/enginekubevaultcom-mariadbrole-editor -n default --create-namespace --version=v0.4.13 --values values.yaml
```
