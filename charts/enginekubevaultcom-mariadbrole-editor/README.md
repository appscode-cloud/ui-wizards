...
$ helm repo update
$ helm search repo appscode-charts-oci/enginekubevaultcom-mariadbrole-editor --version=v0.14.0
$ helm upgrade -i enginekubevaultcom-mariadbrole-editor appscode-charts-oci/enginekubevaultcom-mariadbrole-editor -n default --create-namespace --version=v0.14.0
```
...
```bash
$ helm upgrade -i enginekubevaultcom-mariadbrole-editor appscode-charts-oci/enginekubevaultcom-mariadbrole-editor -n default --create-namespace --version=v0.14.0 --set apiVersion=engine.kubevault.com/v1alpha1
```
...
```bash
$ helm upgrade -i enginekubevaultcom-mariadbrole-editor appscode-charts-oci/enginekubevaultcom-mariadbrole-editor -n default --create-namespace --version=v0.14.0 --values values.yaml
```
