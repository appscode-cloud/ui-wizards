...
$ helm repo update
$ helm search repo appscode-charts-oci/autoscalingkubedbcom-redissentinelautoscaler-editor --version=v0.4.19
$ helm upgrade -i autoscalingkubedbcom-redissentinelautoscaler-editor appscode-charts-oci/autoscalingkubedbcom-redissentinelautoscaler-editor -n default --create-namespace --version=v0.4.19
```
...
```bash
$ helm upgrade -i autoscalingkubedbcom-redissentinelautoscaler-editor appscode-charts-oci/autoscalingkubedbcom-redissentinelautoscaler-editor -n default --create-namespace --version=v0.4.19 --set apiVersion=autoscaling.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i autoscalingkubedbcom-redissentinelautoscaler-editor appscode-charts-oci/autoscalingkubedbcom-redissentinelautoscaler-editor -n default --create-namespace --version=v0.4.19 --values values.yaml
```
