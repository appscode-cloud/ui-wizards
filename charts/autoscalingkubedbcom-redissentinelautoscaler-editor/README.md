...
$ helm repo update
$ helm search repo appscode/autoscalingkubedbcom-redissentinelautoscaler-editor --version=v0.26.0
$ helm upgrade -i autoscalingkubedbcom-redissentinelautoscaler-editor appscode/autoscalingkubedbcom-redissentinelautoscaler-editor -n default --create-namespace --version=v0.26.0
```
...
```bash
$ helm upgrade -i autoscalingkubedbcom-redissentinelautoscaler-editor appscode/autoscalingkubedbcom-redissentinelautoscaler-editor -n default --create-namespace --version=v0.26.0 --set apiVersion=autoscaling.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i autoscalingkubedbcom-redissentinelautoscaler-editor appscode/autoscalingkubedbcom-redissentinelautoscaler-editor -n default --create-namespace --version=v0.26.0 --values values.yaml
```
