...
$ helm repo update
$ helm search repo appscode-charts-oci/policy-eviction-editor --version=v0.12.0
$ helm upgrade -i policy-eviction-editor appscode-charts-oci/policy-eviction-editor -n default --create-namespace --version=v0.12.0
```
...
```bash
$ helm upgrade -i policy-eviction-editor appscode-charts-oci/policy-eviction-editor -n default --create-namespace --version=v0.12.0 --set apiVersion=policy/v1
```
...
```bash
$ helm upgrade -i policy-eviction-editor appscode-charts-oci/policy-eviction-editor -n default --create-namespace --version=v0.12.0 --values values.yaml
```
