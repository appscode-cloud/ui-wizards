...
$ helm repo update
$ helm search repo appscode/policy-eviction-editor --version=v0.26.0
$ helm upgrade -i policy-eviction-editor appscode/policy-eviction-editor -n default --create-namespace --version=v0.26.0
```
...
```bash
$ helm upgrade -i policy-eviction-editor appscode/policy-eviction-editor -n default --create-namespace --version=v0.26.0 --set apiVersion=policy/v1
```
...
```bash
$ helm upgrade -i policy-eviction-editor appscode/policy-eviction-editor -n default --create-namespace --version=v0.26.0 --values values.yaml
```
