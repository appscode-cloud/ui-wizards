...
*/}}
{{- define "kubedbcom-pgbouncer-editor-options.name" -}}
...
*/}}
{{- define "kubedbcom-pgbouncer-editor-options.fullname" -}}
...
*/}}
{{- define "kubedbcom-pgbouncer-editor-options.chart" -}}
...
Common labels
*/}}
{{- define "kubedbcom-pgbouncer-editor-options.labels" -}}
{{ include "kubedbcom-pgbouncer-editor-options.selectorLabels" . }}
...
Selector labels
*/}}
{{- define "kubedbcom-pgbouncer-editor-options.selectorLabels" -}}
app.kubernetes.io/name: pgbouncers.kubedb.com
app.kubernetes.io/instance: {{ include "kubedbcom-pgbouncer-editor-options.fullname" . }}
{{- end }}

{{/*
Create the name of the service account to use
*/}}
{{- define "kubedbcom-pgbouncer-editor-options.serviceAccountName" -}}
{{- if .Values.spec.serviceAccount.create }}
{{- default (include "kubedbcom-pgbouncer-editor-options.fullname" .) .Values.spec.serviceAccount.name }}
{{- else }}
...
Common annotations
*/}}
{{- define "kubedbcom-pgbouncer-editor-options.annotations" -}}
...
Alert Enabled
*/}}
{{- define "kubedbcom-pgbouncer-editor-options.alertEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
