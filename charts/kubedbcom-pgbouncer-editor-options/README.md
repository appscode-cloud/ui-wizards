...
$ helm repo update
$ helm search repo bytebuilders-ui/kubedbcom-pgbouncer-editor-options --version=v0.4.15
$ helm upgrade -i kubedbcom-pgbouncer-editor-options bytebuilders-ui/kubedbcom-pgbouncer-editor-options -n kube-system --create-namespace --version=v0.4.15
```
...
```bash
$ helm upgrade -i kubedbcom-pgbouncer-editor-options bytebuilders-ui/kubedbcom-pgbouncer-editor-options -n kube-system --create-namespace --version=v0.4.15 --set metadata.resource.group=kubedb.com
```
...
```bash
$ helm upgrade -i kubedbcom-pgbouncer-editor-options bytebuilders-ui/kubedbcom-pgbouncer-editor-options -n kube-system --create-namespace --version=v0.4.15 --values values.yaml
```
