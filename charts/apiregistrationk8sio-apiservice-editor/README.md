...
$ helm repo update
$ helm search repo appscode-charts-oci/apiregistrationk8sio-apiservice-editor --version=v0.4.21
$ helm upgrade -i apiregistrationk8sio-apiservice-editor appscode-charts-oci/apiregistrationk8sio-apiservice-editor -n default --create-namespace --version=v0.4.21
```
...
```bash
$ helm upgrade -i apiregistrationk8sio-apiservice-editor appscode-charts-oci/apiregistrationk8sio-apiservice-editor -n default --create-namespace --version=v0.4.21 --set apiVersion=apiregistration.k8s.io/v1
```
...
```bash
$ helm upgrade -i apiregistrationk8sio-apiservice-editor appscode-charts-oci/apiregistrationk8sio-apiservice-editor -n default --create-namespace --version=v0.4.21 --values values.yaml
```
