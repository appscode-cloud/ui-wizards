...
$ helm repo update
$ helm search repo appscode/apiregistrationk8sio-apiservice-editor --version=v0.36.0
$ helm upgrade -i apiregistrationk8sio-apiservice-editor appscode/apiregistrationk8sio-apiservice-editor -n default --create-namespace --version=v0.36.0
```
...
```bash
$ helm upgrade -i apiregistrationk8sio-apiservice-editor appscode/apiregistrationk8sio-apiservice-editor -n default --create-namespace --version=v0.36.0 --set apiVersion=apiregistration.k8s.io/v1
```
...
```bash
$ helm upgrade -i apiregistrationk8sio-apiservice-editor appscode/apiregistrationk8sio-apiservice-editor -n default --create-namespace --version=v0.36.0 --values values.yaml
```
