...
$ helm repo update
$ helm search repo bytebuilders-ui/uikubedbcom-pgbouncerpools-editor --version=v0.4.16
$ helm upgrade -i uikubedbcom-pgbouncerpools-editor bytebuilders-ui/uikubedbcom-pgbouncerpools-editor -n default --create-namespace --version=v0.4.16
```
...
```bash
$ helm upgrade -i uikubedbcom-pgbouncerpools-editor bytebuilders-ui/uikubedbcom-pgbouncerpools-editor -n default --create-namespace --version=v0.4.16 --set apiVersion=ui.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i uikubedbcom-pgbouncerpools-editor bytebuilders-ui/uikubedbcom-pgbouncerpools-editor -n default --create-namespace --version=v0.4.16 --values values.yaml
```
