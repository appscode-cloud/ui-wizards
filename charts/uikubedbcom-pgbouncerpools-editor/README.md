...
$ helm repo update
$ helm search repo bytebuilders-ui/uikubedbcom-pgbouncerpools-editor --version=v0.4.14
$ helm upgrade -i uikubedbcom-pgbouncerpools-editor bytebuilders-ui/uikubedbcom-pgbouncerpools-editor -n default --create-namespace --version=v0.4.14
```
...
```bash
$ helm upgrade -i uikubedbcom-pgbouncerpools-editor bytebuilders-ui/uikubedbcom-pgbouncerpools-editor -n default --create-namespace --version=v0.4.14 --set apiVersion=ui.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i uikubedbcom-pgbouncerpools-editor bytebuilders-ui/uikubedbcom-pgbouncerpools-editor -n default --create-namespace --version=v0.4.14 --values values.yaml
```
