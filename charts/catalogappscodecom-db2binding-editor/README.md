...
$ helm repo update
$ helm search repo appscode/catalogappscodecom-db2binding-editor --version=v0.37.0
$ helm upgrade -i catalogappscodecom-db2binding-editor appscode/catalogappscodecom-db2binding-editor -n default --create-namespace --version=v0.37.0
```
...
```bash
$ helm upgrade -i catalogappscodecom-db2binding-editor appscode/catalogappscodecom-db2binding-editor -n default --create-namespace --version=v0.37.0 --set apiVersion=catalog.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i catalogappscodecom-db2binding-editor appscode/catalogappscodecom-db2binding-editor -n default --create-namespace --version=v0.37.0 --values values.yaml
```
