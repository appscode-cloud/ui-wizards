...
$ helm repo update
$ helm search repo appscode/monitoringk8sappscodecom-telemetrystack-editor-options --version=v0.36.0
$ helm upgrade -i monitoringk8sappscodecom-telemetrystack-editor-options appscode/monitoringk8sappscodecom-telemetrystack-editor-options -n kube-system --create-namespace --version=v0.36.0
```
...
```bash
$ helm upgrade -i monitoringk8sappscodecom-telemetrystack-editor-options appscode/monitoringk8sappscodecom-telemetrystack-editor-options -n kube-system --create-namespace --version=v0.36.0 --set metadata.resource.group=monitoring.k8s.appscode.com
```
...
```bash
$ helm upgrade -i monitoringk8sappscodecom-telemetrystack-editor-options appscode/monitoringk8sappscodecom-telemetrystack-editor-options -n kube-system --create-namespace --version=v0.36.0 --values values.yaml
```
