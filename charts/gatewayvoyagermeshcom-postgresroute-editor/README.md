...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/gatewayvoyagermeshcom-postgresroute-editor --version=v0.4.17
$ helm upgrade -i gatewayvoyagermeshcom-postgresroute-editor bytebuilders-ui-dev/gatewayvoyagermeshcom-postgresroute-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i gatewayvoyagermeshcom-postgresroute-editor bytebuilders-ui-dev/gatewayvoyagermeshcom-postgresroute-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=gateway.voyagermesh.com/v1alpha1
```
...
```bash
$ helm upgrade -i gatewayvoyagermeshcom-postgresroute-editor bytebuilders-ui-dev/gatewayvoyagermeshcom-postgresroute-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
