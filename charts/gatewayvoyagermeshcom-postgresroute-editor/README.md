...
$ helm repo update
$ helm search repo appscode/gatewayvoyagermeshcom-postgresroute-editor --version=v0.33.0
$ helm upgrade -i gatewayvoyagermeshcom-postgresroute-editor appscode/gatewayvoyagermeshcom-postgresroute-editor -n default --create-namespace --version=v0.33.0
```
...
```bash
$ helm upgrade -i gatewayvoyagermeshcom-postgresroute-editor appscode/gatewayvoyagermeshcom-postgresroute-editor -n default --create-namespace --version=v0.33.0 --set apiVersion=gateway.voyagermesh.com/v1alpha1
```
...
```bash
$ helm upgrade -i gatewayvoyagermeshcom-postgresroute-editor appscode/gatewayvoyagermeshcom-postgresroute-editor -n default --create-namespace --version=v0.33.0 --values values.yaml
```
