...
$ helm repo update
$ helm search repo bytebuilders-ui/gatewayvoyagermeshcom-postgresroute-editor --version=v0.4.16
$ helm upgrade -i gatewayvoyagermeshcom-postgresroute-editor bytebuilders-ui/gatewayvoyagermeshcom-postgresroute-editor -n default --create-namespace --version=v0.4.16
```
...
```bash
$ helm upgrade -i gatewayvoyagermeshcom-postgresroute-editor bytebuilders-ui/gatewayvoyagermeshcom-postgresroute-editor -n default --create-namespace --version=v0.4.16 --set apiVersion=gateway.voyagermesh.com/v1alpha1
```
...
```bash
$ helm upgrade -i gatewayvoyagermeshcom-postgresroute-editor bytebuilders-ui/gatewayvoyagermeshcom-postgresroute-editor -n default --create-namespace --version=v0.4.16 --values values.yaml
```
