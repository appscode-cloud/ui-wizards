...
$ helm repo update
$ helm search repo appscode/authenticationk8sappscodecom-account-editor --version=v0.22.0
$ helm upgrade -i authenticationk8sappscodecom-account-editor appscode/authenticationk8sappscodecom-account-editor -n default --create-namespace --version=v0.22.0
```
...
```bash
$ helm upgrade -i authenticationk8sappscodecom-account-editor appscode/authenticationk8sappscodecom-account-editor -n default --create-namespace --version=v0.22.0 --set apiVersion=authentication.k8s.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i authenticationk8sappscodecom-account-editor appscode/authenticationk8sappscodecom-account-editor -n default --create-namespace --version=v0.22.0 --values values.yaml
```
