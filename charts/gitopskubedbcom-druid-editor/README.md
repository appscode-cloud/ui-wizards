...
$ helm repo update
$ helm search repo appscode-charts-oci/gitopskubedbcom-druid-editor --version=v0.14.0
$ helm upgrade -i gitopskubedbcom-druid-editor appscode-charts-oci/gitopskubedbcom-druid-editor -n default --create-namespace --version=v0.14.0
```
...
```bash
$ helm upgrade -i gitopskubedbcom-druid-editor appscode-charts-oci/gitopskubedbcom-druid-editor -n default --create-namespace --version=v0.14.0 --set apiVersion=gitops.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i gitopskubedbcom-druid-editor appscode-charts-oci/gitopskubedbcom-druid-editor -n default --create-namespace --version=v0.14.0 --values values.yaml
```
