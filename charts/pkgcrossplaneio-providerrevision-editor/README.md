...
$ helm repo update
$ helm search repo appscode-charts-oci/pkgcrossplaneio-providerrevision-editor --version=v0.4.19
$ helm upgrade -i pkgcrossplaneio-providerrevision-editor appscode-charts-oci/pkgcrossplaneio-providerrevision-editor -n default --create-namespace --version=v0.4.19
```
...
```bash
$ helm upgrade -i pkgcrossplaneio-providerrevision-editor appscode-charts-oci/pkgcrossplaneio-providerrevision-editor -n default --create-namespace --version=v0.4.19 --set apiVersion=pkg.crossplane.io/v1
```
...
```bash
$ helm upgrade -i pkgcrossplaneio-providerrevision-editor appscode-charts-oci/pkgcrossplaneio-providerrevision-editor -n default --create-namespace --version=v0.4.19 --values values.yaml
```
