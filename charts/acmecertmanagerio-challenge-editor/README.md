...
$ helm repo update
$ helm search repo appscode-charts-oci/acmecertmanagerio-challenge-editor --version=v0.13.0
$ helm upgrade -i acmecertmanagerio-challenge-editor appscode-charts-oci/acmecertmanagerio-challenge-editor -n default --create-namespace --version=v0.13.0
```
...
```bash
$ helm upgrade -i acmecertmanagerio-challenge-editor appscode-charts-oci/acmecertmanagerio-challenge-editor -n default --create-namespace --version=v0.13.0 --set apiVersion=acme.cert-manager.io/v1
```
...
```bash
$ helm upgrade -i acmecertmanagerio-challenge-editor appscode-charts-oci/acmecertmanagerio-challenge-editor -n default --create-namespace --version=v0.13.0 --values values.yaml
```
