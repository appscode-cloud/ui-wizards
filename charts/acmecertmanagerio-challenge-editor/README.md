...
$ helm repo update
$ helm search repo appscode-charts-oci/acmecertmanagerio-challenge-editor --version=v0.4.20
$ helm upgrade -i acmecertmanagerio-challenge-editor appscode-charts-oci/acmecertmanagerio-challenge-editor -n default --create-namespace --version=v0.4.20
```
...
```bash
$ helm upgrade -i acmecertmanagerio-challenge-editor appscode-charts-oci/acmecertmanagerio-challenge-editor -n default --create-namespace --version=v0.4.20 --set apiVersion=acme.cert-manager.io/v1
```
...
```bash
$ helm upgrade -i acmecertmanagerio-challenge-editor appscode-charts-oci/acmecertmanagerio-challenge-editor -n default --create-namespace --version=v0.4.20 --values values.yaml
```
