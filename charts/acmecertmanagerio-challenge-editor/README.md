...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/acmecertmanagerio-challenge-editor --version=v0.4.17
$ helm upgrade -i acmecertmanagerio-challenge-editor bytebuilders-ui-dev/acmecertmanagerio-challenge-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i acmecertmanagerio-challenge-editor bytebuilders-ui-dev/acmecertmanagerio-challenge-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=acme.cert-manager.io/v1
```
...
```bash
$ helm upgrade -i acmecertmanagerio-challenge-editor bytebuilders-ui-dev/acmecertmanagerio-challenge-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
