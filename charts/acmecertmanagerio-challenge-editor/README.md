...
$ helm repo update
$ helm search repo appscode/acmecertmanagerio-challenge-editor --version=v0.20.0
$ helm upgrade -i acmecertmanagerio-challenge-editor appscode/acmecertmanagerio-challenge-editor -n default --create-namespace --version=v0.20.0
```
...
```bash
$ helm upgrade -i acmecertmanagerio-challenge-editor appscode/acmecertmanagerio-challenge-editor -n default --create-namespace --version=v0.20.0 --set apiVersion=acme.cert-manager.io/v1
```
...
```bash
$ helm upgrade -i acmecertmanagerio-challenge-editor appscode/acmecertmanagerio-challenge-editor -n default --create-namespace --version=v0.20.0 --values values.yaml
```
