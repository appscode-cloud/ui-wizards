...
$ helm repo update
$ helm search repo appscode-charts-oci/ec2awskubedbcom-vpcpeeringconnection-editor --version=v0.4.18
$ helm upgrade -i ec2awskubedbcom-vpcpeeringconnection-editor appscode-charts-oci/ec2awskubedbcom-vpcpeeringconnection-editor -n default --create-namespace --version=v0.4.18
```
...
```bash
$ helm upgrade -i ec2awskubedbcom-vpcpeeringconnection-editor appscode-charts-oci/ec2awskubedbcom-vpcpeeringconnection-editor -n default --create-namespace --version=v0.4.18 --set apiVersion=ec2.aws.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i ec2awskubedbcom-vpcpeeringconnection-editor appscode-charts-oci/ec2awskubedbcom-vpcpeeringconnection-editor -n default --create-namespace --version=v0.4.18 --values values.yaml
```
