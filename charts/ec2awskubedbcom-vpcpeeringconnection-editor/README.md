...
$ helm repo update
$ helm search repo appscode-charts-oci/ec2awskubedbcom-vpcpeeringconnection-editor --version=v0.14.0
$ helm upgrade -i ec2awskubedbcom-vpcpeeringconnection-editor appscode-charts-oci/ec2awskubedbcom-vpcpeeringconnection-editor -n default --create-namespace --version=v0.14.0
```
...
```bash
$ helm upgrade -i ec2awskubedbcom-vpcpeeringconnection-editor appscode-charts-oci/ec2awskubedbcom-vpcpeeringconnection-editor -n default --create-namespace --version=v0.14.0 --set apiVersion=ec2.aws.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i ec2awskubedbcom-vpcpeeringconnection-editor appscode-charts-oci/ec2awskubedbcom-vpcpeeringconnection-editor -n default --create-namespace --version=v0.14.0 --values values.yaml
```
