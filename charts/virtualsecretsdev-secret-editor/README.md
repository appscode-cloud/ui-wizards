...
$ helm repo update
$ helm search repo appscode-charts-oci/virtualsecretsdev-secret-editor --version=v0.14.0
$ helm upgrade -i virtualsecretsdev-secret-editor appscode-charts-oci/virtualsecretsdev-secret-editor -n default --create-namespace --version=v0.14.0
```
...
```bash
$ helm upgrade -i virtualsecretsdev-secret-editor appscode-charts-oci/virtualsecretsdev-secret-editor -n default --create-namespace --version=v0.14.0 --set apiVersion=virtual-secrets.dev/v1alpha1
```
...
```bash
$ helm upgrade -i virtualsecretsdev-secret-editor appscode-charts-oci/virtualsecretsdev-secret-editor -n default --create-namespace --version=v0.14.0 --values values.yaml
```
