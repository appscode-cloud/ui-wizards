...
$ helm repo update
$ helm search repo appscode/dbformysqlazurekubedbcom-configuration-editor --version=v0.14.0
$ helm upgrade -i dbformysqlazurekubedbcom-configuration-editor appscode/dbformysqlazurekubedbcom-configuration-editor -n default --create-namespace --version=v0.14.0
```
...
```bash
$ helm upgrade -i dbformysqlazurekubedbcom-configuration-editor appscode/dbformysqlazurekubedbcom-configuration-editor -n default --create-namespace --version=v0.14.0 --set apiVersion=dbformysql.azure.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i dbformysqlazurekubedbcom-configuration-editor appscode/dbformysqlazurekubedbcom-configuration-editor -n default --create-namespace --version=v0.14.0 --values values.yaml
```
