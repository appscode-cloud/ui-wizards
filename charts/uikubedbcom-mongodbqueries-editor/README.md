...
$ helm repo update
$ helm search repo appscode/uikubedbcom-mongodbqueries-editor --version=v0.22.0
$ helm upgrade -i uikubedbcom-mongodbqueries-editor appscode/uikubedbcom-mongodbqueries-editor -n default --create-namespace --version=v0.22.0
```
...
```bash
$ helm upgrade -i uikubedbcom-mongodbqueries-editor appscode/uikubedbcom-mongodbqueries-editor -n default --create-namespace --version=v0.22.0 --set apiVersion=ui.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i uikubedbcom-mongodbqueries-editor appscode/uikubedbcom-mongodbqueries-editor -n default --create-namespace --version=v0.22.0 --values values.yaml
```
