...
$ helm repo update
$ helm search repo appscode/dbformariadbazurekubedbcom-virtualnetworkrule-editor --version=v0.33.0
$ helm upgrade -i dbformariadbazurekubedbcom-virtualnetworkrule-editor appscode/dbformariadbazurekubedbcom-virtualnetworkrule-editor -n default --create-namespace --version=v0.33.0
```
...
```bash
$ helm upgrade -i dbformariadbazurekubedbcom-virtualnetworkrule-editor appscode/dbformariadbazurekubedbcom-virtualnetworkrule-editor -n default --create-namespace --version=v0.33.0 --set apiVersion=dbformariadb.azure.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i dbformariadbazurekubedbcom-virtualnetworkrule-editor appscode/dbformariadbazurekubedbcom-virtualnetworkrule-editor -n default --create-namespace --version=v0.33.0 --values values.yaml
```
