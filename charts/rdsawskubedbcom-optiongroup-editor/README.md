...
$ helm repo update
$ helm search repo appscode-charts-oci/rdsawskubedbcom-optiongroup-editor --version=v0.7.0
$ helm upgrade -i rdsawskubedbcom-optiongroup-editor appscode-charts-oci/rdsawskubedbcom-optiongroup-editor -n default --create-namespace --version=v0.7.0
```
...
```bash
$ helm upgrade -i rdsawskubedbcom-optiongroup-editor appscode-charts-oci/rdsawskubedbcom-optiongroup-editor -n default --create-namespace --version=v0.7.0 --set apiVersion=rds.aws.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i rdsawskubedbcom-optiongroup-editor appscode-charts-oci/rdsawskubedbcom-optiongroup-editor -n default --create-namespace --version=v0.7.0 --values values.yaml
```
