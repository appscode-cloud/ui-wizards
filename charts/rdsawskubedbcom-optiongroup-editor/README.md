...
$ helm repo update
$ helm search repo appscode/rdsawskubedbcom-optiongroup-editor --version=v0.37.0
$ helm upgrade -i rdsawskubedbcom-optiongroup-editor appscode/rdsawskubedbcom-optiongroup-editor -n default --create-namespace --version=v0.37.0
```
...
```bash
$ helm upgrade -i rdsawskubedbcom-optiongroup-editor appscode/rdsawskubedbcom-optiongroup-editor -n default --create-namespace --version=v0.37.0 --set apiVersion=rds.aws.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i rdsawskubedbcom-optiongroup-editor appscode/rdsawskubedbcom-optiongroup-editor -n default --create-namespace --version=v0.37.0 --values values.yaml
```
