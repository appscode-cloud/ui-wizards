...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/monitoringcoreoscom-thanosruler-editor --version=v0.4.17
$ helm upgrade -i monitoringcoreoscom-thanosruler-editor bytebuilders-ui-dev/monitoringcoreoscom-thanosruler-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i monitoringcoreoscom-thanosruler-editor bytebuilders-ui-dev/monitoringcoreoscom-thanosruler-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=monitoring.coreos.com/v1
```
...
```bash
$ helm upgrade -i monitoringcoreoscom-thanosruler-editor bytebuilders-ui-dev/monitoringcoreoscom-thanosruler-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
