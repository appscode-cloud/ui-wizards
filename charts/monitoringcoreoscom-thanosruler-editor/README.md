...
$ helm repo update
$ helm search repo appscode/monitoringcoreoscom-thanosruler-editor --version=v0.26.0
$ helm upgrade -i monitoringcoreoscom-thanosruler-editor appscode/monitoringcoreoscom-thanosruler-editor -n default --create-namespace --version=v0.26.0
```
...
```bash
$ helm upgrade -i monitoringcoreoscom-thanosruler-editor appscode/monitoringcoreoscom-thanosruler-editor -n default --create-namespace --version=v0.26.0 --set apiVersion=monitoring.coreos.com/v1
```
...
```bash
$ helm upgrade -i monitoringcoreoscom-thanosruler-editor appscode/monitoringcoreoscom-thanosruler-editor -n default --create-namespace --version=v0.26.0 --values values.yaml
```
