...
$ helm repo update
$ helm search repo appscode-charts-oci/gatewaynetworkingk8sio-tlsroute-editor --version=v0.4.18
$ helm upgrade -i gatewaynetworkingk8sio-tlsroute-editor appscode-charts-oci/gatewaynetworkingk8sio-tlsroute-editor -n default --create-namespace --version=v0.4.18
```
...
```bash
$ helm upgrade -i gatewaynetworkingk8sio-tlsroute-editor appscode-charts-oci/gatewaynetworkingk8sio-tlsroute-editor -n default --create-namespace --version=v0.4.18 --set apiVersion=gateway.networking.k8s.io/v1alpha2
```
...
```bash
$ helm upgrade -i gatewaynetworkingk8sio-tlsroute-editor appscode-charts-oci/gatewaynetworkingk8sio-tlsroute-editor -n default --create-namespace --version=v0.4.18 --values values.yaml
```
