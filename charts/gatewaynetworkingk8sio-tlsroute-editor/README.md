...
$ helm repo update
$ helm search repo bytebuilders-ui/gatewaynetworkingk8sio-tlsroute-editor --version=v0.4.17
$ helm upgrade -i gatewaynetworkingk8sio-tlsroute-editor bytebuilders-ui/gatewaynetworkingk8sio-tlsroute-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i gatewaynetworkingk8sio-tlsroute-editor bytebuilders-ui/gatewaynetworkingk8sio-tlsroute-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=gateway.networking.k8s.io/v1alpha2
```
...
```bash
$ helm upgrade -i gatewaynetworkingk8sio-tlsroute-editor bytebuilders-ui/gatewaynetworkingk8sio-tlsroute-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
