...
export const useFunc = (model) => {
  ...
  async function getDbDetails() {
    ...
    if (namespace && name) {
      const url = `/clusters/${owner}/${cluster}/proxy/kubedb.com/${version}/namespaces/${namespace}/documentdbs/${name}`
  ...
  async function getDbVersions() {
    ...
    try {
      ...
      const versionsToShow = filteredDocumentDBVersions.length
        ? filteredDocumentDBVersions
