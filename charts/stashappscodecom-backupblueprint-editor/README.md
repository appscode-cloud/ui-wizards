...
$ helm repo update
$ helm search repo appscode-charts-oci/stashappscodecom-backupblueprint-editor --version=v0.4.19
$ helm upgrade -i stashappscodecom-backupblueprint-editor appscode-charts-oci/stashappscodecom-backupblueprint-editor -n default --create-namespace --version=v0.4.19
```
...
```bash
$ helm upgrade -i stashappscodecom-backupblueprint-editor appscode-charts-oci/stashappscodecom-backupblueprint-editor -n default --create-namespace --version=v0.4.19 --set apiVersion=stash.appscode.com/v1beta1
```
...
```bash
$ helm upgrade -i stashappscodecom-backupblueprint-editor appscode-charts-oci/stashappscodecom-backupblueprint-editor -n default --create-namespace --version=v0.4.19 --values values.yaml
```
