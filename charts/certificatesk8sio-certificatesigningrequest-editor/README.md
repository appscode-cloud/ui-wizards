...
$ helm repo update
$ helm search repo appscode-charts-oci/certificatesk8sio-certificatesigningrequest-editor --version=v0.4.18
$ helm upgrade -i certificatesk8sio-certificatesigningrequest-editor appscode-charts-oci/certificatesk8sio-certificatesigningrequest-editor -n default --create-namespace --version=v0.4.18
```
...
```bash
$ helm upgrade -i certificatesk8sio-certificatesigningrequest-editor appscode-charts-oci/certificatesk8sio-certificatesigningrequest-editor -n default --create-namespace --version=v0.4.18 --set apiVersion=certificates.k8s.io/v1
```
...
```bash
$ helm upgrade -i certificatesk8sio-certificatesigningrequest-editor appscode-charts-oci/certificatesk8sio-certificatesigningrequest-editor -n default --create-namespace --version=v0.4.18 --values values.yaml
```
