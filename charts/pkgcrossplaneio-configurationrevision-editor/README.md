...
$ helm repo update
$ helm search repo appscode-charts-oci/pkgcrossplaneio-configurationrevision-editor --version=v0.14.0
$ helm upgrade -i pkgcrossplaneio-configurationrevision-editor appscode-charts-oci/pkgcrossplaneio-configurationrevision-editor -n default --create-namespace --version=v0.14.0
```
...
```bash
$ helm upgrade -i pkgcrossplaneio-configurationrevision-editor appscode-charts-oci/pkgcrossplaneio-configurationrevision-editor -n default --create-namespace --version=v0.14.0 --set apiVersion=pkg.crossplane.io/v1
```
...
```bash
$ helm upgrade -i pkgcrossplaneio-configurationrevision-editor appscode-charts-oci/pkgcrossplaneio-configurationrevision-editor -n default --create-namespace --version=v0.14.0 --values values.yaml
```
