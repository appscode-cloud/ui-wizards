...
$ helm repo update
$ helm search repo appscode-charts-oci/dbformysqlazurekubedbcom-virtualnetworkrule-editor --version=v0.5.0
$ helm upgrade -i dbformysqlazurekubedbcom-virtualnetworkrule-editor appscode-charts-oci/dbformysqlazurekubedbcom-virtualnetworkrule-editor -n default --create-namespace --version=v0.5.0
```
...
```bash
$ helm upgrade -i dbformysqlazurekubedbcom-virtualnetworkrule-editor appscode-charts-oci/dbformysqlazurekubedbcom-virtualnetworkrule-editor -n default --create-namespace --version=v0.5.0 --set apiVersion=dbformysql.azure.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i dbformysqlazurekubedbcom-virtualnetworkrule-editor appscode-charts-oci/dbformysqlazurekubedbcom-virtualnetworkrule-editor -n default --create-namespace --version=v0.5.0 --values values.yaml
```
