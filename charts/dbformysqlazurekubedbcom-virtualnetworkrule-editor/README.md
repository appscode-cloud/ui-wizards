...
$ helm repo update
$ helm search repo appscode/dbformysqlazurekubedbcom-virtualnetworkrule-editor --version=v0.33.0
$ helm upgrade -i dbformysqlazurekubedbcom-virtualnetworkrule-editor appscode/dbformysqlazurekubedbcom-virtualnetworkrule-editor -n default --create-namespace --version=v0.33.0
```
...
```bash
$ helm upgrade -i dbformysqlazurekubedbcom-virtualnetworkrule-editor appscode/dbformysqlazurekubedbcom-virtualnetworkrule-editor -n default --create-namespace --version=v0.33.0 --set apiVersion=dbformysql.azure.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i dbformysqlazurekubedbcom-virtualnetworkrule-editor appscode/dbformysqlazurekubedbcom-virtualnetworkrule-editor -n default --create-namespace --version=v0.33.0 --values values.yaml
```
