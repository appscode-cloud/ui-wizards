...
$ helm repo update
$ helm search repo appscode-charts-oci/addonskubestashcom-function-editor --version=v0.4.19
$ helm upgrade -i addonskubestashcom-function-editor appscode-charts-oci/addonskubestashcom-function-editor -n default --create-namespace --version=v0.4.19
```
...
```bash
$ helm upgrade -i addonskubestashcom-function-editor appscode-charts-oci/addonskubestashcom-function-editor -n default --create-namespace --version=v0.4.19 --set apiVersion=addons.kubestash.com/v1alpha1
```
...
```bash
$ helm upgrade -i addonskubestashcom-function-editor appscode-charts-oci/addonskubestashcom-function-editor -n default --create-namespace --version=v0.4.19 --values values.yaml
```
