...
$ helm repo update
$ helm search repo appscode-charts-oci/addonskubestashcom-function-editor --version=v0.12.0
$ helm upgrade -i addonskubestashcom-function-editor appscode-charts-oci/addonskubestashcom-function-editor -n default --create-namespace --version=v0.12.0
```
...
```bash
$ helm upgrade -i addonskubestashcom-function-editor appscode-charts-oci/addonskubestashcom-function-editor -n default --create-namespace --version=v0.12.0 --set apiVersion=addons.kubestash.com/v1alpha1
```
...
```bash
$ helm upgrade -i addonskubestashcom-function-editor appscode-charts-oci/addonskubestashcom-function-editor -n default --create-namespace --version=v0.12.0 --values values.yaml
```
