...
$ helm repo update
$ helm search repo bytebuilders-ui/clusteropenclustermanagementio-addonplacementscore-editor --version=v0.4.16
$ helm upgrade -i clusteropenclustermanagementio-addonplacementscore-editor bytebuilders-ui/clusteropenclustermanagementio-addonplacementscore-editor -n default --create-namespace --version=v0.4.16
```
...
```bash
$ helm upgrade -i clusteropenclustermanagementio-addonplacementscore-editor bytebuilders-ui/clusteropenclustermanagementio-addonplacementscore-editor -n default --create-namespace --version=v0.4.16 --set apiVersion=cluster.open-cluster-management.io/v1alpha1
```
...
```bash
$ helm upgrade -i clusteropenclustermanagementio-addonplacementscore-editor bytebuilders-ui/clusteropenclustermanagementio-addonplacementscore-editor -n default --create-namespace --version=v0.4.16 --values values.yaml
```
