...
$ helm repo update
$ helm search repo appscode-charts-oci/catalogkubedbcom-ferretdbversion-editor --version=v0.5.0
$ helm upgrade -i catalogkubedbcom-ferretdbversion-editor appscode-charts-oci/catalogkubedbcom-ferretdbversion-editor -n default --create-namespace --version=v0.5.0
```
...
```bash
$ helm upgrade -i catalogkubedbcom-ferretdbversion-editor appscode-charts-oci/catalogkubedbcom-ferretdbversion-editor -n default --create-namespace --version=v0.5.0 --set apiVersion=catalog.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i catalogkubedbcom-ferretdbversion-editor appscode-charts-oci/catalogkubedbcom-ferretdbversion-editor -n default --create-namespace --version=v0.5.0 --values values.yaml
```
