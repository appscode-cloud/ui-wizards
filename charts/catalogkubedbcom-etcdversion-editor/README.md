...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/catalogkubedbcom-etcdversion-editor --version=v0.4.17
$ helm upgrade -i catalogkubedbcom-etcdversion-editor bytebuilders-ui-dev/catalogkubedbcom-etcdversion-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i catalogkubedbcom-etcdversion-editor bytebuilders-ui-dev/catalogkubedbcom-etcdversion-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=catalog.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i catalogkubedbcom-etcdversion-editor bytebuilders-ui-dev/catalogkubedbcom-etcdversion-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
