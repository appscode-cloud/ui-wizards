...
$ helm repo update
$ helm search repo appscode/elasticsearchawskubedbcom-domain-editor --version=v0.22.0
$ helm upgrade -i elasticsearchawskubedbcom-domain-editor appscode/elasticsearchawskubedbcom-domain-editor -n default --create-namespace --version=v0.22.0
```
...
```bash
$ helm upgrade -i elasticsearchawskubedbcom-domain-editor appscode/elasticsearchawskubedbcom-domain-editor -n default --create-namespace --version=v0.22.0 --set apiVersion=elasticsearch.aws.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i elasticsearchawskubedbcom-domain-editor appscode/elasticsearchawskubedbcom-domain-editor -n default --create-namespace --version=v0.22.0 --values values.yaml
```
