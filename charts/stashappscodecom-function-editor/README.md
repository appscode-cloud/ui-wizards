...
$ helm repo update
$ helm search repo bytebuilders-ui/stashappscodecom-function-editor --version=v0.4.12
$ helm upgrade -i stashappscodecom-function-editor bytebuilders-ui/stashappscodecom-function-editor -n default --create-namespace --version=v0.4.12
```
...
```bash
$ helm upgrade -i stashappscodecom-function-editor bytebuilders-ui/stashappscodecom-function-editor -n default --create-namespace --version=v0.4.12 --set apiVersion=stash.appscode.com/v1beta1
```
...
```bash
$ helm upgrade -i stashappscodecom-function-editor bytebuilders-ui/stashappscodecom-function-editor -n default --create-namespace --version=v0.4.12 --values values.yaml
```
