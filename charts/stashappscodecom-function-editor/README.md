...
$ helm repo update
$ helm search repo appscode/stashappscodecom-function-editor --version=v0.35.0
$ helm upgrade -i stashappscodecom-function-editor appscode/stashappscodecom-function-editor -n default --create-namespace --version=v0.35.0
```
...
```bash
$ helm upgrade -i stashappscodecom-function-editor appscode/stashappscodecom-function-editor -n default --create-namespace --version=v0.35.0 --set apiVersion=stash.appscode.com/v1beta1
```
...
```bash
$ helm upgrade -i stashappscodecom-function-editor appscode/stashappscodecom-function-editor -n default --create-namespace --version=v0.35.0 --values values.yaml
```
