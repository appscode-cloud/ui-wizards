...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/networkingk8sio-ingressclass-editor --version=v0.4.17
$ helm upgrade -i networkingk8sio-ingressclass-editor bytebuilders-ui-dev/networkingk8sio-ingressclass-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i networkingk8sio-ingressclass-editor bytebuilders-ui-dev/networkingk8sio-ingressclass-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=networking.k8s.io/v1
```
...
```bash
$ helm upgrade -i networkingk8sio-ingressclass-editor bytebuilders-ui-dev/networkingk8sio-ingressclass-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
