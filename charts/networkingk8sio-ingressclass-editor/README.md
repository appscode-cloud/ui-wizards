...
$ helm repo update
$ helm search repo appscode-charts-oci/networkingk8sio-ingressclass-editor --version=v0.4.21
$ helm upgrade -i networkingk8sio-ingressclass-editor appscode-charts-oci/networkingk8sio-ingressclass-editor -n default --create-namespace --version=v0.4.21
```
...
```bash
$ helm upgrade -i networkingk8sio-ingressclass-editor appscode-charts-oci/networkingk8sio-ingressclass-editor -n default --create-namespace --version=v0.4.21 --set apiVersion=networking.k8s.io/v1
```
...
```bash
$ helm upgrade -i networkingk8sio-ingressclass-editor appscode-charts-oci/networkingk8sio-ingressclass-editor -n default --create-namespace --version=v0.4.21 --values values.yaml
```
