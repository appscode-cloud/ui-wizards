...
$ helm repo update
$ helm search repo bytebuilders-ui/postgreskubedbcom-publisher-editor --version=v0.4.16
$ helm upgrade -i postgreskubedbcom-publisher-editor bytebuilders-ui/postgreskubedbcom-publisher-editor -n default --create-namespace --version=v0.4.16
```
...
```bash
$ helm upgrade -i postgreskubedbcom-publisher-editor bytebuilders-ui/postgreskubedbcom-publisher-editor -n default --create-namespace --version=v0.4.16 --set apiVersion=postgres.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i postgreskubedbcom-publisher-editor bytebuilders-ui/postgreskubedbcom-publisher-editor -n default --create-namespace --version=v0.4.16 --values values.yaml
```
