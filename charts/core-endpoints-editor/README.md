...
$ helm repo update
$ helm search repo bytebuilders-ui/core-endpoints-editor --version=v0.4.14
$ helm upgrade -i core-endpoints-editor bytebuilders-ui/core-endpoints-editor -n default --create-namespace --version=v0.4.14
```
...
```bash
$ helm upgrade -i core-endpoints-editor bytebuilders-ui/core-endpoints-editor -n default --create-namespace --version=v0.4.14 --set apiVersion=v1
```
...
```bash
$ helm upgrade -i core-endpoints-editor bytebuilders-ui/core-endpoints-editor -n default --create-namespace --version=v0.4.14 --values values.yaml
```
