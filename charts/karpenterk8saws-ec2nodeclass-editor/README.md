...
$ helm repo update
$ helm search repo appscode-charts-oci/karpenterk8saws-ec2nodeclass-editor --version=v0.5.0
$ helm upgrade -i karpenterk8saws-ec2nodeclass-editor appscode-charts-oci/karpenterk8saws-ec2nodeclass-editor -n default --create-namespace --version=v0.5.0
```
...
```bash
$ helm upgrade -i karpenterk8saws-ec2nodeclass-editor appscode-charts-oci/karpenterk8saws-ec2nodeclass-editor -n default --create-namespace --version=v0.5.0 --set apiVersion=karpenter.k8s.aws/v1beta1
```
...
```bash
$ helm upgrade -i karpenterk8saws-ec2nodeclass-editor appscode-charts-oci/karpenterk8saws-ec2nodeclass-editor -n default --create-namespace --version=v0.5.0 --values values.yaml
```
