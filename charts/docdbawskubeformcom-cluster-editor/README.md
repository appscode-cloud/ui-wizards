...
$ helm repo update
$ helm search repo bytebuilders-ui/docdbawskubeformcom-cluster-editor --version=v0.4.18
$ helm upgrade -i docdbawskubeformcom-cluster-editor bytebuilders-ui/docdbawskubeformcom-cluster-editor -n default --create-namespace --version=v0.4.18
```
...
```bash
$ helm upgrade -i docdbawskubeformcom-cluster-editor bytebuilders-ui/docdbawskubeformcom-cluster-editor -n default --create-namespace --version=v0.4.18 --set apiVersion=docdb.aws.kubeform.com/v1alpha1
```
...
```bash
$ helm upgrade -i docdbawskubeformcom-cluster-editor bytebuilders-ui/docdbawskubeformcom-cluster-editor -n default --create-namespace --version=v0.4.18 --values values.yaml
```
