...
$ helm repo update
$ helm search repo appscode/configvirtualsecretsdev-secretmetadata-editor --version=v0.29.0
$ helm upgrade -i configvirtualsecretsdev-secretmetadata-editor appscode/configvirtualsecretsdev-secretmetadata-editor -n default --create-namespace --version=v0.29.0
```
...
```bash
$ helm upgrade -i configvirtualsecretsdev-secretmetadata-editor appscode/configvirtualsecretsdev-secretmetadata-editor -n default --create-namespace --version=v0.29.0 --set apiVersion=config.virtual-secrets.dev/v1alpha1
```
...
```bash
$ helm upgrade -i configvirtualsecretsdev-secretmetadata-editor appscode/configvirtualsecretsdev-secretmetadata-editor -n default --create-namespace --version=v0.29.0 --values values.yaml
```
