...
$ helm repo update
$ helm search repo appscode/gitopskubedbcom-mongodb-editor --version=v0.37.0
$ helm upgrade -i gitopskubedbcom-mongodb-editor appscode/gitopskubedbcom-mongodb-editor -n default --create-namespace --version=v0.37.0
```
...
```bash
$ helm upgrade -i gitopskubedbcom-mongodb-editor appscode/gitopskubedbcom-mongodb-editor -n default --create-namespace --version=v0.37.0 --set apiVersion=gitops.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i gitopskubedbcom-mongodb-editor appscode/gitopskubedbcom-mongodb-editor -n default --create-namespace --version=v0.37.0 --values values.yaml
```
