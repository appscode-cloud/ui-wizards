...
$ helm repo update
$ helm search repo appscode-charts-oci/iamawskubedbcom-role-editor --version=v0.14.0
$ helm upgrade -i iamawskubedbcom-role-editor appscode-charts-oci/iamawskubedbcom-role-editor -n default --create-namespace --version=v0.14.0
```
...
```bash
$ helm upgrade -i iamawskubedbcom-role-editor appscode-charts-oci/iamawskubedbcom-role-editor -n default --create-namespace --version=v0.14.0 --set apiVersion=iam.aws.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i iamawskubedbcom-role-editor appscode-charts-oci/iamawskubedbcom-role-editor -n default --create-namespace --version=v0.14.0 --values values.yaml
```
