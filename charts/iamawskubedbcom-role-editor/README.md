...
$ helm repo update
$ helm search repo appscode/iamawskubedbcom-role-editor --version=v0.21.0
$ helm upgrade -i iamawskubedbcom-role-editor appscode/iamawskubedbcom-role-editor -n default --create-namespace --version=v0.21.0
```
...
```bash
$ helm upgrade -i iamawskubedbcom-role-editor appscode/iamawskubedbcom-role-editor -n default --create-namespace --version=v0.21.0 --set apiVersion=iam.aws.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i iamawskubedbcom-role-editor appscode/iamawskubedbcom-role-editor -n default --create-namespace --version=v0.21.0 --values values.yaml
```
