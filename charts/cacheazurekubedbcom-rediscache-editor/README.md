...
$ helm repo update
$ helm search repo appscode/cacheazurekubedbcom-rediscache-editor --version=v0.21.0
$ helm upgrade -i cacheazurekubedbcom-rediscache-editor appscode/cacheazurekubedbcom-rediscache-editor -n default --create-namespace --version=v0.21.0
```
...
```bash
$ helm upgrade -i cacheazurekubedbcom-rediscache-editor appscode/cacheazurekubedbcom-rediscache-editor -n default --create-namespace --version=v0.21.0 --set apiVersion=cache.azure.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i cacheazurekubedbcom-rediscache-editor appscode/cacheazurekubedbcom-rediscache-editor -n default --create-namespace --version=v0.21.0 --values values.yaml
```
