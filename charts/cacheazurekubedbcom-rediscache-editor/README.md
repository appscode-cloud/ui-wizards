...
$ helm repo update
$ helm search repo appscode-charts-oci/cacheazurekubedbcom-rediscache-editor --version=v0.4.21
$ helm upgrade -i cacheazurekubedbcom-rediscache-editor appscode-charts-oci/cacheazurekubedbcom-rediscache-editor -n default --create-namespace --version=v0.4.21
```
...
```bash
$ helm upgrade -i cacheazurekubedbcom-rediscache-editor appscode-charts-oci/cacheazurekubedbcom-rediscache-editor -n default --create-namespace --version=v0.4.21 --set apiVersion=cache.azure.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i cacheazurekubedbcom-rediscache-editor appscode-charts-oci/cacheazurekubedbcom-rediscache-editor -n default --create-namespace --version=v0.4.21 --values values.yaml
```
