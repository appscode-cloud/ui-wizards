...
$ helm repo update
$ helm search repo appscode/kafkaawskubedbcom-configuration-editor --version=v0.17.0
$ helm upgrade -i kafkaawskubedbcom-configuration-editor appscode/kafkaawskubedbcom-configuration-editor -n default --create-namespace --version=v0.17.0
```
...
```bash
$ helm upgrade -i kafkaawskubedbcom-configuration-editor appscode/kafkaawskubedbcom-configuration-editor -n default --create-namespace --version=v0.17.0 --set apiVersion=kafka.aws.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i kafkaawskubedbcom-configuration-editor appscode/kafkaawskubedbcom-configuration-editor -n default --create-namespace --version=v0.17.0 --values values.yaml
```
