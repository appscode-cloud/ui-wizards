...
$ helm repo update
$ helm search repo appscode-charts-oci/kafkaawskubedbcom-configuration-editor --version=v0.11.0
$ helm upgrade -i kafkaawskubedbcom-configuration-editor appscode-charts-oci/kafkaawskubedbcom-configuration-editor -n default --create-namespace --version=v0.11.0
```
...
```bash
$ helm upgrade -i kafkaawskubedbcom-configuration-editor appscode-charts-oci/kafkaawskubedbcom-configuration-editor -n default --create-namespace --version=v0.11.0 --set apiVersion=kafka.aws.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i kafkaawskubedbcom-configuration-editor appscode-charts-oci/kafkaawskubedbcom-configuration-editor -n default --create-namespace --version=v0.11.0 --values values.yaml
```
