...
$ helm repo update
$ helm search repo bytebuilders-ui/kubedbcom-mysql-editor-options --version=v0.4.21
$ helm upgrade -i kubedbcom-mysql-editor-options bytebuilders-ui/kubedbcom-mysql-editor-options -n kube-system --create-namespace --version=v0.4.21
```
...
| spec.mode                                                                      | Standalone, GroupReplication, InnoDBCluster                                                          | <code>GroupReplication</code>                             |
...
| spec.admin.databases.MySQL.versions.default                                    |                                                                                                      | <code>"8.0.36"</code>                                     |
...
```bash
$ helm upgrade -i kubedbcom-mysql-editor-options bytebuilders-ui/kubedbcom-mysql-editor-options -n kube-system --create-namespace --version=v0.4.21 --set metadata.resource.group=kubedb.com
```
...
```bash
$ helm upgrade -i kubedbcom-mysql-editor-options bytebuilders-ui/kubedbcom-mysql-editor-options -n kube-system --create-namespace --version=v0.4.21 --values values.yaml
```
