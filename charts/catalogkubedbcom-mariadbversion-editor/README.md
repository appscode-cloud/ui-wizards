...
$ helm repo update
$ helm search repo appscode/catalogkubedbcom-mariadbversion-editor --version=v0.16.0
$ helm upgrade -i catalogkubedbcom-mariadbversion-editor appscode/catalogkubedbcom-mariadbversion-editor -n default --create-namespace --version=v0.16.0
```
...
```bash
$ helm upgrade -i catalogkubedbcom-mariadbversion-editor appscode/catalogkubedbcom-mariadbversion-editor -n default --create-namespace --version=v0.16.0 --set apiVersion=catalog.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i catalogkubedbcom-mariadbversion-editor appscode/catalogkubedbcom-mariadbversion-editor -n default --create-namespace --version=v0.16.0 --values values.yaml
```
