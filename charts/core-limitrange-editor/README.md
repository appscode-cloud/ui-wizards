...
$ helm repo update
$ helm search repo bytebuilders-ui/core-limitrange-editor --version=v0.4.18
$ helm upgrade -i core-limitrange-editor bytebuilders-ui/core-limitrange-editor -n default --create-namespace --version=v0.4.18
```
...
```bash
$ helm upgrade -i core-limitrange-editor bytebuilders-ui/core-limitrange-editor -n default --create-namespace --version=v0.4.18 --set apiVersion=v1
```
...
```bash
$ helm upgrade -i core-limitrange-editor bytebuilders-ui/core-limitrange-editor -n default --create-namespace --version=v0.4.18 --values values.yaml
```
