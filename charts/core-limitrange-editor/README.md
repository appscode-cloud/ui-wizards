...
$ helm repo update
$ helm search repo appscode/core-limitrange-editor --version=v0.22.0
$ helm upgrade -i core-limitrange-editor appscode/core-limitrange-editor -n default --create-namespace --version=v0.22.0
```
...
```bash
$ helm upgrade -i core-limitrange-editor appscode/core-limitrange-editor -n default --create-namespace --version=v0.22.0 --set apiVersion=v1
```
...
```bash
$ helm upgrade -i core-limitrange-editor appscode/core-limitrange-editor -n default --create-namespace --version=v0.22.0 --values values.yaml
```
