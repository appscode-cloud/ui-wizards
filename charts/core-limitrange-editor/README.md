...
$ helm repo update
$ helm search repo appscode-charts-oci/core-limitrange-editor --version=v0.4.19
$ helm upgrade -i core-limitrange-editor appscode-charts-oci/core-limitrange-editor -n default --create-namespace --version=v0.4.19
```
...
```bash
$ helm upgrade -i core-limitrange-editor appscode-charts-oci/core-limitrange-editor -n default --create-namespace --version=v0.4.19 --set apiVersion=v1
```
...
```bash
$ helm upgrade -i core-limitrange-editor appscode-charts-oci/core-limitrange-editor -n default --create-namespace --version=v0.4.19 --values values.yaml
```
