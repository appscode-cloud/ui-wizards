...
$ helm repo update
$ helm search repo appscode-charts-oci/core-limitrange-editor --version=v0.8.0
$ helm upgrade -i core-limitrange-editor appscode-charts-oci/core-limitrange-editor -n default --create-namespace --version=v0.8.0
```
...
```bash
$ helm upgrade -i core-limitrange-editor appscode-charts-oci/core-limitrange-editor -n default --create-namespace --version=v0.8.0 --set apiVersion=v1
```
...
```bash
$ helm upgrade -i core-limitrange-editor appscode-charts-oci/core-limitrange-editor -n default --create-namespace --version=v0.8.0 --values values.yaml
```
