...
$ helm repo update
$ helm search repo appscode-charts-oci/kmsawskubedbcom-key-editor --version=v0.7.0
$ helm upgrade -i kmsawskubedbcom-key-editor appscode-charts-oci/kmsawskubedbcom-key-editor -n default --create-namespace --version=v0.7.0
```
...
```bash
$ helm upgrade -i kmsawskubedbcom-key-editor appscode-charts-oci/kmsawskubedbcom-key-editor -n default --create-namespace --version=v0.7.0 --set apiVersion=kms.aws.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i kmsawskubedbcom-key-editor appscode-charts-oci/kmsawskubedbcom-key-editor -n default --create-namespace --version=v0.7.0 --values values.yaml
```
