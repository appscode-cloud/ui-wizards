...
$ helm repo update
$ helm search repo appscode/kmsawskubedbcom-key-editor --version=v0.22.0
$ helm upgrade -i kmsawskubedbcom-key-editor appscode/kmsawskubedbcom-key-editor -n default --create-namespace --version=v0.22.0
```
...
```bash
$ helm upgrade -i kmsawskubedbcom-key-editor appscode/kmsawskubedbcom-key-editor -n default --create-namespace --version=v0.22.0 --set apiVersion=kms.aws.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i kmsawskubedbcom-key-editor appscode/kmsawskubedbcom-key-editor -n default --create-namespace --version=v0.22.0 --values values.yaml
```
