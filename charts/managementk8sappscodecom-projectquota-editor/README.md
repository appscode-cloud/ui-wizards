...
$ helm repo update
$ helm search repo appscode-charts-oci/managementk8sappscodecom-projectquota-editor --version=v0.8.0
$ helm upgrade -i managementk8sappscodecom-projectquota-editor appscode-charts-oci/managementk8sappscodecom-projectquota-editor -n default --create-namespace --version=v0.8.0
```
...
```bash
$ helm upgrade -i managementk8sappscodecom-projectquota-editor appscode-charts-oci/managementk8sappscodecom-projectquota-editor -n default --create-namespace --version=v0.8.0 --set apiVersion=management.k8s.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i managementk8sappscodecom-projectquota-editor appscode-charts-oci/managementk8sappscodecom-projectquota-editor -n default --create-namespace --version=v0.8.0 --values values.yaml
```
