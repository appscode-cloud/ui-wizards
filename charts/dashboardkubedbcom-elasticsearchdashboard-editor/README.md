...
$ helm repo update
$ helm search repo appscode-charts-oci/dashboardkubedbcom-elasticsearchdashboard-editor --version=v0.4.18
$ helm upgrade -i dashboardkubedbcom-elasticsearchdashboard-editor appscode-charts-oci/dashboardkubedbcom-elasticsearchdashboard-editor -n default --create-namespace --version=v0.4.18
```
...
```bash
$ helm upgrade -i dashboardkubedbcom-elasticsearchdashboard-editor appscode-charts-oci/dashboardkubedbcom-elasticsearchdashboard-editor -n default --create-namespace --version=v0.4.18 --set apiVersion=dashboard.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i dashboardkubedbcom-elasticsearchdashboard-editor appscode-charts-oci/dashboardkubedbcom-elasticsearchdashboard-editor -n default --create-namespace --version=v0.4.18 --values values.yaml
```
