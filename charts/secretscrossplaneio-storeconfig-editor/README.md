...
$ helm repo update
$ helm search repo bytebuilders-ui/secretscrossplaneio-storeconfig-editor --version=v0.4.18
$ helm upgrade -i secretscrossplaneio-storeconfig-editor bytebuilders-ui/secretscrossplaneio-storeconfig-editor -n default --create-namespace --version=v0.4.18
```
...
```bash
$ helm upgrade -i secretscrossplaneio-storeconfig-editor bytebuilders-ui/secretscrossplaneio-storeconfig-editor -n default --create-namespace --version=v0.4.18 --set apiVersion=secrets.crossplane.io/v1alpha1
```
...
```bash
$ helm upgrade -i secretscrossplaneio-storeconfig-editor bytebuilders-ui/secretscrossplaneio-storeconfig-editor -n default --create-namespace --version=v0.4.18 --values values.yaml
```
