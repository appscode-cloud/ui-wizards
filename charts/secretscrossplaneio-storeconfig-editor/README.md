...
$ helm repo update
$ helm search repo appscode-charts-oci/secretscrossplaneio-storeconfig-editor --version=v0.13.0
$ helm upgrade -i secretscrossplaneio-storeconfig-editor appscode-charts-oci/secretscrossplaneio-storeconfig-editor -n default --create-namespace --version=v0.13.0
```
...
```bash
$ helm upgrade -i secretscrossplaneio-storeconfig-editor appscode-charts-oci/secretscrossplaneio-storeconfig-editor -n default --create-namespace --version=v0.13.0 --set apiVersion=secrets.crossplane.io/v1alpha1
```
...
```bash
$ helm upgrade -i secretscrossplaneio-storeconfig-editor appscode-charts-oci/secretscrossplaneio-storeconfig-editor -n default --create-namespace --version=v0.13.0 --values values.yaml
```
