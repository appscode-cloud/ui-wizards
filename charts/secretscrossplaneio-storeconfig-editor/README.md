...
$ helm repo update
$ helm search repo appscode/secretscrossplaneio-storeconfig-editor --version=v0.16.0
$ helm upgrade -i secretscrossplaneio-storeconfig-editor appscode/secretscrossplaneio-storeconfig-editor -n default --create-namespace --version=v0.16.0
```
...
```bash
$ helm upgrade -i secretscrossplaneio-storeconfig-editor appscode/secretscrossplaneio-storeconfig-editor -n default --create-namespace --version=v0.16.0 --set apiVersion=secrets.crossplane.io/v1alpha1
```
...
```bash
$ helm upgrade -i secretscrossplaneio-storeconfig-editor appscode/secretscrossplaneio-storeconfig-editor -n default --create-namespace --version=v0.16.0 --values values.yaml
```
