...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/secretscrossplaneio-storeconfig-editor --version=v0.4.17
$ helm upgrade -i secretscrossplaneio-storeconfig-editor bytebuilders-ui-dev/secretscrossplaneio-storeconfig-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i secretscrossplaneio-storeconfig-editor bytebuilders-ui-dev/secretscrossplaneio-storeconfig-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=secrets.crossplane.io/v1alpha1
```
...
```bash
$ helm upgrade -i secretscrossplaneio-storeconfig-editor bytebuilders-ui-dev/secretscrossplaneio-storeconfig-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
