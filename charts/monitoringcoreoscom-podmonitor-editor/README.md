...
$ helm repo update
$ helm search repo appscode-charts-oci/monitoringcoreoscom-podmonitor-editor --version=v0.4.19
$ helm upgrade -i monitoringcoreoscom-podmonitor-editor appscode-charts-oci/monitoringcoreoscom-podmonitor-editor -n default --create-namespace --version=v0.4.19
```
...
```bash
$ helm upgrade -i monitoringcoreoscom-podmonitor-editor appscode-charts-oci/monitoringcoreoscom-podmonitor-editor -n default --create-namespace --version=v0.4.19 --set apiVersion=monitoring.coreos.com/v1
```
...
```bash
$ helm upgrade -i monitoringcoreoscom-podmonitor-editor appscode-charts-oci/monitoringcoreoscom-podmonitor-editor -n default --create-namespace --version=v0.4.19 --values values.yaml
```
