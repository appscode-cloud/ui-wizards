...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/policy-podsecuritypolicy-editor --version=v0.4.17
$ helm upgrade -i policy-podsecuritypolicy-editor bytebuilders-ui-dev/policy-podsecuritypolicy-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i policy-podsecuritypolicy-editor bytebuilders-ui-dev/policy-podsecuritypolicy-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=policy/v1beta1
```
...
```bash
$ helm upgrade -i policy-podsecuritypolicy-editor bytebuilders-ui-dev/policy-podsecuritypolicy-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
