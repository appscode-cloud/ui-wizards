...
$ helm repo update
$ helm search repo bytebuilders-ui/policy-podsecuritypolicy-editor --version=v0.4.18
$ helm upgrade -i policy-podsecuritypolicy-editor bytebuilders-ui/policy-podsecuritypolicy-editor -n default --create-namespace --version=v0.4.18
```
...
```bash
$ helm upgrade -i policy-podsecuritypolicy-editor bytebuilders-ui/policy-podsecuritypolicy-editor -n default --create-namespace --version=v0.4.18 --set apiVersion=policy/v1beta1
```
...
```bash
$ helm upgrade -i policy-podsecuritypolicy-editor bytebuilders-ui/policy-podsecuritypolicy-editor -n default --create-namespace --version=v0.4.18 --values values.yaml
```
