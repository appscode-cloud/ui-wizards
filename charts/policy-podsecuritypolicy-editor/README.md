...
$ helm repo update
$ helm search repo appscode-charts-oci/policy-podsecuritypolicy-editor --version=v0.6.0
$ helm upgrade -i policy-podsecuritypolicy-editor appscode-charts-oci/policy-podsecuritypolicy-editor -n default --create-namespace --version=v0.6.0
```
...
```bash
$ helm upgrade -i policy-podsecuritypolicy-editor appscode-charts-oci/policy-podsecuritypolicy-editor -n default --create-namespace --version=v0.6.0 --set apiVersion=policy/v1beta1
```
...
```bash
$ helm upgrade -i policy-podsecuritypolicy-editor appscode-charts-oci/policy-podsecuritypolicy-editor -n default --create-namespace --version=v0.6.0 --values values.yaml
```
