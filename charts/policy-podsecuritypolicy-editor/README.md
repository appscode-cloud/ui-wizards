...
$ helm repo update
$ helm search repo bytebuilders-ui/policy-podsecuritypolicy-editor --version=v0.4.1
$ helm upgrade -i policy-podsecuritypolicy-editor bytebuilders-ui/policy-podsecuritypolicy-editor -n default --create-namespace --version=v0.4.1
```
...
```bash
$ helm upgrade -i policy-podsecuritypolicy-editor bytebuilders-ui/policy-podsecuritypolicy-editor -n default --create-namespace --version=v0.4.1 --set apiVersion=policy/v1beta1
```
...
```bash
$ helm upgrade -i policy-podsecuritypolicy-editor bytebuilders-ui/policy-podsecuritypolicy-editor -n default --create-namespace --version=v0.4.1 --values values.yaml
```
