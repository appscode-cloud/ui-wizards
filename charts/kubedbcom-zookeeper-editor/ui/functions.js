...
function isNotShardModeSelected({ model, getValue, watchDependency }) {
  watchDependency('model#/resources/kubedbComZooKeeper/spec')
  const hasShardTopology = getValue(model, '/resources/kubedbComZooKeeper/spec/shardTopology')
...
function isShardModeSelected({ model, getValue, watchDependency, commit }) {
  ...
  if (resp) {
    commit('wizard/model$delete', '/resources/kubedbComZooKeeper/spec/configSecret')
...
function showAuthSecretField({ model, getValue, watchDependency }) {
  watchDependency('model#/resources/kubedbComZooKeeper/spec')
  const modelPathValue = getValue(model, '/resources/kubedbComZooKeeper/spec')
...
async function getStorageClassNames(
  ...
  const path =
    mode === 'shard'
      ? '/resources/kubedbComZooKeeper/spec/shardTopology/shard/storage/storageClassName'
      : '/resources/kubedbComZooKeeper/spec/storage/storageClassName'
...
function setStorageClass({ getValue, commit, model, discriminator }) {
  const deletionPolicy = getValue(model, 'resources/kubedbComZooKeeper/spec/deletionPolicy') || ''
  const suffix = '-retain'
  let storageClass = ''
  ...
  if (mode === 'Sharded') {
    commit('wizard/model$update', {
      path: '/resources/kubedbComZooKeeper/spec/shardTopology/shard/storage/storageClassName',
      value: storageClass,
      force: true,
    })
    commit('wizard/model$update', {
      path: '/resources/kubedbComZooKeeper/spec/shardTopology/configServer/storage/storageClassName',
      value: storageClass,
      force: true,
    })
    commit('wizard/model$delete', '/resources/kubedbComZooKeeper/spec/storage')
  } else {
    commit('wizard/model$update', {
      path: '/resources/kubedbComZooKeeper/spec/storage/storageClassName',
      value: storageClass,
      force: true,
    })
  }
...
function deleteDatabaseModePath({ discriminator, getValue, commit, model }) {
  const mode = getValue(discriminator, '/activeDatabaseMode')
  const modelSpec = getValue(model, '/resources/kubedbComZooKeeper/spec')
  if (mode === 'Sharded') {
    commit('wizard/model$delete', '/resources/kubedbComZooKeeper/spec/replicaSet')
    commit('wizard/model$delete', '/resources/kubedbComZooKeeper/spec/replicas')
    commit('wizard/model$delete', '/resources/kubedbComZooKeeper/spec/storage')
    commit('wizard/model$delete', '/resources/kubedbComZooKeeper/spec/podTemplate')
    commit('wizard/model$delete', '/resources/kubedbComZooKeeper/spec/configSecret')
    ...
    if (!modelSpec.shardTopology) {
      commit('wizard/model$update', {
        path: '/resources/kubedbComZooKeeper/spec/shardTopology',
        value: {
          configServer: {
            replicas: 3,
            storage: {
    ...
    commit('wizard/model$delete', '/resources/kubedbComZooKeeper/spec/shardTopology')
    ...
    if (!modelSpec.replicaSet) {
      commit('wizard/model$update', {
        path: '/resources/kubedbComZooKeeper/spec/replicaSet',
        value: { name: '' },
        force: true,
      })
      commit('wizard/model$update', {
        path: '/resources/kubedbComZooKeeper/spec/replicas',
        value: 3,
        force: true,
      })
    }
...
async function getIssuerRefsName({ axios, storeGet, getValue, model, watchDependency }) {
  const owner = storeGet('/route/params/user')
  const cluster = storeGet('/route/params/cluster')
  watchDependency('model#/resources/kubedbComZooKeeper/spec/tls/issuerRef/apiGroup')
  watchDependency('model#/resources/kubedbComZooKeeper/spec/tls/issuerRef/kind')
  watchDependency('model#/metadata/release/namespace')
  const apiGroup = getValue(model, '/resources/kubedbComZooKeeper/spec/tls/issuerRef/apiGroup')
  const kind = getValue(model, '/resources/kubedbComZooKeeper/spec/tls/issuerRef/kind')
  const namespace = getValue(model, '/metadata/release/namespace')
...
function setClusterAuthMode({ model, getValue }) {
  const val = getValue(model, '/resources/kubedbComZooKeeper/spec/clusterAuthMode')
  return val || 'x509'
}

function setSSLMode({ model, getValue }) {
  const val = getValue(model, '/resources/kubedbComZooKeeper/spec/sslMode')
...
function onTlsConfigureChange({ discriminator, getValue, commit }) {
  ...
  if (configureStatus) {
    commit('wizard/model$update', {
      path: '/resources/kubedbComZooKeeper/spec/tls',
      value: { issuerRef: {}, certificates: [] },
      force: true,
    })
  } else {
    commit('wizard/model$delete', '/resources/kubedbComZooKeeper/spec/tls')
    commit('wizard/model$delete', '/resources/kubedbComZooKeeper/spec/clusterAuthMode')
    commit('wizard/model$delete', '/resources/kubedbComZooKeeper/spec/sslMode')
  }
}
...
function disableInitializationSection({ model, getValue, watchDependency }) {
  const initialized = getValue(model, '/resources/kubedbComZooKeeper/spec/init/initialized')
  watchDependency('model#/resources/kubedbComZooKeeper/spec/init/initialized')
  return !!initialized
}
...
function initPrePopulateDatabase({ getValue, model }) {
  const waitForInitialRestore = getValue(
    model,
    '/resources/kubedbComZooKeeper/spec/init/waitForInitialRestore',
  )
  const stashAppscodeComRestoreSession_init = getValue(
    model,
    '/resources/stashAppscodeComRestoreSession_init',
  )
  const script = getValue(model, '/resources/kubedbComZooKeeper/spec/init/script')
...
function onPrePopulateDatabaseChange({ commit, getValue, discriminator, model }) {
  ...
  if (prePopulateDatabase === 'no') {
    ...
    commit('wizard/model$update', {
      path: '/resources/kubedbComZooKeeper/spec/init/waitForInitialRestore',
      value: false,
    })
    commit('wizard/model$delete', '/resources/stashAppscodeComRestoreSession_init')
    commit('wizard/model$delete', '/resources/kubedbComZooKeeper/spec/init/script')
...
function onDataSourceChange({ commit, getValue, discriminator, model }) {
  ...
  if (dataSource === 'script') {
    ...
    if (!valueExists(model, getValue, '/resources/kubedbComZooKeeper/spec/init/script'))
      commit('wizard/model$update', {
        path: '/resources/kubedbComZooKeeper/spec/init/script',
        value: initScript,
      })
...
function initVolumeType({ getValue, model }) {
  const configMap = getValue(model, '/resources/kubedbComZooKeeper/spec/init/script/configMap/name')
  const secret = getValue(model, '/resources/kubedbComZooKeeper/spec/init/script/secret/secretName')
...
function onVolumeTypeChange({ commit, getValue, discriminator, model }) {
  ...
  if (sourceVolumeType === 'configMap') {
    ...
    commit('wizard/model$delete', '/resources/kubedbComZooKeeper/spec/init/script/secret')

    if (!valueExists(model, getValue, '/resources/kubedbComZooKeeper/spec/init/script/configMap')) {
      commit('wizard/model$update', {
        path: '/resources/kubedbComZooKeeper/spec/init/script/configMap',
        value: {
          name: '',
        },
      })
    ...
    commit('wizard/model$delete', '/resources/kubedbComZooKeeper/spec/init/script/configMap')

    if (!valueExists(model, getValue, '/resources/kubedbComZooKeeper/spec/init/script/secret')) {
      commit('wizard/model$update', {
        path: '/resources/kubedbComZooKeeper/spec/init/script/secret',
        value: {
          secretName: '',
        },
      })
...
function getBackupConfigsAndAnnotations(getValue, model) {
  ...
  const mongoDB = getValue(model, '/resources/kubedbComZooKeeper')
  ...
  const kubedbComZooKeeperAnnotations =
    getValue(model, '/resources/kubedbComZooKeeper/metadata/annotations') || {}

  const isBluePrint = Object.keys(kubedbComZooKeeperAnnotations).some(
    (k) =>
...
function deleteKubeDbComMongDbAnnotation(getValue, model, commit) {
  const annotations = getValue(model, '/resources/kubedbComZooKeeper/metadata/annotations') || {}
  ...
  commit('wizard/model$update', {
    path: '/resources/kubedbComZooKeeper/metadata/annotations',
...
function onScheduleBackupChange({ commit, getValue, discriminator, model }) {
  ...
  if (scheduleBackup === 'no') {
    ...
    // delete annotation from kubedbComZooKeeper annotation
...
async function setBackupSwitch({ commit, storeGet, axios, getValue, model }) {
  ...
  } else dbResource = getValue(model, '/resources/kubedbComZooKeeper')
...
function onTaskParametersChange({ getValue, discriminator, model, commit }) {
  ...
  const oldAnnotations = getValue(model, '/resources/kubedbComZooKeeper/metadata/annotations') || {}
...
function onNameChange({ commit, model, getValue }) {
  ...
  if (hasSecretConfig) {
    commit('wizard/model$update', {
      path: '/resources/kubedbComZooKeeper/spec/configSecret/name',
      value: `${dbName}-config`,
      force: true,
    })
  }
  ...
  if (hasSecretShardConfig) {
    commit('wizard/model$update', {
      path: '/resources/kubedbComZooKeeper/spec/shardTopology/shard/configSecret/name',
  ...
  if (hasSecretConfigServerConfig) {
    commit('wizard/model$update', {
      path: '/resources/kubedbComZooKeeper/spec/shardTopology/configServer/configSecret/name',
  ...
  if (hasSecretMongosConfig) {
    commit('wizard/model$update', {
      path: '/resources/kubedbComZooKeeper/spec/shardTopology/mongos/configSecret/name',
...
function getCreateAuthSecret({ model, getValue }) {
  const authSecret = getValue(model, '/resources/kubedbComZooKeeper/spec/authSecret')
...
function onCreateAuthSecretChange({ discriminator, getValue, commit }) {
  ...
  if (createAuthSecret) {
    commit('wizard/model$delete', '/resources/kubedbComZooKeeper/spec/authSecret')
...
function transferConfigSecret({ commit, model, getValue }, src, des) {
  const isShardedMode = getValue(model, '/resources/kubedbComZooKeeper/spec/shardTopology')
  if (isShardedMode) {
    commit('wizard/model$update', {
      path: `/resources/kubedbComZooKeeper/spec/shardTopology/${
      ...
      value: getValue(
        model,
        `/resources/kubedbComZooKeeper/spec/shardTopology/${
...
function onSetCustomConfigChange({ discriminator, getValue, commit }) {
  ...
  if (value === 'no') {
    ...
    commit(
      'wizard/model$delete',
      '/resources/kubedbComZooKeeper/spec/shardTopology/shard/configSecret',
    )
    commit(
      'wizard/model$delete',
      '/resources/kubedbComZooKeeper/spec/shardTopology/configServer/configSecret',
    )
    commit(
      'wizard/model$delete',
      '/resources/kubedbComZooKeeper/spec/shardTopology/mongos/configSecret',
    )
    commit('wizard/model$delete', '/resources/secret_config')
    commit('wizard/model$delete', '/resources/secret_shard_config')
    commit('wizard/model$delete', '/resources/secret_configserver_config')
...
function clearSpecModel({ commit }, dbtype) {
  if (dbtype === 'standalone') {
    commit(
      'wizard/model$delete',
      `/resources/autoscalingkubedbComZooKeeperAutoscaler/spec/${autoscaleType}/cluster`,
    )
    commit(
      'wizard/model$delete',
      `/resources/autoscalingkubedbComZooKeeperAutoscaler/spec/${autoscaleType}/sentinel`,
    )
  } else if (dbtype === 'cluster') {
    commit(
      'wizard/model$delete',
      `/resources/autoscalingkubedbComZooKeeperAutoscaler/spec/${autoscaleType}/standalone`,
    )
    commit(
      'wizard/model$delete',
      `/resources/autoscalingkubedbComZooKeeperAutoscaler/spec/${autoscaleType}/sentinel`,
