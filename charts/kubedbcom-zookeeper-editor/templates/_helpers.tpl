...
*/}}
{{- define "kubedbcom-zookeeper-editor.name" -}}
...
*/}}
{{- define "kubedbcom-zookeeper-editor.fullname" -}}
...
*/}}
{{- define "kubedbcom-zookeeper-editor.chart" -}}
...
Alert Enabled
*/}}
{{- define "kubedbcom-zookeeper-editor.alertEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
