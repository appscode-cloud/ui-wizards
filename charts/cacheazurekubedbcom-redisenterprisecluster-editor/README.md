...
$ helm repo update
$ helm search repo appscode/cacheazurekubedbcom-redisenterprisecluster-editor --version=v0.25.0
$ helm upgrade -i cacheazurekubedbcom-redisenterprisecluster-editor appscode/cacheazurekubedbcom-redisenterprisecluster-editor -n default --create-namespace --version=v0.25.0
```
...
```bash
$ helm upgrade -i cacheazurekubedbcom-redisenterprisecluster-editor appscode/cacheazurekubedbcom-redisenterprisecluster-editor -n default --create-namespace --version=v0.25.0 --set apiVersion=cache.azure.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i cacheazurekubedbcom-redisenterprisecluster-editor appscode/cacheazurekubedbcom-redisenterprisecluster-editor -n default --create-namespace --version=v0.25.0 --values values.yaml
```
