...
$ helm repo update
$ helm search repo appscode/sqlazurekubedbcom-mssqlmanagedinstance-editor --version=v0.22.0
$ helm upgrade -i sqlazurekubedbcom-mssqlmanagedinstance-editor appscode/sqlazurekubedbcom-mssqlmanagedinstance-editor -n default --create-namespace --version=v0.22.0
```
...
```bash
$ helm upgrade -i sqlazurekubedbcom-mssqlmanagedinstance-editor appscode/sqlazurekubedbcom-mssqlmanagedinstance-editor -n default --create-namespace --version=v0.22.0 --set apiVersion=sql.azure.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i sqlazurekubedbcom-mssqlmanagedinstance-editor appscode/sqlazurekubedbcom-mssqlmanagedinstance-editor -n default --create-namespace --version=v0.22.0 --values values.yaml
```
