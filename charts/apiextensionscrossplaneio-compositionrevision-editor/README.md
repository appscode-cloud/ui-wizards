...
$ helm repo update
$ helm search repo appscode-charts-oci/apiextensionscrossplaneio-compositionrevision-editor --version=v0.7.0
$ helm upgrade -i apiextensionscrossplaneio-compositionrevision-editor appscode-charts-oci/apiextensionscrossplaneio-compositionrevision-editor -n default --create-namespace --version=v0.7.0
```
...
```bash
$ helm upgrade -i apiextensionscrossplaneio-compositionrevision-editor appscode-charts-oci/apiextensionscrossplaneio-compositionrevision-editor -n default --create-namespace --version=v0.7.0 --set apiVersion=apiextensions.crossplane.io/v1
```
...
```bash
$ helm upgrade -i apiextensionscrossplaneio-compositionrevision-editor appscode-charts-oci/apiextensionscrossplaneio-compositionrevision-editor -n default --create-namespace --version=v0.7.0 --values values.yaml
```
