...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/apiextensionscrossplaneio-compositionrevision-editor --version=v0.4.17
$ helm upgrade -i apiextensionscrossplaneio-compositionrevision-editor bytebuilders-ui-dev/apiextensionscrossplaneio-compositionrevision-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i apiextensionscrossplaneio-compositionrevision-editor bytebuilders-ui-dev/apiextensionscrossplaneio-compositionrevision-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=apiextensions.crossplane.io/v1
```
...
```bash
$ helm upgrade -i apiextensionscrossplaneio-compositionrevision-editor bytebuilders-ui-dev/apiextensionscrossplaneio-compositionrevision-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
