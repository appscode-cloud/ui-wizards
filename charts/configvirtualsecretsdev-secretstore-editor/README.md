...
$ helm repo update
$ helm search repo appscode/configvirtualsecretsdev-secretstore-editor --version=v0.34.0
$ helm upgrade -i configvirtualsecretsdev-secretstore-editor appscode/configvirtualsecretsdev-secretstore-editor -n default --create-namespace --version=v0.34.0
```
...
```bash
$ helm upgrade -i configvirtualsecretsdev-secretstore-editor appscode/configvirtualsecretsdev-secretstore-editor -n default --create-namespace --version=v0.34.0 --set apiVersion=config.virtual-secrets.dev/v1alpha1
```
...
```bash
$ helm upgrade -i configvirtualsecretsdev-secretstore-editor appscode/configvirtualsecretsdev-secretstore-editor -n default --create-namespace --version=v0.34.0 --values values.yaml
```
