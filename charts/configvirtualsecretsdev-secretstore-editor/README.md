...
$ helm repo update
$ helm search repo appscode-charts-oci/configvirtualsecretsdev-secretstore-editor --version=v0.14.0
$ helm upgrade -i configvirtualsecretsdev-secretstore-editor appscode-charts-oci/configvirtualsecretsdev-secretstore-editor -n default --create-namespace --version=v0.14.0
```
...
```bash
$ helm upgrade -i configvirtualsecretsdev-secretstore-editor appscode-charts-oci/configvirtualsecretsdev-secretstore-editor -n default --create-namespace --version=v0.14.0 --set apiVersion=config.virtual-secrets.dev/v1alpha1
```
...
```bash
$ helm upgrade -i configvirtualsecretsdev-secretstore-editor appscode-charts-oci/configvirtualsecretsdev-secretstore-editor -n default --create-namespace --version=v0.14.0 --values values.yaml
```
