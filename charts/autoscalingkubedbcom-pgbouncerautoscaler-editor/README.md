...
$ helm repo update
$ helm install autoscalingkubedbcom-pgbouncerautoscaler-editor bytebuilders-ui-dev/autoscalingkubedbcom-pgbouncerautoscaler-editor -n default
```
...
```console
$ helm install autoscalingkubedbcom-pgbouncerautoscaler-editor bytebuilders-ui-dev/autoscalingkubedbcom-pgbouncerautoscaler-editor -n default --set apiVersion=autoscaling.kubedb.com/v1alpha1
```
...
```console
$ helm install autoscalingkubedbcom-pgbouncerautoscaler-editor bytebuilders-ui-dev/autoscalingkubedbcom-pgbouncerautoscaler-editor -n default --values values.yaml
```
