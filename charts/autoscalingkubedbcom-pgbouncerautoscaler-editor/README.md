...
$ helm repo update
$ helm search repo appscode-charts-oci/autoscalingkubedbcom-pgbouncerautoscaler-editor --version=v0.11.0
...
```bash
$ helm upgrade -i autoscalingkubedbcom-pgbouncerautoscaler-editor appscode-charts-oci/autoscalingkubedbcom-pgbouncerautoscaler-editor -n default --create-namespace --version=v0.11.0 --set apiVersion=autoscaling.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i autoscalingkubedbcom-pgbouncerautoscaler-editor appscode-charts-oci/autoscalingkubedbcom-pgbouncerautoscaler-editor -n default --create-namespace --version=v0.11.0 --values values.yaml
```
