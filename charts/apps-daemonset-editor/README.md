...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/apps-daemonset-editor --version=v0.4.17
$ helm upgrade -i apps-daemonset-editor bytebuilders-ui-dev/apps-daemonset-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i apps-daemonset-editor bytebuilders-ui-dev/apps-daemonset-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=apps/v1
```
...
```bash
$ helm upgrade -i apps-daemonset-editor bytebuilders-ui-dev/apps-daemonset-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
