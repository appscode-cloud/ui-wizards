...
$ helm repo update
$ helm search repo bytebuilders-ui/apps-daemonset-editor --version=v0.4.15
$ helm upgrade -i apps-daemonset-editor bytebuilders-ui/apps-daemonset-editor -n default --create-namespace --version=v0.4.15
```
...
```bash
$ helm upgrade -i apps-daemonset-editor bytebuilders-ui/apps-daemonset-editor -n default --create-namespace --version=v0.4.15 --set apiVersion=apps/v1
```
...
```bash
$ helm upgrade -i apps-daemonset-editor bytebuilders-ui/apps-daemonset-editor -n default --create-namespace --version=v0.4.15 --values values.yaml
```
