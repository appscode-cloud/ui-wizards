...
$ helm repo update
$ helm search repo appscode-charts-oci/apps-daemonset-editor --version=v0.6.0
$ helm upgrade -i apps-daemonset-editor appscode-charts-oci/apps-daemonset-editor -n default --create-namespace --version=v0.6.0
```
...
```bash
$ helm upgrade -i apps-daemonset-editor appscode-charts-oci/apps-daemonset-editor -n default --create-namespace --version=v0.6.0 --set apiVersion=apps/v1
```
...
```bash
$ helm upgrade -i apps-daemonset-editor appscode-charts-oci/apps-daemonset-editor -n default --create-namespace --version=v0.6.0 --values values.yaml
```
