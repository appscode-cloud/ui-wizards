...
$ helm repo update
$ helm search repo appscode/apps-daemonset-editor --version=v0.34.0
$ helm upgrade -i apps-daemonset-editor appscode/apps-daemonset-editor -n default --create-namespace --version=v0.34.0
```
...
```bash
$ helm upgrade -i apps-daemonset-editor appscode/apps-daemonset-editor -n default --create-namespace --version=v0.34.0 --set apiVersion=apps/v1
```
...
```bash
$ helm upgrade -i apps-daemonset-editor appscode/apps-daemonset-editor -n default --create-namespace --version=v0.34.0 --values values.yaml
```
