...
$ helm repo update
$ helm search repo appscode/gatewaynetworkingk8sio-backendlbpolicy-editor --version=v0.20.0
$ helm upgrade -i gatewaynetworkingk8sio-backendlbpolicy-editor appscode/gatewaynetworkingk8sio-backendlbpolicy-editor -n default --create-namespace --version=v0.20.0
```
...
```bash
$ helm upgrade -i gatewaynetworkingk8sio-backendlbpolicy-editor appscode/gatewaynetworkingk8sio-backendlbpolicy-editor -n default --create-namespace --version=v0.20.0 --set apiVersion=gateway.networking.k8s.io/v1alpha2
```
...
```bash
$ helm upgrade -i gatewaynetworkingk8sio-backendlbpolicy-editor appscode/gatewaynetworkingk8sio-backendlbpolicy-editor -n default --create-namespace --version=v0.20.0 --values values.yaml
```
