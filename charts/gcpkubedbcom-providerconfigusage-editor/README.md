...
$ helm repo update
$ helm search repo appscode/gcpkubedbcom-providerconfigusage-editor --version=v0.14.0
$ helm upgrade -i gcpkubedbcom-providerconfigusage-editor appscode/gcpkubedbcom-providerconfigusage-editor -n default --create-namespace --version=v0.14.0
```
...
```bash
$ helm upgrade -i gcpkubedbcom-providerconfigusage-editor appscode/gcpkubedbcom-providerconfigusage-editor -n default --create-namespace --version=v0.14.0 --set apiVersion=gcp.kubedb.com/v1beta1
```
...
```bash
$ helm upgrade -i gcpkubedbcom-providerconfigusage-editor appscode/gcpkubedbcom-providerconfigusage-editor -n default --create-namespace --version=v0.14.0 --values values.yaml
```
