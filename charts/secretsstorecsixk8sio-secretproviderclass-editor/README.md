...
$ helm repo update
$ helm search repo appscode-charts-oci/secretsstorecsixk8sio-secretproviderclass-editor --version=v0.4.19
$ helm upgrade -i secretsstorecsixk8sio-secretproviderclass-editor appscode-charts-oci/secretsstorecsixk8sio-secretproviderclass-editor -n default --create-namespace --version=v0.4.19
```
...
```bash
$ helm upgrade -i secretsstorecsixk8sio-secretproviderclass-editor appscode-charts-oci/secretsstorecsixk8sio-secretproviderclass-editor -n default --create-namespace --version=v0.4.19 --set apiVersion=secrets-store.csi.x-k8s.io/v1alpha1
```
...
```bash
$ helm upgrade -i secretsstorecsixk8sio-secretproviderclass-editor appscode-charts-oci/secretsstorecsixk8sio-secretproviderclass-editor -n default --create-namespace --version=v0.4.19 --values values.yaml
```
