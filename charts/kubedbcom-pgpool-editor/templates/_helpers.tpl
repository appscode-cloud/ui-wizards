...
*/}}
{{- define "kubedbcom-pgpool-editor.name" -}}
...
*/}}
{{- define "kubedbcom-pgpool-editor.fullname" -}}
...
*/}}
{{- define "kubedbcom-pgpool-editor.chart" -}}
...
Common labels
*/}}
{{- define "kubedbcom-pgpool-editor.labels" -}}
{{ include "kubedbcom-pgpool-editor.selectorLabels" . }}
...
Selector labels
*/}}
{{- define "kubedbcom-pgpool-editor.selectorLabels" -}}
app.kubernetes.io/name: pgpools.kubedb.com
app.kubernetes.io/instance: {{ include "kubedbcom-pgpool-editor.fullname" . }}
{{- end }}

{{/*
Create the name of the service account to use
*/}}
{{- define "kubedbcom-pgpool-editor.serviceAccountName" -}}
{{- if .Values.spec.serviceAccount.create }}
{{- default (include "kubedbcom-pgpool-editor.fullname" .) .Values.spec.serviceAccount.name }}
{{- else }}
...
Common annotations
*/}}
{{- define "kubedbcom-pgpool-editor.annotations" -}}
...
Alert labels
*/}}
{{- define "kubedbcom-pgpool-editor.alertLabels" -}}
...
Alert Enabled
*/}}
{{- define "kubedbcom-pgpool-editor.alertEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
