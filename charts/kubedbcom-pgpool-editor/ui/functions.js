...
export const useFunc = (model) => {
  ...
  async function getConfigMapKeys() {
    ...
    const configMapName = getValue(
      model,
      '/resources/kubedbComPgpool/spec/monitor/prometheus/exporter/env/items/valueFrom/configMapKeyRef/name',
    )
  ...
  async function getSecretKeys() {
    ...
    const secretName = getValue(
      model,
      '/resources/kubedbComPgpool/spec/monitor/prometheus/exporter/env/items/valueFrom/secretKeyRef/name',
    )
