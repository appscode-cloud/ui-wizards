...
$ helm repo update
$ helm search repo appscode/kubedbcom-pgpool-editor --version=v0.35.0
$ helm upgrade -i kubedbcom-pgpool-editor appscode/kubedbcom-pgpool-editor -n default --create-namespace --version=v0.35.0
```
...
```bash
$ helm upgrade -i kubedbcom-pgpool-editor appscode/kubedbcom-pgpool-editor -n default --create-namespace --version=v0.35.0 --values values.yaml
```
