...
$ helm repo update
$ helm search repo appscode-charts-oci/nodek8sappscodecom-nodetopology-editor --version=v0.4.20
$ helm upgrade -i nodek8sappscodecom-nodetopology-editor appscode-charts-oci/nodek8sappscodecom-nodetopology-editor -n default --create-namespace --version=v0.4.20
```
...
```bash
$ helm upgrade -i nodek8sappscodecom-nodetopology-editor appscode-charts-oci/nodek8sappscodecom-nodetopology-editor -n default --create-namespace --version=v0.4.20 --set apiVersion=node.k8s.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i nodek8sappscodecom-nodetopology-editor appscode-charts-oci/nodek8sappscodecom-nodetopology-editor -n default --create-namespace --version=v0.4.20 --values values.yaml
```
