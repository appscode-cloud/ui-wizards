...
$ helm repo update
$ helm search repo appscode/elasticacheawskubedbcom-parametergroup-editor --version=v0.29.0
$ helm upgrade -i elasticacheawskubedbcom-parametergroup-editor appscode/elasticacheawskubedbcom-parametergroup-editor -n default --create-namespace --version=v0.29.0
```
...
```bash
$ helm upgrade -i elasticacheawskubedbcom-parametergroup-editor appscode/elasticacheawskubedbcom-parametergroup-editor -n default --create-namespace --version=v0.29.0 --set apiVersion=elasticache.aws.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i elasticacheawskubedbcom-parametergroup-editor appscode/elasticacheawskubedbcom-parametergroup-editor -n default --create-namespace --version=v0.29.0 --values values.yaml
```
