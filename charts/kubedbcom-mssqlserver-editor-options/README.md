...
$ helm repo update
$ helm search repo bytebuilders-ui/kubedbcom-mssqlserver-editor-options --version=v0.5.0
$ helm upgrade -i kubedbcom-mssqlserver-editor-options bytebuilders-ui/kubedbcom-mssqlserver-editor-options -n kube-system --create-namespace --version=v0.5.0
```
...
| spec.topology.availabilityGroup.databases                                      |                                                                                                      | <code>[]</code>                                           |
...
| spec.podResources.resources.limits.memory                                      |                                                                                                      | <code>1.5Gi</code>                                        |
...
| spec.admin.databases.MSSQLServer.versions.default                              |                                                                                                      | <code>"2022-cu12"</code>                                  |
| spec.admin.databases.MSSQLServer.versions.toggle                               |                                                                                                      | <code>true</code>                                         |
...
```bash
$ helm upgrade -i kubedbcom-mssqlserver-editor-options bytebuilders-ui/kubedbcom-mssqlserver-editor-options -n kube-system --create-namespace --version=v0.5.0 --set metadata.resource.group=kubedb.com
```
...
```bash
$ helm upgrade -i kubedbcom-mssqlserver-editor-options bytebuilders-ui/kubedbcom-mssqlserver-editor-options -n kube-system --create-namespace --version=v0.5.0 --values values.yaml
```
