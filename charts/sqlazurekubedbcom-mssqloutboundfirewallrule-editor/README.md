...
$ helm repo update
$ helm search repo appscode-charts-oci/sqlazurekubedbcom-mssqloutboundfirewallrule-editor --version=v0.7.0
$ helm upgrade -i sqlazurekubedbcom-mssqloutboundfirewallrule-editor appscode-charts-oci/sqlazurekubedbcom-mssqloutboundfirewallrule-editor -n default --create-namespace --version=v0.7.0
```
...
```bash
$ helm upgrade -i sqlazurekubedbcom-mssqloutboundfirewallrule-editor appscode-charts-oci/sqlazurekubedbcom-mssqloutboundfirewallrule-editor -n default --create-namespace --version=v0.7.0 --set apiVersion=sql.azure.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i sqlazurekubedbcom-mssqloutboundfirewallrule-editor appscode-charts-oci/sqlazurekubedbcom-mssqloutboundfirewallrule-editor -n default --create-namespace --version=v0.7.0 --values values.yaml
```
