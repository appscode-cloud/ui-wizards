...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/kustomizetoolkitfluxcdio-kustomization-editor --version=v0.4.17
$ helm upgrade -i kustomizetoolkitfluxcdio-kustomization-editor bytebuilders-ui-dev/kustomizetoolkitfluxcdio-kustomization-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i kustomizetoolkitfluxcdio-kustomization-editor bytebuilders-ui-dev/kustomizetoolkitfluxcdio-kustomization-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=kustomize.toolkit.fluxcd.io/v1beta2
```
...
```bash
$ helm upgrade -i kustomizetoolkitfluxcdio-kustomization-editor bytebuilders-ui-dev/kustomizetoolkitfluxcdio-kustomization-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
