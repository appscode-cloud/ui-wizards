...
$ helm repo update
$ helm search repo appscode-charts-oci/kustomizetoolkitfluxcdio-kustomization-editor --version=v0.12.0
$ helm upgrade -i kustomizetoolkitfluxcdio-kustomization-editor appscode-charts-oci/kustomizetoolkitfluxcdio-kustomization-editor -n default --create-namespace --version=v0.12.0
```
...
```bash
$ helm upgrade -i kustomizetoolkitfluxcdio-kustomization-editor appscode-charts-oci/kustomizetoolkitfluxcdio-kustomization-editor -n default --create-namespace --version=v0.12.0 --set apiVersion=kustomize.toolkit.fluxcd.io/v1
```
...
```bash
$ helm upgrade -i kustomizetoolkitfluxcdio-kustomization-editor appscode-charts-oci/kustomizetoolkitfluxcdio-kustomization-editor -n default --create-namespace --version=v0.12.0 --values values.yaml
```
