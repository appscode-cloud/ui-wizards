...
$ helm repo update
$ helm search repo appscode-charts-oci/kustomizetoolkitfluxcdio-kustomization-editor --version=v0.4.21
$ helm upgrade -i kustomizetoolkitfluxcdio-kustomization-editor appscode-charts-oci/kustomizetoolkitfluxcdio-kustomization-editor -n default --create-namespace --version=v0.4.21
```
...
```bash
$ helm upgrade -i kustomizetoolkitfluxcdio-kustomization-editor appscode-charts-oci/kustomizetoolkitfluxcdio-kustomization-editor -n default --create-namespace --version=v0.4.21 --set apiVersion=kustomize.toolkit.fluxcd.io/v1
```
...
```bash
$ helm upgrade -i kustomizetoolkitfluxcdio-kustomization-editor appscode-charts-oci/kustomizetoolkitfluxcdio-kustomization-editor -n default --create-namespace --version=v0.4.21 --values values.yaml
```
