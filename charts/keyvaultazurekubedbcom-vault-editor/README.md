...
$ helm repo update
$ helm search repo appscode-charts-oci/keyvaultazurekubedbcom-vault-editor --version=v0.6.0
$ helm upgrade -i keyvaultazurekubedbcom-vault-editor appscode-charts-oci/keyvaultazurekubedbcom-vault-editor -n default --create-namespace --version=v0.6.0
```
...
```bash
$ helm upgrade -i keyvaultazurekubedbcom-vault-editor appscode-charts-oci/keyvaultazurekubedbcom-vault-editor -n default --create-namespace --version=v0.6.0 --set apiVersion=keyvault.azure.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i keyvaultazurekubedbcom-vault-editor appscode-charts-oci/keyvaultazurekubedbcom-vault-editor -n default --create-namespace --version=v0.6.0 --values values.yaml
```
