...
$ helm repo update
$ helm search repo appscode-charts-oci/cosmosdbazurekubedbcom-sqlroledefinition-editor --version=v0.4.20
$ helm upgrade -i cosmosdbazurekubedbcom-sqlroledefinition-editor appscode-charts-oci/cosmosdbazurekubedbcom-sqlroledefinition-editor -n default --create-namespace --version=v0.4.20
```
...
```bash
$ helm upgrade -i cosmosdbazurekubedbcom-sqlroledefinition-editor appscode-charts-oci/cosmosdbazurekubedbcom-sqlroledefinition-editor -n default --create-namespace --version=v0.4.20 --set apiVersion=cosmosdb.azure.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i cosmosdbazurekubedbcom-sqlroledefinition-editor appscode-charts-oci/cosmosdbazurekubedbcom-sqlroledefinition-editor -n default --create-namespace --version=v0.4.20 --values values.yaml
```
