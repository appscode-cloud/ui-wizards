...
$ helm repo update
$ helm install voyagerappscodecom-ingress-editor bytebuilders-ui/voyagerappscodecom-ingress-editor -n default --version=v0.1.0
```
...
```console
$ helm install voyagerappscodecom-ingress-editor bytebuilders-ui/voyagerappscodecom-ingress-editor -n default --version=v0.1.0 --set apiVersion=voyager.appscode.com/v1beta1
```
...
```console
$ helm install voyagerappscodecom-ingress-editor bytebuilders-ui/voyagerappscodecom-ingress-editor -n default --version=v0.1.0 --values values.yaml
```
