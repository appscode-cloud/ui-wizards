...
$ helm repo update
$ helm search repo bytebuilders-ui/voyagerappscodecom-ingress-editor --version=v0.4.15
$ helm upgrade -i voyagerappscodecom-ingress-editor bytebuilders-ui/voyagerappscodecom-ingress-editor -n default --create-namespace --version=v0.4.15
```
...
```bash
$ helm upgrade -i voyagerappscodecom-ingress-editor bytebuilders-ui/voyagerappscodecom-ingress-editor -n default --create-namespace --version=v0.4.15 --set apiVersion=voyager.appscode.com/v1
```
...
```bash
$ helm upgrade -i voyagerappscodecom-ingress-editor bytebuilders-ui/voyagerappscodecom-ingress-editor -n default --create-namespace --version=v0.4.15 --values values.yaml
```
