...
$ helm repo update
$ helm search repo appscode/voyagerappscodecom-ingress-editor --version=v0.37.0
$ helm upgrade -i voyagerappscodecom-ingress-editor appscode/voyagerappscodecom-ingress-editor -n default --create-namespace --version=v0.37.0
```
...
```bash
$ helm upgrade -i voyagerappscodecom-ingress-editor appscode/voyagerappscodecom-ingress-editor -n default --create-namespace --version=v0.37.0 --set apiVersion=voyager.appscode.com/v1
```
...
```bash
$ helm upgrade -i voyagerappscodecom-ingress-editor appscode/voyagerappscodecom-ingress-editor -n default --create-namespace --version=v0.37.0 --values values.yaml
```
