...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/voyagerappscodecom-ingress-editor --version=v0.4.17
$ helm upgrade -i voyagerappscodecom-ingress-editor bytebuilders-ui-dev/voyagerappscodecom-ingress-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i voyagerappscodecom-ingress-editor bytebuilders-ui-dev/voyagerappscodecom-ingress-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=voyager.appscode.com/v1
```
...
```bash
$ helm upgrade -i voyagerappscodecom-ingress-editor bytebuilders-ui-dev/voyagerappscodecom-ingress-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
