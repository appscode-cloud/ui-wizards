# APIServiceExportRequest Editor

[APIServiceExportRequest Editor by AppsCode](https://byte.builders) - APIServiceExportRequest Editor
...
$ helm repo update
$ helm search repo appscode-charts-oci/kubebindappscodecom-apiserviceexportrequest-editor --version=v0.4.20
$ helm upgrade -i kubebindappscodecom-apiserviceexportrequest-editor appscode-charts-oci/kubebindappscodecom-apiserviceexportrequest-editor -n default --create-namespace --version=v0.4.20
```
...
```bash
$ helm upgrade -i kubebindappscodecom-apiserviceexportrequest-editor appscode-charts-oci/kubebindappscodecom-apiserviceexportrequest-editor -n default --create-namespace --version=v0.4.20 --set apiVersion=kube-bind.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i kubebindappscodecom-apiserviceexportrequest-editor appscode-charts-oci/kubebindappscodecom-apiserviceexportrequest-editor -n default --create-namespace --version=v0.4.20 --values values.yaml
```
