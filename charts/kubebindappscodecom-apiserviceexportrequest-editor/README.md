...
$ helm repo update
$ helm search repo appscode/kubebindappscodecom-apiserviceexportrequest-editor --version=v0.37.0
$ helm upgrade -i kubebindappscodecom-apiserviceexportrequest-editor appscode/kubebindappscodecom-apiserviceexportrequest-editor -n default --create-namespace --version=v0.37.0
```
...
```bash
$ helm upgrade -i kubebindappscodecom-apiserviceexportrequest-editor appscode/kubebindappscodecom-apiserviceexportrequest-editor -n default --create-namespace --version=v0.37.0 --set apiVersion=kube-bind.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i kubebindappscodecom-apiserviceexportrequest-editor appscode/kubebindappscodecom-apiserviceexportrequest-editor -n default --create-namespace --version=v0.37.0 --values values.yaml
```
