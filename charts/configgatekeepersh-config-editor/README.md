...
$ helm repo update
$ helm search repo bytebuilders-ui/configgatekeepersh-config-editor --version=v0.4.15
$ helm upgrade -i configgatekeepersh-config-editor bytebuilders-ui/configgatekeepersh-config-editor -n default --create-namespace --version=v0.4.15
```
...
```bash
$ helm upgrade -i configgatekeepersh-config-editor bytebuilders-ui/configgatekeepersh-config-editor -n default --create-namespace --version=v0.4.15 --set apiVersion=config.gatekeeper.sh/v1alpha1
```
...
```bash
$ helm upgrade -i configgatekeepersh-config-editor bytebuilders-ui/configgatekeepersh-config-editor -n default --create-namespace --version=v0.4.15 --values values.yaml
```
