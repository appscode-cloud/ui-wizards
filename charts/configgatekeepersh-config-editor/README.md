...
$ helm repo update
$ helm search repo appscode/configgatekeepersh-config-editor --version=v0.32.0
$ helm upgrade -i configgatekeepersh-config-editor appscode/configgatekeepersh-config-editor -n default --create-namespace --version=v0.32.0
```
...
```bash
$ helm upgrade -i configgatekeepersh-config-editor appscode/configgatekeepersh-config-editor -n default --create-namespace --version=v0.32.0 --set apiVersion=config.gatekeeper.sh/v1alpha1
```
...
```bash
$ helm upgrade -i configgatekeepersh-config-editor appscode/configgatekeepersh-config-editor -n default --create-namespace --version=v0.32.0 --values values.yaml
```
