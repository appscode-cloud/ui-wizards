...
$ helm repo update
$ helm search repo appscode-charts-oci/configgatekeepersh-config-editor --version=v0.4.21
$ helm upgrade -i configgatekeepersh-config-editor appscode-charts-oci/configgatekeepersh-config-editor -n default --create-namespace --version=v0.4.21
```
...
```bash
$ helm upgrade -i configgatekeepersh-config-editor appscode-charts-oci/configgatekeepersh-config-editor -n default --create-namespace --version=v0.4.21 --set apiVersion=config.gatekeeper.sh/v1alpha1
```
...
```bash
$ helm upgrade -i configgatekeepersh-config-editor appscode-charts-oci/configgatekeepersh-config-editor -n default --create-namespace --version=v0.4.21 --values values.yaml
```
