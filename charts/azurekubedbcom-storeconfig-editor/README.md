...
$ helm repo update
$ helm search repo appscode-charts-oci/azurekubedbcom-storeconfig-editor --version=v0.4.18
$ helm upgrade -i azurekubedbcom-storeconfig-editor appscode-charts-oci/azurekubedbcom-storeconfig-editor -n default --create-namespace --version=v0.4.18
```
...
```bash
$ helm upgrade -i azurekubedbcom-storeconfig-editor appscode-charts-oci/azurekubedbcom-storeconfig-editor -n default --create-namespace --version=v0.4.18 --set apiVersion=azure.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i azurekubedbcom-storeconfig-editor appscode-charts-oci/azurekubedbcom-storeconfig-editor -n default --create-namespace --version=v0.4.18 --values values.yaml
```
