...
$ helm repo update
$ helm search repo appscode/azurekubedbcom-storeconfig-editor --version=v0.14.0
$ helm upgrade -i azurekubedbcom-storeconfig-editor appscode/azurekubedbcom-storeconfig-editor -n default --create-namespace --version=v0.14.0
```
...
```bash
$ helm upgrade -i azurekubedbcom-storeconfig-editor appscode/azurekubedbcom-storeconfig-editor -n default --create-namespace --version=v0.14.0 --set apiVersion=azure.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i azurekubedbcom-storeconfig-editor appscode/azurekubedbcom-storeconfig-editor -n default --create-namespace --version=v0.14.0 --values values.yaml
```
