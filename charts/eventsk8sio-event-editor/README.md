...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/eventsk8sio-event-editor --version=v0.4.17
$ helm upgrade -i eventsk8sio-event-editor bytebuilders-ui-dev/eventsk8sio-event-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i eventsk8sio-event-editor bytebuilders-ui-dev/eventsk8sio-event-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=events.k8s.io/v1
```
...
```bash
$ helm upgrade -i eventsk8sio-event-editor bytebuilders-ui-dev/eventsk8sio-event-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
