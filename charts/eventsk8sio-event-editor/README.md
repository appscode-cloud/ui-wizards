...
$ helm repo update
$ helm search repo appscode-charts-oci/eventsk8sio-event-editor --version=v0.8.0
$ helm upgrade -i eventsk8sio-event-editor appscode-charts-oci/eventsk8sio-event-editor -n default --create-namespace --version=v0.8.0
```
...
```bash
$ helm upgrade -i eventsk8sio-event-editor appscode-charts-oci/eventsk8sio-event-editor -n default --create-namespace --version=v0.8.0 --set apiVersion=events.k8s.io/v1
```
...
```bash
$ helm upgrade -i eventsk8sio-event-editor appscode-charts-oci/eventsk8sio-event-editor -n default --create-namespace --version=v0.8.0 --values values.yaml
```
