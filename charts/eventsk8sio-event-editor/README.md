...
$ helm repo update
$ helm search repo bytebuilders-ui/eventsk8sio-event-editor --version=v0.3.1
$ helm upgrade -i eventsk8sio-event-editor bytebuilders-ui/eventsk8sio-event-editor -n default --create-namespace --version=v0.3.1
```
...
```bash
$ helm upgrade -i eventsk8sio-event-editor bytebuilders-ui/eventsk8sio-event-editor -n default --create-namespace --version=v0.3.1 --set apiVersion=events.k8s.io/v1
```
...
```bash
$ helm upgrade -i eventsk8sio-event-editor bytebuilders-ui/eventsk8sio-event-editor -n default --create-namespace --version=v0.3.1 --values values.yaml
```
