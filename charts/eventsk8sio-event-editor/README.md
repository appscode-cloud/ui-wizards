...
$ helm repo update
$ helm search repo appscode/eventsk8sio-event-editor --version=v0.19.0
$ helm upgrade -i eventsk8sio-event-editor appscode/eventsk8sio-event-editor -n default --create-namespace --version=v0.19.0
```
...
```bash
$ helm upgrade -i eventsk8sio-event-editor appscode/eventsk8sio-event-editor -n default --create-namespace --version=v0.19.0 --set apiVersion=events.k8s.io/v1
```
...
```bash
$ helm upgrade -i eventsk8sio-event-editor appscode/eventsk8sio-event-editor -n default --create-namespace --version=v0.19.0 --values values.yaml
```
