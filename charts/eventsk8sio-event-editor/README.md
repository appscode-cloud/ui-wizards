...
$ helm repo update
$ helm search repo bytebuilders-ui/eventsk8sio-event-editor --version=v0.4.5
$ helm upgrade -i eventsk8sio-event-editor bytebuilders-ui/eventsk8sio-event-editor -n default --create-namespace --version=v0.4.5
```
...
```bash
$ helm upgrade -i eventsk8sio-event-editor bytebuilders-ui/eventsk8sio-event-editor -n default --create-namespace --version=v0.4.5 --set apiVersion=events.k8s.io/v1
```
...
```bash
$ helm upgrade -i eventsk8sio-event-editor bytebuilders-ui/eventsk8sio-event-editor -n default --create-namespace --version=v0.4.5 --values values.yaml
```
