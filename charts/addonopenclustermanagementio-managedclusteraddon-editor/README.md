...
$ helm repo update
$ helm search repo appscode-charts-oci/addonopenclustermanagementio-managedclusteraddon-editor --version=v0.14.0
$ helm upgrade -i addonopenclustermanagementio-managedclusteraddon-editor appscode-charts-oci/addonopenclustermanagementio-managedclusteraddon-editor -n default --create-namespace --version=v0.14.0
```
...
```bash
$ helm upgrade -i addonopenclustermanagementio-managedclusteraddon-editor appscode-charts-oci/addonopenclustermanagementio-managedclusteraddon-editor -n default --create-namespace --version=v0.14.0 --set apiVersion=addon.open-cluster-management.io/v1alpha1
```
...
```bash
$ helm upgrade -i addonopenclustermanagementio-managedclusteraddon-editor appscode-charts-oci/addonopenclustermanagementio-managedclusteraddon-editor -n default --create-namespace --version=v0.14.0 --values values.yaml
```
