...
$ helm repo update
$ helm search repo appscode/authenticationk8sappscodecom-user-editor --version=v0.27.0
...
```bash
$ helm upgrade -i authenticationk8sappscodecom-user-editor appscode/authenticationk8sappscodecom-user-editor -n default --create-namespace --version=v0.27.0 --set apiVersion=authentication.k8s.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i authenticationk8sappscodecom-user-editor appscode/authenticationk8sappscodecom-user-editor -n default --create-namespace --version=v0.27.0 --values values.yaml
```
