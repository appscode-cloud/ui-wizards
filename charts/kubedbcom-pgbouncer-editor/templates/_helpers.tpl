...
*/}}
{{- define "kubedbcom-pgbouncer-editor.name" -}}
...
*/}}
{{- define "kubedbcom-pgbouncer-editor.fullname" -}}
...
*/}}
{{- define "kubedbcom-pgbouncer-editor.chart" -}}
...
Common labels
*/}}
{{- define "kubedbcom-pgbouncer-editor.labels" -}}
{{ include "kubedbcom-pgbouncer-editor.selectorLabels" . }}
...
Selector labels
*/}}
{{- define "kubedbcom-pgbouncer-editor.selectorLabels" -}}
app.kubernetes.io/name: pgbouncers.kubedb.com
app.kubernetes.io/instance: {{ include "kubedbcom-pgbouncer-editor.fullname" . }}
{{- end }}

{{/*
Create the name of the service account to use
*/}}
{{- define "kubedbcom-pgbouncer-editor.serviceAccountName" -}}
{{- if .Values.spec.serviceAccount.create }}
{{- default (include "kubedbcom-pgbouncer-editor.fullname" .) .Values.spec.serviceAccount.name }}
{{- else }}
...
Common annotations
*/}}
{{- define "kubedbcom-pgbouncer-editor.annotations" -}}
...
Alert labels
*/}}
{{- define "kubedbcom-pgbouncer-editor.alertLabels" -}}
...
Alert Enabled
*/}}
{{- define "kubedbcom-pgbouncer-editor.alertEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
