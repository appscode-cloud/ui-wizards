...
$ helm repo update
$ helm search repo appscode-charts-oci/dbforpostgresqlazurekubedbcom-serverkey-editor --version=v0.6.0
$ helm upgrade -i dbforpostgresqlazurekubedbcom-serverkey-editor appscode-charts-oci/dbforpostgresqlazurekubedbcom-serverkey-editor -n default --create-namespace --version=v0.6.0
```
...
```bash
$ helm upgrade -i dbforpostgresqlazurekubedbcom-serverkey-editor appscode-charts-oci/dbforpostgresqlazurekubedbcom-serverkey-editor -n default --create-namespace --version=v0.6.0 --set apiVersion=dbforpostgresql.azure.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i dbforpostgresqlazurekubedbcom-serverkey-editor appscode-charts-oci/dbforpostgresqlazurekubedbcom-serverkey-editor -n default --create-namespace --version=v0.6.0 --values values.yaml
```
