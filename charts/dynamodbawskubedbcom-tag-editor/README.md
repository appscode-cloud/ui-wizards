...
$ helm repo update
$ helm search repo appscode-charts-oci/dynamodbawskubedbcom-tag-editor --version=v0.8.0
$ helm upgrade -i dynamodbawskubedbcom-tag-editor appscode-charts-oci/dynamodbawskubedbcom-tag-editor -n default --create-namespace --version=v0.8.0
```
...
```bash
$ helm upgrade -i dynamodbawskubedbcom-tag-editor appscode-charts-oci/dynamodbawskubedbcom-tag-editor -n default --create-namespace --version=v0.8.0 --set apiVersion=dynamodb.aws.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i dynamodbawskubedbcom-tag-editor appscode-charts-oci/dynamodbawskubedbcom-tag-editor -n default --create-namespace --version=v0.8.0 --values values.yaml
```
