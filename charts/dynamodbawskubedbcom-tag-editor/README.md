...
$ helm repo update
$ helm search repo appscode/dynamodbawskubedbcom-tag-editor --version=v0.26.0
$ helm upgrade -i dynamodbawskubedbcom-tag-editor appscode/dynamodbawskubedbcom-tag-editor -n default --create-namespace --version=v0.26.0
```
...
```bash
$ helm upgrade -i dynamodbawskubedbcom-tag-editor appscode/dynamodbawskubedbcom-tag-editor -n default --create-namespace --version=v0.26.0 --set apiVersion=dynamodb.aws.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i dynamodbawskubedbcom-tag-editor appscode/dynamodbawskubedbcom-tag-editor -n default --create-namespace --version=v0.26.0 --values values.yaml
```
