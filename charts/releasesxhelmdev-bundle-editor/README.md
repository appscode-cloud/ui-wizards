...
$ helm repo update
$ helm search repo bytebuilders-ui/releasesxhelmdev-bundle-editor --version=v0.4.14
$ helm upgrade -i releasesxhelmdev-bundle-editor bytebuilders-ui/releasesxhelmdev-bundle-editor -n default --create-namespace --version=v0.4.14
```
...
```bash
$ helm upgrade -i releasesxhelmdev-bundle-editor bytebuilders-ui/releasesxhelmdev-bundle-editor -n default --create-namespace --version=v0.4.14 --set apiVersion=releases.x-helm.dev/v1alpha1
```
...
```bash
$ helm upgrade -i releasesxhelmdev-bundle-editor bytebuilders-ui/releasesxhelmdev-bundle-editor -n default --create-namespace --version=v0.4.14 --values values.yaml
```
