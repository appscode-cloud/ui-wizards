...
$ helm repo update
$ helm search repo appscode/releasesxhelmdev-bundle-editor --version=v0.37.0
$ helm upgrade -i releasesxhelmdev-bundle-editor appscode/releasesxhelmdev-bundle-editor -n default --create-namespace --version=v0.37.0
```
...
```bash
$ helm upgrade -i releasesxhelmdev-bundle-editor appscode/releasesxhelmdev-bundle-editor -n default --create-namespace --version=v0.37.0 --set apiVersion=releases.x-helm.dev/v1alpha1
```
...
```bash
$ helm upgrade -i releasesxhelmdev-bundle-editor appscode/releasesxhelmdev-bundle-editor -n default --create-namespace --version=v0.37.0 --values values.yaml
```
