...
$ helm repo update
$ helm search repo appscode/kafkakubedbcom-schemaregistry-editor --version=v0.19.0
$ helm upgrade -i kafkakubedbcom-schemaregistry-editor appscode/kafkakubedbcom-schemaregistry-editor -n default --create-namespace --version=v0.19.0
```
...
```bash
$ helm upgrade -i kafkakubedbcom-schemaregistry-editor appscode/kafkakubedbcom-schemaregistry-editor -n default --create-namespace --version=v0.19.0 --set apiVersion=kafka.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i kafkakubedbcom-schemaregistry-editor appscode/kafkakubedbcom-schemaregistry-editor -n default --create-namespace --version=v0.19.0 --values values.yaml
```
