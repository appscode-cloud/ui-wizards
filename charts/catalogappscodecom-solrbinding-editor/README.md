...
$ helm repo update
$ helm search repo appscode/catalogappscodecom-solrbinding-editor --version=v0.17.0
$ helm upgrade -i catalogappscodecom-solrbinding-editor appscode/catalogappscodecom-solrbinding-editor -n default --create-namespace --version=v0.17.0
```
...
```bash
$ helm upgrade -i catalogappscodecom-solrbinding-editor appscode/catalogappscodecom-solrbinding-editor -n default --create-namespace --version=v0.17.0 --set apiVersion=catalog.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i catalogappscodecom-solrbinding-editor appscode/catalogappscodecom-solrbinding-editor -n default --create-namespace --version=v0.17.0 --values values.yaml
```
