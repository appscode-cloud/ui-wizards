...
$ helm repo update
$ helm search repo appscode-charts-oci/catalogappscodecom-solrbinding-editor --version=v0.14.0
$ helm upgrade -i catalogappscodecom-solrbinding-editor appscode-charts-oci/catalogappscodecom-solrbinding-editor -n default --create-namespace --version=v0.14.0
```
...
```bash
$ helm upgrade -i catalogappscodecom-solrbinding-editor appscode-charts-oci/catalogappscodecom-solrbinding-editor -n default --create-namespace --version=v0.14.0 --set apiVersion=catalog.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i catalogappscodecom-solrbinding-editor appscode-charts-oci/catalogappscodecom-solrbinding-editor -n default --create-namespace --version=v0.14.0 --values values.yaml
```
