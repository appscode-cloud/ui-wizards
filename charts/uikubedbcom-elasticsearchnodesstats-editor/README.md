...
$ helm repo update
$ helm search repo appscode-charts-oci/uikubedbcom-elasticsearchnodesstats-editor --version=v0.13.0
$ helm upgrade -i uikubedbcom-elasticsearchnodesstats-editor appscode-charts-oci/uikubedbcom-elasticsearchnodesstats-editor -n default --create-namespace --version=v0.13.0
```
...
```bash
$ helm upgrade -i uikubedbcom-elasticsearchnodesstats-editor appscode-charts-oci/uikubedbcom-elasticsearchnodesstats-editor -n default --create-namespace --version=v0.13.0 --set apiVersion=ui.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i uikubedbcom-elasticsearchnodesstats-editor appscode-charts-oci/uikubedbcom-elasticsearchnodesstats-editor -n default --create-namespace --version=v0.13.0 --values values.yaml
```
