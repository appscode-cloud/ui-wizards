...
```bash
$ helm upgrade -i stashappscodecom-repository-editor appscode-charts-oci/stashappscodecom-repository-editor -n default --create-namespace --version=v0.10.0 --set metadata.resource.group=stash.appscode.com
```
