...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/stashappscodecom-repository-editor --version=v0.4.17
$ helm upgrade -i stashappscodecom-repository-editor bytebuilders-ui-dev/stashappscodecom-repository-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i stashappscodecom-repository-editor bytebuilders-ui-dev/stashappscodecom-repository-editor -n default --create-namespace --version=v0.4.17 --set metadata.resource.group=stash.appscode.com
```
...
```bash
$ helm upgrade -i stashappscodecom-repository-editor bytebuilders-ui-dev/stashappscodecom-repository-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
