...
$ helm repo update
$ helm install stashappscodecom-repository-editor bytebuilders-ui-dev/stashappscodecom-repository-editor -n default
```
...
```console
$ helm install stashappscodecom-repository-editor bytebuilders-ui-dev/stashappscodecom-repository-editor -n default --set apiVersion=stash.appscode.com/v1alpha1
```
...
```console
$ helm install stashappscodecom-repository-editor bytebuilders-ui-dev/stashappscodecom-repository-editor -n default --values values.yaml
```
