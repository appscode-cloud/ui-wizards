...
$ helm repo update
$ helm search repo appscode-charts-oci/stashappscodecom-repository-editor --version=v0.5.0
$ helm upgrade -i stashappscodecom-repository-editor appscode-charts-oci/stashappscodecom-repository-editor -n default --create-namespace --version=v0.5.0
```
...
```bash
$ helm upgrade -i stashappscodecom-repository-editor appscode-charts-oci/stashappscodecom-repository-editor -n default --create-namespace --version=v0.5.0 --values values.yaml
```
