...
$ helm repo update
$ helm search repo appscode/notificationtoolkitfluxcdio-provider-editor --version=v0.26.0
$ helm upgrade -i notificationtoolkitfluxcdio-provider-editor appscode/notificationtoolkitfluxcdio-provider-editor -n default --create-namespace --version=v0.26.0
```
...
```bash
$ helm upgrade -i notificationtoolkitfluxcdio-provider-editor appscode/notificationtoolkitfluxcdio-provider-editor -n default --create-namespace --version=v0.26.0 --set apiVersion=notification.toolkit.fluxcd.io/v1beta3
```
...
```bash
$ helm upgrade -i notificationtoolkitfluxcdio-provider-editor appscode/notificationtoolkitfluxcdio-provider-editor -n default --create-namespace --version=v0.26.0 --values values.yaml
```
