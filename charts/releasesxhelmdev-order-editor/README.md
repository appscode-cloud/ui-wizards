...
$ helm repo update
$ helm search repo appscode-charts-oci/releasesxhelmdev-order-editor --version=v0.13.0
$ helm upgrade -i releasesxhelmdev-order-editor appscode-charts-oci/releasesxhelmdev-order-editor -n default --create-namespace --version=v0.13.0
```
...
```bash
$ helm upgrade -i releasesxhelmdev-order-editor appscode-charts-oci/releasesxhelmdev-order-editor -n default --create-namespace --version=v0.13.0 --set apiVersion=releases.x-helm.dev/v1alpha1
```
...
```bash
$ helm upgrade -i releasesxhelmdev-order-editor appscode-charts-oci/releasesxhelmdev-order-editor -n default --create-namespace --version=v0.13.0 --values values.yaml
```
