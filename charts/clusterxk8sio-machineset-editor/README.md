...
$ helm repo update
$ helm search repo appscode/clusterxk8sio-machineset-editor --version=v0.29.0
$ helm upgrade -i clusterxk8sio-machineset-editor appscode/clusterxk8sio-machineset-editor -n default --create-namespace --version=v0.29.0
```
...
```bash
$ helm upgrade -i clusterxk8sio-machineset-editor appscode/clusterxk8sio-machineset-editor -n default --create-namespace --version=v0.29.0 --set apiVersion=cluster.x-k8s.io/v1beta1
```
...
```bash
$ helm upgrade -i clusterxk8sio-machineset-editor appscode/clusterxk8sio-machineset-editor -n default --create-namespace --version=v0.29.0 --values values.yaml
```
