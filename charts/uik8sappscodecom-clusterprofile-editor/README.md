...
$ helm repo update
$ helm search repo appscode/uik8sappscodecom-clusterprofile-editor --version=v0.27.0
...
```bash
$ helm upgrade -i uik8sappscodecom-clusterprofile-editor appscode/uik8sappscodecom-clusterprofile-editor -n default --create-namespace --version=v0.27.0 --set apiVersion=ui.k8s.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i uik8sappscodecom-clusterprofile-editor appscode/uik8sappscodecom-clusterprofile-editor -n default --create-namespace --version=v0.27.0 --values values.yaml
```
