...
$ helm repo update
$ helm search repo appscode/kubedbcom-perconaxtradb-editor --version=v0.35.0
$ helm upgrade -i kubedbcom-perconaxtradb-editor appscode/kubedbcom-perconaxtradb-editor -n default --create-namespace --version=v0.35.0
```
...
```bash
$ helm upgrade -i kubedbcom-perconaxtradb-editor appscode/kubedbcom-perconaxtradb-editor -n default --create-namespace --version=v0.35.0 --values values.yaml
```
