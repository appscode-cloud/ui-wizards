...
$ helm repo update
$ helm search repo appscode-charts-oci/kubedbcom-perconaxtradb-editor --version=v0.4.19
$ helm upgrade -i kubedbcom-perconaxtradb-editor appscode-charts-oci/kubedbcom-perconaxtradb-editor -n default --create-namespace --version=v0.4.19
```
...
```bash
$ helm upgrade -i kubedbcom-perconaxtradb-editor appscode-charts-oci/kubedbcom-perconaxtradb-editor -n default --create-namespace --version=v0.4.19 --set apiVersion=kubedb.com/v1alpha2
```
...
```bash
$ helm upgrade -i kubedbcom-perconaxtradb-editor appscode-charts-oci/kubedbcom-perconaxtradb-editor -n default --create-namespace --version=v0.4.19 --values values.yaml
```
