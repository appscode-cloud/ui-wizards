...
$ helm repo update
$ helm search repo bytebuilders-ui/kubedbcom-perconaxtradb-editor --version=v0.4.10
$ helm upgrade -i kubedbcom-perconaxtradb-editor bytebuilders-ui/kubedbcom-perconaxtradb-editor -n default --create-namespace --version=v0.4.10
```
...
```bash
$ helm upgrade -i kubedbcom-perconaxtradb-editor bytebuilders-ui/kubedbcom-perconaxtradb-editor -n default --create-namespace --version=v0.4.10 --set apiVersion=kubedb.com/v1alpha2
```
...
```bash
$ helm upgrade -i kubedbcom-perconaxtradb-editor bytebuilders-ui/kubedbcom-perconaxtradb-editor -n default --create-namespace --version=v0.4.10 --values values.yaml
```
