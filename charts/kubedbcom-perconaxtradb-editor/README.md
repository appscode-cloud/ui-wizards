...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/kubedbcom-perconaxtradb-editor --version=v0.4.17
$ helm upgrade -i kubedbcom-perconaxtradb-editor bytebuilders-ui-dev/kubedbcom-perconaxtradb-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i kubedbcom-perconaxtradb-editor bytebuilders-ui-dev/kubedbcom-perconaxtradb-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=kubedb.com/v1alpha2
```
...
```bash
$ helm upgrade -i kubedbcom-perconaxtradb-editor bytebuilders-ui-dev/kubedbcom-perconaxtradb-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
