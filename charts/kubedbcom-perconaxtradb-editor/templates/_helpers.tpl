...
*/}}
{{- define "kubedbcom-perconaxtradb-editor.name" -}}
...
*/}}
{{- define "kubedbcom-perconaxtradb-editor.fullname" -}}
...
*/}}
{{- define "kubedbcom-perconaxtradb-editor.chart" -}}
...
Common labels
*/}}
{{- define "kubedbcom-perconaxtradb-editor.labels" -}}
{{ include "kubedbcom-perconaxtradb-editor.selectorLabels" . }}
...
Selector labels
*/}}
{{- define "kubedbcom-perconaxtradb-editor.selectorLabels" -}}
app.kubernetes.io/name: perconaxtradbs.kubedb.com
app.kubernetes.io/instance: {{ include "kubedbcom-perconaxtradb-editor.fullname" . }}
{{- end }}

{{/*
Create the name of the service account to use
*/}}
{{- define "kubedbcom-perconaxtradb-editor.serviceAccountName" -}}
{{- if .Values.spec.serviceAccount.create }}
{{- default (include "kubedbcom-perconaxtradb-editor.fullname" .) .Values.spec.serviceAccount.name }}
{{- else }}
...
Common annotations
*/}}
{{- define "kubedbcom-perconaxtradb-editor.annotations" -}}
...
Alert Enabled
*/}}
{{- define "kubedbcom-perconaxtradb-editor.alertEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
