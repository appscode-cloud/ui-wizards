...
$ helm repo update
$ helm search repo bytebuilders-ui/stashappscodecom-backupbatch-editor --version=v0.3.1
$ helm upgrade -i stashappscodecom-backupbatch-editor bytebuilders-ui/stashappscodecom-backupbatch-editor -n default --create-namespace --version=v0.3.1
```
...
```bash
$ helm upgrade -i stashappscodecom-backupbatch-editor bytebuilders-ui/stashappscodecom-backupbatch-editor -n default --create-namespace --version=v0.3.1 --set apiVersion=stash.appscode.com/v1beta1
```
...
```bash
$ helm upgrade -i stashappscodecom-backupbatch-editor bytebuilders-ui/stashappscodecom-backupbatch-editor -n default --create-namespace --version=v0.3.1 --values values.yaml
```
