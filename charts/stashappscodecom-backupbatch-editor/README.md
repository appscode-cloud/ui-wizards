...
$ helm repo update
$ helm search repo appscode/stashappscodecom-backupbatch-editor --version=v0.37.0
$ helm upgrade -i stashappscodecom-backupbatch-editor appscode/stashappscodecom-backupbatch-editor -n default --create-namespace --version=v0.37.0
```
...
```bash
$ helm upgrade -i stashappscodecom-backupbatch-editor appscode/stashappscodecom-backupbatch-editor -n default --create-namespace --version=v0.37.0 --set apiVersion=stash.appscode.com/v1beta1
```
...
```bash
$ helm upgrade -i stashappscodecom-backupbatch-editor appscode/stashappscodecom-backupbatch-editor -n default --create-namespace --version=v0.37.0 --values values.yaml
```
