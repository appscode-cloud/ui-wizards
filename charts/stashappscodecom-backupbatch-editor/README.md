...
$ helm repo update
$ helm search repo bytebuilders-ui/stashappscodecom-backupbatch-editor --version=v0.4.6
$ helm upgrade -i stashappscodecom-backupbatch-editor bytebuilders-ui/stashappscodecom-backupbatch-editor -n default --create-namespace --version=v0.4.6
```
...
```bash
$ helm upgrade -i stashappscodecom-backupbatch-editor bytebuilders-ui/stashappscodecom-backupbatch-editor -n default --create-namespace --version=v0.4.6 --set apiVersion=stash.appscode.com/v1beta1
```
...
```bash
$ helm upgrade -i stashappscodecom-backupbatch-editor bytebuilders-ui/stashappscodecom-backupbatch-editor -n default --create-namespace --version=v0.4.6 --values values.yaml
```
