...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/authorizationk8sio-subjectaccessreview-editor --version=v0.4.17
$ helm upgrade -i authorizationk8sio-subjectaccessreview-editor bytebuilders-ui-dev/authorizationk8sio-subjectaccessreview-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i authorizationk8sio-subjectaccessreview-editor bytebuilders-ui-dev/authorizationk8sio-subjectaccessreview-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=authorization.k8s.io/v1
```
...
```bash
$ helm upgrade -i authorizationk8sio-subjectaccessreview-editor bytebuilders-ui-dev/authorizationk8sio-subjectaccessreview-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
