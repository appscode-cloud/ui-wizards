...
$ helm repo update
$ helm install imagepolicyk8sio-imagereview-editor bytebuilders-ui/imagepolicyk8sio-imagereview-editor -n default --version=v0.1.0
```
...
```console
$ helm install imagepolicyk8sio-imagereview-editor bytebuilders-ui/imagepolicyk8sio-imagereview-editor -n default --version=v0.1.0 --set apiVersion=imagepolicy.k8s.io/v1alpha1
```
...
```console
$ helm install imagepolicyk8sio-imagereview-editor bytebuilders-ui/imagepolicyk8sio-imagereview-editor -n default --version=v0.1.0 --values values.yaml
```
