...
$ helm repo update
$ helm search repo bytebuilders-ui/imagepolicyk8sio-imagereview-editor --version=v0.4.10
$ helm upgrade -i imagepolicyk8sio-imagereview-editor bytebuilders-ui/imagepolicyk8sio-imagereview-editor -n default --create-namespace --version=v0.4.10
```
...
```bash
$ helm upgrade -i imagepolicyk8sio-imagereview-editor bytebuilders-ui/imagepolicyk8sio-imagereview-editor -n default --create-namespace --version=v0.4.10 --set apiVersion=imagepolicy.k8s.io/v1alpha1
```
...
```bash
$ helm upgrade -i imagepolicyk8sio-imagereview-editor bytebuilders-ui/imagepolicyk8sio-imagereview-editor -n default --create-namespace --version=v0.4.10 --values values.yaml
```
