...
$ helm repo update
$ helm search repo appscode-charts-oci/imagepolicyk8sio-imagereview-editor --version=v0.4.18
$ helm upgrade -i imagepolicyk8sio-imagereview-editor appscode-charts-oci/imagepolicyk8sio-imagereview-editor -n default --create-namespace --version=v0.4.18
```
...
```bash
$ helm upgrade -i imagepolicyk8sio-imagereview-editor appscode-charts-oci/imagepolicyk8sio-imagereview-editor -n default --create-namespace --version=v0.4.18 --set apiVersion=imagepolicy.k8s.io/v1alpha1
```
...
```bash
$ helm upgrade -i imagepolicyk8sio-imagereview-editor appscode-charts-oci/imagepolicyk8sio-imagereview-editor -n default --create-namespace --version=v0.4.18 --values values.yaml
```
