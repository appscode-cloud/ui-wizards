...
$ helm repo update
$ helm search repo bytebuilders-ui/authenticationk8sio-tokenreview-editor --version=v0.4.12
$ helm upgrade -i authenticationk8sio-tokenreview-editor bytebuilders-ui/authenticationk8sio-tokenreview-editor -n default --create-namespace --version=v0.4.12
```
...
```bash
$ helm upgrade -i authenticationk8sio-tokenreview-editor bytebuilders-ui/authenticationk8sio-tokenreview-editor -n default --create-namespace --version=v0.4.12 --set apiVersion=authentication.k8s.io/v1
```
...
```bash
$ helm upgrade -i authenticationk8sio-tokenreview-editor bytebuilders-ui/authenticationk8sio-tokenreview-editor -n default --create-namespace --version=v0.4.12 --values values.yaml
```
