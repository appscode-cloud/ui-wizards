...
$ helm repo update
$ helm search repo appscode/authenticationk8sio-tokenreview-editor --version=v0.28.0
$ helm upgrade -i authenticationk8sio-tokenreview-editor appscode/authenticationk8sio-tokenreview-editor -n default --create-namespace --version=v0.28.0
```
...
```bash
$ helm upgrade -i authenticationk8sio-tokenreview-editor appscode/authenticationk8sio-tokenreview-editor -n default --create-namespace --version=v0.28.0 --set apiVersion=authentication.k8s.io/v1
```
...
```bash
$ helm upgrade -i authenticationk8sio-tokenreview-editor appscode/authenticationk8sio-tokenreview-editor -n default --create-namespace --version=v0.28.0 --values values.yaml
```
