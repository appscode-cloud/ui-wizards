...
$ helm repo update
$ helm search repo bytebuilders-ui/authenticationk8sio-tokenreview-editor --version=v0.4.10
$ helm upgrade -i authenticationk8sio-tokenreview-editor bytebuilders-ui/authenticationk8sio-tokenreview-editor -n default --create-namespace --version=v0.4.10
```
...
```bash
$ helm upgrade -i authenticationk8sio-tokenreview-editor bytebuilders-ui/authenticationk8sio-tokenreview-editor -n default --create-namespace --version=v0.4.10 --set apiVersion=authentication.k8s.io/v1
```
...
```bash
$ helm upgrade -i authenticationk8sio-tokenreview-editor bytebuilders-ui/authenticationk8sio-tokenreview-editor -n default --create-namespace --version=v0.4.10 --values values.yaml
```
