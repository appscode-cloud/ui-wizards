...
$ helm repo update
$ helm search repo appscode-charts-oci/enginekubevaultcom-mysqlrole-editor --version=v0.6.0
$ helm upgrade -i enginekubevaultcom-mysqlrole-editor appscode-charts-oci/enginekubevaultcom-mysqlrole-editor -n default --create-namespace --version=v0.6.0
```
...
```bash
$ helm upgrade -i enginekubevaultcom-mysqlrole-editor appscode-charts-oci/enginekubevaultcom-mysqlrole-editor -n default --create-namespace --version=v0.6.0 --set apiVersion=engine.kubevault.com/v1alpha1
```
...
```bash
$ helm upgrade -i enginekubevaultcom-mysqlrole-editor appscode-charts-oci/enginekubevaultcom-mysqlrole-editor -n default --create-namespace --version=v0.6.0 --values values.yaml
```
