...
*/}}
{{- define "kubedbcom-cassandra-editor.name" -}}
...
*/}}
{{- define "kubedbcom-cassandra-editor.fullname" -}}
...
*/}}
{{- define "kubedbcom-cassandra-editor.chart" -}}
...
Common labels
*/}}
{{- define "kubedbcom-cassandra-editor.labels" -}}
{{ include "kubedbcom-cassandra-editor.selectorLabels" . }}
...
Selector labels
*/}}
{{- define "kubedbcom-cassandra-editor.selectorLabels" -}}
app.kubernetes.io/name: cassandras.kubedb.com
app.kubernetes.io/instance: {{ include "kubedbcom-cassandra-editor.fullname" . }}
{{- end }}

{{/*
Create the name of the service account to use
*/}}
{{- define "kubedbcom-cassandra-editor.serviceAccountName" -}}
{{- if .Values.spec.serviceAccount.create }}
{{- default (include "kubedbcom-cassandra-editor.fullname" .) .Values.spec.serviceAccount.name }}
{{- else }}
...
Common annotations
*/}}
{{- define "kubedbcom-cassandra-editor.annotations" -}}
...
Alert labels
*/}}
{{- define "kubedbcom-cassandra-editor.alertLabels" -}}
...
Alert Enabled
*/}}
{{- define "kubedbcom-cassandra-editor.alertEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
