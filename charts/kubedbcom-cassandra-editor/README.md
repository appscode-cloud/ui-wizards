...
$ helm repo update
$ helm search repo appscode-charts-oci/kubedbcom-cassandra-editor --version=v0.11.0
...
```bash
$ helm upgrade -i kubedbcom-cassandra-editor appscode-charts-oci/kubedbcom-cassandra-editor -n default --create-namespace --version=v0.11.0 --set apiVersion=kubedb.com/v1alpha2
```
...
```bash
$ helm upgrade -i kubedbcom-cassandra-editor appscode-charts-oci/kubedbcom-cassandra-editor -n default --create-namespace --version=v0.11.0 --values values.yaml
```
