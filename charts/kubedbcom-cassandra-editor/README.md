...
$ helm repo update
$ helm search repo appscode/kubedbcom-cassandra-editor --version=v0.16.0
$ helm upgrade -i kubedbcom-cassandra-editor appscode/kubedbcom-cassandra-editor -n default --create-namespace --version=v0.16.0
```
...
```bash
$ helm upgrade -i kubedbcom-cassandra-editor appscode/kubedbcom-cassandra-editor -n default --create-namespace --version=v0.16.0 --set apiVersion=kubedb.com/v1alpha2
```
...
```bash
$ helm upgrade -i kubedbcom-cassandra-editor appscode/kubedbcom-cassandra-editor -n default --create-namespace --version=v0.16.0 --values values.yaml
```
