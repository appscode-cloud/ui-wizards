...
$ helm repo update
$ helm search repo appscode-charts-oci/uikubedbcom-mariadbinsight-editor --version=v0.4.20
$ helm upgrade -i uikubedbcom-mariadbinsight-editor appscode-charts-oci/uikubedbcom-mariadbinsight-editor -n default --create-namespace --version=v0.4.20
```
...
```bash
$ helm upgrade -i uikubedbcom-mariadbinsight-editor appscode-charts-oci/uikubedbcom-mariadbinsight-editor -n default --create-namespace --version=v0.4.20 --set apiVersion=ui.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i uikubedbcom-mariadbinsight-editor appscode-charts-oci/uikubedbcom-mariadbinsight-editor -n default --create-namespace --version=v0.4.20 --values values.yaml
```
