...
$ helm repo update
$ helm search repo bytebuilders-ui/addonopenclustermanagementio-addontemplate-editor --version=v0.4.16
$ helm upgrade -i addonopenclustermanagementio-addontemplate-editor bytebuilders-ui/addonopenclustermanagementio-addontemplate-editor -n default --create-namespace --version=v0.4.16
```
...
```bash
$ helm upgrade -i addonopenclustermanagementio-addontemplate-editor bytebuilders-ui/addonopenclustermanagementio-addontemplate-editor -n default --create-namespace --version=v0.4.16 --set apiVersion=addon.open-cluster-management.io/v1alpha1
```
...
```bash
$ helm upgrade -i addonopenclustermanagementio-addontemplate-editor bytebuilders-ui/addonopenclustermanagementio-addontemplate-editor -n default --create-namespace --version=v0.4.16 --values values.yaml
```
