...
$ helm repo update
$ helm search repo appscode-charts-oci/addonopenclustermanagementio-addontemplate-editor --version=v0.4.20
$ helm upgrade -i addonopenclustermanagementio-addontemplate-editor appscode-charts-oci/addonopenclustermanagementio-addontemplate-editor -n default --create-namespace --version=v0.4.20
```
...
```bash
$ helm upgrade -i addonopenclustermanagementio-addontemplate-editor appscode-charts-oci/addonopenclustermanagementio-addontemplate-editor -n default --create-namespace --version=v0.4.20 --set apiVersion=addon.open-cluster-management.io/v1alpha1
```
...
```bash
$ helm upgrade -i addonopenclustermanagementio-addontemplate-editor appscode-charts-oci/addonopenclustermanagementio-addontemplate-editor -n default --create-namespace --version=v0.4.20 --values values.yaml
```
