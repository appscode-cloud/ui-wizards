...
$ helm repo update
$ helm search repo appscode/schemakubedbcom-mariadbdatabase-editor --version=v0.29.0
$ helm upgrade -i schemakubedbcom-mariadbdatabase-editor appscode/schemakubedbcom-mariadbdatabase-editor -n default --create-namespace --version=v0.29.0
```
...
```bash
$ helm upgrade -i schemakubedbcom-mariadbdatabase-editor appscode/schemakubedbcom-mariadbdatabase-editor -n default --create-namespace --version=v0.29.0 --set apiVersion=schema.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i schemakubedbcom-mariadbdatabase-editor appscode/schemakubedbcom-mariadbdatabase-editor -n default --create-namespace --version=v0.29.0 --values values.yaml
```
