...
const modeDetails = {
  Standalone: {
    description: 'Single node HanaDB without high availability.',
    text: 'Standalone',
  },
  SystemReplication: {
    description: 'HanaDB System Replication for high availability and disaster recovery.',
    text: 'System Replication',
  },
}
...
export const useFunc = (model) => {
  ...
  async function initBundle() {
    ...
    if (!getValue(model, `/spec/admin/databases/HanaDB/mode/toggle`)) {
      ...
      if (defMode === '') {
        const arr = getValue(model, '/spec/admin/databases/HanaDB/mode/available') || []
