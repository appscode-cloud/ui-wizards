...
const modeDetails = {
  ...
  DataGuard: {
    description: 'HanaDB Data Guard for high availability, data protection, and disaster recovery',
    text: 'DataGuard',
  },
}
...
export const useFunc = (model) => {
  ...
  async function initBundle() {
    ...
    if (!getValue(model, `/spec/admin/databases/HanaDB/mode/toggle`)) {
      ...
      if (defMode === '') {
        const arr = getValue(model, '/spec/databases/HanaDB/mode/available') || []
