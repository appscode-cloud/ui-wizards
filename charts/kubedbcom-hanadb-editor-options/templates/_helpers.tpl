...
*/}}
{{- define "kubedbcom-hanadb-editor-options.name" -}}
...
*/}}
{{- define "kubedbcom-hanadb-editor-options.fullname" -}}
...
*/}}
{{- define "kubedbcom-hanadb-editor-options.chart" -}}
...
Common labels
*/}}
{{- define "kubedbcom-hanadb-editor-options.labels" -}}
{{ include "kubedbcom-hanadb-editor-options.selectorLabels" . }}
...
Selector labels
*/}}
{{- define "kubedbcom-hanadb-editor-options.selectorLabels" -}}
app.kubernetes.io/name: hanadbs.kubedb.com
app.kubernetes.io/instance: {{ include "kubedbcom-hanadb-editor-options.fullname" . }}
{{- end }}

{{/*
Create the name of the service account to use
*/}}
{{- define "kubedbcom-hanadb-editor-options.serviceAccountName" -}}
{{- if .Values.spec.serviceAccount.create }}
{{- default (include "kubedbcom-hanadb-editor-options.fullname" .) .Values.spec.serviceAccount.name }}
{{- else }}
...
Common annotations
*/}}
{{- define "kubedbcom-hanadb-editor-options.annotations" -}}
...
Alert Enabled
*/}}
{{- define "kubedbcom-hanadb-editor-options.alertEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
