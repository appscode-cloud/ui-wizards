...
$ helm repo update
$ helm search repo appscode/schemakubedbcom-mysqldatabase-editor --version=v0.34.0
$ helm upgrade -i schemakubedbcom-mysqldatabase-editor appscode/schemakubedbcom-mysqldatabase-editor -n default --create-namespace --version=v0.34.0
```
...
```bash
$ helm upgrade -i schemakubedbcom-mysqldatabase-editor appscode/schemakubedbcom-mysqldatabase-editor -n default --create-namespace --version=v0.34.0 --set apiVersion=schema.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i schemakubedbcom-mysqldatabase-editor appscode/schemakubedbcom-mysqldatabase-editor -n default --create-namespace --version=v0.34.0 --values values.yaml
```
