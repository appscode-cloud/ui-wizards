...
$ helm repo update
$ helm search repo appscode-charts-oci/schemakubedbcom-mysqldatabase-editor --version=v0.4.18
$ helm upgrade -i schemakubedbcom-mysqldatabase-editor appscode-charts-oci/schemakubedbcom-mysqldatabase-editor -n default --create-namespace --version=v0.4.18
```
...
```bash
$ helm upgrade -i schemakubedbcom-mysqldatabase-editor appscode-charts-oci/schemakubedbcom-mysqldatabase-editor -n default --create-namespace --version=v0.4.18 --set apiVersion=schema.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i schemakubedbcom-mysqldatabase-editor appscode-charts-oci/schemakubedbcom-mysqldatabase-editor -n default --create-namespace --version=v0.4.18 --values values.yaml
```
