...
$ helm repo update
$ helm search repo appscode-charts-oci/schemakubedbcom-mysqldatabase-editor --version=v0.4.19
$ helm upgrade -i schemakubedbcom-mysqldatabase-editor appscode-charts-oci/schemakubedbcom-mysqldatabase-editor -n default --create-namespace --version=v0.4.19
```
...
```bash
$ helm upgrade -i schemakubedbcom-mysqldatabase-editor appscode-charts-oci/schemakubedbcom-mysqldatabase-editor -n default --create-namespace --version=v0.4.19 --set apiVersion=schema.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i schemakubedbcom-mysqldatabase-editor appscode-charts-oci/schemakubedbcom-mysqldatabase-editor -n default --create-namespace --version=v0.4.19 --values values.yaml
```
