...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/dbformariadbazurekubeformcom-server-editor --version=v0.4.17
$ helm upgrade -i dbformariadbazurekubeformcom-server-editor bytebuilders-ui-dev/dbformariadbazurekubeformcom-server-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i dbformariadbazurekubeformcom-server-editor bytebuilders-ui-dev/dbformariadbazurekubeformcom-server-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=dbformariadb.azure.kubeform.com/v1alpha1
```
...
```bash
$ helm upgrade -i dbformariadbazurekubeformcom-server-editor bytebuilders-ui-dev/dbformariadbazurekubeformcom-server-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
