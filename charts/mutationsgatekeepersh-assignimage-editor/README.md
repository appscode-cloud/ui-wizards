...
$ helm repo update
$ helm search repo bytebuilders-ui/mutationsgatekeepersh-assignimage-editor --version=v0.4.16
$ helm upgrade -i mutationsgatekeepersh-assignimage-editor bytebuilders-ui/mutationsgatekeepersh-assignimage-editor -n default --create-namespace --version=v0.4.16
```
...
```bash
$ helm upgrade -i mutationsgatekeepersh-assignimage-editor bytebuilders-ui/mutationsgatekeepersh-assignimage-editor -n default --create-namespace --version=v0.4.16 --set apiVersion=mutations.gatekeeper.sh/v1alpha1
```
...
```bash
$ helm upgrade -i mutationsgatekeepersh-assignimage-editor bytebuilders-ui/mutationsgatekeepersh-assignimage-editor -n default --create-namespace --version=v0.4.16 --values values.yaml
```
