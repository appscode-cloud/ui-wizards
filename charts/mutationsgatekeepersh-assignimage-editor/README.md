...
$ helm repo update
$ helm search repo appscode-charts-oci/mutationsgatekeepersh-assignimage-editor --version=v0.4.20
$ helm upgrade -i mutationsgatekeepersh-assignimage-editor appscode-charts-oci/mutationsgatekeepersh-assignimage-editor -n default --create-namespace --version=v0.4.20
```
...
```bash
$ helm upgrade -i mutationsgatekeepersh-assignimage-editor appscode-charts-oci/mutationsgatekeepersh-assignimage-editor -n default --create-namespace --version=v0.4.20 --set apiVersion=mutations.gatekeeper.sh/v1alpha1
```
...
```bash
$ helm upgrade -i mutationsgatekeepersh-assignimage-editor appscode-charts-oci/mutationsgatekeepersh-assignimage-editor -n default --create-namespace --version=v0.4.20 --values values.yaml
```
