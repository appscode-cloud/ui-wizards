...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/addonopenclustermanagementio-addondeploymentconfig-editor --version=v0.4.17
$ helm upgrade -i addonopenclustermanagementio-addondeploymentconfig-editor bytebuilders-ui-dev/addonopenclustermanagementio-addondeploymentconfig-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i addonopenclustermanagementio-addondeploymentconfig-editor bytebuilders-ui-dev/addonopenclustermanagementio-addondeploymentconfig-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=addon.open-cluster-management.io/v1alpha1
```
...
```bash
$ helm upgrade -i addonopenclustermanagementio-addondeploymentconfig-editor bytebuilders-ui-dev/addonopenclustermanagementio-addondeploymentconfig-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
