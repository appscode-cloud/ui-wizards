...
$ helm repo update
$ helm search repo appscode-charts-oci/gcpkubedbcom-providerconfig-editor --version=v0.4.20
$ helm upgrade -i gcpkubedbcom-providerconfig-editor appscode-charts-oci/gcpkubedbcom-providerconfig-editor -n default --create-namespace --version=v0.4.20
```
...
```bash
$ helm upgrade -i gcpkubedbcom-providerconfig-editor appscode-charts-oci/gcpkubedbcom-providerconfig-editor -n default --create-namespace --version=v0.4.20 --set apiVersion=gcp.kubedb.com/v1beta1
```
...
```bash
$ helm upgrade -i gcpkubedbcom-providerconfig-editor appscode-charts-oci/gcpkubedbcom-providerconfig-editor -n default --create-namespace --version=v0.4.20 --values values.yaml
```
