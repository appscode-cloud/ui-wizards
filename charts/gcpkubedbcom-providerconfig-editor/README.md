...
$ helm repo update
$ helm search repo appscode/gcpkubedbcom-providerconfig-editor --version=v0.29.0
$ helm upgrade -i gcpkubedbcom-providerconfig-editor appscode/gcpkubedbcom-providerconfig-editor -n default --create-namespace --version=v0.29.0
```
...
```bash
$ helm upgrade -i gcpkubedbcom-providerconfig-editor appscode/gcpkubedbcom-providerconfig-editor -n default --create-namespace --version=v0.29.0 --set apiVersion=gcp.kubedb.com/v1beta1
```
...
```bash
$ helm upgrade -i gcpkubedbcom-providerconfig-editor appscode/gcpkubedbcom-providerconfig-editor -n default --create-namespace --version=v0.29.0 --values values.yaml
```
