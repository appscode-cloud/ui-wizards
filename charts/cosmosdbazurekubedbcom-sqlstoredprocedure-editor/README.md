...
$ helm repo update
$ helm search repo appscode-charts-oci/cosmosdbazurekubedbcom-sqlstoredprocedure-editor --version=v0.4.19
$ helm upgrade -i cosmosdbazurekubedbcom-sqlstoredprocedure-editor appscode-charts-oci/cosmosdbazurekubedbcom-sqlstoredprocedure-editor -n default --create-namespace --version=v0.4.19
```
...
```bash
$ helm upgrade -i cosmosdbazurekubedbcom-sqlstoredprocedure-editor appscode-charts-oci/cosmosdbazurekubedbcom-sqlstoredprocedure-editor -n default --create-namespace --version=v0.4.19 --set apiVersion=cosmosdb.azure.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i cosmosdbazurekubedbcom-sqlstoredprocedure-editor appscode-charts-oci/cosmosdbazurekubedbcom-sqlstoredprocedure-editor -n default --create-namespace --version=v0.4.19 --values values.yaml
```
