...
$ helm repo update
$ helm search repo appscode/courierkubedbcom-mariadbmigration-editor --version=v0.37.0
$ helm upgrade -i courierkubedbcom-mariadbmigration-editor appscode/courierkubedbcom-mariadbmigration-editor -n default --create-namespace --version=v0.37.0
```
...
```bash
$ helm upgrade -i courierkubedbcom-mariadbmigration-editor appscode/courierkubedbcom-mariadbmigration-editor -n default --create-namespace --version=v0.37.0 --set apiVersion=courier.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i courierkubedbcom-mariadbmigration-editor appscode/courierkubedbcom-mariadbmigration-editor -n default --create-namespace --version=v0.37.0 --values values.yaml
```
