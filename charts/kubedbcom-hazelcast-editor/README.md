...
$ helm repo update
$ helm search repo appscode/kubedbcom-hazelcast-editor --version=v0.35.0
$ helm upgrade -i kubedbcom-hazelcast-editor appscode/kubedbcom-hazelcast-editor -n default --create-namespace --version=v0.35.0
```
...
```bash
$ helm upgrade -i kubedbcom-hazelcast-editor appscode/kubedbcom-hazelcast-editor -n default --create-namespace --version=v0.35.0 --values values.yaml
```
