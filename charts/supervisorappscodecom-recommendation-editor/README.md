...
$ helm repo update
$ helm search repo bytebuilders-ui/supervisorappscodecom-recommendation-editor --version=v0.4.15
$ helm upgrade -i supervisorappscodecom-recommendation-editor bytebuilders-ui/supervisorappscodecom-recommendation-editor -n default --create-namespace --version=v0.4.15
```
...
```bash
$ helm upgrade -i supervisorappscodecom-recommendation-editor bytebuilders-ui/supervisorappscodecom-recommendation-editor -n default --create-namespace --version=v0.4.15 --set apiVersion=supervisor.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i supervisorappscodecom-recommendation-editor bytebuilders-ui/supervisorappscodecom-recommendation-editor -n default --create-namespace --version=v0.4.15 --values values.yaml
```
