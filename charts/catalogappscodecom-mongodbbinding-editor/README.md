...
$ helm repo update
$ helm search repo appscode-charts-oci/catalogappscodecom-mongodbbinding-editor --version=v0.14.0
$ helm upgrade -i catalogappscodecom-mongodbbinding-editor appscode-charts-oci/catalogappscodecom-mongodbbinding-editor -n default --create-namespace --version=v0.14.0
```
...
```bash
$ helm upgrade -i catalogappscodecom-mongodbbinding-editor appscode-charts-oci/catalogappscodecom-mongodbbinding-editor -n default --create-namespace --version=v0.14.0 --set apiVersion=catalog.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i catalogappscodecom-mongodbbinding-editor appscode-charts-oci/catalogappscodecom-mongodbbinding-editor -n default --create-namespace --version=v0.14.0 --values values.yaml
```
