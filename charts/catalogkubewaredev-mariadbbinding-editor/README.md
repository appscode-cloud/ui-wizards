...
$ helm repo update
$ helm search repo appscode-charts-oci/catalogkubewaredev-mariadbbinding-editor --version=v0.11.0
...
```bash
$ helm upgrade -i catalogkubewaredev-mariadbbinding-editor appscode-charts-oci/catalogkubewaredev-mariadbbinding-editor -n default --create-namespace --version=v0.11.0 --set apiVersion=catalog.kubeware.dev/v1alpha1
```
...
```bash
$ helm upgrade -i catalogkubewaredev-mariadbbinding-editor appscode-charts-oci/catalogkubewaredev-mariadbbinding-editor -n default --create-namespace --version=v0.11.0 --values values.yaml
```
