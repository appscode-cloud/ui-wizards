...
$ helm repo update
$ helm search repo bytebuilders-ui/clusterxk8sio-cluster-editor --version=v0.4.14
$ helm upgrade -i clusterxk8sio-cluster-editor bytebuilders-ui/clusterxk8sio-cluster-editor -n default --create-namespace --version=v0.4.14
```
...
```bash
$ helm upgrade -i clusterxk8sio-cluster-editor bytebuilders-ui/clusterxk8sio-cluster-editor -n default --create-namespace --version=v0.4.14 --set apiVersion=cluster.x-k8s.io/v1beta1
```
...
```bash
$ helm upgrade -i clusterxk8sio-cluster-editor bytebuilders-ui/clusterxk8sio-cluster-editor -n default --create-namespace --version=v0.4.14 --values values.yaml
```
