...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/metricsappscodecom-metricsconfiguration-editor --version=v0.4.17
$ helm upgrade -i metricsappscodecom-metricsconfiguration-editor bytebuilders-ui-dev/metricsappscodecom-metricsconfiguration-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i metricsappscodecom-metricsconfiguration-editor bytebuilders-ui-dev/metricsappscodecom-metricsconfiguration-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=metrics.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i metricsappscodecom-metricsconfiguration-editor bytebuilders-ui-dev/metricsappscodecom-metricsconfiguration-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
