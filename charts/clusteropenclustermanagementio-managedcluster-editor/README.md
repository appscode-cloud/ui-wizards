...
$ helm repo update
$ helm search repo bytebuilders-ui/clusteropenclustermanagementio-managedcluster-editor --version=v0.4.18
$ helm upgrade -i clusteropenclustermanagementio-managedcluster-editor bytebuilders-ui/clusteropenclustermanagementio-managedcluster-editor -n default --create-namespace --version=v0.4.18
```
...
```bash
$ helm upgrade -i clusteropenclustermanagementio-managedcluster-editor bytebuilders-ui/clusteropenclustermanagementio-managedcluster-editor -n default --create-namespace --version=v0.4.18 --set apiVersion=cluster.open-cluster-management.io/v1
```
...
```bash
$ helm upgrade -i clusteropenclustermanagementio-managedcluster-editor bytebuilders-ui/clusteropenclustermanagementio-managedcluster-editor -n default --create-namespace --version=v0.4.18 --values values.yaml
```
