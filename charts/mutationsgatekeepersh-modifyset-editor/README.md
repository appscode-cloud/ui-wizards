...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/mutationsgatekeepersh-modifyset-editor --version=v0.4.17
$ helm upgrade -i mutationsgatekeepersh-modifyset-editor bytebuilders-ui-dev/mutationsgatekeepersh-modifyset-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i mutationsgatekeepersh-modifyset-editor bytebuilders-ui-dev/mutationsgatekeepersh-modifyset-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=mutations.gatekeeper.sh/v1
```
...
```bash
$ helm upgrade -i mutationsgatekeepersh-modifyset-editor bytebuilders-ui-dev/mutationsgatekeepersh-modifyset-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
