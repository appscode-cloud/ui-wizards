...
$ helm repo update
$ helm search repo bytebuilders-ui/mutationsgatekeepersh-modifyset-editor --version=v0.4.14
$ helm upgrade -i mutationsgatekeepersh-modifyset-editor bytebuilders-ui/mutationsgatekeepersh-modifyset-editor -n default --create-namespace --version=v0.4.14
```
...
```bash
$ helm upgrade -i mutationsgatekeepersh-modifyset-editor bytebuilders-ui/mutationsgatekeepersh-modifyset-editor -n default --create-namespace --version=v0.4.14 --set apiVersion=mutations.gatekeeper.sh/v1
```
...
```bash
$ helm upgrade -i mutationsgatekeepersh-modifyset-editor bytebuilders-ui/mutationsgatekeepersh-modifyset-editor -n default --create-namespace --version=v0.4.14 --values values.yaml
```
