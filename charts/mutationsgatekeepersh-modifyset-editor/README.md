...
$ helm repo update
$ helm search repo appscode/mutationsgatekeepersh-modifyset-editor --version=v0.16.0
$ helm upgrade -i mutationsgatekeepersh-modifyset-editor appscode/mutationsgatekeepersh-modifyset-editor -n default --create-namespace --version=v0.16.0
```
...
```bash
$ helm upgrade -i mutationsgatekeepersh-modifyset-editor appscode/mutationsgatekeepersh-modifyset-editor -n default --create-namespace --version=v0.16.0 --set apiVersion=mutations.gatekeeper.sh/v1
```
...
```bash
$ helm upgrade -i mutationsgatekeepersh-modifyset-editor appscode/mutationsgatekeepersh-modifyset-editor -n default --create-namespace --version=v0.16.0 --values values.yaml
```
