...
$ helm repo update
$ helm search repo appscode-charts-oci/opskubedbcom-pgbounceropsrequest-editor --version=v0.14.0
$ helm upgrade -i opskubedbcom-pgbounceropsrequest-editor appscode-charts-oci/opskubedbcom-pgbounceropsrequest-editor -n default --create-namespace --version=v0.14.0
```
...
```bash
$ helm upgrade -i opskubedbcom-pgbounceropsrequest-editor appscode-charts-oci/opskubedbcom-pgbounceropsrequest-editor -n default --create-namespace --version=v0.14.0 --set apiVersion=ops.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i opskubedbcom-pgbounceropsrequest-editor appscode-charts-oci/opskubedbcom-pgbounceropsrequest-editor -n default --create-namespace --version=v0.14.0 --values values.yaml
```
