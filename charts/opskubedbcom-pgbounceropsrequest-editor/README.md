...
$ helm repo update
$ helm search repo appscode/opskubedbcom-pgbounceropsrequest-editor --version=v0.29.0
$ helm upgrade -i opskubedbcom-pgbounceropsrequest-editor appscode/opskubedbcom-pgbounceropsrequest-editor -n default --create-namespace --version=v0.29.0
```
...
```bash
$ helm upgrade -i opskubedbcom-pgbounceropsrequest-editor appscode/opskubedbcom-pgbounceropsrequest-editor -n default --create-namespace --version=v0.29.0 --set apiVersion=ops.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i opskubedbcom-pgbounceropsrequest-editor appscode/opskubedbcom-pgbounceropsrequest-editor -n default --create-namespace --version=v0.29.0 --values values.yaml
```
