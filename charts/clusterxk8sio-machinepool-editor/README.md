...
$ helm repo update
$ helm search repo appscode-charts-oci/clusterxk8sio-machinepool-editor --version=v0.4.18
$ helm upgrade -i clusterxk8sio-machinepool-editor appscode-charts-oci/clusterxk8sio-machinepool-editor -n default --create-namespace --version=v0.4.18
```
...
```bash
$ helm upgrade -i clusterxk8sio-machinepool-editor appscode-charts-oci/clusterxk8sio-machinepool-editor -n default --create-namespace --version=v0.4.18 --set apiVersion=cluster.x-k8s.io/v1beta1
```
...
```bash
$ helm upgrade -i clusterxk8sio-machinepool-editor appscode-charts-oci/clusterxk8sio-machinepool-editor -n default --create-namespace --version=v0.4.18 --values values.yaml
```
