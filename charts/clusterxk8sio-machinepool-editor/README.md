...
$ helm repo update
$ helm search repo appscode/clusterxk8sio-machinepool-editor --version=v0.16.0
$ helm upgrade -i clusterxk8sio-machinepool-editor appscode/clusterxk8sio-machinepool-editor -n default --create-namespace --version=v0.16.0
```
...
```bash
$ helm upgrade -i clusterxk8sio-machinepool-editor appscode/clusterxk8sio-machinepool-editor -n default --create-namespace --version=v0.16.0 --set apiVersion=cluster.x-k8s.io/v1beta1
```
...
```bash
$ helm upgrade -i clusterxk8sio-machinepool-editor appscode/clusterxk8sio-machinepool-editor -n default --create-namespace --version=v0.16.0 --values values.yaml
```
