...
$ helm repo update
$ helm search repo appscode/opskubedbcom-elasticsearchopsrequest-editor --version=v0.29.0
$ helm upgrade -i opskubedbcom-elasticsearchopsrequest-editor appscode/opskubedbcom-elasticsearchopsrequest-editor -n default --create-namespace --version=v0.29.0
```
...
```bash
$ helm upgrade -i opskubedbcom-elasticsearchopsrequest-editor appscode/opskubedbcom-elasticsearchopsrequest-editor -n default --create-namespace --version=v0.29.0 --set apiVersion=ops.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i opskubedbcom-elasticsearchopsrequest-editor appscode/opskubedbcom-elasticsearchopsrequest-editor -n default --create-namespace --version=v0.29.0 --values values.yaml
```
