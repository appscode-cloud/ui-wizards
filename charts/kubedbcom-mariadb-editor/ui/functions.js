...
function getClientAuthModes({
  ...
  watchDependency("model#/resources/kubedbComMariaDB/spec/version");

  const version = getValue(model, "/resources/kubedbComMariaDB/spec/version")
...
function deleteDatabaseModePath({
  ...
  if (mode === "Cluster") {
    ...
    commit("wizard/model$delete", "/resources/kubedbComMariaDB/spec/standbyMode");
    commit("wizard/model$delete", "/resources/kubedbComMariaDB/spec/leaderElectiion");
  }
}
