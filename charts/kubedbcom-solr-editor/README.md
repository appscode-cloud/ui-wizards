...
$ helm repo update
$ helm search repo appscode/kubedbcom-solr-editor --version=v0.37.0
$ helm upgrade -i kubedbcom-solr-editor appscode/kubedbcom-solr-editor -n default --create-namespace --version=v0.37.0
```
...
```bash
$ helm upgrade -i kubedbcom-solr-editor appscode/kubedbcom-solr-editor -n default --create-namespace --version=v0.37.0 --set form.alert.enabled=warning
```
...
```bash
$ helm upgrade -i kubedbcom-solr-editor appscode/kubedbcom-solr-editor -n default --create-namespace --version=v0.37.0 --values values.yaml
```
