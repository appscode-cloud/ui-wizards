...
*/}}
{{- define "kubedbcom-solr-editor.name" -}}
...
*/}}
{{- define "kubedbcom-solr-editor.fullname" -}}
...
*/}}
{{- define "kubedbcom-solr-editor.chart" -}}
...
Alert Enabled
*/}}
{{- define "kubedbcom-solr-editor.alertEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
