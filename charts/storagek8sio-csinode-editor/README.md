...
$ helm repo update
$ helm search repo appscode-charts-oci/storagek8sio-csinode-editor --version=v0.4.20
$ helm upgrade -i storagek8sio-csinode-editor appscode-charts-oci/storagek8sio-csinode-editor -n default --create-namespace --version=v0.4.20
```
...
```bash
$ helm upgrade -i storagek8sio-csinode-editor appscode-charts-oci/storagek8sio-csinode-editor -n default --create-namespace --version=v0.4.20 --set apiVersion=storage.k8s.io/v1
```
...
```bash
$ helm upgrade -i storagek8sio-csinode-editor appscode-charts-oci/storagek8sio-csinode-editor -n default --create-namespace --version=v0.4.20 --values values.yaml
```
