...
$ helm repo update
$ helm search repo appscode-charts-oci/storagek8sio-csinode-editor --version=v0.6.0
$ helm upgrade -i storagek8sio-csinode-editor appscode-charts-oci/storagek8sio-csinode-editor -n default --create-namespace --version=v0.6.0
```
...
```bash
$ helm upgrade -i storagek8sio-csinode-editor appscode-charts-oci/storagek8sio-csinode-editor -n default --create-namespace --version=v0.6.0 --set apiVersion=storage.k8s.io/v1
```
...
```bash
$ helm upgrade -i storagek8sio-csinode-editor appscode-charts-oci/storagek8sio-csinode-editor -n default --create-namespace --version=v0.6.0 --values values.yaml
```
