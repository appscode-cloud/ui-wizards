...
$ helm repo update
$ helm search repo bytebuilders-ui/storagek8sio-csinode-editor --version=v0.4.0
$ helm upgrade -i storagek8sio-csinode-editor bytebuilders-ui/storagek8sio-csinode-editor -n default --create-namespace --version=v0.4.0
```
...
```bash
$ helm upgrade -i storagek8sio-csinode-editor bytebuilders-ui/storagek8sio-csinode-editor -n default --create-namespace --version=v0.4.0 --set apiVersion=storage.k8s.io/v1
```
...
```bash
$ helm upgrade -i storagek8sio-csinode-editor bytebuilders-ui/storagek8sio-csinode-editor -n default --create-namespace --version=v0.4.0 --values values.yaml
```
