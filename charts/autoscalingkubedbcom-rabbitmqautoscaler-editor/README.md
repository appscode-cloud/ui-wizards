...
$ helm repo update
$ helm search repo appscode/autoscalingkubedbcom-rabbitmqautoscaler-editor --version=v0.33.0
$ helm upgrade -i autoscalingkubedbcom-rabbitmqautoscaler-editor appscode/autoscalingkubedbcom-rabbitmqautoscaler-editor -n default --create-namespace --version=v0.33.0
```
...
```bash
$ helm upgrade -i autoscalingkubedbcom-rabbitmqautoscaler-editor appscode/autoscalingkubedbcom-rabbitmqautoscaler-editor -n default --create-namespace --version=v0.33.0 --set apiVersion=autoscaling.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i autoscalingkubedbcom-rabbitmqautoscaler-editor appscode/autoscalingkubedbcom-rabbitmqautoscaler-editor -n default --create-namespace --version=v0.33.0 --values values.yaml
```
