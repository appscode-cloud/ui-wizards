...
$ helm repo update
$ helm search repo bytebuilders-ui/uikubedbcom-pgbouncersettings-editor --version=v0.4.18
$ helm upgrade -i uikubedbcom-pgbouncersettings-editor bytebuilders-ui/uikubedbcom-pgbouncersettings-editor -n default --create-namespace --version=v0.4.18
```
...
```bash
$ helm upgrade -i uikubedbcom-pgbouncersettings-editor bytebuilders-ui/uikubedbcom-pgbouncersettings-editor -n default --create-namespace --version=v0.4.18 --set apiVersion=ui.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i uikubedbcom-pgbouncersettings-editor bytebuilders-ui/uikubedbcom-pgbouncersettings-editor -n default --create-namespace --version=v0.4.18 --values values.yaml
```
