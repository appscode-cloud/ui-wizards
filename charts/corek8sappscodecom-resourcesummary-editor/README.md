...
$ helm repo update
$ helm search repo appscode-charts-oci/corek8sappscodecom-resourcesummary-editor --version=v0.12.0
$ helm upgrade -i corek8sappscodecom-resourcesummary-editor appscode-charts-oci/corek8sappscodecom-resourcesummary-editor -n default --create-namespace --version=v0.12.0
```
...
```bash
$ helm upgrade -i corek8sappscodecom-resourcesummary-editor appscode-charts-oci/corek8sappscodecom-resourcesummary-editor -n default --create-namespace --version=v0.12.0 --set apiVersion=core.k8s.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i corek8sappscodecom-resourcesummary-editor appscode-charts-oci/corek8sappscodecom-resourcesummary-editor -n default --create-namespace --version=v0.12.0 --values values.yaml
```
