...
$ helm repo update
$ helm search repo appscode-charts-oci/kubebindappscodecom-apiserviceexport-editor --version=v0.5.0
$ helm upgrade -i kubebindappscodecom-apiserviceexport-editor appscode-charts-oci/kubebindappscodecom-apiserviceexport-editor -n default --create-namespace --version=v0.5.0
```
...
```bash
$ helm upgrade -i kubebindappscodecom-apiserviceexport-editor appscode-charts-oci/kubebindappscodecom-apiserviceexport-editor -n default --create-namespace --version=v0.5.0 --set apiVersion=kube-bind.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i kubebindappscodecom-apiserviceexport-editor appscode-charts-oci/kubebindappscodecom-apiserviceexport-editor -n default --create-namespace --version=v0.5.0 --values values.yaml
```
