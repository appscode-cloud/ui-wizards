...
$ helm repo update
$ helm search repo appscode-charts-oci/enginekubevaultcom-azurerole-editor --version=v0.8.0
$ helm upgrade -i enginekubevaultcom-azurerole-editor appscode-charts-oci/enginekubevaultcom-azurerole-editor -n default --create-namespace --version=v0.8.0
```
...
```bash
$ helm upgrade -i enginekubevaultcom-azurerole-editor appscode-charts-oci/enginekubevaultcom-azurerole-editor -n default --create-namespace --version=v0.8.0 --set apiVersion=engine.kubevault.com/v1alpha1
```
...
```bash
$ helm upgrade -i enginekubevaultcom-azurerole-editor appscode-charts-oci/enginekubevaultcom-azurerole-editor -n default --create-namespace --version=v0.8.0 --values values.yaml
```
