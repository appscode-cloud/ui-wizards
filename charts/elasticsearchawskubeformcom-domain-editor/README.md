...
$ helm repo update
$ helm search repo bytebuilders-ui/elasticsearchawskubeformcom-domain-editor --version=v0.4.18
$ helm upgrade -i elasticsearchawskubeformcom-domain-editor bytebuilders-ui/elasticsearchawskubeformcom-domain-editor -n default --create-namespace --version=v0.4.18
```
...
```bash
$ helm upgrade -i elasticsearchawskubeformcom-domain-editor bytebuilders-ui/elasticsearchawskubeformcom-domain-editor -n default --create-namespace --version=v0.4.18 --set apiVersion=elasticsearch.aws.kubeform.com/v1alpha1
```
...
```bash
$ helm upgrade -i elasticsearchawskubeformcom-domain-editor bytebuilders-ui/elasticsearchawskubeformcom-domain-editor -n default --create-namespace --version=v0.4.18 --values values.yaml
```
