...
$ helm repo update
$ helm search repo appscode/uikubedbcom-proxysqlqueries-editor --version=v0.36.0
$ helm upgrade -i uikubedbcom-proxysqlqueries-editor appscode/uikubedbcom-proxysqlqueries-editor -n default --create-namespace --version=v0.36.0
```
...
```bash
$ helm upgrade -i uikubedbcom-proxysqlqueries-editor appscode/uikubedbcom-proxysqlqueries-editor -n default --create-namespace --version=v0.36.0 --set apiVersion=ui.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i uikubedbcom-proxysqlqueries-editor appscode/uikubedbcom-proxysqlqueries-editor -n default --create-namespace --version=v0.36.0 --values values.yaml
```
