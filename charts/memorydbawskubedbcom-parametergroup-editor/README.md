...
$ helm repo update
$ helm search repo appscode/memorydbawskubedbcom-parametergroup-editor --version=v0.27.0
$ helm upgrade -i memorydbawskubedbcom-parametergroup-editor appscode/memorydbawskubedbcom-parametergroup-editor -n default --create-namespace --version=v0.27.0
```
...
```bash
$ helm upgrade -i memorydbawskubedbcom-parametergroup-editor appscode/memorydbawskubedbcom-parametergroup-editor -n default --create-namespace --version=v0.27.0 --set apiVersion=memorydb.aws.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i memorydbawskubedbcom-parametergroup-editor appscode/memorydbawskubedbcom-parametergroup-editor -n default --create-namespace --version=v0.27.0 --values values.yaml
```
