...
$ helm repo update
$ helm search repo appscode/rdsawskubedbcom-clusterinstance-editor --version=v0.20.0
$ helm upgrade -i rdsawskubedbcom-clusterinstance-editor appscode/rdsawskubedbcom-clusterinstance-editor -n default --create-namespace --version=v0.20.0
```
...
```bash
$ helm upgrade -i rdsawskubedbcom-clusterinstance-editor appscode/rdsawskubedbcom-clusterinstance-editor -n default --create-namespace --version=v0.20.0 --set apiVersion=rds.aws.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i rdsawskubedbcom-clusterinstance-editor appscode/rdsawskubedbcom-clusterinstance-editor -n default --create-namespace --version=v0.20.0 --values values.yaml
```
