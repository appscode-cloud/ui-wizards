...
$ helm repo update
$ helm search repo appscode-charts-oci/statusgatekeepersh-constrainttemplatepodstatus-editor --version=v0.4.21
$ helm upgrade -i statusgatekeepersh-constrainttemplatepodstatus-editor appscode-charts-oci/statusgatekeepersh-constrainttemplatepodstatus-editor -n default --create-namespace --version=v0.4.21
```
...
```bash
$ helm upgrade -i statusgatekeepersh-constrainttemplatepodstatus-editor appscode-charts-oci/statusgatekeepersh-constrainttemplatepodstatus-editor -n default --create-namespace --version=v0.4.21 --set apiVersion=status.gatekeeper.sh/v1beta1
```
...
```bash
$ helm upgrade -i statusgatekeepersh-constrainttemplatepodstatus-editor appscode-charts-oci/statusgatekeepersh-constrainttemplatepodstatus-editor -n default --create-namespace --version=v0.4.21 --values values.yaml
```
