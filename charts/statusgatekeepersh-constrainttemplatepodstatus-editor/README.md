...
$ helm repo update
$ helm search repo bytebuilders-ui/statusgatekeepersh-constrainttemplatepodstatus-editor --version=v0.4.17
$ helm upgrade -i statusgatekeepersh-constrainttemplatepodstatus-editor bytebuilders-ui/statusgatekeepersh-constrainttemplatepodstatus-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i statusgatekeepersh-constrainttemplatepodstatus-editor bytebuilders-ui/statusgatekeepersh-constrainttemplatepodstatus-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=status.gatekeeper.sh/v1beta1
```
...
```bash
$ helm upgrade -i statusgatekeepersh-constrainttemplatepodstatus-editor bytebuilders-ui/statusgatekeepersh-constrainttemplatepodstatus-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
