...
*/}}
{{- define "kubedbcom-hazelcast-editor-options.name" -}}
...
*/}}
{{- define "kubedbcom-hazelcast-editor-options.fullname" -}}
...
*/}}
{{- define "kubedbcom-hazelcast-editor-options.chart" -}}
...
Common labels
*/}}
{{- define "kubedbcom-hazelcast-editor-options.labels" -}}
{{ include "kubedbcom-hazelcast-editor-options.selectorLabels" . }}
...
Selector labels
*/}}
{{- define "kubedbcom-hazelcast-editor-options.selectorLabels" -}}
app.kubernetes.io/name: hazelcasts.kubedb.com
app.kubernetes.io/instance: {{ include "kubedbcom-hazelcast-editor-options.fullname" . }}
{{- end }}

{{/*
Create the name of the service account to use
*/}}
{{- define "kubedbcom-hazelcast-editor-options.serviceAccountName" -}}
{{- if .Values.spec.serviceAccount.create }}
{{- default (include "kubedbcom-hazelcast-editor-options.fullname" .) .Values.spec.serviceAccount.name }}
{{- else }}
...
Common annotations
*/}}
{{- define "kubedbcom-hazelcast-editor-options.annotations" -}}
...
Alert Enabled
*/}}
{{- define "kubedbcom-hazelcast-editor-options.alertEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
