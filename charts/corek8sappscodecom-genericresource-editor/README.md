...
$ helm repo update
$ helm search repo bytebuilders-ui/corek8sappscodecom-genericresource-editor --version=v0.4.15
$ helm upgrade -i corek8sappscodecom-genericresource-editor bytebuilders-ui/corek8sappscodecom-genericresource-editor -n default --create-namespace --version=v0.4.15
```
...
```bash
$ helm upgrade -i corek8sappscodecom-genericresource-editor bytebuilders-ui/corek8sappscodecom-genericresource-editor -n default --create-namespace --version=v0.4.15 --set apiVersion=core.k8s.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i corek8sappscodecom-genericresource-editor bytebuilders-ui/corek8sappscodecom-genericresource-editor -n default --create-namespace --version=v0.4.15 --values values.yaml
```
