...
*/}}
{{- define "kubedbcom-hanadb-editor.name" -}}
...
*/}}
{{- define "kubedbcom-hanadb-editor.fullname" -}}
...
*/}}
{{- define "kubedbcom-hanadb-editor.chart" -}}
...
Common labels
*/}}
{{- define "kubedbcom-hanadb-editor.labels" -}}
{{ include "kubedbcom-hanadb-editor.selectorLabels" . }}
...
Selector labels
*/}}
{{- define "kubedbcom-hanadb-editor.selectorLabels" -}}
app.kubernetes.io/name: hanadbs.kubedb.com
app.kubernetes.io/instance: {{ include "kubedbcom-hanadb-editor.fullname" . }}
{{- end }}

{{/*
Create the name of the service account to use
*/}}
{{- define "kubedbcom-hanadb-editor.serviceAccountName" -}}
{{- if .Values.spec.serviceAccount.create }}
{{- default (include "kubedbcom-hanadb-editor.fullname" .) .Values.spec.serviceAccount.name }}
{{- else }}
...
Common annotations
*/}}
{{- define "kubedbcom-hanadb-editor.annotations" -}}
...
Alert Enabled
*/}}
{{- define "kubedbcom-hanadb-editor.alertEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
