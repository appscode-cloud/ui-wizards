...
$ helm repo update
$ helm search repo appscode/kubedbcom-hanadb-editor --version=v0.35.0
$ helm upgrade -i kubedbcom-hanadb-editor appscode/kubedbcom-hanadb-editor -n default --create-namespace --version=v0.35.0
```
...
```bash
$ helm upgrade -i kubedbcom-hanadb-editor appscode/kubedbcom-hanadb-editor -n default --create-namespace --version=v0.35.0 --values values.yaml
```
