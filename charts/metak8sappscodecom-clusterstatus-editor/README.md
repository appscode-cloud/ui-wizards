...
$ helm repo update
$ helm search repo appscode-charts-oci/metak8sappscodecom-clusterstatus-editor --version=v0.13.0
$ helm upgrade -i metak8sappscodecom-clusterstatus-editor appscode-charts-oci/metak8sappscodecom-clusterstatus-editor -n default --create-namespace --version=v0.13.0
```
...
```bash
$ helm upgrade -i metak8sappscodecom-clusterstatus-editor appscode-charts-oci/metak8sappscodecom-clusterstatus-editor -n default --create-namespace --version=v0.13.0 --set apiVersion=meta.k8s.appscode.com/v1alpha1
```
...
```bash
$ helm upgrade -i metak8sappscodecom-clusterstatus-editor appscode-charts-oci/metak8sappscodecom-clusterstatus-editor -n default --create-namespace --version=v0.13.0 --values values.yaml
```
