...
$ helm repo update
$ helm search repo bytebuilders-ui/controlplaneclusterxk8sio-awsmanagedcontrolplane-editor --version=v0.4.15
$ helm upgrade -i controlplaneclusterxk8sio-awsmanagedcontrolplane-editor bytebuilders-ui/controlplaneclusterxk8sio-awsmanagedcontrolplane-editor -n default --create-namespace --version=v0.4.15
```
...
```bash
$ helm upgrade -i controlplaneclusterxk8sio-awsmanagedcontrolplane-editor bytebuilders-ui/controlplaneclusterxk8sio-awsmanagedcontrolplane-editor -n default --create-namespace --version=v0.4.15 --set apiVersion=controlplane.cluster.x-k8s.io/v1beta2
```
...
```bash
$ helm upgrade -i controlplaneclusterxk8sio-awsmanagedcontrolplane-editor bytebuilders-ui/controlplaneclusterxk8sio-awsmanagedcontrolplane-editor -n default --create-namespace --version=v0.4.15 --values values.yaml
```
