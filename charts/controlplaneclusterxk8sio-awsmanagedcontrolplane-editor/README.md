...
$ helm repo update
$ helm search repo appscode-charts-oci/controlplaneclusterxk8sio-awsmanagedcontrolplane-editor --version=v0.12.0
$ helm upgrade -i controlplaneclusterxk8sio-awsmanagedcontrolplane-editor appscode-charts-oci/controlplaneclusterxk8sio-awsmanagedcontrolplane-editor -n default --create-namespace --version=v0.12.0
```
...
```bash
$ helm upgrade -i controlplaneclusterxk8sio-awsmanagedcontrolplane-editor appscode-charts-oci/controlplaneclusterxk8sio-awsmanagedcontrolplane-editor -n default --create-namespace --version=v0.12.0 --set apiVersion=controlplane.cluster.x-k8s.io/v1beta2
```
...
```bash
$ helm upgrade -i controlplaneclusterxk8sio-awsmanagedcontrolplane-editor appscode-charts-oci/controlplaneclusterxk8sio-awsmanagedcontrolplane-editor -n default --create-namespace --version=v0.12.0 --values values.yaml
```
