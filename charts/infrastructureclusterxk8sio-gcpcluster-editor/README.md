...
$ helm repo update
$ helm search repo appscode/infrastructureclusterxk8sio-gcpcluster-editor --version=v0.37.0
$ helm upgrade -i infrastructureclusterxk8sio-gcpcluster-editor appscode/infrastructureclusterxk8sio-gcpcluster-editor -n default --create-namespace --version=v0.37.0
```
...
```bash
$ helm upgrade -i infrastructureclusterxk8sio-gcpcluster-editor appscode/infrastructureclusterxk8sio-gcpcluster-editor -n default --create-namespace --version=v0.37.0 --set apiVersion=infrastructure.cluster.x-k8s.io/v1beta1
```
...
```bash
$ helm upgrade -i infrastructureclusterxk8sio-gcpcluster-editor appscode/infrastructureclusterxk8sio-gcpcluster-editor -n default --create-namespace --version=v0.37.0 --values values.yaml
```
