...
[GCPCluster Editor by AppsCode](https://byte.builders) - GCPCluster Editor
...
$ helm repo update
$ helm search repo appscode-charts-oci/infrastructureclusterxk8sio-gcpcluster-editor --version=v0.4.20
$ helm upgrade -i infrastructureclusterxk8sio-gcpcluster-editor appscode-charts-oci/infrastructureclusterxk8sio-gcpcluster-editor -n default --create-namespace --version=v0.4.20
```
...
```bash
$ helm upgrade -i infrastructureclusterxk8sio-gcpcluster-editor appscode-charts-oci/infrastructureclusterxk8sio-gcpcluster-editor -n default --create-namespace --version=v0.4.20 --set apiVersion=infrastructure.cluster.x-k8s.io/v1beta1
```
...
```bash
$ helm upgrade -i infrastructureclusterxk8sio-gcpcluster-editor appscode-charts-oci/infrastructureclusterxk8sio-gcpcluster-editor -n default --create-namespace --version=v0.4.20 --values values.yaml
```
