...
$ helm repo update
$ helm search repo appscode/azurekubedbcom-providerconfig-editor --version=v0.28.0
$ helm upgrade -i azurekubedbcom-providerconfig-editor appscode/azurekubedbcom-providerconfig-editor -n default --create-namespace --version=v0.28.0
```
...
```bash
$ helm upgrade -i azurekubedbcom-providerconfig-editor appscode/azurekubedbcom-providerconfig-editor -n default --create-namespace --version=v0.28.0 --set apiVersion=azure.kubedb.com/v1beta1
```
...
```bash
$ helm upgrade -i azurekubedbcom-providerconfig-editor appscode/azurekubedbcom-providerconfig-editor -n default --create-namespace --version=v0.28.0 --values values.yaml
```
