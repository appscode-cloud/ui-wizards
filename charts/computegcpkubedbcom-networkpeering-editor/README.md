...
$ helm repo update
$ helm search repo appscode-charts-oci/computegcpkubedbcom-networkpeering-editor --version=v0.4.18
$ helm upgrade -i computegcpkubedbcom-networkpeering-editor appscode-charts-oci/computegcpkubedbcom-networkpeering-editor -n default --create-namespace --version=v0.4.18
```
...
```bash
$ helm upgrade -i computegcpkubedbcom-networkpeering-editor appscode-charts-oci/computegcpkubedbcom-networkpeering-editor -n default --create-namespace --version=v0.4.18 --set apiVersion=compute.gcp.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i computegcpkubedbcom-networkpeering-editor appscode-charts-oci/computegcpkubedbcom-networkpeering-editor -n default --create-namespace --version=v0.4.18 --values values.yaml
```
