...
$ helm repo update
$ helm search repo appscode-charts-oci/computegcpkubedbcom-networkpeering-editor --version=v0.11.0
...
```bash
$ helm upgrade -i computegcpkubedbcom-networkpeering-editor appscode-charts-oci/computegcpkubedbcom-networkpeering-editor -n default --create-namespace --version=v0.11.0 --set apiVersion=compute.gcp.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i computegcpkubedbcom-networkpeering-editor appscode-charts-oci/computegcpkubedbcom-networkpeering-editor -n default --create-namespace --version=v0.11.0 --values values.yaml
```
