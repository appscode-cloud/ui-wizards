...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/dbforpostgresqlazurekubeformcom-database-editor --version=v0.4.17
$ helm upgrade -i dbforpostgresqlazurekubeformcom-database-editor bytebuilders-ui-dev/dbforpostgresqlazurekubeformcom-database-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i dbforpostgresqlazurekubeformcom-database-editor bytebuilders-ui-dev/dbforpostgresqlazurekubeformcom-database-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=dbforpostgresql.azure.kubeform.com/v1alpha1
```
...
```bash
$ helm upgrade -i dbforpostgresqlazurekubeformcom-database-editor bytebuilders-ui-dev/dbforpostgresqlazurekubeformcom-database-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
