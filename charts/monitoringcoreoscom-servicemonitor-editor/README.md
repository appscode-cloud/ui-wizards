...
$ helm repo update
$ helm search repo appscode-charts-oci/monitoringcoreoscom-servicemonitor-editor --version=v0.4.19
$ helm upgrade -i monitoringcoreoscom-servicemonitor-editor appscode-charts-oci/monitoringcoreoscom-servicemonitor-editor -n default --create-namespace --version=v0.4.19
```
...
```bash
$ helm upgrade -i monitoringcoreoscom-servicemonitor-editor appscode-charts-oci/monitoringcoreoscom-servicemonitor-editor -n default --create-namespace --version=v0.4.19 --set apiVersion=monitoring.coreos.com/v1
```
...
```bash
$ helm upgrade -i monitoringcoreoscom-servicemonitor-editor appscode-charts-oci/monitoringcoreoscom-servicemonitor-editor -n default --create-namespace --version=v0.4.19 --values values.yaml
```
