...
$ helm repo update
$ helm search repo appscode-charts-oci/monitoringcoreoscom-servicemonitor-editor --version=v0.12.0
$ helm upgrade -i monitoringcoreoscom-servicemonitor-editor appscode-charts-oci/monitoringcoreoscom-servicemonitor-editor -n default --create-namespace --version=v0.12.0
```
...
```bash
$ helm upgrade -i monitoringcoreoscom-servicemonitor-editor appscode-charts-oci/monitoringcoreoscom-servicemonitor-editor -n default --create-namespace --version=v0.12.0 --set apiVersion=monitoring.coreos.com/v1
```
...
```bash
$ helm upgrade -i monitoringcoreoscom-servicemonitor-editor appscode-charts-oci/monitoringcoreoscom-servicemonitor-editor -n default --create-namespace --version=v0.12.0 --values values.yaml
```
