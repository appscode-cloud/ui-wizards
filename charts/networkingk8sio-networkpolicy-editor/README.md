...
$ helm repo update
$ helm search repo appscode-charts-oci/networkingk8sio-networkpolicy-editor --version=v0.13.0
$ helm upgrade -i networkingk8sio-networkpolicy-editor appscode-charts-oci/networkingk8sio-networkpolicy-editor -n default --create-namespace --version=v0.13.0
```
...
```bash
$ helm upgrade -i networkingk8sio-networkpolicy-editor appscode-charts-oci/networkingk8sio-networkpolicy-editor -n default --create-namespace --version=v0.13.0 --set apiVersion=networking.k8s.io/v1
```
...
```bash
$ helm upgrade -i networkingk8sio-networkpolicy-editor appscode-charts-oci/networkingk8sio-networkpolicy-editor -n default --create-namespace --version=v0.13.0 --values values.yaml
```
