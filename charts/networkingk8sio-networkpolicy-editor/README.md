...
$ helm repo update
$ helm search repo bytebuilders-ui/networkingk8sio-networkpolicy-editor --version=v0.3.1
$ helm upgrade -i networkingk8sio-networkpolicy-editor bytebuilders-ui/networkingk8sio-networkpolicy-editor -n default --create-namespace --version=v0.3.1
```
...
```bash
$ helm upgrade -i networkingk8sio-networkpolicy-editor bytebuilders-ui/networkingk8sio-networkpolicy-editor -n default --create-namespace --version=v0.3.1 --set apiVersion=networking.k8s.io/v1
```
...
```bash
$ helm upgrade -i networkingk8sio-networkpolicy-editor bytebuilders-ui/networkingk8sio-networkpolicy-editor -n default --create-namespace --version=v0.3.1 --values values.yaml
```
