...
$ helm repo update
$ helm search repo appscode/networkingk8sio-networkpolicy-editor --version=v0.28.0
$ helm upgrade -i networkingk8sio-networkpolicy-editor appscode/networkingk8sio-networkpolicy-editor -n default --create-namespace --version=v0.28.0
```
...
```bash
$ helm upgrade -i networkingk8sio-networkpolicy-editor appscode/networkingk8sio-networkpolicy-editor -n default --create-namespace --version=v0.28.0 --set apiVersion=networking.k8s.io/v1
```
...
```bash
$ helm upgrade -i networkingk8sio-networkpolicy-editor appscode/networkingk8sio-networkpolicy-editor -n default --create-namespace --version=v0.28.0 --values values.yaml
```
