...
$ helm repo update
$ helm install core-pod-editor bytebuilders-ui-dev/core-pod-editor -n default
```
...
```console
$ helm install core-pod-editor bytebuilders-ui-dev/core-pod-editor -n default --set apiVersion=/v1
```
...
```console
$ helm install core-pod-editor bytebuilders-ui-dev/core-pod-editor -n default --values values.yaml
```
