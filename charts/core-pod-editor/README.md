...
$ helm repo update
$ helm search repo appscode-charts-oci/core-pod-editor --version=v0.6.0
$ helm upgrade -i core-pod-editor appscode-charts-oci/core-pod-editor -n default --create-namespace --version=v0.6.0
```
...
```bash
$ helm upgrade -i core-pod-editor appscode-charts-oci/core-pod-editor -n default --create-namespace --version=v0.6.0 --set apiVersion=v1
```
...
```bash
$ helm upgrade -i core-pod-editor appscode-charts-oci/core-pod-editor -n default --create-namespace --version=v0.6.0 --values values.yaml
```
