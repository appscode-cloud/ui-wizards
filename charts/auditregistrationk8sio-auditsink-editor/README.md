...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/auditregistrationk8sio-auditsink-editor --version=v0.4.17
$ helm upgrade -i auditregistrationk8sio-auditsink-editor bytebuilders-ui-dev/auditregistrationk8sio-auditsink-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i auditregistrationk8sio-auditsink-editor bytebuilders-ui-dev/auditregistrationk8sio-auditsink-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=auditregistration.k8s.io/v1alpha1
```
...
```bash
$ helm upgrade -i auditregistrationk8sio-auditsink-editor bytebuilders-ui-dev/auditregistrationk8sio-auditsink-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
