...
$ helm repo update
$ helm search repo appscode-charts-oci/auditregistrationk8sio-auditsink-editor --version=v0.13.0
$ helm upgrade -i auditregistrationk8sio-auditsink-editor appscode-charts-oci/auditregistrationk8sio-auditsink-editor -n default --create-namespace --version=v0.13.0
```
...
```bash
$ helm upgrade -i auditregistrationk8sio-auditsink-editor appscode-charts-oci/auditregistrationk8sio-auditsink-editor -n default --create-namespace --version=v0.13.0 --set apiVersion=auditregistration.k8s.io/v1alpha1
```
...
```bash
$ helm upgrade -i auditregistrationk8sio-auditsink-editor appscode-charts-oci/auditregistrationk8sio-auditsink-editor -n default --create-namespace --version=v0.13.0 --values values.yaml
```
