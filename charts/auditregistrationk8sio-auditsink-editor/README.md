...
$ helm repo update
$ helm search repo appscode/auditregistrationk8sio-auditsink-editor --version=v0.28.0
$ helm upgrade -i auditregistrationk8sio-auditsink-editor appscode/auditregistrationk8sio-auditsink-editor -n default --create-namespace --version=v0.28.0
```
...
```bash
$ helm upgrade -i auditregistrationk8sio-auditsink-editor appscode/auditregistrationk8sio-auditsink-editor -n default --create-namespace --version=v0.28.0 --set apiVersion=auditregistration.k8s.io/v1alpha1
```
...
```bash
$ helm upgrade -i auditregistrationk8sio-auditsink-editor appscode/auditregistrationk8sio-auditsink-editor -n default --create-namespace --version=v0.28.0 --values values.yaml
```
