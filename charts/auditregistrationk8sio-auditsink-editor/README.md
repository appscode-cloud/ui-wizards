...
$ helm repo update
$ helm search repo bytebuilders-ui/auditregistrationk8sio-auditsink-editor --version=v0.3.1
$ helm upgrade -i auditregistrationk8sio-auditsink-editor bytebuilders-ui/auditregistrationk8sio-auditsink-editor -n default --create-namespace --version=v0.3.1
```
...
```bash
$ helm upgrade -i auditregistrationk8sio-auditsink-editor bytebuilders-ui/auditregistrationk8sio-auditsink-editor -n default --create-namespace --version=v0.3.1 --set apiVersion=auditregistration.k8s.io/v1alpha1
```
...
```bash
$ helm upgrade -i auditregistrationk8sio-auditsink-editor bytebuilders-ui/auditregistrationk8sio-auditsink-editor -n default --create-namespace --version=v0.3.1 --values values.yaml
```
