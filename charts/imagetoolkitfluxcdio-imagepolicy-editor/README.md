...
$ helm repo update
$ helm search repo bytebuilders-ui/imagetoolkitfluxcdio-imagepolicy-editor --version=v0.4.16
$ helm upgrade -i imagetoolkitfluxcdio-imagepolicy-editor bytebuilders-ui/imagetoolkitfluxcdio-imagepolicy-editor -n default --create-namespace --version=v0.4.16
```
...
```bash
$ helm upgrade -i imagetoolkitfluxcdio-imagepolicy-editor bytebuilders-ui/imagetoolkitfluxcdio-imagepolicy-editor -n default --create-namespace --version=v0.4.16 --set apiVersion=image.toolkit.fluxcd.io/v1beta1
```
...
```bash
$ helm upgrade -i imagetoolkitfluxcdio-imagepolicy-editor bytebuilders-ui/imagetoolkitfluxcdio-imagepolicy-editor -n default --create-namespace --version=v0.4.16 --values values.yaml
```
