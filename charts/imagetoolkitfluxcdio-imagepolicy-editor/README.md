...
$ helm repo update
$ helm search repo bytebuilders-ui-dev/imagetoolkitfluxcdio-imagepolicy-editor --version=v0.4.17
$ helm upgrade -i imagetoolkitfluxcdio-imagepolicy-editor bytebuilders-ui-dev/imagetoolkitfluxcdio-imagepolicy-editor -n default --create-namespace --version=v0.4.17
```
...
```bash
$ helm upgrade -i imagetoolkitfluxcdio-imagepolicy-editor bytebuilders-ui-dev/imagetoolkitfluxcdio-imagepolicy-editor -n default --create-namespace --version=v0.4.17 --set apiVersion=image.toolkit.fluxcd.io/v1beta1
```
...
```bash
$ helm upgrade -i imagetoolkitfluxcdio-imagepolicy-editor bytebuilders-ui-dev/imagetoolkitfluxcdio-imagepolicy-editor -n default --create-namespace --version=v0.4.17 --values values.yaml
```
