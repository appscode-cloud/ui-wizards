...
*/}}
{{- define "kubedbcom-pgpool-editor-options.name" -}}
...
*/}}
{{- define "kubedbcom-pgpool-editor-options.fullname" -}}
...
*/}}
{{- define "kubedbcom-pgpool-editor-options.chart" -}}
...
Common labels
*/}}
{{- define "kubedbcom-pgpool-editor-options.labels" -}}
{{ include "kubedbcom-pgpool-editor-options.selectorLabels" . }}
...
Selector labels
*/}}
{{- define "kubedbcom-pgpool-editor-options.selectorLabels" -}}
app.kubernetes.io/name: pgpools.kubedb.com
app.kubernetes.io/instance: {{ include "kubedbcom-pgpool-editor-options.fullname" . }}
{{- end }}

{{/*
Create the name of the service account to use
*/}}
{{- define "kubedbcom-pgpool-editor-options.serviceAccountName" -}}
{{- if .Values.spec.serviceAccount.create }}
{{- default (include "kubedbcom-pgpool-editor-options.fullname" .) .Values.spec.serviceAccount.name }}
{{- else }}
...
Common annotations
*/}}
{{- define "kubedbcom-pgpool-editor-options.annotations" -}}
...
Alert Enabled
*/}}
{{- define "kubedbcom-pgpool-editor-options.alertEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
