...
$ helm repo update
$ helm search repo appscode/kubedbcom-documentdb-editor --version=v0.32.0
$ helm upgrade -i kubedbcom-documentdb-editor appscode/kubedbcom-documentdb-editor -n default --create-namespace --version=v0.32.0
```
...
```bash
$ helm upgrade -i kubedbcom-documentdb-editor appscode/kubedbcom-documentdb-editor -n default --create-namespace --version=v0.32.0 --set apiVersion=kubedb.com/v1alpha2
```
...
```bash
$ helm upgrade -i kubedbcom-documentdb-editor appscode/kubedbcom-documentdb-editor -n default --create-namespace --version=v0.32.0 --values values.yaml
```
