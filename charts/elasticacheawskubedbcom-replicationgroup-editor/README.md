...
$ helm repo update
$ helm search repo appscode/elasticacheawskubedbcom-replicationgroup-editor --version=v0.25.0
$ helm upgrade -i elasticacheawskubedbcom-replicationgroup-editor appscode/elasticacheawskubedbcom-replicationgroup-editor -n default --create-namespace --version=v0.25.0
```
...
```bash
$ helm upgrade -i elasticacheawskubedbcom-replicationgroup-editor appscode/elasticacheawskubedbcom-replicationgroup-editor -n default --create-namespace --version=v0.25.0 --set apiVersion=elasticache.aws.kubedb.com/v1alpha1
```
...
```bash
$ helm upgrade -i elasticacheawskubedbcom-replicationgroup-editor appscode/elasticacheawskubedbcom-replicationgroup-editor -n default --create-namespace --version=v0.25.0 --values values.yaml
```
