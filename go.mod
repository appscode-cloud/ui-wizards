...
require (
	...
	kubepack.dev/lib-app v0.0.6-0.20220402111129-39540d8d9e1c
)
...
require (
	...
	kmodules.xyz/client-go v0.0.0-20220317213815-2a6d5a5784f2 // indirect
	kubepack.dev/kubepack v0.3.9-0.20220201033352-575b50c5a43d // indirect
