...
type KubedbcomDruidEditorOptionsSpecSpec struct {
	...
	// +optional
	ServiceTemplates []DruidServiceTemplate `json:"serviceTemplates,omitempty"`
...
type DruidServiceAlias string

type DruidServiceTemplate struct {
	Alias DruidServiceAlias `json:"alias"`
	// +optional
