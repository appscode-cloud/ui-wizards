...
type KubedbcomDocumentDBEditorOptionsSpecSpec struct {
	...
	// +optional
	ServiceTemplates []DocumentDBServiceTemplate `json:"serviceTemplates,omitempty"`
...
type DocumentDBServiceAlias string

type DocumentDBServiceTemplate struct {
	Alias DocumentDBServiceAlias `json:"alias"`
	// +optional
