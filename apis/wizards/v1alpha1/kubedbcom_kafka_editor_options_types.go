...
type KubedbcomKafkaEditorOptionsSpecSpec struct {
	...
	// +optional
	ServiceTemplates []KafkaServiceTemplate `json:"serviceTemplates,omitempty"`
...
type KafkaServiceAlias string

type KafkaServiceTemplate struct {
	Alias KafkaServiceAlias `json:"alias"`
	// +optional
